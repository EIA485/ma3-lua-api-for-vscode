...
---@return string | integer | integer | nil value
function GetVar(variableSetHandle, varName)
    return ""
end
...
---@param block boolean
---@param _showInfo? boolean @Optional
function SetBlockInput(block, _showInfo)
end
