...
---@field MulticastBase MultiCastBase
---@field Interface string
---@field MasterPriority MasterPriority
---@field PUPriority PUPriority
---@field Status HostStatus
---@field Functional YesNo|boolean
---@field SessionManager YesNo|boolean
---@field RemoteIP Network.IP8
---@field EnableNetwork YesNo|boolean
---@field EnableRemotes YesNo|boolean
---@field EnableInvite YesNo|boolean
---@field EnablesFTP YesNo|boolean
---@field PlaybackDataMerge YesNo|boolean
---@field DisableTimeouts YesNo|boolean
---@field EnableRemoteHID YesNo|boolean
---@field Version Stream.Version
---@field Branch BuildType
---@field PacketLossSimulation integer
---@field PacketLossRandomized YesNo|boolean
---@field HostStatusStable YesNo|boolean
---@field HostType HostType
---@field HostSubType HostSubType
---@field SessionFilter NetworkFilter
---@field SoftwareFilter NetworkFilter
---@field ExtraStatusInfo ExtraStatusInfo
...
---@generic T : MAnetSocket
---@param class `T`
---@return boolean
function MAnetSocket:IsClass(class) end
---@return Root
function MAnetSocket:Parent() end
---@return 47
function MAnetSocket:PropertyCount() end
...
---@overload fun(idx: 15): "HostName"
---@overload fun(idx: 16): "Session"
---@overload fun(idx: 17): "Location"
---@overload fun(idx: 18): "Showfile"
---@overload fun(idx: 19): "PrimaryIp"
---@overload fun(idx: 20): "MulticastBase"
---@overload fun(idx: 21): "Interface"
---@overload fun(idx: 22): "MasterPriority"
---@overload fun(idx: 23): "PUPriority"
---@overload fun(idx: 24): "Status"
---@overload fun(idx: 25): "Functional"
---@overload fun(idx: 26): "SessionManager"
---@overload fun(idx: 27): "RemoteIP"
---@overload fun(idx: 28): "EnableNetwork"
---@overload fun(idx: 29): "EnableRemotes"
---@overload fun(idx: 30): "EnableInvite"
---@overload fun(idx: 31): "EnablesFTP"
---@overload fun(idx: 32): "PlaybackDataMerge"
---@overload fun(idx: 33): "DisableTimeouts"
---@overload fun(idx: 34): "EnableRemoteHID"
---@overload fun(idx: 35): "Version"
---@overload fun(idx: 36): "Branch"
---@overload fun(idx: 37): "PacketLossSimulation"
---@overload fun(idx: 38): "PacketLossRandomized"
---@overload fun(idx: 39): "HostStatusStable"
---@overload fun(idx: 40): "HostType"
---@overload fun(idx: 41): "HostSubType"
---@overload fun(idx: 42): "SessionFilter"
---@overload fun(idx: 43): "SoftwareFilter"
---@overload fun(idx: 44): "ExtraStatusInfo"
---@overload fun(idx: 45): "SelectedUpdateFile"
---@overload fun(idx: 46): "ExtraInitPackets"
function MAnetSocket:PropertyName(idx) end
---@overload fun(idx: 0|1|2|25|26|39): {ExportIgnore: True, EnumCollection: YesNo, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 3|12|28|29|30|31|32|33|34|38): {ExportIgnore: False, EnumCollection: YesNo, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 4|5|6|19|35|36): {ExportIgnore: True, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 7|8|13|15|16|17|18|21|27|37|45|46): {ExportIgnore: False, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 9): {ExportIgnore: False, EnumCollection: YesNo, ReadOnly: True, ImportIgnore: True}
---@overload fun(idx: 10|11): {ExportIgnore: True, EnumCollection: YesNo, ReadOnly: True, ImportIgnore: True}
---@overload fun(idx: 14): {ExportIgnore: False, ReadOnly: True, ImportIgnore: True}
---@overload fun(idx: 20): {ExportIgnore: False, EnumCollection: MultiCastBase, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 22): {ExportIgnore: False, EnumCollection: MasterPriority, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 23): {ExportIgnore: True, EnumCollection: PUPriority, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 24): {ExportIgnore: True, EnumCollection: HostStatus, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 40): {ExportIgnore: True, EnumCollection: HostType, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 41): {ExportIgnore: True, EnumCollection: HostSubType, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 42|43): {ExportIgnore: False, EnumCollection: NetworkFilter, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 44): {ExportIgnore: True, EnumCollection: ExtraStatusInfo, ReadOnly: False, ImportIgnore: False}
function MAnetSocket:PropertyInfo(idx) end
---@overload fun(idx: 0|1|2|3|4|5|6|9|28|29|30|31|32|33|34|36|37): "UInt32"
---@overload fun(idx: 7|8|13|15|16|17|18|21|45): "String"
---@overload fun(idx: 10|11|25|26|38|39): "Bool"
---@overload fun(idx: 12): "UInt64"
---@overload fun(idx: 14): "Int64"
---@overload fun(idx: 19|20|27|35): "Custom"
---@overload fun(idx: 22|23|24|40|41|42|43|44|46): "UInt8"
function MAnetSocket:PropertyType(idx) end
---@overload fun(name: "Branch", role: nil): BuildType
---@overload fun(name: "ExtraStatusInfo", role: nil): ExtraStatusInfo
---@overload fun(name: "Status", role: nil): HostStatus
---@overload fun(name: "HostSubType", role: nil): HostSubType
---@overload fun(name: "HostType", role: nil): HostType
---@overload fun(name: "PrimaryIp", role: nil): Manet.IP4
---@overload fun(name: "MasterPriority", role: nil): MasterPriority
---@overload fun(name: "MulticastBase", role: nil): MultiCastBase
---@overload fun(name: "RemoteIP", role: nil): Network.IP8
---@overload fun(name: "SessionFilter"|"SoftwareFilter", role: nil): NetworkFilter
---@overload fun(name: "PUPriority", role: nil): PUPriority
---@overload fun(name: "Version", role: nil): Stream.Version
---@overload fun(name: "IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"UserExpanded"|"FaderEnabled"|"Owned"|"Hidden"|"Functional"|"SessionManager"|"EnableNetwork"|"EnableRemotes"|"EnableInvite"|"EnablesFTP"|"PlaybackDataMerge"|"DisableTimeouts"|"EnableRemoteHID"|"PacketLossRandomized"|"HostStatusStable", role: nil): YesNo|boolean
---@overload fun(name: "Index"|"Count"|"No"|"MemoryFootprint"|"PacketLossSimulation"|"ExtraInitPackets", role: nil): integer
---@overload fun(name: "Name"|"Note"|"DependencyExport"|"HostName"|"Session"|"Location"|"Showfile"|"Interface"|"SelectedUpdateFile", role: nil): string
...
---@overload fun(property_name: "Branch", property_value: BuildType, override_change_level: ChangeLevel?)
---@overload fun(property_name: "ExtraStatusInfo", property_value: ExtraStatusInfo, override_change_level: ChangeLevel?)
---@overload fun(property_name: "Status", property_value: HostStatus, override_change_level: ChangeLevel?)
...
---@overload fun(property_name: "PrimaryIp", property_value: Manet.IP4, override_change_level: ChangeLevel?)
---@overload fun(property_name: "MasterPriority", property_value: MasterPriority, override_change_level: ChangeLevel?)
---@overload fun(property_name: "MulticastBase", property_value: MultiCastBase, override_change_level: ChangeLevel?)
---@overload fun(property_name: "RemoteIP", property_value: Network.IP8, override_change_level: ChangeLevel?)
---@overload fun(property_name: "SessionFilter"|"SoftwareFilter", property_value: NetworkFilter, override_change_level: ChangeLevel?)
---@overload fun(property_name: "PUPriority", property_value: PUPriority, override_change_level: ChangeLevel?)
---@overload fun(property_name: "Version", property_value: Stream.Version, override_change_level: ChangeLevel?)
---@overload fun(property_name: "IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"Hidden"|"Functional"|"SessionManager"|"EnableNetwork"|"EnableRemotes"|"EnableInvite"|"EnablesFTP"|"PlaybackDataMerge"|"DisableTimeouts"|"EnableRemoteHID"|"PacketLossRandomized"|"HostStatusStable", property_value: YesNo|boolean, override_change_level: ChangeLevel?)
---@overload fun(property_name: "Index"|"Count"|"No"|"PacketLossSimulation"|"ExtraInitPackets", property_value: integer, override_change_level: ChangeLevel?)
---@overload fun(property_name: "Name"|"Note"|"DependencyExport"|"HostName"|"Session"|"Location"|"Showfile"|"Interface"|"SelectedUpdateFile", property_value: string, override_change_level: ChangeLevel?)
function MAnetSocket:Set(property_name, property_value, override_change_level) end
...
function MAnetSocket:SetChildren(property_name, property_value) end