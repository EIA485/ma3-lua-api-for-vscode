...
---@overload fun(name: "HostName"|"Session"|"Location"|"Showfile", role: nil): string
...
---@overload fun(name: "Functional"|"SessionManager", role: nil): boolean
---@overload fun(name: "RemoteIP", role: nil): Network.IP8
---@overload fun(name: "EnableNetwork"|"EnableRemotes"|"EnableInvite"|"EnablesFTP"|"PlaybackDataMerge"|"DisableTimeouts"|"EnableRemoteHID", role: nil): integer
---@overload fun(name: "Version", role: nil): Stream.Version
---@overload fun(name: "Branch", role: nil): BuildType
---@overload fun(name: "PacketLossSimulation", role: nil): integer
---@overload fun(name: "PacketLossRandomized"|"HostStatusStable", role: nil): boolean
---@overload fun(name: "HostType", role: nil): HostType
---@overload fun(name: "HostSubType", role: nil): HostSubType
---@overload fun(name: "SessionFilter"|"SoftwareFilter"|"ExtraStatusInfo", role: nil): integer
---@overload fun(name: "SelectedUpdateFile", role: nil): string
---@overload fun(name: "ExtraInitPackets", role: nil): integer
---@overload fun(name: "IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"Index"|"Count"|"No"|"Name"|"Note"|"UserExpanded"|"FaderEnabled"|"Owned"|"Hidden"|"DependencyExport"|"MemoryFootprint"|"HostName"|"Session"|"Location"|"Showfile"|"PrimaryIp"|"MulticastBase"|"Interface"|"MasterPriority"|"PUPriority"|"Status"|"Functional"|"SessionManager"|"RemoteIP"|"EnableNetwork"|"EnableRemotes"|"EnableInvite"|"EnablesFTP"|"PlaybackDataMerge"|"DisableTimeouts"|"EnableRemoteHID"|"Version"|"Branch"|"PacketLossSimulation"|"PacketLossRandomized"|"HostStatusStable"|"HostType"|"HostSubType"|"SessionFilter"|"SoftwareFilter"|"ExtraStatusInfo"|"SelectedUpdateFile"|"ExtraInitPackets", role: Enums.Roles): string
...
---@overload fun(index: integer, class: "HostTypes", undo: Undo?): HostTypes
---@overload fun(index: integer, class: "Sessions", undo: Undo?): Sessions
...
---@overload fun(class: "HostTypes", undo: Undo?, count: integer?): HostTypes
---@overload fun(class: "Sessions", undo: Undo?, count: integer?): Sessions
...
---@overload fun(class: "HostTypes", undo: Undo?): HostTypes
---@overload fun(class: "Sessions", undo: Undo?): Sessions
...
---@overload fun(index: integer, class: "HostTypes", undo: Undo?, count: integer?): HostTypes
---@overload fun(index: integer, class: "Sessions", undo: Undo?, count: integer?): Sessions
...
---@overload fun(name: string, class: "HostTypes"): HostTypes
---@overload fun(name: string, class: "Sessions"): Sessions
...
function MAnetSocket:Find(name, class) end
---@overload fun(name: string, class: "Object"): Object
---@overload fun(name: string, class: "MVRxchange"): MVRxchange
---@overload fun(name: string, class: "SmartViewSettingsCollect"): SmartViewSettingsCollect
---@overload fun(name: string, class: "RunningPlaybacksSettingsCollect"): RunningPlaybacksSettingsCollect
...
---@overload fun(name: string, class: "IllegalObject"): IllegalObject
---@overload fun(name: string, class: nil): Object
function MAnetSocket:FindRecursive(name, class) end
