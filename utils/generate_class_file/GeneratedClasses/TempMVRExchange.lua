...
---@overload fun(class: "NoteTextEdit", undo: Undo?): NoteTextEdit
---@overload fun(class: nil, undo: Undo?): Object
function TempMVRExchange:Find(class, undo) end
...
function TempMVRExchange:SetChildren(property_name, property_value) end