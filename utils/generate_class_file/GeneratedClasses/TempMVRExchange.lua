...
---@class TempMVRExchange: Object
local TempMVRExchange = {}
---@return "TempMVRExchange"
function TempMVRExchange:GetClass() end
---@return "Object"
function TempMVRExchange:GetChildClass() end
---@return Temp
function TempMVRExchange:Parent() end
---@overload fun(index: integer, class: "Object", undo: Undo?): Object
---@overload fun(index: integer, class: "MVRFileCollect", undo: Undo?): MVRFileCollect
---@overload fun(index: integer, class: "MVRServiceCollect", undo: Undo?): MVRServiceCollect
...
function TempMVRExchange:Create(index, class, undo) end
---@overload fun(class: "Object", undo: Undo?, count: integer?): Object
---@overload fun(class: "MVRFileCollect", undo: Undo?, count: integer?): MVRFileCollect
---@overload fun(class: "MVRServiceCollect", undo: Undo?, count: integer?): MVRServiceCollect
...
function TempMVRExchange:Append(class, undo, count) end
---@overload fun(class: "Object", undo: Undo?): Object
---@overload fun(class: "MVRFileCollect", undo: Undo?): MVRFileCollect
---@overload fun(class: "MVRServiceCollect", undo: Undo?): MVRServiceCollect
...
function TempMVRExchange:Acquire(class, undo) end
---@overload fun(class: "Object", undo: Undo?): Object
---@overload fun(class: "MVRFileCollect", undo: Undo?): MVRFileCollect
---@overload fun(class: "MVRServiceCollect", undo: Undo?): MVRServiceCollect
---@overload fun(class: "MVRxchange", undo: Undo?): MVRxchange
...
function TempMVRExchange:Aquire(class, undo) end
---@overload fun(index: integer, class: "Object", undo: Undo?, count: integer?): Object
---@overload fun(index: integer, class: "MVRFileCollect", undo: Undo?, count: integer?): MVRFileCollect
---@overload fun(index: integer, class: "MVRServiceCollect", undo: Undo?, count: integer?): MVRServiceCollect
...
function TempMVRExchange:Insert(index, class, undo, count) end
---@overload fun(name: string, class: "Object"): Object
---@overload fun(name: string, class: "MVRFileCollect"): MVRFileCollect
---@overload fun(name: string, class: "MVRServiceCollect"): MVRServiceCollect
...
function TempMVRExchange:Find(name, class) end
---@overload fun(name: string, class: "Object"): Object
---@overload fun(name: string, class: "MVRFileCollect"): MVRFileCollect
---@overload fun(name: string, class: "MVRServiceCollect"): MVRServiceCollect
---@overload fun(name: string, class: "MVRxchange"): MVRxchange
...
---@overload fun(name: string, class: "IllegalObject"): IllegalObject
---@overload fun(name: string, class: nil): Object
function TempMVRExchange:FindRecursive(name, class) end
