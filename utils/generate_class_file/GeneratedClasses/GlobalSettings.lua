...
---@field ExportCachedObjectsOnShowSave YesNo|boolean
---@field Accepted3rdParty YesNo|boolean
---@field EnumShowFileNameWhenDescriptionChanges YesNo|boolean
---@field TimecodeEventsRecordingfrom TimecodeSingleUserRecord
---@field DSCPDMX DSCPCodesDMX
---@field DSCPMANetData DSCPCodes
---@field DSCPNetworkUpdate DSCPCodes
---@field DSCPDMXProtocols DSCPCodes
---@field DSCPInOutProtocols DSCPCodes
---@field TTL TTL
---@field DSCPConfiguration integer
---@field DataMergeDefaultMode DataNegotiationModeDefault
---@field DataMergeDefaultTimeout DataMergeTimeout
...
---@generic T : GlobalSettings
---@param class `T`
---@return boolean
function GlobalSettings:IsClass(class) end
---@return ShowSettings
function GlobalSettings:Parent() end
---@return 32
function GlobalSettings:PropertyCount() end
...
---@overload fun(idx: 15): "AutosaveInterval"
---@overload fun(idx: 16): "AutoSaveCurrentTime"
---@overload fun(idx: 17): "AutoSaveStartTime"
---@overload fun(idx: 18): "AutoSaveCountdown"
---@overload fun(idx: 19): "ExportCachedObjectsOnShowSave"
---@overload fun(idx: 20): "Accepted3rdParty"
---@overload fun(idx: 21): "EnumShowFileNameWhenDescriptionChanges"
---@overload fun(idx: 22): "TimecodeEventsRecordingfrom"
---@overload fun(idx: 23): "DSCPDMX"
---@overload fun(idx: 24): "DSCPMANetData"
---@overload fun(idx: 25): "DSCPNetworkUpdate"
---@overload fun(idx: 26): "DSCPDMXProtocols"
---@overload fun(idx: 27): "DSCPInOutProtocols"
---@overload fun(idx: 28): "TTL"
---@overload fun(idx: 29): "DSCPConfiguration"
---@overload fun(idx: 30): "DataMergeDefaultMode"
---@overload fun(idx: 31): "DataMergeDefaultTimeout"
function GlobalSettings:PropertyName(idx) end
---@overload fun(idx: 0|1|2): {ExportIgnore: True, EnumCollection: YesNo, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 3|12|19|20|21): {ExportIgnore: False, EnumCollection: YesNo, ReadOnly: False, ImportIgnore: False}
...
---@overload fun(idx: 14|29): {ExportIgnore: False, ReadOnly: True, ImportIgnore: True}
---@overload fun(idx: 15): {ExportIgnore: False, EnumCollection: AutoSaveMode, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 22): {ExportIgnore: False, EnumCollection: TimecodeSingleUserRecord, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 23): {ExportIgnore: False, EnumCollection: DSCPCodesDMX, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 24|25|26|27): {ExportIgnore: False, EnumCollection: DSCPCodes, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 28): {ExportIgnore: False, EnumCollection: TTL, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 30): {ExportIgnore: False, EnumCollection: DataNegotiationModeDefault, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 31): {ExportIgnore: False, EnumCollection: DataMergeTimeout, ReadOnly: False, ImportIgnore: False}
function GlobalSettings:PropertyInfo(idx) end
---@overload fun(idx: 0|1|2|3|4|5|6|9|16|17): "UInt32"
---@overload fun(idx: 7|8|13|18): "String"
---@overload fun(idx: 10|11): "Bool"
---@overload fun(idx: 12|19|20|21|22): "UInt64"
---@overload fun(idx: 14): "Int64"
---@overload fun(idx: 15|23|24|25|26|27|28|29|30): "UInt8"
---@overload fun(idx: 31): "Int64Time"
function GlobalSettings:PropertyType(idx) end
---@overload fun(name: "AutosaveInterval", role: nil): AutoSaveMode
---@overload fun(name: "DSCPMANetData"|"DSCPNetworkUpdate"|"DSCPDMXProtocols"|"DSCPInOutProtocols", role: nil): DSCPCodes
---@overload fun(name: "DSCPDMX", role: nil): DSCPCodesDMX
---@overload fun(name: "DataMergeDefaultTimeout", role: nil): DataMergeTimeout
---@overload fun(name: "DataMergeDefaultMode", role: nil): DataNegotiationModeDefault
---@overload fun(name: "TTL", role: nil): TTL
---@overload fun(name: "TimecodeEventsRecordingfrom", role: nil): TimecodeSingleUserRecord
---@overload fun(name: "IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"UserExpanded"|"FaderEnabled"|"Owned"|"Hidden"|"ExportCachedObjectsOnShowSave"|"Accepted3rdParty"|"EnumShowFileNameWhenDescriptionChanges", role: nil): YesNo|boolean
---@overload fun(name: "Index"|"Count"|"No"|"MemoryFootprint"|"AutoSaveCurrentTime"|"AutoSaveStartTime"|"DSCPConfiguration", role: nil): integer
---@overload fun(name: "Name"|"Note"|"DependencyExport"|"AutoSaveCountdown", role: nil): string
...
---@overload fun(property_name: "AutosaveInterval", property_value: AutoSaveMode, override_change_level: ChangeLevel?)
---@overload fun(property_name: "DSCPMANetData"|"DSCPNetworkUpdate"|"DSCPDMXProtocols"|"DSCPInOutProtocols", property_value: DSCPCodes, override_change_level: ChangeLevel?)
---@overload fun(property_name: "DSCPDMX", property_value: DSCPCodesDMX, override_change_level: ChangeLevel?)
---@overload fun(property_name: "DataMergeDefaultTimeout", property_value: DataMergeTimeout, override_change_level: ChangeLevel?)
---@overload fun(property_name: "DataMergeDefaultMode", property_value: DataNegotiationModeDefault, override_change_level: ChangeLevel?)
---@overload fun(property_name: "TTL", property_value: TTL, override_change_level: ChangeLevel?)
---@overload fun(property_name: "TimecodeEventsRecordingfrom", property_value: TimecodeSingleUserRecord, override_change_level: ChangeLevel?)
---@overload fun(property_name: "IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"Hidden"|"ExportCachedObjectsOnShowSave"|"Accepted3rdParty"|"EnumShowFileNameWhenDescriptionChanges", property_value: YesNo|boolean, override_change_level: ChangeLevel?)
---@overload fun(property_name: "Index"|"Count"|"No"|"AutoSaveCurrentTime"|"AutoSaveStartTime", property_value: integer, override_change_level: ChangeLevel?)
---@overload fun(property_name: "Name"|"Note"|"DependencyExport"|"AutoSaveCountdown", property_value: string, override_change_level: ChangeLevel?)
function GlobalSettings:Set(property_name, property_value, override_change_level) end
...
function GlobalSettings:SetChildren(property_name, property_value) end