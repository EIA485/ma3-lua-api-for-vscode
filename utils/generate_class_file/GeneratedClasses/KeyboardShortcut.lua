...
---@field Name string
---@field KeyCode VirtualKeyCode
---@field ExecutorIndex integer
---@field SpecialExec integer
...
---@overload fun(name: "KeyCode", role: nil): VirtualKeyCode
---@overload fun(name: "FaderEnabled"|"Owned", role: nil): boolean
---@overload fun(name: "ExecutorIndex"|"SpecialExec"|"IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"Index"|"Count"|"No"|"UserExpanded"|"Hidden"|"MemoryFootprint", role: nil): integer
---@overload fun(name: "Name"|"Note"|"DependencyExport", role: nil): string
---@overload fun(name: "Name"|"KeyCode"|"ExecutorIndex"|"SpecialExec"|"Shortcut"|"IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"Index"|"Count"|"No"|"Note"|"UserExpanded"|"FaderEnabled"|"Owned"|"Hidden"|"DependencyExport"|"MemoryFootprint", role: Enums.Roles): string
