...
---@field EULAAccepted YesNo|boolean
---@field ForceLogin YesNo|boolean
---@field ShowReleaseNotes YesNo|boolean
---@field SystemGuid Key128
---@field ForceSetOnPCSystemTime YesNo|boolean
---@field OnPCSystemTimeOffset integer
---@field ResolutionLimit ResolutionLimit
...
---@field OnPCMidiFromWing YesNo|boolean
---@field OnPCMidiTimecodeSlot SignalSlot
---@field OnPCMidiOffset integer
---@field OnPCUseVizKey YesNo|boolean
...
---@generic T : LocalSettings
---@param class `T`
---@return boolean
function LocalSettings:IsClass(class) end
---@return StationSettings
function LocalSettings:Parent() end
---@return 38
function LocalSettings:PropertyCount() end
...
---@overload fun(idx: 15): "DefaultLanguage"
---@overload fun(idx: 16): "RememberedUser"
---@overload fun(idx: 17): "SelectedDrive"
---@overload fun(idx: 18): "SelectedDriveObject"
---@overload fun(idx: 19): "EULAAccepted"
---@overload fun(idx: 20): "ForceLogin"
---@overload fun(idx: 21): "ShowReleaseNotes"
---@overload fun(idx: 22): "SystemGuid"
---@overload fun(idx: 23): "ForceSetOnPCSystemTime"
---@overload fun(idx: 24): "OnPCSystemTimeOffset"
---@overload fun(idx: 25): "ResolutionLimit"
---@overload fun(idx: 26): "ConnectionLimit"
---@overload fun(idx: 27): "OnPCMidiOutDeviceName"
---@overload fun(idx: 28): "OnPCMidiInDeviceName"
---@overload fun(idx: 29): "OnPCAudioInDeviceName"
---@overload fun(idx: 30): "AudioOutDeviceName"
---@overload fun(idx: 31): "OnPCMidiFromWing"
---@overload fun(idx: 32): "OnPCMidiTimecodeSlot"
---@overload fun(idx: 33): "OnPCMidiOffset"
---@overload fun(idx: 34): "OnPCUseVizKey"
---@overload fun(idx: 35): "StartupShowfileName"
---@overload fun(idx: 36): "StartupBrowserFilter"
---@overload fun(idx: 37): "StartupShowfileFilter"
function LocalSettings:PropertyName(idx) end
---@overload fun(idx: 0|1|2): {ExportIgnore: True, EnumCollection: YesNo, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 3|12|19|20|21|23|31|34): {ExportIgnore: False, EnumCollection: YesNo, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 4|5|6): {ExportIgnore: True, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 7|8|13|15|16|17|22|24|26|27|28|29|30|33|35|37): {ExportIgnore: False, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 9): {ExportIgnore: False, EnumCollection: YesNo, ReadOnly: True, ImportIgnore: True}
---@overload fun(idx: 10|11): {ExportIgnore: True, EnumCollection: YesNo, ReadOnly: True, ImportIgnore: True}
---@overload fun(idx: 14): {ExportIgnore: False, ReadOnly: True, ImportIgnore: True}
---@overload fun(idx: 18): {ExportIgnore: True, ReadOnly: True, ImportIgnore: True}
---@overload fun(idx: 25): {ExportIgnore: False, EnumCollection: ResolutionLimit, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 32): {ExportIgnore: False, EnumCollection: SignalSlot, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 36): {ExportIgnore: False, EnumCollection: StartupBrowserFilter, ReadOnly: False, ImportIgnore: False}
function LocalSettings:PropertyInfo(idx) end
---@overload fun(idx: 0|1|2|3|4|5|6|9|19|20|21|23|31|32|34): "UInt32"
---@overload fun(idx: 7|8|13|15|16|17|27|28|29|30|35): "String"
---@overload fun(idx: 10|11): "Bool"
---@overload fun(idx: 12|24): "UInt64"
---@overload fun(idx: 14): "Int64"
---@overload fun(idx: 18): "Handle"
---@overload fun(idx: 22): "Custom"
---@overload fun(idx: 25|26|36|37): "UInt8"
---@overload fun(idx: 33): "Int32"
function LocalSettings:PropertyType(idx) end
---@overload fun(name: "SelectedDriveObject", role: nil): Drive
---@overload fun(name: "SystemGuid", role: nil): Key128
---@overload fun(name: "ResolutionLimit", role: nil): ResolutionLimit
---@overload fun(name: "OnPCMidiTimecodeSlot", role: nil): SignalSlot
---@overload fun(name: "StartupBrowserFilter", role: nil): StartupBrowserFilter
---@overload fun(name: "IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"UserExpanded"|"FaderEnabled"|"Owned"|"Hidden"|"EULAAccepted"|"ForceLogin"|"ShowReleaseNotes"|"ForceSetOnPCSystemTime"|"OnPCMidiFromWing"|"OnPCUseVizKey", role: nil): YesNo|boolean
---@overload fun(name: "Index"|"Count"|"No"|"MemoryFootprint"|"OnPCSystemTimeOffset"|"ConnectionLimit"|"OnPCMidiOffset"|"StartupShowfileFilter", role: nil): integer
---@overload fun(name: "Name"|"Note"|"DependencyExport"|"DefaultLanguage"|"RememberedUser"|"SelectedDrive"|"OnPCMidiOutDeviceName"|"OnPCMidiInDeviceName"|"OnPCAudioInDeviceName"|"AudioOutDeviceName"|"StartupShowfileName", role: nil): string
---@overload fun(name: "IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"Index"|"Count"|"No"|"Name"|"Note"|"UserExpanded"|"FaderEnabled"|"Owned"|"Hidden"|"DependencyExport"|"MemoryFootprint"|"DefaultLanguage"|"RememberedUser"|"SelectedDrive"|"SelectedDriveObject"|"EULAAccepted"|"ForceLogin"|"ShowReleaseNotes"|"SystemGuid"|"ForceSetOnPCSystemTime"|"OnPCSystemTimeOffset"|"ResolutionLimit"|"ConnectionLimit"|"OnPCMidiOutDeviceName"|"OnPCMidiInDeviceName"|"OnPCAudioInDeviceName"|"AudioOutDeviceName"|"OnPCMidiFromWing"|"OnPCMidiTimecodeSlot"|"OnPCMidiOffset"|"OnPCUseVizKey"|"StartupShowfileName"|"StartupBrowserFilter"|"StartupShowfileFilter", role: Enums.Roles): string
...
---@overload fun(property_name: "SystemGuid", property_value: Key128, override_change_level: ChangeLevel?)
---@overload fun(property_name: "ResolutionLimit", property_value: ResolutionLimit, override_change_level: ChangeLevel?)
---@overload fun(property_name: "OnPCMidiTimecodeSlot", property_value: SignalSlot, override_change_level: ChangeLevel?)
---@overload fun(property_name: "StartupBrowserFilter", property_value: StartupBrowserFilter, override_change_level: ChangeLevel?)
---@overload fun(property_name: "IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"Hidden"|"EULAAccepted"|"ForceLogin"|"ShowReleaseNotes"|"ForceSetOnPCSystemTime"|"OnPCMidiFromWing"|"OnPCUseVizKey", property_value: YesNo|boolean, override_change_level: ChangeLevel?)
---@overload fun(property_name: "Index"|"Count"|"No"|"OnPCSystemTimeOffset"|"ConnectionLimit"|"OnPCMidiOffset"|"StartupShowfileFilter", property_value: integer, override_change_level: ChangeLevel?)
---@overload fun(property_name: "Name"|"Note"|"DependencyExport"|"DefaultLanguage"|"RememberedUser"|"SelectedDrive"|"OnPCMidiOutDeviceName"|"OnPCMidiInDeviceName"|"OnPCAudioInDeviceName"|"AudioOutDeviceName"|"StartupShowfileName", property_value: string, override_change_level: ChangeLevel?)
function LocalSettings:Set(property_name, property_value, override_change_level) end
...
function LocalSettings:SetChildren(property_name, property_value) end