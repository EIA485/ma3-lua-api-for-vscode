...
local DeviceConfigurations = {}
---@return "DeviceConfigurations"
function DeviceConfigurations:GetClass() end
---@return "Object"
function DeviceConfigurations:GetChildClass() end
---@return Root
function DeviceConfigurations:Parent() end
...
---@overload fun(name: "IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"Index"|"Count"|"No"|"Name"|"Note"|"UserExpanded"|"FaderEnabled"|"Owned"|"Hidden"|"DependencyExport"|"MemoryFootprint"|"FileName", role: Enums.Roles): string
---@overload fun(name: integer, role: nil): Object
function DeviceConfigurations:Get(name, role) end
...
---@overload fun(index: integer, class: "OutputStations", undo: Undo?): OutputStations
---@overload fun(index: integer, class: "DMXProtocols", undo: Undo?): DMXProtocols
...
function DeviceConfigurations:Create(index, class, undo) end
...
---@overload fun(class: "OutputStations", undo: Undo?, count: integer?): OutputStations
---@overload fun(class: "DMXProtocols", undo: Undo?, count: integer?): DMXProtocols
...
function DeviceConfigurations:Append(class, undo, count) end
...
---@overload fun(class: "OutputStations", undo: Undo?): OutputStations
---@overload fun(class: "DMXProtocols", undo: Undo?): DMXProtocols
...
function DeviceConfigurations:Acquire(class, undo) end
---@overload fun(class: "Object", undo: Undo?): Object
---@overload fun(class: "MVRxchange", undo: Undo?): MVRxchange
---@overload fun(class: "SmartViewSettingsCollect", undo: Undo?): SmartViewSettingsCollect
---@overload fun(class: "RunningPlaybacksSettingsCollect", undo: Undo?): RunningPlaybacksSettingsCollect
...
function DeviceConfigurations:Aquire(class, undo) end
...
---@overload fun(index: integer, class: "OutputStations", undo: Undo?, count: integer?): OutputStations
---@overload fun(index: integer, class: "DMXProtocols", undo: Undo?, count: integer?): DMXProtocols
...
function DeviceConfigurations:Insert(index, class, undo, count) end
...
---@overload fun(name: string, class: "OutputStations"): OutputStations
---@overload fun(name: string, class: "DMXProtocols"): DMXProtocols
...
function DeviceConfigurations:Find(name, class) end
---@overload fun(name: string, class: "Object"): Object
---@overload fun(name: string, class: "MVRxchange"): MVRxchange
---@overload fun(name: string, class: "SmartViewSettingsCollect"): SmartViewSettingsCollect
---@overload fun(name: string, class: "RunningPlaybacksSettingsCollect"): RunningPlaybacksSettingsCollect
...
---@overload fun(name: string, class: "IllegalObject"): IllegalObject
---@overload fun(name: string, class: nil): Object
function DeviceConfigurations:FindRecursive(name, class) end
