...
---@generic T : DeviceConfigurations
---@param class `T`
---@return boolean
function DeviceConfigurations:IsClass(class) end
---@return Root
function DeviceConfigurations:Parent() end
---@return 16
function DeviceConfigurations:PropertyCount() end
...
function DeviceConfigurations:PropertyName(idx) end
...
---@overload fun(class: "NoteTextEdit", undo: Undo?): NoteTextEdit
---@overload fun(class: nil, undo: Undo?): Object
function DeviceConfigurations:Find(class, undo) end
...
function DeviceConfigurations:Set(property_name, property_value, override_change_level) end
...
---@overload fun(property_name: "Action", property_value: TimecodeSlotPoolAction|PresetAction|SequenceAction|SoundPoolAction|PresetActionToken|VideoPoolAction|TimecodePoolAction|FilterAction|fun(command: string) : boolean|MacroPoolAction|PluginPoolAction)
...
function DeviceConfigurations:SetChildren(property_name, property_value) end