...
---@param class `T`
---@return boolean
function FilterRuleFixture:IsClass(class) end
---@return FixtureFilterRules
function FilterRuleFixture:Parent() end
---@return 16
function FilterRuleFixture:PropertyCount() end
...
function FilterRuleFixture:PropertyName(idx) end
...
---@overload fun(class: "NoteTextEdit", undo: Undo?): NoteTextEdit
---@overload fun(class: nil, undo: Undo?): Object
function FilterRuleFixture:Find(class, undo) end
...
function FilterRuleFixture:Set(property_name, property_value, override_change_level) end
...
function FilterRuleFixture:SetChildren(property_name, property_value) end