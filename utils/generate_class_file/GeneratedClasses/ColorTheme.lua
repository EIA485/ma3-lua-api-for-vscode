...
---@generic T : ColorTheme
---@param class `T`
---@return boolean
function ColorTheme:IsClass(class) end
---@return 16
function ColorTheme:PropertyCount() end
...
function ColorTheme:PropertyName(idx) end
...
---@overload fun(class: "NoteTextEdit", undo: Undo?): NoteTextEdit
---@overload fun(class: nil, undo: Undo?): Object
function ColorTheme:Find(class, undo) end
...
function ColorTheme:Set(property_name, property_value, override_change_level) end
...
---@overload fun(property_name: "TimezoneStr"|"ClassFilter"|"TitlePrefix"|"StoredData"|"FixtureTypeFilter"|"Type"|"ToolAction"|"FileName"|"SelectedFilter"|"FilePath"|"GroupName"|"Interface"|"FileContent"|"Author"|"SelectionCount"|"Path"|"ManufacturerID"|"DeviceModelID"|"Name"|"Note"|"SoftwareVersionLabel"|"Comment"|"Note"|"DisplayPool"|"TargetName"|"DependencyExport"|"ChildName"|"Description"|"SelectedDataPool"|"GridColumnConfigurationType"|"Type"|"User"|"LastReceivedMidi"|"FeatureGroup"|"*"|"ContentFilterType"|"Trigger"|"NewShowStartDescription"|"Type"|"LayerFilter", property_value: string)
...
function ColorTheme:SetChildren(property_name, property_value) end