...
---@param class `T`
---@return boolean
function Root:IsClass(class) end
---@return 19
function Root:PropertyCount() end
...
---@overload fun(idx: 15): "LastReceivedMidi"
---@overload fun(idx: 16): "RealtimeIteration"
---@overload fun(idx: 17): "DisableGlobalPresetUpdate"
---@overload fun(idx: 18): "NewShowStartDescription"
...
function Root:PropertyInfo(idx) end
---@overload fun(idx: 0|1|2|3|4|5|6|9|16): "UInt32"
---@overload fun(idx: 7|8|13|15|18): "String"
---@overload fun(idx: 10|11|17): "Bool"
---@overload fun(idx: 12): "UInt64"
---@overload fun(idx: 14): "Int64"
function Root:PropertyType(idx) end
...
---@overload fun(name: "Index"|"Count"|"No"|"MemoryFootprint"|"RealtimeIteration", role: nil): integer
---@overload fun(name: "Name"|"Note"|"DependencyExport"|"LastReceivedMidi"|"NewShowStartDescription", role: nil): string
...
---@generic T : KeyRegistry|GroupPoolSettingsCollect|RdmWindowSettingsCollect|WindowPhaserEditorSettingsCollect|TimecodeWindowSettingsCollect|UnassignedTagGridFilter|NetworkGridFilter|FixtureSheetRowFilter|PhaserSheetRowFilter|RunningPlaybacksGirdContentFilter|GridPatchContentFilter|RunningPlaybacksSettingsCollect|TimecodeSlots|PresetShapersPoolSettingsCollect|FixtureSheetSettingsCollect|PresetGoboPoolSettingsCollect|PresetColorPoolSettingsCollect|FilterPoolSettingsCollect|MacroPoolSettingsCollect|MidiInDescriptions|TimecodePoolSettingsCollect|CommandlineWindowSettingsCollect|SysmonWindowSettingsCollect|ExecConfigPoolSettingsCollect|AttributeDefinitions|Tags|Images|GoboImages|Symbols|MeshImagePool|Menus|Scribbles|Variables|RDMFixtureType|RenderQuality|ExecEditorSettings|CommandlineWindowSettings|WindowInfoSettings|CloningWindowSettings|ClockWindowSettings|PoolSettings|SpecialWindowSettings|ModularPlaybackWindowSettings|WindowAgendaSettings|TimecodeWindowSettings|FixtureEditorSettings|PSRPatchSheetSettings|MessageGridSettings|GelGridSettings|SequenceSheetSettings|DMXSheetSettings|FixtureSheetSettings|RdmWindowSettings|RecipeSheetSettings|RunningPlaybacksSheetSettings|ShowCreatorSheetSettings|WindowPhaserEditorSettings|AtFilterSettings|WindowSoundSettings|LayoutViewSettings|CustomMasterSectionWindowSettings|HelpViewerWindowSettings|SysmonWindowSettings|ColorPickerSettings|WindowTrackpadSettings|EncoderBarWindowSettings|ShaperWindowSettings|MatricksWindowSettings|View3DSettings|SelectionViewSettings|SysteminfoWindowSettings|XkeysWindowSettings|CommandWingBarSettings|PlaybackWindowSettings|Camera|ShowData|AudioInDeviceDescription|GridColumnConfiguration|MIDIDeviceDescription|HelperWindowSettingsCollect|WindowInfoSettingsCollect|TagFakeCollect|Addons|ClockWindowSettingsCollect|IllegalObject|AddonVariables|WindowSettingsCollect|NtpMonitor|Timezones|GridColumnConfigurationCollect|MatricksPoolSettingsCollect|HardwareConfigurations|TimerPoolSettingsCollect|PresetDimmerPoolSettingsCollect|LayoutViewSettingsCollect|PoolSettingsCollect|Interfaces|PluginPoolSettingsCollect|PultCollect|MidiOutDescriptions|PresetControlPoolSettingsCollect|StationSettings|KeyboardLayouts|PluginPreferencesCollect|WindowAgendaSettingsCollect|DmxSheetSettingsCollect|PresetAllPoolSettingsCollect|SoundChannels|SysteminfoWindowSettingsCollect|GridBase|Certificates|AutoCreateSettings|LayoutElementDefaultsCollect|GridColumnFilterCollect|GridContentFilterSettings|DMXRoot|PlaybackWindowSettingsCollect|ShowMetaData|GelPoolSettingsCollect|PresetVideoPoolSettingsCollect|AudioInDescriptions|SequenceSheetSettingsCollect|HardwareStatus|TabRegistry|SelectionViewSettingsCollect|DriveCollect|ColorTheme|UsbNotifier|MessageCenter|BitmapPoolSettingsCollect|WorldPoolSettingsCollect|NDI|EncoderBarWindowSettingsCollect|Temp|PresetFocusPoolSettingsCollect|ScribbleEdit|MessageGridSettingsCollect|GeneratorPoolSettingsCollect|PresetBeamPoolSettingsCollect|TimecodeSlotPoolSettingsCollect|DeviceConfigurations|ExecutorFixation|PresetPositionPoolSettingsCollect|LayoutCameraObject|Cloud|MAnetSocket|VideoPoolSettingsCollect|View3DSettingsCollect|LayoutPoolSettingsCollect|WebServer|PresetDynamicPoolSettingsCollect|Users|SoundPoolSettingsCollect|MVRxchange|SequencePoolSettingsCollect|TestRGBInterface|PresetPoolSettingsCollect|QuickeyPoolSettingsCollect|ModularPlaybackWindowSettingsCollect|ProgLayers|SmartViewSettingsCollect|SpecialWindowSettingsCollect|ContentSheetSettingsCollect|ColorPickerSettingsCollect|PagePoolSettingsCollect|Recipe|grandMA3Modules|GraphicsRoot|ContentSheetGridScroller|MeshLineEdit|DMXSheet|MeshMaterialGrid|FixtureSheet
---@param index integer
---@param class `T`
---@param undo Undo?
---@return T
...
---@overload fun(class: "NoteTextEdit", undo: Undo?): NoteTextEdit
---@overload fun(class: nil, undo: Undo?): Object
function Root:Find(class, undo) end
...
---@overload fun(property_name: "DisableGlobalPresetUpdate", property_value: boolean, override_change_level: ChangeLevel?)
---@overload fun(property_name: "Index"|"Count"|"No"|"RealtimeIteration", property_value: integer, override_change_level: ChangeLevel?)
---@overload fun(property_name: "Name"|"Note"|"DependencyExport"|"LastReceivedMidi"|"NewShowStartDescription", property_value: string, override_change_level: ChangeLevel?)
function Root:Set(property_name, property_value, override_change_level) end
...
---@overload fun(property_name: "PrimaryIp", property_value: Manet.IP4)
...
---@overload fun(property_name: "RemoteIP", property_value: Network.IP8)
...
---@overload fun(property_name: "DirectAction"|"Executors"|"Labels"|"Executors"|"Row400"|"WorldServerStatus"|"Labels"|"Row300"|"Row100"|"Row400"|"Row200"|"Row300"|"Row100"|"Row200"|"Labels"|"Executors", property_value: OnOff|boolean)
---@overload fun(property_name: "FilterType", property_value: PSRPatchFilterType)
---@overload fun(property_name: "PUPriority", property_value: PUPriority)
---@overload fun(property_name: "AbsRelMode", property_value: PhaserAbsRelMode)
---@overload fun(property_name: "EncoderBar", property_value: PhaserBars)
...
---@overload fun(property_name: "ExtraInitPackets"|"Page"|"VisibleGrid"|"TimerIndex"|"SnapGrid"|"PaddingBottom"|"LastConnectionTime"|"LightBeamOverdrawLimit"|"PaddingLeft"|"DimmerIncrement"|"AmountHue"|"PaddingRight"|"AmountSaturation"|"Mode"|"MemoryLimit"|"PaddingTop"|"ParameterCount"|"InitialWhiteFilter"|"Page"|"FileSize"|"DesiredUiFps"|"Index"|"Page"|"Count"|"SplitSize"|"No"|"SoftwareID"|"DynamicGoboResolution"|"PoolObjectContentSizeLimitation"|"SubPoolSelectorValue"|"SubPoolSelectorIndex"|"ColumnsCount"|"Texture"|"Width"|"PacketLossSimulation"|"HazeLayers"|"Cont.Size"|"Height"|"SplitSize"|"Cont.Ref"|"Page"|"TCSlot"|"ColumnsCount"|"LabMaxCount"|"AutoColumnsWidth", property_value: integer)
---@overload fun(property_name: "StageFilterList", property_value: integer[])
---@overload fun(property_name: "BeamIntensity"|"SpotIntensity"|"Physical"|"Zoom"|"CameraAnimationSpeedMeterSec"|"FOV"|"Pan"|"CameraAnimationSpeedDegreeSec"|"Tilt"|"AmbientIntensity"|"Roll"|"PointLightIntensity"|"LuminousIntensitySpread"|"BackgroundIntensity"|"ResolutionScale3D"|"MultiBeamBorderSmoothness"|"IgnoreNormals"|"ResolutionScaleLight"|"TriangleCalibrationFactor"|"StageBorder"|"Dev1"|"DilutionScale"|"ProportionalGain"|"Dev2"|"NativeColors"|"Scale"|"MultiBeamBlur"|"IntegrationTime"|"Aspect"|"LabelBackgroundTransparency"|"DerivativeTime"|"Dev3"|"LabelTextTransparency"|"Dev4"|"HazeParticleQuality"|"ArrangementAlpha"|"HazeScale"|"HazeParticleSize"|"HazeBlend"|"HazeAnimationSpeed"|"WorldserverExpireTime"|"TimeSlotMS"|"RowHeightFactor"|"MotorPredictP"|"MotorPredictI"|"MotorPredictD"|"Timezone", property_value: number)
---@overload fun(property_name: "TimezoneStr"|"FileName"|"ClassFilter"|"TitlePrefix"|"StoredData"|"HostName"|"Session"|"Location"|"FixtureTypeFilter"|"Type"|"Showfile"|"ToolAction"|"Interface"|"FileName"|"SelectedFilter"|"FilePath"|"GroupName"|"Interface"|"FileContent"|"Author"|"SelectionCount"|"WorldServer"|"ManufacturerID"|"Path"|"DeviceModelID"|"Name"|"Note"|"SoftwareVersionLabel"|"Comment"|"Note"|"SerialNumber"|"DisplayPool"|"TargetName"|"DependencyExport"|"Date"|"ChildName"|"Description"|"SelectedDataPool"|"GridColumnConfigurationType"|"Type"|"User"|"FeatureGroup"|"*"|"ContentFilterType"|"Trigger"|"Type"|"LayerFilter"|"SelectedUpdateFile", property_value: string)
...
function Root:SetChildren(property_name, property_value) end