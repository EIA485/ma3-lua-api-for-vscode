...
---@generic T : TemporaryWindowSettings
---@param class `T`
---@return boolean
function TemporaryWindowSettings:IsClass(class) end
---@return UserProfile
...
---@overload fun(property_name: "Page"|"VisibleGrid"|"SnapGrid"|"TimerIndex"|"PaddingBottom"|"LightBeamOverdrawLimit"|"PaddingLeft"|"DimmerIncrement"|"AmountHue"|"PaddingRight"|"AmountSaturation"|"PaddingTop"|"Page"|"DesiredUiFps"|"Page"|"SplitSize"|"DynamicGoboResolution"|"SubPoolSelectorValue"|"SplitFrameSize"|"SubPoolSelectorIndex"|"ColumnsCount"|"AutoColumnsWidth"|"SelectedStage"|"FilterMaskValue"|"Page"|"SplitFrameSize3d"|"ColumnsCount"|"TCSlot"|"LabMaxCount"|"SelectedSplitView"|"SplitSize", property_value: integer)
---@overload fun(property_name: "StageFilterList", property_value: integer[])
...
---@overload fun(property_name: "ToolAction"|"GridColumnConfigurationType"|"TimezoneStr"|"TitlePrefix"|"ClassFilter"|"ChildName"|"ContentFilterType"|"FixtureTypeFilter"|"LayerFilter"|"DisplayPool"|"TargetName"|"SelectionCount"|"SelectedDataPool", property_value: string)
...
function TemporaryWindowSettings:SetChildren(property_name, property_value) end