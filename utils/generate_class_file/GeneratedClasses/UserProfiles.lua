...
---@overload fun(property_name: "ValueReadout", property_value: ValueReadoutModeNatural)
---@overload fun(property_name: "WheelMode", property_value: WheelMode)
---@overload fun(property_name: "ActiveOnly"|"MultiStepOnly"|"PreciseEdit"|"ScreenEncoder"|"SingleDigitInput"|"ScreenshotEnabled"|"ResolveExecutorAssignments"|"UpdateMenuPresetOptionsExpanded"|"PreviewVariables"|"UpdateMenuCueOptionsExpanded"|"NotificationsEnabled"|"SystemFpsLimit"|"VKExpanded"|"SEExpanded"|"NEExpanded"|"ShowConnectors"|"LoadFixtureLibraryMA"|"OopsViews"|"OopsProgrammer"|"LoadFixtureLibraryUser"|"OopsSelection"|"LoadFixtureLibraryShare"|"CreateOops"|"DmxTesterRetainMode"|"MirrorSpecialExecutorPages"|"ShowAppearanceInCueInput"|"ShowSettingsInEditors", property_value: YesNo|boolean)
---@overload fun(property_name: "HelpPopupZoomFactor", property_value: ZoomFactor)
---@overload fun(property_name: "ScribbleWidthScale"|"LastOpenRemotesTab"|"LastOpenDmxProtocolsTab"|"OverlayFade"|"DefaultToken"|"DmxTesterTestValue"|"ShowUserEncoder"|"SelectedPage", property_value: integer)
function UserProfiles:SetChildren(property_name, property_value) end