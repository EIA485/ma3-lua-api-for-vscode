...
---@class AttributeDefinitions: Object Defines the default attributes, features and preset types.
local AttributeDefinitions = {}
---@return "AttributeDefinitions"
function AttributeDefinitions:GetClass() end
---@return "Object"
function AttributeDefinitions:GetChildClass() end
...
---@overload fun(index: integer, class: "Attributes", undo: Undo?): Attributes
---@overload fun(index: integer, class: "ActivationGroups", undo: Undo?): ActivationGroups
---@overload fun(index: integer, class: "FeatureGroups", undo: Undo?): FeatureGroups
---@overload fun(index: integer, class: "DeactivationGroups", undo: Undo?): DeactivationGroups
...
function AttributeDefinitions:Create(index, class, undo) end
...
---@overload fun(class: "Attributes", undo: Undo?, count: integer?): Attributes
---@overload fun(class: "ActivationGroups", undo: Undo?, count: integer?): ActivationGroups
---@overload fun(class: "FeatureGroups", undo: Undo?, count: integer?): FeatureGroups
---@overload fun(class: "DeactivationGroups", undo: Undo?, count: integer?): DeactivationGroups
...
function AttributeDefinitions:Append(class, undo, count) end
...
---@overload fun(class: "Attributes", undo: Undo?): Attributes
---@overload fun(class: "ActivationGroups", undo: Undo?): ActivationGroups
---@overload fun(class: "FeatureGroups", undo: Undo?): FeatureGroups
---@overload fun(class: "DeactivationGroups", undo: Undo?): DeactivationGroups
...
function AttributeDefinitions:Acquire(class, undo) end
---@overload fun(class: "Object", undo: Undo?): Object
---@overload fun(class: "MVRxchange", undo: Undo?): MVRxchange
---@overload fun(class: "SmartViewSettingsCollect", undo: Undo?): SmartViewSettingsCollect
---@overload fun(class: "RunningPlaybacksSettingsCollect", undo: Undo?): RunningPlaybacksSettingsCollect
...
function AttributeDefinitions:Aquire(class, undo) end
...
---@overload fun(index: integer, class: "Attributes", undo: Undo?, count: integer?): Attributes
---@overload fun(index: integer, class: "ActivationGroups", undo: Undo?, count: integer?): ActivationGroups
---@overload fun(index: integer, class: "FeatureGroups", undo: Undo?, count: integer?): FeatureGroups
---@overload fun(index: integer, class: "DeactivationGroups", undo: Undo?, count: integer?): DeactivationGroups
...
function AttributeDefinitions:Insert(index, class, undo, count) end
...
---@overload fun(name: string, class: "Attributes"): Attributes
---@overload fun(name: string, class: "ActivationGroups"): ActivationGroups
---@overload fun(name: string, class: "FeatureGroups"): FeatureGroups
---@overload fun(name: string, class: "DeactivationGroups"): DeactivationGroups
...
function AttributeDefinitions:Find(name, class) end
---@overload fun(name: string, class: "Object"): Object
---@overload fun(name: string, class: "MVRxchange"): MVRxchange
---@overload fun(name: string, class: "SmartViewSettingsCollect"): SmartViewSettingsCollect
---@overload fun(name: string, class: "RunningPlaybacksSettingsCollect"): RunningPlaybacksSettingsCollect
...
---@overload fun(name: string, class: "IllegalObject"): IllegalObject
---@overload fun(name: string, class: nil): Object
function AttributeDefinitions:FindRecursive(name, class) end
