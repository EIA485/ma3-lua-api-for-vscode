...
---@overload fun(class: "NoteTextEdit", undo: Undo?): NoteTextEdit
---@overload fun(class: nil, undo: Undo?): Object
function AttributeDefinitions:Find(class, undo) end
...
function AttributeDefinitions:SetChildren(property_name, property_value) end