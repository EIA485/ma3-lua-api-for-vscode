...
---@generic T : FixtureFilterRulePatch
---@param class `T`
---@return boolean
function FixtureFilterRulePatch:IsClass(class) end
---@return 17
function FixtureFilterRulePatch:PropertyCount() end
...
function FixtureFilterRulePatch:PropertyName(idx) end
...
function FixtureFilterRulePatch:Set(property_name, property_value, override_change_level) end