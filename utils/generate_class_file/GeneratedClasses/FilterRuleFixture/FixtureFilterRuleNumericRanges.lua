...
---@generic T : FixtureFilterRuleNumericRanges
---@param class `T`
---@return boolean
function FixtureFilterRuleNumericRanges:IsClass(class) end
---@return 17
function FixtureFilterRuleNumericRanges:PropertyCount() end
...
---@overload fun(idx: 15): "Invert"
---@overload fun(idx: 16): "FilterValue"
function FixtureFilterRuleNumericRanges:PropertyName(idx) end
...
---@overload fun(idx: 15): {ExportIgnore: False, EnumCollection: Yes, ReadOnly: False, ImportIgnore: False}
function FixtureFilterRuleNumericRanges:PropertyInfo(idx) end
---@overload fun(idx: 0|1|2|3|4|5|6|9|15): "UInt32"
---@overload fun(idx: 7|8|13|16): "String"
---@overload fun(idx: 10|11): "Bool"
---@overload fun(idx: 12): "UInt64"
---@overload fun(idx: 14): "Int64"
function FixtureFilterRuleNumericRanges:PropertyType(idx) end
...
---@overload fun(name: "Invert", role: nil): Yes|true
---@overload fun(name: "Index"|"Count"|"No"|"MemoryFootprint", role: nil): integer
---@overload fun(name: "Name"|"Note"|"DependencyExport"|"FilterValue", role: nil): string
...
---@overload fun(property_name: "Invert", property_value: Yes|true, override_change_level: ChangeLevel?)
---@overload fun(property_name: "Index"|"Count"|"No", property_value: integer, override_change_level: ChangeLevel?)
---@overload fun(property_name: "Name"|"Note"|"DependencyExport"|"FilterValue", property_value: string, override_change_level: ChangeLevel?)
function FixtureFilterRuleNumericRanges:Set(property_name, property_value, override_change_level) end