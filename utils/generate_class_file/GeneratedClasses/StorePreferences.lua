...
---@overload fun(name: "StoreLook", role: nil): integer
---@overload fun(name: "StoreMode", role: nil): StoreMode
---@overload fun(name: "UpdateModePresets", role: nil): Update
---@overload fun(name: "StoreSource", role: nil): StoreSource
---@overload fun(name: "UpdateModeCues", role: nil): Update
---@overload fun(name: "StoreEmbedded"|"StoreMatricks"|"StoreScreenshot"|"PresetInputFilter"|"UpdateInputFilter"|"UpdateCueOnly"|"KeepActivation"|"CueOnly"|"TrackingShield"|"GridMergeMode"|"PresetMode"|"UpdatePresetMode", role: nil): integer
---@overload fun(name: "CopyMode", role: nil): StoreMode
---@overload fun(name: "CopyCueOnly"|"CopyTrackingShield"|"CopyCueSrc"|"CopyCueDst"|"CopyCueDstMode", role: nil): integer
---@overload fun(name: "IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"Index"|"Count"|"No"|"Name"|"Note"|"UserExpanded"|"FaderEnabled"|"Owned"|"Hidden"|"DependencyExport"|"MemoryFootprint"|"ChannelFilter"|"StoreLook"|"StoreMode"|"UpdateModePresets"|"StoreSource"|"UpdateModeCues"|"StoreEmbedded"|"StoreMatricks"|"StoreScreenshot"|"PresetInputFilter"|"UpdateInputFilter"|"UpdateCueOnly"|"KeepActivation"|"CueOnly"|"TrackingShield"|"GridMergeMode"|"PresetMode"|"UpdatePresetMode"|"CopyMode"|"CopyCueOnly"|"CopyTrackingShield"|"CopyCueSrc"|"CopyCueDst"|"CopyCueDstMode", role: Enums.Roles): string
...
---@overload fun(index: integer, class: "StorePreferencesViews", undo: Undo?): StorePreferencesViews
...
---@overload fun(index: integer, class: "StorePreferencesTimecode", undo: Undo?): StorePreferencesTimecode
...
---@overload fun(index: integer, class: "StorePreferencesTimer", undo: Undo?): StorePreferencesTimer
...
---@overload fun(index: integer, class: "StorePreferencesGroup", undo: Undo?): StorePreferencesGroup
---@overload fun(index: integer, class: "StorePreferencesExec", undo: Undo?): StorePreferencesExec
---@overload fun(index: integer, class: "StorePreferencesSequence", undo: Undo?): StorePreferencesSequence
...
---@overload fun(class: "StorePreferencesViews", undo: Undo?, count: integer?): StorePreferencesViews
...
---@overload fun(class: "StorePreferencesTimecode", undo: Undo?, count: integer?): StorePreferencesTimecode
...
---@overload fun(class: "StorePreferencesTimer", undo: Undo?, count: integer?): StorePreferencesTimer
...
---@overload fun(class: "StorePreferencesGroup", undo: Undo?, count: integer?): StorePreferencesGroup
---@overload fun(class: "StorePreferencesExec", undo: Undo?, count: integer?): StorePreferencesExec
---@overload fun(class: "StorePreferencesSequence", undo: Undo?, count: integer?): StorePreferencesSequence
...
---@overload fun(class: "StorePreferencesViews", undo: Undo?): StorePreferencesViews
...
---@overload fun(class: "StorePreferencesTimecode", undo: Undo?): StorePreferencesTimecode
...
---@overload fun(class: "StorePreferencesTimer", undo: Undo?): StorePreferencesTimer
...
---@overload fun(class: "StorePreferencesGroup", undo: Undo?): StorePreferencesGroup
---@overload fun(class: "StorePreferencesExec", undo: Undo?): StorePreferencesExec
---@overload fun(class: "StorePreferencesSequence", undo: Undo?): StorePreferencesSequence
...
---@overload fun(index: integer, class: "StorePreferencesViews", undo: Undo?, count: integer?): StorePreferencesViews
...
---@overload fun(index: integer, class: "StorePreferencesTimecode", undo: Undo?, count: integer?): StorePreferencesTimecode
...
---@overload fun(index: integer, class: "StorePreferencesTimer", undo: Undo?, count: integer?): StorePreferencesTimer
...
---@overload fun(index: integer, class: "StorePreferencesGroup", undo: Undo?, count: integer?): StorePreferencesGroup
---@overload fun(index: integer, class: "StorePreferencesExec", undo: Undo?, count: integer?): StorePreferencesExec
---@overload fun(index: integer, class: "StorePreferencesSequence", undo: Undo?, count: integer?): StorePreferencesSequence
...
---@overload fun(name: string, class: "StorePreferencesViews"): StorePreferencesViews
...
---@overload fun(name: string, class: "StorePreferencesTimecode"): StorePreferencesTimecode
...
---@overload fun(name: string, class: "StorePreferencesTimer"): StorePreferencesTimer
...
---@overload fun(name: string, class: "StorePreferencesGroup"): StorePreferencesGroup
---@overload fun(name: string, class: "StorePreferencesExec"): StorePreferencesExec
---@overload fun(name: string, class: "StorePreferencesSequence"): StorePreferencesSequence
...
function StorePreferences:Find(name, class) end
---@overload fun(name: string, class: "Object"): Object
---@overload fun(name: string, class: "MVRxchange"): MVRxchange
---@overload fun(name: string, class: "StorePreferencesViews"): StorePreferencesViews
---@overload fun(name: string, class: "SmartViewSettingsCollect"): SmartViewSettingsCollect
...
---@overload fun(name: string, class: "IllegalObject"): IllegalObject
---@overload fun(name: string, class: nil): Object
function StorePreferences:FindRecursive(name, class) end
