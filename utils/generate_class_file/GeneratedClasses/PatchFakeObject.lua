...
---@field Stage Default
---@field FixtureID NoneAndDefault
---@field IDType Default
---@field CID NoneAndDefault
---@field Name string
...
---@param class `T`
---@return boolean
function PatchFakeObject:IsClass(class) end
---@return PatchFakeCollect
function PatchFakeObject:Parent() end
---@return 26
function PatchFakeObject:PropertyCount() end
...
---@overload fun(idx: 14): "Stage"
---@overload fun(idx: 15): "FixtureID"
---@overload fun(idx: 16): "IDType"
---@overload fun(idx: 17): "CID"
---@overload fun(idx: 18): "Name"
---@overload fun(idx: 19): "FixtureType"
---@overload fun(idx: 20): "Patch"
---@overload fun(idx: 21): "Layer"
---@overload fun(idx: 22): "Class"
---@overload fun(idx: 23): "PosX"
---@overload fun(idx: 24): "PosY"
---@overload fun(idx: 25): "PosZ"
function PatchFakeObject:PropertyName(idx) end
---@overload fun(idx: 0|1|2): {ExportIgnore: True, EnumCollection: YesNo, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 3|11): {ExportIgnore: False, EnumCollection: YesNo, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 4|5|6|18|19|20|21|22|23|24|25): {ExportIgnore: True, ReadOnly: False, ImportIgnore: False}
...
---@overload fun(idx: 14|16): {ExportIgnore: False, EnumCollection: Default, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 15|17): {ExportIgnore: False, EnumCollection: NoneAndDefault, ReadOnly: False, ImportIgnore: False}
function PatchFakeObject:PropertyInfo(idx) end
---@overload fun(idx: 0|1|2|3|4|5|6|8|14|15|16|17|19): "UInt32"
---@overload fun(idx: 7|12|18|21|22|23|24|25): "String"
---@overload fun(idx: 9|10): "Bool"
---@overload fun(idx: 11): "UInt64"
---@overload fun(idx: 13): "Int64"
---@overload fun(idx: 20): "Custom"
function PatchFakeObject:PropertyType(idx) end
---@overload fun(name: "Patch", role: nil): DMXPropertyAddress
---@overload fun(name: "Stage"|"IDType", role: nil): Default
---@overload fun(name: "FixtureID"|"CID", role: nil): NoneAndDefault
...
---@overload fun(name: "Index"|"Count"|"No"|"MemoryFootprint"|"FixtureType", role: nil): integer
---@overload fun(name: "Note"|"DependencyExport"|"Name"|"Layer"|"Class"|"PosX"|"PosY"|"PosZ", role: nil): string
---@overload fun(name: "IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"Index"|"Count"|"No"|"Note"|"UserExpanded"|"FaderEnabled"|"Owned"|"Hidden"|"DependencyExport"|"MemoryFootprint"|"Stage"|"FixtureID"|"IDType"|"CID"|"Name"|"FixtureType"|"Patch"|"Layer"|"Class"|"PosX"|"PosY"|"PosZ", role: Enums.Roles): string
...
---@overload fun(property_name: "Patch", property_value: DMXPropertyAddress, override_change_level: ChangeLevel?)
---@overload fun(property_name: "Stage"|"IDType", property_value: Default, override_change_level: ChangeLevel?)
---@overload fun(property_name: "FixtureID"|"CID", property_value: NoneAndDefault, override_change_level: ChangeLevel?)
...
---@overload fun(property_name: "Index"|"Count"|"No"|"FixtureType", property_value: integer, override_change_level: ChangeLevel?)
---@overload fun(property_name: "Note"|"DependencyExport"|"Name"|"Layer"|"Class"|"PosX"|"PosY"|"PosZ", property_value: string, override_change_level: ChangeLevel?)
function PatchFakeObject:Set(property_name, property_value, override_change_level) end
...
function PatchFakeObject:SetChildren(property_name, property_value) end