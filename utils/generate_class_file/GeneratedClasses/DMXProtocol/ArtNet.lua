...
---@field BroadcastThreshold ArtNetBroadcastThreshold Threshold for Broadcasts
...
---@param class `T`
---@return boolean
function ArtNet:IsClass(class) end
---@return 23
function ArtNet:PropertyCount() end
...
---@overload fun(idx: 15): "Out"
---@overload fun(idx: 16): "In"
---@overload fun(idx: 17): "Interface"
---@overload fun(idx: 18): "SetupMode"
---@overload fun(idx: 19): "OutputDelay"
---@overload fun(idx: 20): "PreferredIP"
---@overload fun(idx: 21): "BroadcastThreshold"
---@overload fun(idx: 22): "ArtPollRate"
function ArtNet:PropertyName(idx) end
---@overload fun(idx: 0|1|2): {ExportIgnore: True, EnumCollection: YesNo, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 3|12|15|16|18): {ExportIgnore: False, EnumCollection: YesNo, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 4|5|6): {ExportIgnore: True, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 7|8|13|17|20|22): {ExportIgnore: False, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 9): {ExportIgnore: False, EnumCollection: YesNo, ReadOnly: True, ImportIgnore: True}
---@overload fun(idx: 10|11): {ExportIgnore: True, EnumCollection: YesNo, ReadOnly: True, ImportIgnore: True}
---@overload fun(idx: 14): {ExportIgnore: False, ReadOnly: True, ImportIgnore: True}
---@overload fun(idx: 19): {ExportIgnore: False, EnumCollection: OutputDelay, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 21): {ExportIgnore: False, EnumCollection: ArtNetBroadcastThreshold, ReadOnly: False, ImportIgnore: False}
function ArtNet:PropertyInfo(idx) end
---@overload fun(idx: 0|1|2|3|4|5|6|9): "UInt32"
---@overload fun(idx: 7|8|13|17): "String"
---@overload fun(idx: 10|11): "Bool"
---@overload fun(idx: 12): "UInt64"
---@overload fun(idx: 14|21): "Int64"
---@overload fun(idx: 15|16|18|19): "UInt8"
---@overload fun(idx: 20): "Custom"
---@overload fun(idx: 22): "Int64Time"
function ArtNet:PropertyType(idx) end
---@overload fun(name: "BroadcastThreshold", role: nil): ArtNetBroadcastThreshold
---@overload fun(name: "PreferredIP", role: nil): Manet.IP4
---@overload fun(name: "OutputDelay", role: nil): OutputDelay
---@overload fun(name: "ArtPollRate", role: nil): TimePropertyValue
---@overload fun(name: "IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"UserExpanded"|"FaderEnabled"|"Owned"|"Hidden"|"Out"|"In"|"SetupMode", role: nil): YesNo|boolean
...
---@overload fun(class: "NoteTextEdit", undo: Undo?): NoteTextEdit
---@overload fun(class: nil, undo: Undo?): Object
function ArtNet:Find(class, undo) end
---@overload fun(property_name: "BroadcastThreshold", property_value: ArtNetBroadcastThreshold, override_change_level: ChangeLevel?)
---@overload fun(property_name: "PreferredIP", property_value: Manet.IP4, override_change_level: ChangeLevel?)
---@overload fun(property_name: "OutputDelay", property_value: OutputDelay, override_change_level: ChangeLevel?)
---@overload fun(property_name: "ArtPollRate", property_value: TimePropertyValue, override_change_level: ChangeLevel?)
---@overload fun(property_name: "IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"Hidden"|"Out"|"In"|"SetupMode", property_value: YesNo|boolean, override_change_level: ChangeLevel?)
...
function ArtNet:Set(property_name, property_value, override_change_level) end
...
function ArtNet:SetChildren(property_name, property_value) end