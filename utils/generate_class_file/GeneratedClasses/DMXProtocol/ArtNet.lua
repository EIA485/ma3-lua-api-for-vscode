...
---@class ArtNet: DMXProtocol
---@field Broadcast
Threshold integer Threshold for Broadcasts
---@field ArtPollRate TimePropertyValue
local ArtNet = {
    ArtPollRate="3000"
}
---@return "ArtNet"
function ArtNet:GetClass() end
---@return "Object"
function ArtNet:GetChildClass() end
...
---@overload fun(name: "Broadcast
Threshold", role: nil): integer
---@overload fun(name: "ArtPollRate", role: nil): TimePropertyValue
...
Delay"|"PreferredIP"|"Broadcast
Threshold"|"ArtPollRate", role: Enums.Roles): string
---@overload fun(name: integer, role: nil): Object
function ArtNet:Get(name, role) end
...
---@overload fun(index: integer, class: "ArtNetNodeCollect", undo: Undo?): ArtNetNodeCollect
---@overload fun(index: integer, class: "ArtNetDataCollect", undo: Undo?): ArtNetDataCollect
...
function ArtNet:Create(index, class, undo) end
...
---@overload fun(class: "ArtNetNodeCollect", undo: Undo?, count: integer?): ArtNetNodeCollect
---@overload fun(class: "ArtNetDataCollect", undo: Undo?, count: integer?): ArtNetDataCollect
...
function ArtNet:Append(class, undo, count) end
...
---@overload fun(class: "ArtNetNodeCollect", undo: Undo?): ArtNetNodeCollect
---@overload fun(class: "ArtNetDataCollect", undo: Undo?): ArtNetDataCollect
...
function ArtNet:Acquire(class, undo) end
---@overload fun(class: "Object", undo: Undo?): Object
---@overload fun(class: "MVRxchange", undo: Undo?): MVRxchange
---@overload fun(class: "SmartViewSettingsCollect", undo: Undo?): SmartViewSettingsCollect
---@overload fun(class: "RunningPlaybacksSettingsCollect", undo: Undo?): RunningPlaybacksSettingsCollect
...
function ArtNet:Aquire(class, undo) end
...
---@overload fun(index: integer, class: "ArtNetNodeCollect", undo: Undo?, count: integer?): ArtNetNodeCollect
---@overload fun(index: integer, class: "ArtNetDataCollect", undo: Undo?, count: integer?): ArtNetDataCollect
...
function ArtNet:Insert(index, class, undo, count) end
...
---@overload fun(name: string, class: "ArtNetNodeCollect"): ArtNetNodeCollect
---@overload fun(name: string, class: "ArtNetDataCollect"): ArtNetDataCollect
...
function ArtNet:Find(name, class) end
---@overload fun(name: string, class: "Object"): Object
---@overload fun(name: string, class: "MVRxchange"): MVRxchange
---@overload fun(name: string, class: "SmartViewSettingsCollect"): SmartViewSettingsCollect
---@overload fun(name: string, class: "RunningPlaybacksSettingsCollect"): RunningPlaybacksSettingsCollect
...
---@overload fun(name: string, class: "IllegalObject"): IllegalObject
---@overload fun(name: string, class: nil): Object
function ArtNet:FindRecursive(name, class) end
