...
---@param class `T`
---@return boolean
function sACN:IsClass(class) end
---@return 22
function sACN:PropertyCount() end
...
---@overload fun(idx: 21): "DataValid"
function sACN:PropertyName(idx) end
...
---@overload fun(idx: 7|8|13|17|20): {ExportIgnore: False, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 9|21): {ExportIgnore: False, EnumCollection: YesNo, ReadOnly: True, ImportIgnore: True}
...
function sACN:PropertyInfo(idx) end
---@overload fun(idx: 0|1|2|3|4|5|6|9): "UInt32"
---@overload fun(idx: 7|8|13|17): "String"
---@overload fun(idx: 10|11): "Bool"
---@overload fun(idx: 12): "UInt64"
---@overload fun(idx: 14): "Int64"
---@overload fun(idx: 15|16|18|19|21): "UInt8"
---@overload fun(idx: 20): "Custom"
function sACN:PropertyType(idx) end
---@overload fun(name: "PreferredIP", role: nil): Manet.IP4
---@overload fun(name: "OutputDelay", role: nil): OutputDelay
---@overload fun(name: "IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"UserExpanded"|"FaderEnabled"|"Owned"|"Hidden"|"Out"|"In"|"SetupMode"|"DataValid", role: nil): YesNo|boolean
...
---@overload fun(class: "NoteTextEdit", undo: Undo?): NoteTextEdit
---@overload fun(class: nil, undo: Undo?): Object
function sACN:Find(class, undo) end
...
function sACN:Set(property_name, property_value, override_change_level) end
...
function sACN:SetChildren(property_name, property_value) end