...
---@overload fun(name: "MemoryFootprint"|"ActiveSel"|"ActiveSelIndex"|"First
Step"|"Last
Step", role: nil): integer
---@overload fun(name: "MultiStepSelected"|"AllStepSelected", role: nil): boolean
---@overload fun(name: "AlignMode"|"AlignTransition"|"AlignRotYZ"|"AlignRotXZ"|"AlignRotXY", role: nil): integer
---@overload fun(name: "AlignCombined", role: nil): string
---@overload fun(name: "StepMask", role: nil): StepMask
---@overload fun(name: "StepMaskFirst"|"StepMaskLast", role: nil): integer
---@overload fun(name: "ProgPart", role: nil): ProgPart
---@overload fun(name: "Sync"|"Single
Step"|"Freeze", role: nil): integer
---@overload fun(name: "CurrentSelectionRef", role: nil): Selection
---@overload fun(name: "IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"Index"|"Count"|"No"|"Name"|"Note"|"UserExpanded"|"FaderEnabled"|"Owned"|"Hidden"|"DependencyExport"|"MemoryFootprint"|"ActiveSel"|"ActiveSelIndex"|"First
Step"|"Last
Step"|"MultiStepSelected"|"AllStepSelected"|"AlignMode"|"AlignTransition"|"AlignRotYZ"|"AlignRotXZ"|"AlignRotXY"|"AlignCombined"|"StepMask"|"StepMaskFirst"|"StepMaskLast"|"ProgPart"|"Sync"|"Single
Step"|"Freeze"|"CurrentSelectionRef", role: Enums.Roles): string
...
---@overload fun(index: integer, class: "RecipeEditor", undo: Undo?): RecipeEditor
---@overload fun(index: integer, class: "Programmer", undo: Undo?): Programmer
...
---@overload fun(index: integer, class: "AtFilter", undo: Undo?): AtFilter
...
---@overload fun(index: integer, class: "Selection", undo: Undo?): Selection
---@overload fun(index: integer, class: "Patch3dSelection", undo: Undo?): Patch3dSelection
---@overload fun(index: integer, class: "LivePatch3dSelection", undo: Undo?): LivePatch3dSelection
...
---@overload fun(class: "RecipeEditor", undo: Undo?, count: integer?): RecipeEditor
---@overload fun(class: "Programmer", undo: Undo?, count: integer?): Programmer
...
---@overload fun(class: "AtFilter", undo: Undo?, count: integer?): AtFilter
...
---@overload fun(class: "Selection", undo: Undo?, count: integer?): Selection
---@overload fun(class: "Patch3dSelection", undo: Undo?, count: integer?): Patch3dSelection
---@overload fun(class: "LivePatch3dSelection", undo: Undo?, count: integer?): LivePatch3dSelection
...
---@overload fun(class: "RecipeEditor", undo: Undo?): RecipeEditor
---@overload fun(class: "Programmer", undo: Undo?): Programmer
...
---@overload fun(class: "AtFilter", undo: Undo?): AtFilter
...
---@overload fun(class: "Selection", undo: Undo?): Selection
---@overload fun(class: "Patch3dSelection", undo: Undo?): Patch3dSelection
---@overload fun(class: "LivePatch3dSelection", undo: Undo?): LivePatch3dSelection
...
---@overload fun(index: integer, class: "RecipeEditor", undo: Undo?, count: integer?): RecipeEditor
---@overload fun(index: integer, class: "Programmer", undo: Undo?, count: integer?): Programmer
...
---@overload fun(index: integer, class: "AtFilter", undo: Undo?, count: integer?): AtFilter
...
---@overload fun(index: integer, class: "Selection", undo: Undo?, count: integer?): Selection
---@overload fun(index: integer, class: "Patch3dSelection", undo: Undo?, count: integer?): Patch3dSelection
---@overload fun(index: integer, class: "LivePatch3dSelection", undo: Undo?, count: integer?): LivePatch3dSelection
...
---@overload fun(name: string, class: "RecipeEditor"): RecipeEditor
---@overload fun(name: string, class: "Programmer"): Programmer
...
---@overload fun(name: string, class: "AtFilter"): AtFilter
...
---@overload fun(name: string, class: "Selection"): Selection
---@overload fun(name: string, class: "Patch3dSelection"): Patch3dSelection
---@overload fun(name: string, class: "LivePatch3dSelection"): LivePatch3dSelection
...
function UserEnvironment:Find(name, class) end
---@overload fun(name: string, class: "Object"): Object
---@overload fun(name: string, class: "MVRxchange"): MVRxchange
---@overload fun(name: string, class: "SmartViewSettingsCollect"): SmartViewSettingsCollect
---@overload fun(name: string, class: "RunningPlaybacksSettingsCollect"): RunningPlaybacksSettingsCollect
...
---@overload fun(name: string, class: "IllegalObject"): IllegalObject
---@overload fun(name: string, class: nil): Object
function UserEnvironment:FindRecursive(name, class) end
