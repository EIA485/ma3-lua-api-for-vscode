...
---@class RDMData: Object RDM datas
---@field Enable boolean
local RDMData = {
    Enable="No"
}
---@return "RDMData"
function RDMData:GetClass() end
---@return "Object"
function RDMData:GetChildClass() end
---@return ShowData
function RDMData:Parent() end
...
---@overload fun(name: "Enable", role: nil): boolean
---@overload fun(name: "IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"Index"|"Count"|"No"|"Name"|"Note"|"UserExpanded"|"FaderEnabled"|"Owned"|"Hidden"|"DependencyExport"|"MemoryFootprint"|"Enable", role: Enums.Roles): string
---@overload fun(name: integer, role: nil): Object
function RDMData:Get(name, role) end
...
---@overload fun(index: integer, class: "RDMFixtureTypes", undo: Undo?): RDMFixtureTypes
---@overload fun(index: integer, class: "RDMPorts", undo: Undo?): RDMPorts
...
function RDMData:Create(index, class, undo) end
...
---@overload fun(class: "RDMFixtureTypes", undo: Undo?, count: integer?): RDMFixtureTypes
---@overload fun(class: "RDMPorts", undo: Undo?, count: integer?): RDMPorts
...
function RDMData:Append(class, undo, count) end
...
---@overload fun(class: "RDMFixtureTypes", undo: Undo?): RDMFixtureTypes
---@overload fun(class: "RDMPorts", undo: Undo?): RDMPorts
...
function RDMData:Acquire(class, undo) end
---@overload fun(class: "Object", undo: Undo?): Object
---@overload fun(class: "MVRxchange", undo: Undo?): MVRxchange
---@overload fun(class: "SmartViewSettingsCollect", undo: Undo?): SmartViewSettingsCollect
---@overload fun(class: "RunningPlaybacksSettingsCollect", undo: Undo?): RunningPlaybacksSettingsCollect
...
function RDMData:Aquire(class, undo) end
...
---@overload fun(index: integer, class: "RDMFixtureTypes", undo: Undo?, count: integer?): RDMFixtureTypes
---@overload fun(index: integer, class: "RDMPorts", undo: Undo?, count: integer?): RDMPorts
...
function RDMData:Insert(index, class, undo, count) end
...
---@overload fun(name: string, class: "RDMFixtureTypes"): RDMFixtureTypes
---@overload fun(name: string, class: "RDMPorts"): RDMPorts
...
function RDMData:Find(name, class) end
---@overload fun(name: string, class: "Object"): Object
---@overload fun(name: string, class: "MVRxchange"): MVRxchange
---@overload fun(name: string, class: "SmartViewSettingsCollect"): SmartViewSettingsCollect
---@overload fun(name: string, class: "RunningPlaybacksSettingsCollect"): RunningPlaybacksSettingsCollect
...
---@overload fun(name: string, class: "IllegalObject"): IllegalObject
---@overload fun(name: string, class: nil): Object
function RDMData:FindRecursive(name, class) end
