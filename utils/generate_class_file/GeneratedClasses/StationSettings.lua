...
---@class StationSettings: Object Container for all settings which are relevant for the local station only.
local StationSettings = {}
---@return "StationSettings"
function StationSettings:GetClass() end
---@return "Object"
function StationSettings:GetChildClass() end
---@return Root
function StationSettings:Parent() end
...
---@overload fun(index: integer, class: "LocalSettings", undo: Undo?): LocalSettings
...
---@overload fun(index: integer, class: "ExtensionConfigurations", undo: Undo?): ExtensionConfigurations
---@overload fun(index: integer, class: "DeskLightsCollect", undo: Undo?): DeskLightsCollect
---@overload fun(index: integer, class: "DefaultDisplayPositionsCollect", undo: Undo?): DefaultDisplayPositionsCollect
---@overload fun(index: integer, class: "DisplaySurfaces", undo: Undo?): DisplaySurfaces
---@overload fun(index: integer, class: "TimeConfig", undo: Undo?): TimeConfig
...
function StationSettings:Create(index, class, undo) end
...
---@overload fun(class: "LocalSettings", undo: Undo?, count: integer?): LocalSettings
...
---@overload fun(class: "ExtensionConfigurations", undo: Undo?, count: integer?): ExtensionConfigurations
---@overload fun(class: "DeskLightsCollect", undo: Undo?, count: integer?): DeskLightsCollect
---@overload fun(class: "DefaultDisplayPositionsCollect", undo: Undo?, count: integer?): DefaultDisplayPositionsCollect
---@overload fun(class: "DisplaySurfaces", undo: Undo?, count: integer?): DisplaySurfaces
---@overload fun(class: "TimeConfig", undo: Undo?, count: integer?): TimeConfig
...
function StationSettings:Append(class, undo, count) end
...
---@overload fun(class: "LocalSettings", undo: Undo?): LocalSettings
...
---@overload fun(class: "ExtensionConfigurations", undo: Undo?): ExtensionConfigurations
---@overload fun(class: "DeskLightsCollect", undo: Undo?): DeskLightsCollect
---@overload fun(class: "DefaultDisplayPositionsCollect", undo: Undo?): DefaultDisplayPositionsCollect
---@overload fun(class: "DisplaySurfaces", undo: Undo?): DisplaySurfaces
---@overload fun(class: "TimeConfig", undo: Undo?): TimeConfig
...
function StationSettings:Acquire(class, undo) end
---@overload fun(class: "Object", undo: Undo?): Object
---@overload fun(class: "MVRxchange", undo: Undo?): MVRxchange
---@overload fun(class: "SmartViewSettingsCollect", undo: Undo?): SmartViewSettingsCollect
---@overload fun(class: "RunningPlaybacksSettingsCollect", undo: Undo?): RunningPlaybacksSettingsCollect
...
function StationSettings:Aquire(class, undo) end
...
---@overload fun(index: integer, class: "LocalSettings", undo: Undo?, count: integer?): LocalSettings
...
---@overload fun(index: integer, class: "ExtensionConfigurations", undo: Undo?, count: integer?): ExtensionConfigurations
---@overload fun(index: integer, class: "DeskLightsCollect", undo: Undo?, count: integer?): DeskLightsCollect
---@overload fun(index: integer, class: "DefaultDisplayPositionsCollect", undo: Undo?, count: integer?): DefaultDisplayPositionsCollect
---@overload fun(index: integer, class: "DisplaySurfaces", undo: Undo?, count: integer?): DisplaySurfaces
---@overload fun(index: integer, class: "TimeConfig", undo: Undo?, count: integer?): TimeConfig
...
function StationSettings:Insert(index, class, undo, count) end
...
---@overload fun(name: string, class: "LocalSettings"): LocalSettings
...
---@overload fun(name: string, class: "ExtensionConfigurations"): ExtensionConfigurations
---@overload fun(name: string, class: "DeskLightsCollect"): DeskLightsCollect
---@overload fun(name: string, class: "DefaultDisplayPositionsCollect"): DefaultDisplayPositionsCollect
---@overload fun(name: string, class: "DisplaySurfaces"): DisplaySurfaces
---@overload fun(name: string, class: "TimeConfig"): TimeConfig
...
function StationSettings:Find(name, class) end
---@overload fun(name: string, class: "Object"): Object
---@overload fun(name: string, class: "MVRxchange"): MVRxchange
---@overload fun(name: string, class: "SmartViewSettingsCollect"): SmartViewSettingsCollect
---@overload fun(name: string, class: "RunningPlaybacksSettingsCollect"): RunningPlaybacksSettingsCollect
...
---@overload fun(name: string, class: "IllegalObject"): IllegalObject
---@overload fun(name: string, class: nil): Object
function StationSettings:FindRecursive(name, class) end
