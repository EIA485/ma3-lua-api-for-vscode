...
---@overload fun(class: "NoteTextEdit", undo: Undo?): NoteTextEdit
---@overload fun(class: nil, undo: Undo?): Object
function HardwareStatus:Find(class, undo) end
...
function HardwareStatus:SetChildren(property_name, property_value) end