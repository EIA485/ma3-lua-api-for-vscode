...
---@param class `T`
---@return boolean
function FixtureFilterRuleFixtureTypeItem:IsClass(class) end
---@return FixtureFilterRuleFixtureType
function FixtureFilterRuleFixtureTypeItem:Parent() end
---@return 16
function FixtureFilterRuleFixtureTypeItem:PropertyCount() end
...
---@overload fun(idx: 15): "DMXMode"
function FixtureFilterRuleFixtureTypeItem:PropertyName(idx) end
...
function FixtureFilterRuleFixtureTypeItem:PropertyInfo(idx) end
...
function FixtureFilterRuleFixtureTypeItem:PropertyType(idx) end
...
---@overload fun(property_name: "DMXMode", property_value: DMXMode, override_change_level: ChangeLevel?)
...
function FixtureFilterRuleFixtureTypeItem:Set(property_name, property_value, override_change_level) end