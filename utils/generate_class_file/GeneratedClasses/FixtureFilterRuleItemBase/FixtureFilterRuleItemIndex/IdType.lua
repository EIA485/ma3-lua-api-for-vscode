...
---@param class `T`
---@return boolean
function IdType:IsClass(class) end
---@return FixtureFilterRuleIDType
function IdType:Parent() end
---@return 16
function IdType:PropertyCount() end
...
---@overload fun(idx: 15): "IDType"
function IdType:PropertyName(idx) end
...
---@overload fun(name: "Index"|"Count"|"No"|"MemoryFootprint"|"IDType", role: nil): integer
---@overload fun(name: "Name"|"Note"|"DependencyExport", role: nil): string
---@overload fun(name: "IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"Index"|"Count"|"No"|"Name"|"Note"|"UserExpanded"|"FaderEnabled"|"Owned"|"Hidden"|"DependencyExport"|"MemoryFootprint"|"IDType", role: Enums.Roles): string
...
---@overload fun(property_name: "Index"|"Count"|"No"|"IDType", property_value: integer, override_change_level: ChangeLevel?)
---@overload fun(property_name: "Name"|"Note"|"DependencyExport", property_value: string, override_change_level: ChangeLevel?)
function IdType:Set(property_name, property_value, override_change_level) end