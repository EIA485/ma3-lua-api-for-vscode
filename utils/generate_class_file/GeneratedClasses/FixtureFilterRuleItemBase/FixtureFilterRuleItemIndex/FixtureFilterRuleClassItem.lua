...
---@param class `T`
---@return boolean
function FixtureFilterRuleClassItem:IsClass(class) end
---@return FixtureFilterRuleClass
function FixtureFilterRuleClassItem:Parent() end
---@return 16
function FixtureFilterRuleClassItem:PropertyCount() end
...
---@overload fun(idx: 15): "Class"
function FixtureFilterRuleClassItem:PropertyName(idx) end
...
function FixtureFilterRuleClassItem:PropertyInfo(idx) end
...
function FixtureFilterRuleClassItem:PropertyType(idx) end
...
function FixtureFilterRuleClassItem:Set(property_name, property_value, override_change_level) end