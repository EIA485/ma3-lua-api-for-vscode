...
---@param class `T`
---@return boolean
function FixtureFilterRuleNameItem:IsClass(class) end
---@return FixtureFilterRuleName
function FixtureFilterRuleNameItem:Parent() end
---@return 16
function FixtureFilterRuleNameItem:PropertyCount() end
...
---@overload fun(idx: 15): "NameFilter"
function FixtureFilterRuleNameItem:PropertyName(idx) end
...
function FixtureFilterRuleNameItem:PropertyInfo(idx) end
---@overload fun(idx: 0|1|2|3|4|5|6|9): "UInt32"
---@overload fun(idx: 7|8|13|15): "String"
---@overload fun(idx: 10|11): "Bool"
---@overload fun(idx: 12): "UInt64"
---@overload fun(idx: 14): "Int64"
function FixtureFilterRuleNameItem:PropertyType(idx) end
...
---@overload fun(name: "Name"|"Note"|"DependencyExport"|"NameFilter", role: nil): string
...
---@overload fun(property_name: "Name"|"Note"|"DependencyExport"|"NameFilter", property_value: string, override_change_level: ChangeLevel?)
function FixtureFilterRuleNameItem:Set(property_name, property_value, override_change_level) end