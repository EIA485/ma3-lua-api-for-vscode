...
---@param class `T`
---@return boolean
function RDMFixtureType:IsClass(class) end
---@return 21
function RDMFixtureType:PropertyCount() end
...
---@overload fun(idx: 15): "Manufacturer"
---@overload fun(idx: 16): "ManufacturerID"
---@overload fun(idx: 17): "DeviceModelID"
---@overload fun(idx: 18): "ProductCategory"
---@overload fun(idx: 19): "SoftwareID"
---@overload fun(idx: 20): "SoftwareVersionLabel"
function RDMFixtureType:PropertyName(idx) end
---@overload fun(idx: 0|1|2): {ExportIgnore: True, EnumCollection: YesNo, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 3|12): {ExportIgnore: False, EnumCollection: YesNo, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 4|5|6|19|20): {ExportIgnore: True, ReadOnly: False, ImportIgnore: False}
...
---@overload fun(idx: 15): {ExportIgnore: False, EnumCollection: RDMManufacturerId, ReadOnly: True, ImportIgnore: True}
---@overload fun(idx: 18): {ExportIgnore: True, EnumCollection: RDMProductCategory, ReadOnly: False, ImportIgnore: False}
function RDMFixtureType:PropertyInfo(idx) end
---@overload fun(idx: 0|1|2|3|4|5|6|9|19): "UInt32"
---@overload fun(idx: 7|8|13|16|17|20): "String"
---@overload fun(idx: 10|11): "Bool"
---@overload fun(idx: 12): "UInt64"
---@overload fun(idx: 14): "Int64"
---@overload fun(idx: 15|18): "UInt16"
function RDMFixtureType:PropertyType(idx) end
...
---@overload fun(name: "Index"|"Count"|"No"|"MemoryFootprint"|"SoftwareID", role: nil): integer
---@overload fun(name: "Name"|"Note"|"DependencyExport"|"ManufacturerID"|"DeviceModelID"|"SoftwareVersionLabel", role: nil): string
...
---@overload fun(class: "NoteTextEdit", undo: Undo?): NoteTextEdit
---@overload fun(class: nil, undo: Undo?): Object
function RDMFixtureType:Find(class, undo) end
---@overload fun(property_name: "ProductCategory", property_value: RDMProductCategory, override_change_level: ChangeLevel?)
...
---@overload fun(property_name: "Index"|"Count"|"No"|"SoftwareID", property_value: integer, override_change_level: ChangeLevel?)
---@overload fun(property_name: "Name"|"Note"|"DependencyExport"|"ManufacturerID"|"DeviceModelID"|"SoftwareVersionLabel", property_value: string, override_change_level: ChangeLevel?)
function RDMFixtureType:Set(property_name, property_value, override_change_level) end
...
---@overload fun(property_name: "TimezoneStr"|"FileName"|"ClassFilter"|"TitlePrefix"|"StoredData"|"FixtureTypeFilter"|"Type"|"ToolAction"|"FileName"|"SelectedFilter"|"FilePath"|"GroupName"|"Interface"|"FileContent"|"Author"|"SelectionCount"|"Path"|"Name"|"Note"|"Comment"|"Note"|"DisplayPool"|"TargetName"|"DependencyExport"|"ChildName"|"Description"|"SelectedDataPool"|"GridColumnConfigurationType"|"Type"|"User"|"LastReceivedMidi"|"FeatureGroup"|"*"|"ContentFilterType"|"Trigger"|"NewShowStartDescription"|"Type"|"LayerFilter", property_value: string)
...
function RDMFixtureType:SetChildren(property_name, property_value) end