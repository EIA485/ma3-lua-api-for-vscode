...
---@class RDMFixtureType: NamedObj RDM section
---@field Manufacturer RDMManufacturerId ESTA Manufacturer
---@field ManufacturerID string ESTA Manufacturer ID
---@field DeviceModelID string This field identifies the Device Model ID of the Root Device or the Sub-Device
---@field ProductCategory RDMProductCategory
---@field SoftwareID integer
---@field SoftwareVersionLabel string
local RDMFixtureType = {
    Manufacturer="ESTA",
    ManufacturerID="0",
    DeviceModelID="0",
    ProductCategory="0"
...
function RDMFixtureType:GetClass() end
---@return "Object"
function RDMFixtureType:GetChildClass() end
...
---@overload fun(name: "ManufacturerID"|"DeviceModelID", role: nil): string
---@overload fun(name: "ProductCategory", role: nil): RDMProductCategory
---@overload fun(name: "SoftwareID", role: nil): integer
---@overload fun(name: "SoftwareVersionLabel", role: nil): string
---@overload fun(name: "IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"Index"|"Count"|"No"|"Name"|"Note"|"UserExpanded"|"FaderEnabled"|"Owned"|"Hidden"|"DependencyExport"|"MemoryFootprint"|"Manufacturer"|"ManufacturerID"|"DeviceModelID"|"ProductCategory"|"SoftwareID"|"SoftwareVersionLabel", role: Enums.Roles): string
---@overload fun(name: integer, role: nil): Object
function RDMFixtureType:Get(name, role) end
...
---@overload fun(index: integer, class: "FTRDMPersonalityCollect", undo: Undo?): FTRDMPersonalityCollect
---@overload fun(index: integer, class: "Notifications", undo: Undo?): Notifications
---@overload fun(index: integer, class: "Parameters", undo: Undo?): Parameters
...
function RDMFixtureType:Create(index, class, undo) end
...
---@overload fun(class: "FTRDMPersonalityCollect", undo: Undo?, count: integer?): FTRDMPersonalityCollect
---@overload fun(class: "Notifications", undo: Undo?, count: integer?): Notifications
---@overload fun(class: "Parameters", undo: Undo?, count: integer?): Parameters
...
function RDMFixtureType:Append(class, undo, count) end
...
---@overload fun(class: "FTRDMPersonalityCollect", undo: Undo?): FTRDMPersonalityCollect
---@overload fun(class: "Notifications", undo: Undo?): Notifications
---@overload fun(class: "Parameters", undo: Undo?): Parameters
...
function RDMFixtureType:Acquire(class, undo) end
---@overload fun(class: "Object", undo: Undo?): Object
---@overload fun(class: "MVRxchange", undo: Undo?): MVRxchange
---@overload fun(class: "SmartViewSettingsCollect", undo: Undo?): SmartViewSettingsCollect
---@overload fun(class: "RunningPlaybacksSettingsCollect", undo: Undo?): RunningPlaybacksSettingsCollect
...
function RDMFixtureType:Aquire(class, undo) end
...
---@overload fun(index: integer, class: "FTRDMPersonalityCollect", undo: Undo?, count: integer?): FTRDMPersonalityCollect
---@overload fun(index: integer, class: "Notifications", undo: Undo?, count: integer?): Notifications
---@overload fun(index: integer, class: "Parameters", undo: Undo?, count: integer?): Parameters
...
function RDMFixtureType:Insert(index, class, undo, count) end
...
---@overload fun(name: string, class: "FTRDMPersonalityCollect"): FTRDMPersonalityCollect
---@overload fun(name: string, class: "Notifications"): Notifications
---@overload fun(name: string, class: "Parameters"): Parameters
...
function RDMFixtureType:Find(name, class) end
---@overload fun(name: string, class: "Object"): Object
---@overload fun(name: string, class: "MVRxchange"): MVRxchange
---@overload fun(name: string, class: "SmartViewSettingsCollect"): SmartViewSettingsCollect
---@overload fun(name: string, class: "RunningPlaybacksSettingsCollect"): RunningPlaybacksSettingsCollect
...
---@overload fun(name: string, class: "IllegalObject"): IllegalObject
---@overload fun(name: string, class: nil): Object
function RDMFixtureType:FindRecursive(name, class) end
