...
---@overload fun(name: "DMXBreak"|"IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"Index"|"Count"|"No"|"UserExpanded"|"Hidden"|"MemoryFootprint", role: nil): integer
---@overload fun(name: "Length", role: nil): number
---@overload fun(name: "Name"|"Note"|"DependencyExport", role: nil): string
---@overload fun(name: "Type"|"Gender"|"DMXBreak"|"Length"|"IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"Index"|"Count"|"No"|"Name"|"Note"|"UserExpanded"|"FaderEnabled"|"Owned"|"Hidden"|"DependencyExport"|"MemoryFootprint", role: Enums.Roles): string
---@overload fun(name: integer, role: nil): PowerConsumption
function Connector:Get(name, role) end
---@generic T : PowerConsumption
---@param index integer
---@param class `T`
---@param undo Undo?
---@return T
...
---@generic T : Connectors
---@param class `T`
---@return T
function Connector:FindParent(class) end