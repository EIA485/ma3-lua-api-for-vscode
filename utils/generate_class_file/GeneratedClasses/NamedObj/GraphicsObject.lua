...
---@return T
---@overload fun(class: "NoteTextEdit", undo: Undo?): NoteTextEdit
function GraphicsObject:Find(class, undo) end
...
function GraphicsObject:FindParent(class) end