...
---@field DefaultsLoaded YesNo|boolean
local GenericPool = {
    DefaultsLoaded="Yes"
}
---@return "GenericPool"
...
---@generic T : GenericPool
---@param class `T`
---@return boolean
function GenericPool:IsClass(class) end
---@return 16
function GenericPool:PropertyCount() end
...
function GenericPool:PropertyName(idx) end
...
function GenericPool:PropertyInfo(idx) end
...
function GenericPool:PropertyType(idx) end
...
---@overload fun(class: "NoteTextEdit", undo: Undo?): NoteTextEdit
---@overload fun(class: nil, undo: Undo?): Object
function GenericPool:Find(class, undo) end
...
function GenericPool:Set(property_name, property_value, override_change_level) end
...
function GenericPool:SetChildren(property_name, property_value) end