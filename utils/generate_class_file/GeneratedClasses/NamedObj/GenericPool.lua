...
---@class GenericPool: NamedObj Base class for all pools (eg. Presets,Sequences, Groups etc).
---@field DefaultsLoaded integer
local GenericPool = {
    DefaultsLoaded="Yes"
}
---@return "GenericPool"
function GenericPool:GetClass() end
---@return "Object"
function GenericPool:GetChildClass() end
...
---@overload fun(name: "IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"Index"|"Count"|"No"|"Name"|"Note"|"UserExpanded"|"FaderEnabled"|"Owned"|"Hidden"|"DependencyExport"|"MemoryFootprint"|"DefaultsLoaded", role: Enums.Roles): string
---@overload fun(name: integer, role: nil): Object
function GenericPool:Get(name, role) end
...
function GenericPool:Create(index, class, undo) end
...
function GenericPool:Append(class, undo, count) end
...
function GenericPool:Acquire(class, undo) end
---@overload fun(class: "Object", undo: Undo?): Object
---@overload fun(class: "MVRxchange", undo: Undo?): MVRxchange
---@overload fun(class: "SmartViewSettingsCollect", undo: Undo?): SmartViewSettingsCollect
---@overload fun(class: "RunningPlaybacksSettingsCollect", undo: Undo?): RunningPlaybacksSettingsCollect
...
function GenericPool:Aquire(class, undo) end
...
function GenericPool:Insert(index, class, undo, count) end
...
function GenericPool:Find(name, class) end
---@overload fun(name: string, class: "Object"): Object
---@overload fun(name: string, class: "MVRxchange"): MVRxchange
---@overload fun(name: string, class: "SmartViewSettingsCollect"): SmartViewSettingsCollect
---@overload fun(name: string, class: "RunningPlaybacksSettingsCollect"): RunningPlaybacksSettingsCollect
...
---@overload fun(name: string, class: "IllegalObject"): IllegalObject
---@overload fun(name: string, class: nil): Object
function GenericPool:FindRecursive(name, class) end
