...
---@generic T : GridObjectContentFilterItem
---@param class `T`
---@return boolean
function GridObjectContentFilterItem:IsClass(class) end
---@return GridObjectContentFilter
function GridObjectContentFilterItem:Parent() end
---@return 21
function GridObjectContentFilterItem:PropertyCount() end
...
function GridObjectContentFilterItem:PropertyName(idx) end
...
---@overload fun(idx: 14|19|20): {ExportIgnore: False, ReadOnly: True, ImportIgnore: True}
function GridObjectContentFilterItem:PropertyInfo(idx) end
...
function GridObjectContentFilterItem:PropertyType(idx) end
...
function GridObjectContentFilterItem:Set(property_name, property_value, override_change_level) end