...
---@generic T : Appearance
---@param class `T`
---@return boolean
function Appearance:IsClass(class) end
---@return Appearances
function Appearance:Parent() end
---@return 41
function Appearance:PropertyCount() end
...
function Appearance:PropertyName(idx) end
...
function Appearance:PropertyInfo(idx) end
...
function Appearance:PropertyType(idx) end
...
function Appearance:Set(property_name, property_value, override_change_level) end
...
function Appearance:SetChildren(property_name, property_value) end