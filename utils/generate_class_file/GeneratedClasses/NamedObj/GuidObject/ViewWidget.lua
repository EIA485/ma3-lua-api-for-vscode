...
---@field MinSizeTranspose boolean
---@field SnapToBlockSize boolean
---@field UIWindow Object
local ViewWidget = {
    MinW="2",
    MinH="2",
    MaxW="0",
    MaxH="0",
    PresetPoolType="Dynamic",
    MinSizeTranspose="No",
    SnapToBlockSize="No"
}
---@return "ViewWidget"
function ViewWidget:GetClass() end
---@return "Object"
function ViewWidget:GetChildClass() end
---@return View
function ViewWidget:Parent() end
...
---@overload fun(name: "Display"|"X"|"Y"|"W"|"H"|"MinW"|"MinH"|"MaxW"|"MaxH"|"PresetPoolType", role: nil): integer
---@overload fun(name: "MinSizeTranspose"|"SnapToBlockSize", role: nil): boolean
---@overload fun(name: "UIWindow", role: nil): Object
---@overload fun(name: "IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"Index"|"Count"|"No"|"Name"|"Note"|"UserExpanded"|"FaderEnabled"|"Owned"|"Hidden"|"DependencyExport"|"MemoryFootprint"|"Guid"|"Scribble"|"Appearance"|"NameAndApp"|"Note"|"Tags"|"Display"|"X"|"Y"|"W"|"H"|"MinW"|"MinH"|"MaxW"|"MaxH"|"PresetPoolType"|"MinSizeTranspose"|"SnapToBlockSize"|"UIWindow", role: Enums.Roles): string
---@overload fun(name: integer, role: nil): Object
function ViewWidget:Get(name, role) end
...
---@overload fun(index: integer, class: "WindowScrollPositions", undo: Undo?): WindowScrollPositions
---@overload fun(index: integer, class: "WindowAppearance", undo: Undo?): WindowAppearance
...
function ViewWidget:Create(index, class, undo) end
...
---@overload fun(class: "WindowScrollPositions", undo: Undo?, count: integer?): WindowScrollPositions
---@overload fun(class: "WindowAppearance", undo: Undo?, count: integer?): WindowAppearance
...
function ViewWidget:Append(class, undo, count) end
...
---@overload fun(class: "WindowScrollPositions", undo: Undo?): WindowScrollPositions
---@overload fun(class: "WindowAppearance", undo: Undo?): WindowAppearance
...
function ViewWidget:Acquire(class, undo) end
---@overload fun(class: "Object", undo: Undo?): Object
---@overload fun(class: "MVRxchange", undo: Undo?): MVRxchange
---@overload fun(class: "SmartViewSettingsCollect", undo: Undo?): SmartViewSettingsCollect
---@overload fun(class: "RunningPlaybacksSettingsCollect", undo: Undo?): RunningPlaybacksSettingsCollect
...
function ViewWidget:Aquire(class, undo) end
...
---@overload fun(index: integer, class: "WindowScrollPositions", undo: Undo?, count: integer?): WindowScrollPositions
---@overload fun(index: integer, class: "WindowAppearance", undo: Undo?, count: integer?): WindowAppearance
...
function ViewWidget:Insert(index, class, undo, count) end
...
---@overload fun(name: string, class: "WindowScrollPositions"): WindowScrollPositions
---@overload fun(name: string, class: "WindowAppearance"): WindowAppearance
...
function ViewWidget:Find(name, class) end
---@overload fun(name: string, class: "Object"): Object
---@overload fun(name: string, class: "MVRxchange"): MVRxchange
---@overload fun(name: string, class: "SmartViewSettingsCollect"): SmartViewSettingsCollect
---@overload fun(name: string, class: "RunningPlaybacksSettingsCollect"): RunningPlaybacksSettingsCollect
...
---@overload fun(name: string, class: "IllegalObject"): IllegalObject
---@overload fun(name: string, class: nil): Object
function ViewWidget:FindRecursive(name, class) end
