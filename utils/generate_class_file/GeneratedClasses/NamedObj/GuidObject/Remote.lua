...
---@class Remote: GuidObject
---@field Target Object
---@field Fader PresetActionToken
---@field Key PresetActionToken
---@field Trigger
On DMXPropertyValue
---@field Trigger
Off DMXPropertyValue
---@field In
...
---@return "Remote"
function Remote:GetClass() end
---@return "Object"
function Remote:GetChildClass() end
---@return RemoteCollect
function Remote:Parent() end
...
To"|"Out
From"|"Out
To"|"Enabled"|"In"|"Out", role: Enums.Roles): string
---@overload fun(name: integer, role: nil): Object
function Remote:Get(name, role) end
