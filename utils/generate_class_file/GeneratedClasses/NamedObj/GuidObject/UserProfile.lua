...
---@field DMX
Readout DMXReadoutMode
---@field Normal
Value DMXPropertyValue
---@field Wheel
Resolution DimmerWheelResolution
---@field Wheel
Mode WheelMode
...
---@field Speed
Readout SpeedReadoutMode
---@field Preset
Readout PresetReadoutMode
...
Readout", role: nil): DMXReadoutMode
---@overload fun(name: "Normal
Value", role: nil): DMXPropertyValue
---@overload fun(name: "Wheel
Resolution", role: nil): DimmerWheelResolution
---@overload fun(name: "Wheel
Mode", role: nil): WheelMode
---@overload fun(name: "VKExpanded"|"SEExpanded"|"NEExpanded", role: nil): integer
...
---@overload fun(name: "ScribbleWidthScale", role: nil): integer
---@overload fun(name: "SelectedDataPool", role: nil): Pool
---@overload fun(name: "DefaultToken", role: nil): integer
---@overload fun(name: "EncoderLinkValues"|"EncoderLinkTiming"|"EncoderLinkPhaser", role: nil): EncoderLink
---@overload fun(name: "KnobUI
Style"|"EncoderUI
Style"|"ActiveOnly"|"MultiStepOnly"|"Precise
Edit"|"Screen
Encoder"|"TimeKey
Target"|"ShowUserEncoder"|"TCSlot"|"SelectedPage", role: nil): integer
---@overload fun(name: "Value
Readout", role: nil): ValueReadoutMode
---@overload fun(name: "Speed
Readout", role: nil): SpeedReadoutMode
---@overload fun(name: "Preset
Readout", role: nil): PresetReadoutMode
...
---@overload fun(name: "HelpPopupZoomFactor"|"Overlay
Fade", role: nil): integer
---@overload fun(name: "TimeReadout", role: nil): TimeDisplayFormat
---@overload fun(name: "FrameReadout", role: nil): integer
---@overload fun(name: "Color
Readout", role: nil): ColorDisplayMode
---@overload fun(name: "Oops
Views"|"Oops
Programmer"|"Oops
Selection"|"Create
Oops"|"Oops
Confirmation"|"Mirror
SpecialExecutorPages"|"ShowAppearanceInCueInput"|"ShowSettingsInEditors", role: nil): integer
---@overload fun(name: "Users", role: nil): User[]
---@overload fun(name: "Cmdlines", role: nil): Cmdline[]
---@overload fun(name: "LastOpenRemotesTab"|"LastOpenDmxProtocolsTab", role: nil): integer
---@overload fun(name: "ProgUpdateCueFilter", role: nil): ProgUpdateCueMode
---@overload fun(name: "SingleDigit
Input"|"ResolveExecutorAssignments"|"Preview
Variables"|"DefaultGroupMasterMode", role: nil): integer
...
---@overload fun(name: "ShowConnectors"|"LoadFixtureLibraryMA"|"LoadFixtureLibraryUser"|"LoadFixtureLibraryShare"|"DmxTesterAddressMode"|"DmxTesterRetainMode", role: nil): integer
---@overload fun(name: "DmxTesterMode", role: nil): DmxTesterMode
---@overload fun(name: "DmxTesterTestValue", role: nil): integer
---@overload fun(name: "MoveGridCursor", role: nil): GridCursorMovement
---@overload fun(name: "EncoderLinkStatusValues"|"EncoderLinkStatusTiming"|"EncoderLinkStatusPhaser"|"EncoderLinkStatusPhaserBar", role: nil): EncoderLink
---@overload fun(name: "ScreenshotEnabled"|"UpdateMenuPresetOptionsExpanded"|"UpdateMenuCueOptionsExpanded"|"NotificationsEnabled", role: nil): integer
---@overload fun(name: "NotificationType", role: nil): NotificationType
---@overload fun(name: "SystemFpsLimit", role: nil): integer
---@overload fun(name: "IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"Index"|"Count"|"No"|"Name"|"Note"|"UserExpanded"|"FaderEnabled"|"Owned"|"Hidden"|"DependencyExport"|"MemoryFootprint"|"Guid"|"Scribble"|"Appearance"|"NameAndApp"|"Note"|"Tags"|"Scribble"|"Appearance"|"DMX
Readout"|"Normal
Value"|"Wheel
Resolution"|"Wheel
Mode"|"VKExpanded"|"SEExpanded"|"NEExpanded"|"TextInputAuxEditor"|"TextInputSmallScreenTab"|"ScribbleColor"|"ScribbleWidthScale"|"SelectedDataPool"|"DefaultToken"|"EncoderLinkValues"|"EncoderLinkTiming"|"EncoderLinkPhaser"|"KnobUI
Style"|"EncoderUI
Style"|"ActiveOnly"|"MultiStepOnly"|"Precise
Edit"|"Screen
Encoder"|"TimeKey
Target"|"ShowUserEncoder"|"TCSlot"|"SelectedPage"|"Value
Readout"|"Speed
Readout"|"Preset
Readout"|"Layer"|"ProgrammingLayer"|"LastValueLayer"|"LastPhaserLayer"|"LastStepLayer"|"ProgrammingLayerGroup"|"HelpPopupZoomFactor"|"Overlay
Fade"|"TimeReadout"|"FrameReadout"|"Color
Readout"|"Oops
Views"|"Oops
Programmer"|"Oops
Selection"|"Create
...
---@overload fun(index: integer, class: "ViewButtonScreens", undo: Undo?): ViewButtonScreens
...
---@overload fun(index: integer, class: "KeyboardShortCuts", undo: Undo?): KeyboardShortCuts
---@overload fun(index: integer, class: "WindowTypes", undo: Undo?): WindowTypes
---@overload fun(index: integer, class: "ScreenConfigurations", undo: Undo?): ScreenConfigurations
---@overload fun(index: integer, class: "Timezones", undo: Undo?): Timezones
---@overload fun(index: integer, class: "StorePreferencesPreset", undo: Undo?): StorePreferencesPreset
...
---@overload fun(index: integer, class: "SpecialExecutorPages", undo: Undo?): SpecialExecutorPages
...
---@overload fun(index: integer, class: "Collection", undo: Undo?): Collection
---@overload fun(index: integer, class: "SequenceSelection", undo: Undo?): SequenceSelection
---@overload fun(index: integer, class: "RunningPlaybacks", undo: Undo?): RunningPlaybacks
---@overload fun(index: integer, class: "UserAttributePreferences", undo: Undo?): UserAttributePreferences
---@overload fun(index: integer, class: "SmartViewPool", undo: Undo?): SmartViewPool
---@overload fun(index: integer, class: "Environments", undo: Undo?): Environments
...
---@overload fun(index: integer, class: "StorePreferences", undo: Undo?): StorePreferences
...
---@overload fun(index: integer, class: "TemporaryWindowSettings", undo: Undo?): TemporaryWindowSettings
...
---@overload fun(index: integer, class: "EncoderBarPool", undo: Undo?): EncoderBarPool
---@overload fun(index: integer, class: "Materials", undo: Undo?): Materials
---@overload fun(index: integer, class: "Cameras", undo: Undo?): Cameras
---@overload fun(index: integer, class: "RenderQualities", undo: Undo?): RenderQualities
...
---@overload fun(class: "ViewButtonScreens", undo: Undo?, count: integer?): ViewButtonScreens
...
---@overload fun(class: "KeyboardShortCuts", undo: Undo?, count: integer?): KeyboardShortCuts
---@overload fun(class: "WindowTypes", undo: Undo?, count: integer?): WindowTypes
---@overload fun(class: "ScreenConfigurations", undo: Undo?, count: integer?): ScreenConfigurations
---@overload fun(class: "Timezones", undo: Undo?, count: integer?): Timezones
---@overload fun(class: "StorePreferencesPreset", undo: Undo?, count: integer?): StorePreferencesPreset
...
---@overload fun(class: "SpecialExecutorPages", undo: Undo?, count: integer?): SpecialExecutorPages
...
---@overload fun(class: "Collection", undo: Undo?, count: integer?): Collection
---@overload fun(class: "SequenceSelection", undo: Undo?, count: integer?): SequenceSelection
---@overload fun(class: "RunningPlaybacks", undo: Undo?, count: integer?): RunningPlaybacks
---@overload fun(class: "UserAttributePreferences", undo: Undo?, count: integer?): UserAttributePreferences
---@overload fun(class: "SmartViewPool", undo: Undo?, count: integer?): SmartViewPool
---@overload fun(class: "Environments", undo: Undo?, count: integer?): Environments
...
---@overload fun(class: "StorePreferences", undo: Undo?, count: integer?): StorePreferences
...
---@overload fun(class: "TemporaryWindowSettings", undo: Undo?, count: integer?): TemporaryWindowSettings
...
---@overload fun(class: "EncoderBarPool", undo: Undo?, count: integer?): EncoderBarPool
---@overload fun(class: "Materials", undo: Undo?, count: integer?): Materials
---@overload fun(class: "Cameras", undo: Undo?, count: integer?): Cameras
---@overload fun(class: "RenderQualities", undo: Undo?, count: integer?): RenderQualities
...
---@overload fun(class: "ViewButtonScreens", undo: Undo?): ViewButtonScreens
...
---@overload fun(class: "KeyboardShortCuts", undo: Undo?): KeyboardShortCuts
---@overload fun(class: "WindowTypes", undo: Undo?): WindowTypes
---@overload fun(class: "ScreenConfigurations", undo: Undo?): ScreenConfigurations
---@overload fun(class: "Timezones", undo: Undo?): Timezones
---@overload fun(class: "StorePreferencesPreset", undo: Undo?): StorePreferencesPreset
...
---@overload fun(class: "SpecialExecutorPages", undo: Undo?): SpecialExecutorPages
---@overload fun(class: "ShowMetaData", undo: Undo?): ShowMetaData
---@overload fun(class: "SoundChannels", undo: Undo?): SoundChannels
---@overload fun(class: "Collection", undo: Undo?): Collection
---@overload fun(class: "SequenceSelection", undo: Undo?): SequenceSelection
---@overload fun(class: "RunningPlaybacks", undo: Undo?): RunningPlaybacks
---@overload fun(class: "UserAttributePreferences", undo: Undo?): UserAttributePreferences
---@overload fun(class: "SmartViewPool", undo: Undo?): SmartViewPool
---@overload fun(class: "Environments", undo: Undo?): Environments
...
---@overload fun(class: "StorePreferences", undo: Undo?): StorePreferences
...
---@overload fun(class: "TemporaryWindowSettings", undo: Undo?): TemporaryWindowSettings
...
---@overload fun(class: "EncoderBarPool", undo: Undo?): EncoderBarPool
---@overload fun(class: "Materials", undo: Undo?): Materials
---@overload fun(class: "Cameras", undo: Undo?): Cameras
---@overload fun(class: "RenderQualities", undo: Undo?): RenderQualities
...
---@overload fun(index: integer, class: "ViewButtonScreens", undo: Undo?, count: integer?): ViewButtonScreens
...
---@overload fun(index: integer, class: "KeyboardShortCuts", undo: Undo?, count: integer?): KeyboardShortCuts
---@overload fun(index: integer, class: "WindowTypes", undo: Undo?, count: integer?): WindowTypes
---@overload fun(index: integer, class: "ScreenConfigurations", undo: Undo?, count: integer?): ScreenConfigurations
---@overload fun(index: integer, class: "Timezones", undo: Undo?, count: integer?): Timezones
---@overload fun(index: integer, class: "StorePreferencesPreset", undo: Undo?, count: integer?): StorePreferencesPreset
...
---@overload fun(index: integer, class: "SpecialExecutorPages", undo: Undo?, count: integer?): SpecialExecutorPages
...
---@overload fun(index: integer, class: "Collection", undo: Undo?, count: integer?): Collection
---@overload fun(index: integer, class: "SequenceSelection", undo: Undo?, count: integer?): SequenceSelection
---@overload fun(index: integer, class: "RunningPlaybacks", undo: Undo?, count: integer?): RunningPlaybacks
---@overload fun(index: integer, class: "UserAttributePreferences", undo: Undo?, count: integer?): UserAttributePreferences
---@overload fun(index: integer, class: "SmartViewPool", undo: Undo?, count: integer?): SmartViewPool
---@overload fun(index: integer, class: "Environments", undo: Undo?, count: integer?): Environments
...
---@overload fun(index: integer, class: "StorePreferences", undo: Undo?, count: integer?): StorePreferences
...
---@overload fun(index: integer, class: "TemporaryWindowSettings", undo: Undo?, count: integer?): TemporaryWindowSettings
...
---@overload fun(index: integer, class: "EncoderBarPool", undo: Undo?, count: integer?): EncoderBarPool
---@overload fun(index: integer, class: "Materials", undo: Undo?, count: integer?): Materials
---@overload fun(index: integer, class: "Cameras", undo: Undo?, count: integer?): Cameras
---@overload fun(index: integer, class: "RenderQualities", undo: Undo?, count: integer?): RenderQualities
...
---@overload fun(name: string, class: "ViewButtonScreens"): ViewButtonScreens
...
---@overload fun(name: string, class: "KeyboardShortCuts"): KeyboardShortCuts
---@overload fun(name: string, class: "WindowTypes"): WindowTypes
---@overload fun(name: string, class: "ScreenConfigurations"): ScreenConfigurations
---@overload fun(name: string, class: "Timezones"): Timezones
---@overload fun(name: string, class: "StorePreferencesPreset"): StorePreferencesPreset
...
---@overload fun(name: string, class: "SpecialExecutorPages"): SpecialExecutorPages
---@overload fun(name: string, class: "ShowMetaData"): ShowMetaData
---@overload fun(name: string, class: "SoundChannels"): SoundChannels
---@overload fun(name: string, class: "Collection"): Collection
---@overload fun(name: string, class: "SequenceSelection"): SequenceSelection
---@overload fun(name: string, class: "RunningPlaybacks"): RunningPlaybacks
---@overload fun(name: string, class: "UserAttributePreferences"): UserAttributePreferences
---@overload fun(name: string, class: "SmartViewPool"): SmartViewPool
---@overload fun(name: string, class: "Environments"): Environments
...
---@overload fun(name: string, class: "StorePreferences"): StorePreferences
...
---@overload fun(name: string, class: "TemporaryWindowSettings"): TemporaryWindowSettings
...
---@overload fun(name: string, class: "Views"): Views
---@overload fun(name: string, class: "Tags"): Tags
---@overload fun(name: string, class: "EncoderBarPool"): EncoderBarPool
---@overload fun(name: string, class: "Materials"): Materials
---@overload fun(name: string, class: "Cameras"): Cameras
---@overload fun(name: string, class: "RenderQualities"): RenderQualities
...
function UserProfile:Find(name, class) end
---@overload fun(name: string, class: "Object"): Object
---@overload fun(name: string, class: "MVRxchange"): MVRxchange
---@overload fun(name: string, class: "SmartViewSettingsCollect"): SmartViewSettingsCollect
---@overload fun(name: string, class: "RunningPlaybacksSettingsCollect"): RunningPlaybacksSettingsCollect
...
---@overload fun(name: string, class: "IllegalObject"): IllegalObject
---@overload fun(name: string, class: nil): Object
function UserProfile:FindRecursive(name, class) end
