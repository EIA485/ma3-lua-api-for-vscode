...
---@field InputPriority DmxPrio
---@field TimecodeSlot TimecodeSlotOff
---@field EnableRdm YesNo|boolean
local ArtNetData = {
    Enabled="No",
    Mode="Auto",
    PacketDelay="0.1",
...
---@generic T : ArtNetData
---@param class `T`
---@return boolean
function ArtNetData:IsClass(class) end
---@return ArtNetDataCollect
function ArtNetData:Parent() end
---@return 35
function ArtNetData:PropertyCount() end
...
---@overload fun(idx: 20): "Enabled"
---@overload fun(idx: 21): "Mode"
---@overload fun(idx: 22): "DestinationIP"
---@overload fun(idx: 23): "SubscribedNodes"
---@overload fun(idx: 24): "LocalUniverse"
---@overload fun(idx: 25): "Amount"
---@overload fun(idx: 26): "Net"
---@overload fun(idx: 27): "Art-NetSub-Net"
---@overload fun(idx: 28): "Universe"
---@overload fun(idx: 29): "Art-NetAbsolute"
---@overload fun(idx: 30): "PacketDelay"
---@overload fun(idx: 31): "MergeMode"
---@overload fun(idx: 32): "InputPriority"
---@overload fun(idx: 33): "TimecodeSlot"
---@overload fun(idx: 34): "EnableRdm"
function ArtNetData:PropertyName(idx) end
---@overload fun(idx: 0|1|2): {ExportIgnore: True, EnumCollection: YesNo, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 3|11|20|34): {ExportIgnore: False, EnumCollection: YesNo, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 4|5|6|23): {ExportIgnore: True, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 7|12|14|15|16|18|19|22|24|25|26|27|28|29|30): {ExportIgnore: False, ReadOnly: False, ImportIgnore: False}
...
---@overload fun(idx: 21): {ExportIgnore: False, EnumCollection: ArtNetDataMode, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 31): {ExportIgnore: False, EnumCollection: DMXMergeMode, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 32): {ExportIgnore: False, EnumCollection: DmxPrio, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 33): {ExportIgnore: False, EnumCollection: TimecodeSlotOff, ReadOnly: False, ImportIgnore: False}
function ArtNetData:PropertyInfo(idx) end
...
---@overload fun(idx: 20|21|26|27|28|31|32|33|34): "UInt8"
---@overload fun(idx: 23|24|25|29): "UInt16"
---@overload fun(idx: 30): "Float"
function ArtNetData:PropertyType(idx) end
---@overload fun(name: "Appearance", role: nil): Appearance
---@overload fun(name: "Mode", role: nil): ArtNetDataMode
---@overload fun(name: "MergeMode", role: nil): DMXMergeMode
---@overload fun(name: "InputPriority", role: nil): DmxPrio
---@overload fun(name: "Guid", role: nil): Key128
---@overload fun(name: "DestinationIP", role: nil): Manet.IP4
---@overload fun(name: "Scribble", role: nil): Scribble
---@overload fun(name: "Tags", role: nil): TagMap
---@overload fun(name: "TimecodeSlot", role: nil): TimecodeSlotOff
---@overload fun(name: "IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"UserExpanded"|"FaderEnabled"|"Owned"|"Hidden"|"Enabled"|"EnableRdm", role: nil): YesNo|boolean
---@overload fun(name: "Index"|"Count"|"No"|"MemoryFootprint"|"SubscribedNodes"|"LocalUniverse"|"Amount"|"Net"|"Art-NetSub-Net"|"Universe"|"Art-NetAbsolute", role: nil): integer
---@overload fun(name: "PacketDelay", role: nil): number
---@overload fun(name: "Name"|"DependencyExport"|"NameAndApp"|"Note", role: nil): string
---@overload fun(name: "IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"Index"|"Count"|"No"|"Name"|"UserExpanded"|"FaderEnabled"|"Owned"|"Hidden"|"DependencyExport"|"MemoryFootprint"|"Guid"|"Scribble"|"Appearance"|"NameAndApp"|"Note"|"Tags"|"Enabled"|"Mode"|"DestinationIP"|"SubscribedNodes"|"LocalUniverse"|"Amount"|"Net"|"Art-NetSub-Net"|"Universe"|"Art-NetAbsolute"|"PacketDelay"|"MergeMode"|"InputPriority"|"TimecodeSlot"|"EnableRdm", role: Enums.Roles): string
...
---@overload fun(property_name: "Mode", property_value: ArtNetDataMode, override_change_level: ChangeLevel?)
---@overload fun(property_name: "MergeMode", property_value: DMXMergeMode, override_change_level: ChangeLevel?)
---@overload fun(property_name: "InputPriority", property_value: DmxPrio, override_change_level: ChangeLevel?)
---@overload fun(property_name: "Guid", property_value: Key128, override_change_level: ChangeLevel?)
---@overload fun(property_name: "DestinationIP", property_value: Manet.IP4, override_change_level: ChangeLevel?)
...
---@overload fun(property_name: "TimecodeSlot", property_value: TimecodeSlotOff, override_change_level: ChangeLevel?)
---@overload fun(property_name: "IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"Hidden"|"Enabled"|"EnableRdm", property_value: YesNo|boolean, override_change_level: ChangeLevel?)
---@overload fun(property_name: "Index"|"Count"|"No"|"SubscribedNodes"|"LocalUniverse"|"Amount"|"Net"|"Art-NetSub-Net"|"Universe"|"Art-NetAbsolute", property_value: integer, override_change_level: ChangeLevel?)
---@overload fun(property_name: "PacketDelay", property_value: number, override_change_level: ChangeLevel?)
---@overload fun(property_name: "Name"|"DependencyExport"|"Note", property_value: string, override_change_level: ChangeLevel?)
function ArtNetData:Set(property_name, property_value, override_change_level) end
...
function ArtNetData:SetChildren(property_name, property_value) end