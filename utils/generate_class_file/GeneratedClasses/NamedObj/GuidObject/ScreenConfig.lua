...
---@class ScreenConfig: GuidObject
local ScreenConfig = {}
---@return "ScreenConfig"
function ScreenConfig:GetClass() end
---@return "Object"
function ScreenConfig:GetChildClass() end
---@return ScreenConfigurations
function ScreenConfig:Parent() end
...
---@overload fun(index: integer, class: "ScreenContents", undo: Undo?): ScreenContents
...
function ScreenConfig:Create(index, class, undo) end
...
---@overload fun(class: "ScreenContents", undo: Undo?, count: integer?): ScreenContents
...
function ScreenConfig:Append(class, undo, count) end
...
---@overload fun(class: "ScreenContents", undo: Undo?): ScreenContents
...
function ScreenConfig:Acquire(class, undo) end
---@overload fun(class: "Object", undo: Undo?): Object
---@overload fun(class: "MVRxchange", undo: Undo?): MVRxchange
---@overload fun(class: "SmartViewSettingsCollect", undo: Undo?): SmartViewSettingsCollect
---@overload fun(class: "RunningPlaybacksSettingsCollect", undo: Undo?): RunningPlaybacksSettingsCollect
...
function ScreenConfig:Aquire(class, undo) end
...
---@overload fun(index: integer, class: "ScreenContents", undo: Undo?, count: integer?): ScreenContents
...
function ScreenConfig:Insert(index, class, undo, count) end
...
---@overload fun(name: string, class: "ScreenContents"): ScreenContents
...
function ScreenConfig:Find(name, class) end
---@overload fun(name: string, class: "Object"): Object
---@overload fun(name: string, class: "MVRxchange"): MVRxchange
---@overload fun(name: string, class: "SmartViewSettingsCollect"): SmartViewSettingsCollect
---@overload fun(name: string, class: "RunningPlaybacksSettingsCollect"): RunningPlaybacksSettingsCollect
...
---@overload fun(name: string, class: "IllegalObject"): IllegalObject
---@overload fun(name: string, class: nil): Object
function ScreenConfig:FindRecursive(name, class) end
