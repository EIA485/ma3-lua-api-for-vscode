...
---@overload fun(class: "NoteTextEdit", undo: Undo?): NoteTextEdit
---@overload fun(class: nil, undo: Undo?): Object
function ScreenConfig:Find(class, undo) end
...
function ScreenConfig:SetChildren(property_name, property_value) end