...
---@overload fun(name: "Type"|"CueNo"|"CueName"|"User"|"NameAndApp"|"Note"|"Name"|"DependencyExport", role: nil): string
---@overload fun(name: "CurrentCue"|"LoadedCue"|"Type"|"CueNo"|"CueName"|"User"|"Action"|"TimingGoto"|"TimingGoBack"|"TimingGoFast"|"TimingGoBackFast"|"Guid"|"Scribble"|"Appearance"|"NameAndApp"|"Note"|"Tags"|"IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"Index"|"Count"|"No"|"Name"|"UserExpanded"|"FaderEnabled"|"Owned"|"Hidden"|"DependencyExport"|"MemoryFootprint", role: Enums.Roles): string
