...
---@class Stage: GuidObject Your description here.
---@field PosX LengthPropertyValueD
---@field PosY LengthPropertyValueD
---@field PosZ LengthPropertyValueD
---@field RotX AnglePropertyValueDegreeD
---@field RotY AnglePropertyValueDegreeD
---@field RotZ AnglePropertyValueDegreeD
...
---@return "Stage"
function Stage:GetClass() end
---@return "Object"
function Stage:GetChildClass() end
---@return Stages
function Stage:Parent() end
...
---@overload fun(name: "PosX"|"PosY"|"PosZ", role: nil): LengthPropertyValueD
---@overload fun(name: "RotX"|"RotY"|"RotZ", role: nil): AnglePropertyValueDegreeD
---@overload fun(name: "MinX"|"MaxX"|"MinY"|"MaxY"|"MinZ"|"MaxZ", role: nil): LengthPropertyValue
---@overload fun(name: "Appearance
Right"|"Appearance
Left"|"Appearance
Front"|"Appearance
Back"|"Appearance
Top"|"Appearance
Bottom", role: nil): Appearance
---@overload fun(name: "IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"Index"|"Count"|"No"|"Name"|"Note"|"UserExpanded"|"FaderEnabled"|"Owned"|"Hidden"|"DependencyExport"|"MemoryFootprint"|"Guid"|"Scribble"|"Appearance"|"NameAndApp"|"Note"|"Tags"|"PosX"|"PosY"|"PosZ"|"RotX"|"RotY"|"RotZ"|"MinX"|"MaxX"|"MinY"|"MaxY"|"MinZ"|"MaxZ"|"Appearance
Right"|"Appearance
Left"|"Appearance
Front"|"Appearance
Back"|"Appearance
Top"|"Appearance
Bottom", role: Enums.Roles): string
---@overload fun(name: integer, role: nil): Object
function Stage:Get(name, role) end
...
---@overload fun(index: integer, class: "Fixtures", undo: Undo?): Fixtures
---@overload fun(index: integer, class: "Spaces", undo: Undo?): Spaces
...
function Stage:Create(index, class, undo) end
...
---@overload fun(class: "Fixtures", undo: Undo?, count: integer?): Fixtures
---@overload fun(class: "Spaces", undo: Undo?, count: integer?): Spaces
...
function Stage:Append(class, undo, count) end
...
---@overload fun(class: "Fixtures", undo: Undo?): Fixtures
---@overload fun(class: "Spaces", undo: Undo?): Spaces
...
function Stage:Acquire(class, undo) end
---@overload fun(class: "Object", undo: Undo?): Object
---@overload fun(class: "MVRxchange", undo: Undo?): MVRxchange
---@overload fun(class: "SmartViewSettingsCollect", undo: Undo?): SmartViewSettingsCollect
---@overload fun(class: "RunningPlaybacksSettingsCollect", undo: Undo?): RunningPlaybacksSettingsCollect
...
function Stage:Aquire(class, undo) end
...
---@overload fun(index: integer, class: "Fixtures", undo: Undo?, count: integer?): Fixtures
---@overload fun(index: integer, class: "Spaces", undo: Undo?, count: integer?): Spaces
...
function Stage:Insert(index, class, undo, count) end
...
---@overload fun(name: string, class: "Fixtures"): Fixtures
---@overload fun(name: string, class: "Spaces"): Spaces
...
function Stage:Find(name, class) end
---@overload fun(name: string, class: "Object"): Object
---@overload fun(name: string, class: "MVRxchange"): MVRxchange
---@overload fun(name: string, class: "SmartViewSettingsCollect"): SmartViewSettingsCollect
---@overload fun(name: string, class: "RunningPlaybacksSettingsCollect"): RunningPlaybacksSettingsCollect
...
---@overload fun(name: string, class: "IllegalObject"): IllegalObject
---@overload fun(name: string, class: nil): Object
function Stage:FindRecursive(name, class) end
