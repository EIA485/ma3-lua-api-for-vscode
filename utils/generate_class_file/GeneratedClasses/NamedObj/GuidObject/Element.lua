...
---@field Selected YesNo|boolean
---@field PosX integer
---@field PosY integer
---@field Width integer
---@field Height integer
---@field VisibilityElement LayoutVisibility|boolean
---@field VisibilityBar LayoutVisibility|boolean
---@field VisibilityObjectName LayoutVisibility|boolean
---@field VisibilityID LayoutVisibility|boolean
---@field VisibilityCID LayoutVisibility|boolean
---@field VisibilityValue LayoutVisibility|boolean
---@field VisibilityIndicatorBar LayoutVisibility|boolean
---@field VisibilitySelectionRelevance YesNo|boolean
---@field VisibilityBorder LayoutVisibility|boolean
---@field BorderSize integer
---@field BorderColor UColor
---@field IsInWorld YesNo|boolean
---@field Scribble Scribble
---@field ObjectTextSize FontSizes
---@field CustomTextVertical YesNo|boolean
---@field FullResolution YesNo|boolean
...
---@param class `T`
---@return boolean
function Element:IsClass(class) end
---@return Layout
function Element:Parent() end
---@return 49
function Element:PropertyCount() end
...
---@overload fun(idx: 18): "AssignType"
---@overload fun(idx: 19): "ID"
---@overload fun(idx: 20): "CID"
---@overload fun(idx: 21): "Appearance"
---@overload fun(idx: 22): "AppearanceRotation"
---@overload fun(idx: 23): "Mirror"
---@overload fun(idx: 24): "Object"
---@overload fun(idx: 25): "Action"
---@overload fun(idx: 26): "Selected"
---@overload fun(idx: 27): "PosX"
---@overload fun(idx: 28): "PosY"
---@overload fun(idx: 29): "Width"
---@overload fun(idx: 30): "Height"
---@overload fun(idx: 31): "VisibilityElement"
---@overload fun(idx: 32): "VisibilityBar"
---@overload fun(idx: 33): "VisibilityObjectName"
---@overload fun(idx: 34): "VisibilityID"
---@overload fun(idx: 35): "VisibilityCID"
---@overload fun(idx: 36): "VisibilityValue"
---@overload fun(idx: 37): "VisibilityIndicatorBar"
---@overload fun(idx: 38): "VisibilitySelectionRelevance"
---@overload fun(idx: 39): "VisibilityBorder"
---@overload fun(idx: 40): "BorderSize"
---@overload fun(idx: 41): "BorderColor"
---@overload fun(idx: 42): "IsInWorld"
---@overload fun(idx: 43): "Scribble"
---@overload fun(idx: 44): "ObjectTextSize"
---@overload fun(idx: 45): "CustomTextVertical"
---@overload fun(idx: 46): "FullResolution"
---@overload fun(idx: 47): "IDType"
---@overload fun(idx: 48): "FixtureID"
function Element:PropertyName(idx) end
---@overload fun(idx: 0|1|2|42): {ExportIgnore: True, EnumCollection: YesNo, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 3|11|26|38|45|46): {ExportIgnore: False, EnumCollection: YesNo, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 4|5|6|43|47|48): {ExportIgnore: True, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 7|12|14|16|17|21|24|27|28|29|30|40|41): {ExportIgnore: False, ReadOnly: False, ImportIgnore: False}
...
---@overload fun(idx: 13|15): {ExportIgnore: False, ReadOnly: True, ImportIgnore: True}
---@overload fun(idx: 18): {ExportIgnore: True, EnumCollection: AssignType, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 19|20): {ExportIgnore: True, EnumCollection: None, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 22): {ExportIgnore: False, EnumCollection: ImageRotation, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 23): {ExportIgnore: False, EnumCollection: ImageMirror, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 25): {ExportIgnore: False, EnumCollection: AssignmentButtonFunctions, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 31|32|33|34|35|36|37|39): {ExportIgnore: False, EnumCollection: LayoutVisibility, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 44): {ExportIgnore: False, EnumCollection: FontSizes, ReadOnly: False, ImportIgnore: False}
function Element:PropertyInfo(idx) end
---@overload fun(idx: 0|1|2|3|4|5|6|8|19|20|26|31|32|33|34|35|36|37|39|45|46|48): "UInt32"
---@overload fun(idx: 7|12|15|16|21): "String"
---@overload fun(idx: 9|10|42): "Bool"
---@overload fun(idx: 11): "UInt64"
---@overload fun(idx: 13|47): "Int64"
---@overload fun(idx: 14|17): "Custom"
---@overload fun(idx: 18|22|23|38|44): "UInt8"
---@overload fun(idx: 24|43): "Handle"
---@overload fun(idx: 25): "Token"
---@overload fun(idx: 27|28|29|30|40): "Int16"
---@overload fun(idx: 41): "RGBA8"
function Element:PropertyType(idx) end
...
---@overload fun(name: "VisibilityElement"|"VisibilityBar"|"VisibilityObjectName"|"VisibilityID"|"VisibilityCID"|"VisibilityValue"|"VisibilityIndicatorBar"|"VisibilityBorder", role: nil): LayoutVisibility|boolean
---@overload fun(name: "Object", role: nil): Object
---@overload fun(name: "Scribble", role: nil): Scribble
---@overload fun(name: "Tags", role: nil): TagMap
---@overload fun(name: "BorderColor", role: nil): UColor
---@overload fun(name: "IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"UserExpanded"|"FaderEnabled"|"Owned"|"Hidden"|"Selected"|"VisibilitySelectionRelevance"|"IsInWorld"|"CustomTextVertical"|"FullResolution", role: nil): YesNo|boolean
---@overload fun(name: "Index"|"Count"|"No"|"MemoryFootprint"|"ID"|"CID"|"PosX"|"PosY"|"Width"|"Height"|"BorderSize"|"IDType"|"FixtureID", role: nil): integer
---@overload fun(name: "Name"|"DependencyExport"|"NameAndApp"|"Note"|"Appearance", role: nil): string
---@overload fun(name: "IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"Index"|"Count"|"No"|"Name"|"UserExpanded"|"FaderEnabled"|"Owned"|"Hidden"|"DependencyExport"|"MemoryFootprint"|"Guid"|"NameAndApp"|"Note"|"Tags"|"AssignType"|"ID"|"CID"|"Appearance"|"AppearanceRotation"|"Mirror"|"Object"|"Action"|"Selected"|"PosX"|"PosY"|"Width"|"Height"|"VisibilityElement"|"VisibilityBar"|"VisibilityObjectName"|"VisibilityID"|"VisibilityCID"|"VisibilityValue"|"VisibilityIndicatorBar"|"VisibilitySelectionRelevance"|"VisibilityBorder"|"BorderSize"|"BorderColor"|"IsInWorld"|"Scribble"|"ObjectTextSize"|"CustomTextVertical"|"FullResolution"|"IDType"|"FixtureID", role: Enums.Roles): string
...
---@overload fun(property_name: "AssignType", property_value: AssignType, override_change_level: ChangeLevel?)
---@overload fun(property_name: "Action", property_value: AssignmentButtonFunctions, override_change_level: ChangeLevel?)
---@overload fun(property_name: "ObjectTextSize", property_value: FontSizes, override_change_level: ChangeLevel?)
---@overload fun(property_name: "Mirror", property_value: ImageMirror, override_change_level: ChangeLevel?)
---@overload fun(property_name: "AppearanceRotation", property_value: ImageRotation, override_change_level: ChangeLevel?)
---@overload fun(property_name: "Guid", property_value: Key128, override_change_level: ChangeLevel?)
---@overload fun(property_name: "VisibilityElement"|"VisibilityBar"|"VisibilityObjectName"|"VisibilityID"|"VisibilityCID"|"VisibilityValue"|"VisibilityIndicatorBar"|"VisibilityBorder", property_value: LayoutVisibility|boolean, override_change_level: ChangeLevel?)
...
---@overload fun(property_name: "BorderColor", property_value: UColor, override_change_level: ChangeLevel?)
---@overload fun(property_name: "IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"Hidden"|"Selected"|"VisibilitySelectionRelevance"|"IsInWorld"|"CustomTextVertical"|"FullResolution", property_value: YesNo|boolean, override_change_level: ChangeLevel?)
---@overload fun(property_name: "Index"|"Count"|"No"|"ID"|"CID"|"PosX"|"PosY"|"Width"|"Height"|"BorderSize"|"IDType"|"FixtureID", property_value: integer, override_change_level: ChangeLevel?)
---@overload fun(property_name: "Name"|"DependencyExport"|"Note"|"Appearance", property_value: string, override_change_level: ChangeLevel?)
function Element:Set(property_name, property_value, override_change_level) end
...
function Element:SetChildren(property_name, property_value) end