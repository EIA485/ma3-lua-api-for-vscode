...
---@class GridSettings: WindowSettings
---@field Transposed integer
---@field AdjustColumns integer
---@field NoFixedColumns integer
---@field MergeCells integer
---@field ForceExpanded integer
---@field RememberSorting integer
---@field RowHeightFactor number
---@field ColumnsCount integer
---@field ContentFilterType string
---@field GridColumnConfigurationType string
---@field SelectedColumnConfiguration GridColumnConfiguration
---@field SetAllVisible fun()
---@field SetAllInvisible fun()
---@field ResetColumnOrder fun()
local GridSettings = {
    Transposed="No",
    AdjustColumns="No",
    NoFixedColumns="No",
    ...
    RowHeightFactor="1",
    ColumnsCount="20",
    ContentFilterType="GridContentFilter"
}
---@return "GridSettings"
function GridSettings:GetClass() end
---@return "Object"
function GridSettings:GetChildClass() end
