...
---@field ShowPov YesNo|boolean
---@field AutoPov YesNo|boolean
---@field ShowResetBar YesNo|boolean
...
---@generic T : ShaperWindowSettings
---@param class `T`
---@return boolean
function ShaperWindowSettings:IsClass(class) end
---@return 39
function ShaperWindowSettings:PropertyCount() end
...
---@overload fun(idx: 26): "ViewMode"
---@overload fun(idx: 27): "BarMode"
---@overload fun(idx: 28): "ControlMode"
---@overload fun(idx: 29): "LinkMode"
---@overload fun(idx: 30): "MiniFadersMode"
---@overload fun(idx: 31): "ShowPov"
---@overload fun(idx: 32): "AutoPov"
---@overload fun(idx: 33): "ShowResetBar"
---@overload fun(idx: 34): "ResetBlade"
---@overload fun(idx: 35): "ResetRotation"
---@overload fun(idx: 36): "ResetPov"
---@overload fun(idx: 37): "ResetShaper"
---@overload fun(idx: 38): "ResetAllBlades"
function ShaperWindowSettings:PropertyName(idx) end
---@overload fun(idx: 0|1|2): {ExportIgnore: True, EnumCollection: YesNo, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 3|11|22|24|31|32|33): {ExportIgnore: False, EnumCollection: YesNo, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 4|5|6): {ExportIgnore: True, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 7|12|14|15|16|18|19|20|23|34|35|36|37|38): {ExportIgnore: False, ReadOnly: False, ImportIgnore: False}
...
---@overload fun(idx: 26): {ExportIgnore: False, EnumCollection: ShaperViewMode, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 27): {ExportIgnore: False, EnumCollection: ShaperBarMode, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 28): {ExportIgnore: False, EnumCollection: ShaperControlMode, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 29): {ExportIgnore: False, EnumCollection: ShaperEncoderLinkMode, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 30): {ExportIgnore: False, EnumCollection: MiniFadersMode, ReadOnly: False, ImportIgnore: False}
function ShaperWindowSettings:PropertyInfo(idx) end
---@overload fun(idx: 0|1|2|3|4|5|6|8|31|32|33): "UInt32"
...
---@overload fun(idx: 21|22|24|26|27|28|29|30): "UInt8"
---@overload fun(idx: 34|35|36|37|38): "Action"
function ShaperWindowSettings:PropertyType(idx) end
...
---@overload fun(name: "IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"UserExpanded"|"FaderEnabled"|"Owned"|"Hidden"|"ShowTitleBar"|"RequestDefaultTitlebuttons"|"ShowPov"|"AutoPov"|"ShowResetBar", role: nil): YesNo|boolean
...
---@overload fun(property_name: "MiniFadersMode", property_value: MiniFadersMode, override_change_level: ChangeLevel?)
...
---@overload fun(property_name: "BarMode", property_value: ShaperBarMode, override_change_level: ChangeLevel?)
---@overload fun(property_name: "ControlMode", property_value: ShaperControlMode, override_change_level: ChangeLevel?)
---@overload fun(property_name: "LinkMode", property_value: ShaperEncoderLinkMode, override_change_level: ChangeLevel?)
---@overload fun(property_name: "ViewMode", property_value: ShaperViewMode, override_change_level: ChangeLevel?)
---@overload fun(property_name: "Tags", property_value: TagMap, override_change_level: ChangeLevel?)
---@overload fun(property_name: "IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"Hidden"|"ShowTitleBar"|"RequestDefaultTitlebuttons"|"ShowPov"|"AutoPov"|"ShowResetBar", property_value: YesNo|boolean, override_change_level: ChangeLevel?)
---@overload fun(property_name: "ResetBlade", property_value: fun(str: string, int: integer) : boolean, override_change_level: ChangeLevel?)
---@overload fun(property_name: "ResetRotation"|"ResetPov"|"ResetShaper"|"ResetAllBlades", property_value: fun(text: string) : boolean, override_change_level: ChangeLevel?)
...
function ShaperWindowSettings:Set(property_name, property_value, override_change_level) end
...
---@overload fun(property_name: "ViewMode", property_value: TCViewMode|PhaserViewMode|AgendaViewMode|DmxSheetSettingsViewMode)
...
---@overload fun(property_name: "ResetSelectedDay"|"ChangeWindowMode"|"ChangeLinkMode"|"ObtainCurrentCue"|"JumpToToday"|"JumpToPrevious"|"JumpToNext"|"ResetSelectedAgenda", property_value: fun(text: string) : boolean)
...
function ShaperWindowSettings:SetChildren(property_name, property_value) end