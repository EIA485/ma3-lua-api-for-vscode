...
---@overload fun(property_name: "ViewMode", property_value: PhaserViewMode|DmxSheetSettingsViewMode|AgendaViewMode|TCViewMode)
...
function ShaperWindowSettings:ActiveDisplay(property_name, property_value) end