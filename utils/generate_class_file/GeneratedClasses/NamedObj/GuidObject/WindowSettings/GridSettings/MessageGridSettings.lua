...
---@class MessageGridSettings: GridSettings
---@field Category GE_StatusCategory Selects the displayed message category
---@field Priority FocusPriority Selects the displayed message priority
local MessageGridSettings = {
    Category="None",
    Priority="None"
}
---@return "MessageGridSettings"
function MessageGridSettings:GetClass() end
---@return "Object"
function MessageGridSettings:GetChildClass() end
