...
---@field StageFilter None_only
---@field StageFilterList integer[]
---@field HideEnvironmental YesNo|boolean
...
---@generic T : PSRPatchSheetSettings
---@param class `T`
---@return boolean
function PSRPatchSheetSettings:IsClass(class) end
---@return 51
function PSRPatchSheetSettings:PropertyCount() end
...
---@overload fun(idx: 40): "FilterType"
---@overload fun(idx: 41): "LayerFilter"
---@overload fun(idx: 42): "LayerFilterList"
---@overload fun(idx: 43): "ClassFilter"
---@overload fun(idx: 44): "ClassFilterList"
---@overload fun(idx: 45): "FixtureTypeFilter"
---@overload fun(idx: 46): "FixtureTypeFilterList"
---@overload fun(idx: 47): "StageFilter"
---@overload fun(idx: 48): "StageFilterList"
---@overload fun(idx: 49): "HideEnvironmental"
---@overload fun(idx: 50): "ResetFilters"
function PSRPatchSheetSettings:PropertyName(idx) end
---@overload fun(idx: 0|1|2): {ExportIgnore: True, EnumCollection: YesNo, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 3|11|22|24|26|27|28|30|31|49): {ExportIgnore: False, EnumCollection: YesNo, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 4|5|6|35): {ExportIgnore: True, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 7|12|14|15|16|18|19|20|23|32|33|34|36|41|42|43|44|45|46|48): {ExportIgnore: False, ReadOnly: False, ImportIgnore: False}
...
---@overload fun(idx: 13|17|25|37|38|39|50): {ExportIgnore: False, ReadOnly: True, ImportIgnore: True}
...
---@overload fun(idx: 40): {ExportIgnore: False, EnumCollection: PSRPatchFilterType, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 47): {ExportIgnore: False, EnumCollection: None_only, ReadOnly: False, ImportIgnore: False}
function PSRPatchSheetSettings:PropertyInfo(idx) end
---@overload fun(idx: 0|1|2|3|4|5|6|8|26|27|28|29|30|31|33|47): "UInt32"
---@overload fun(idx: 7|12|17|18|25|34|35|41|43|45): "String"
---@overload fun(idx: 9|10|49): "Bool"
---@overload fun(idx: 11): "UInt64"
---@overload fun(idx: 13): "Int64"
---@overload fun(idx: 14|19|23|42|44|46|48): "Custom"
---@overload fun(idx: 15|16|20|36): "Handle"
---@overload fun(idx: 21|22|24|40): "UInt8"
---@overload fun(idx: 32): "Float"
---@overload fun(idx: 37|38|39|50): "Method"
function PSRPatchSheetSettings:PropertyType(idx) end
...
---@overload fun(name: "StageFilter", role: nil): None_only
...
---@overload fun(name: "IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"UserExpanded"|"FaderEnabled"|"Owned"|"Hidden"|"ShowTitleBar"|"RequestDefaultTitlebuttons"|"Transposed"|"AdjustColumns"|"NoFixedColumns"|"ForceExpanded"|"RememberSorting"|"HideEnvironmental", role: nil): YesNo|boolean
---@overload fun(name: "SetAllVisible"|"SetAllInvisible"|"ResetColumnOrder"|"ResetFilters", role: nil): fun()
...
---@overload fun(class: "NoteTextEdit", undo: Undo?): NoteTextEdit
---@overload fun(class: nil, undo: Undo?): Object
function PSRPatchSheetSettings:Find(class, undo) end
...
---@overload fun(property_name: "StageFilter", property_value: None_only, override_change_level: ChangeLevel?)
---@overload fun(property_name: "PreferenceHandle", property_value: Object, override_change_level: ChangeLevel?)
---@overload fun(property_name: "FilterType", property_value: PSRPatchFilterType, override_change_level: ChangeLevel?)
...
---@overload fun(property_name: "IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"Hidden"|"ShowTitleBar"|"RequestDefaultTitlebuttons"|"Transposed"|"AdjustColumns"|"NoFixedColumns"|"ForceExpanded"|"RememberSorting"|"HideEnvironmental", property_value: YesNo|boolean, override_change_level: ChangeLevel?)
---@overload fun(property_name: "Index"|"Count"|"No"|"ColumnsCount", property_value: integer, override_change_level: ChangeLevel?)
---@overload fun(property_name: "StageFilterList", property_value: integer[], override_change_level: ChangeLevel?)
---@overload fun(property_name: "RowHeightFactor", property_value: number, override_change_level: ChangeLevel?)
---@overload fun(property_name: "Name"|"DependencyExport"|"Note"|"ContentFilterType"|"GridColumnConfigurationType"|"LayerFilter"|"ClassFilter"|"FixtureTypeFilter", property_value: string, override_change_level: ChangeLevel?)
---@overload fun(property_name: "VisibleTitlebuttons"|"LayerFilterList"|"ClassFilterList"|"FixtureTypeFilterList", property_value: string[], override_change_level: ChangeLevel?)
function PSRPatchSheetSettings:Set(property_name, property_value, override_change_level) end
...
---@overload fun(property_name: "VisibleTitlebuttons", property_value: string[])
---@overload fun(property_name: "ActiveDisplay", property_value: ActiveDisplay)
...
---@overload fun(property_name: "TimezoneStr"|"FileName"|"TitlePrefix"|"StoredData"|"Type"|"ToolAction"|"FileName"|"SelectedFilter"|"FilePath"|"GroupName"|"Interface"|"FileContent"|"Author"|"SelectionCount"|"Path"|"ManufacturerID"|"DeviceModelID"|"Name"|"Note"|"SoftwareVersionLabel"|"Comment"|"Note"|"DisplayPool"|"TargetName"|"DependencyExport"|"ChildName"|"Description"|"SelectedDataPool"|"GridColumnConfigurationType"|"Type"|"User"|"LastReceivedMidi"|"FeatureGroup"|"*"|"ContentFilterType"|"Trigger"|"NewShowStartDescription"|"Type", property_value: string)
---@overload fun(property_name: "VisibleTitlebuttons", property_value: string[])
function PSRPatchSheetSettings:SetChildren(property_name, property_value) end