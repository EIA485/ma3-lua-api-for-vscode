...
---@class PSRPatchSheetSettings: GridSettings
---@field FilterType PSRPatchFilterType
---@field LayerFilter string
---@field LayerFilterList string[]
---@field ClassFilter string
---@field ClassFilterList string[]
---@field FixtureTypeFilter string
---@field FixtureTypeFilterList string[]
---@field StageFilter integer
---@field StageFilterList integer[]
---@field Hide
Environmental boolean
---@field ResetFilters fun()
local PSRPatchSheetSettings = {
    FilterType="None",
    LayerFilter="None",
    ClassFilter="None",
    FixtureTypeFilter="None",
    StageFilter="None"
}
---@return "PSRPatchSheetSettings"
function PSRPatchSheetSettings:GetClass() end
---@return "Object"
function PSRPatchSheetSettings:GetChildClass() end
...
---@overload fun(name: "FilterType", role: nil): PSRPatchFilterType
---@overload fun(name: "LayerFilter", role: nil): string
---@overload fun(name: "LayerFilterList", role: nil): string[]
---@overload fun(name: "ClassFilter", role: nil): string
---@overload fun(name: "ClassFilterList", role: nil): string[]
---@overload fun(name: "FixtureTypeFilter", role: nil): string
---@overload fun(name: "FixtureTypeFilterList", role: nil): string[]
---@overload fun(name: "StageFilter", role: nil): integer
---@overload fun(name: "StageFilterList", role: nil): integer[]
---@overload fun(name: "Hide
Environmental", role: nil): boolean
---@overload fun(name: "ResetFilters", role: nil): fun()
---@overload fun(name: "IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"Index"|"Count"|"No"|"Name"|"Note"|"UserExpanded"|"FaderEnabled"|"Owned"|"Hidden"|"DependencyExport"|"MemoryFootprint"|"Guid"|"Scribble"|"Appearance"|"NameAndApp"|"Note"|"Tags"|"PreferenceHandle"|"FontSize"|"ShowTitleBar"|"VisibleTitlebuttons"|"RequestDefaultTitlebuttons"|"TitleButtonMask"|"Transposed"|"AdjustColumns"|"NoFixedColumns"|"MergeCells"|"ForceExpanded"|"RememberSorting"|"RowHeightFactor"|"ColumnsCount"|"ContentFilterType"|"GridColumnConfigurationType"|"SelectedColumnConfiguration"|"SetAllVisible"|"SetAllInvisible"|"ResetColumnOrder"|"FilterType"|"LayerFilter"|"LayerFilterList"|"ClassFilter"|"ClassFilterList"|"FixtureTypeFilter"|"FixtureTypeFilterList"|"StageFilter"|"StageFilterList"|"Hide
Environmental"|"ResetFilters", role: Enums.Roles): string
---@overload fun(name: integer, role: nil): Object
function PSRPatchSheetSettings:Get(name, role) end
...
---@overload fun(index: integer, class: "PSRPatchSheetContentFilter", undo: Undo?): PSRPatchSheetContentFilter
...
function PSRPatchSheetSettings:Create(index, class, undo) end
...
---@overload fun(class: "PSRPatchSheetContentFilter", undo: Undo?, count: integer?): PSRPatchSheetContentFilter
...
function PSRPatchSheetSettings:Append(class, undo, count) end
...
---@overload fun(class: "PSRPatchSheetContentFilter", undo: Undo?): PSRPatchSheetContentFilter
...
function PSRPatchSheetSettings:Acquire(class, undo) end
---@overload fun(class: "Object", undo: Undo?): Object
---@overload fun(class: "MVRxchange", undo: Undo?): MVRxchange
---@overload fun(class: "SmartViewSettingsCollect", undo: Undo?): SmartViewSettingsCollect
---@overload fun(class: "RunningPlaybacksSettingsCollect", undo: Undo?): RunningPlaybacksSettingsCollect
...
function PSRPatchSheetSettings:Aquire(class, undo) end
...
---@overload fun(index: integer, class: "PSRPatchSheetContentFilter", undo: Undo?, count: integer?): PSRPatchSheetContentFilter
...
function PSRPatchSheetSettings:Insert(index, class, undo, count) end
...
---@overload fun(name: string, class: "PSRPatchSheetContentFilter"): PSRPatchSheetContentFilter
...
function PSRPatchSheetSettings:Find(name, class) end
---@overload fun(name: string, class: "Object"): Object
---@overload fun(name: string, class: "MVRxchange"): MVRxchange
---@overload fun(name: string, class: "SmartViewSettingsCollect"): SmartViewSettingsCollect
---@overload fun(name: string, class: "RunningPlaybacksSettingsCollect"): RunningPlaybacksSettingsCollect
...
---@overload fun(name: string, class: "IllegalObject"): IllegalObject
---@overload fun(name: string, class: nil): Object
function PSRPatchSheetSettings:FindRecursive(name, class) end
