...
---@overload fun(property_name: "ViewMode", property_value: DmxSheetSettingsViewMode|ShaperViewMode|AgendaViewMode|TCViewMode)
...
function WindowPhaserEditorSettings:ActiveDisplay(property_name, property_value) end