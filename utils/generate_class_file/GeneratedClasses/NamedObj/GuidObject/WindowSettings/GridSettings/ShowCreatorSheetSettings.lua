...
---@generic T : ShowCreatorSheetSettings
---@param class `T`
---@return boolean
function ShowCreatorSheetSettings:IsClass(class) end
---@return 42
function ShowCreatorSheetSettings:PropertyCount() end
...
---@overload fun(idx: 40): "ShowCreatorSettings"
---@overload fun(idx: 41): "GridType"
function ShowCreatorSheetSettings:PropertyName(idx) end
---@overload fun(idx: 0|1|2): {ExportIgnore: True, EnumCollection: YesNo, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 3|11|22|24|26|27|28|30|31): {ExportIgnore: False, EnumCollection: YesNo, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 4|5|6|35): {ExportIgnore: True, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 7|12|14|15|16|18|19|20|23|32|33|34|36|40): {ExportIgnore: False, ReadOnly: False, ImportIgnore: False}
...
---@overload fun(idx: 41): {ExportIgnore: False, EnumCollection: GridType, ReadOnly: False, ImportIgnore: False}
function ShowCreatorSheetSettings:PropertyInfo(idx) end
...
---@overload fun(idx: 15|16|20|36|40): "Handle"
---@overload fun(idx: 21|22|24|41): "UInt8"
---@overload fun(idx: 32): "Float"
---@overload fun(idx: 37|38|39): "Method"
function ShowCreatorSheetSettings:PropertyType(idx) end
...
---@overload fun(name: "IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"UserExpanded"|"FaderEnabled"|"Owned"|"Hidden"|"ShowTitleBar"|"RequestDefaultTitlebuttons"|"Transposed"|"AdjustColumns"|"NoFixedColumns"|"ForceExpanded"|"RememberSorting", role: nil): YesNo|boolean
...
---@overload fun(class: "NoteTextEdit", undo: Undo?): NoteTextEdit
---@overload fun(class: nil, undo: Undo?): Object
function ShowCreatorSheetSettings:Find(class, undo) end
...
---@overload fun(property_name: "GridType", property_value: GridType, override_change_level: ChangeLevel?)
...
---@overload fun(property_name: "ShowCreatorSettings", property_value: ShowCreatorSettings, override_change_level: ChangeLevel?)
---@overload fun(property_name: "Tags", property_value: TagMap, override_change_level: ChangeLevel?)
---@overload fun(property_name: "IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"Hidden"|"ShowTitleBar"|"RequestDefaultTitlebuttons"|"Transposed"|"AdjustColumns"|"NoFixedColumns"|"ForceExpanded"|"RememberSorting", property_value: YesNo|boolean, override_change_level: ChangeLevel?)
...
function ShowCreatorSheetSettings:Set(property_name, property_value, override_change_level) end
...
function ShowCreatorSheetSettings:SetChildren(property_name, property_value) end