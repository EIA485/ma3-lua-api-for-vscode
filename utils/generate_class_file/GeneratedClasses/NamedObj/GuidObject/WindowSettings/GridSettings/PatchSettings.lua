...
---@field AllowExtendedCondensed YesNo|boolean
---@field ShowSplitView YesNo|boolean
---@field Show3DPositions YesNo|boolean
---@field FlatFilter YesNo|boolean
---@field FilterOutDMXLess YesNo|boolean
---@field Filter Filter
...
---@generic T : PatchSettings
---@param class `T`
---@return boolean
function PatchSettings:IsClass(class) end
---@return TemporaryWindowSettings
function PatchSettings:Parent() end
---@return 53
function PatchSettings:PropertyCount() end
...
---@overload fun(idx: 40): "ShowFilterToolbar"
---@overload fun(idx: 41): "AllowExtendedCondensed"
---@overload fun(idx: 42): "ShowSplitView"
---@overload fun(idx: 43): "Show3DPositions"
---@overload fun(idx: 44): "FlatFilter"
---@overload fun(idx: 45): "FilterOutDMXLess"
---@overload fun(idx: 46): "Filter"
---@overload fun(idx: 47): "SelectedStage"
---@overload fun(idx: 48): "FilterMaskValue"
---@overload fun(idx: 49): "SplitFrameSize"
---@overload fun(idx: 50): "SplitFrameSize3d"
---@overload fun(idx: 51): "SelectedSplitView"
---@overload fun(idx: 52): "CheckColumnCondensedFilter"
function PatchSettings:PropertyName(idx) end
---@overload fun(idx: 0|1|2): {ExportIgnore: True, EnumCollection: YesNo, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 3|11|22|24|26|27|28|30|31|40|41|42|43|44|45): {ExportIgnore: False, EnumCollection: YesNo, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 4|5|6|35|48): {ExportIgnore: True, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 7|12|14|15|16|18|19|20|23|32|33|34|36|46|47|49|50|51): {ExportIgnore: False, ReadOnly: False, ImportIgnore: False}
...
---@overload fun(idx: 13|17|25|37|38|39|52): {ExportIgnore: False, ReadOnly: True, ImportIgnore: True}
...
function PatchSettings:PropertyInfo(idx) end
---@overload fun(idx: 0|1|2|3|4|5|6|8|26|27|28|29|30|31|33|40|41|42|43|44|45|47|48|51): "UInt32"
...
---@overload fun(idx: 21|22|24): "UInt8"
---@overload fun(idx: 32): "Float"
---@overload fun(idx: 37|38|39|52): "Method"
---@overload fun(idx: 49|50): "Int16"
function PatchSettings:PropertyType(idx) end
...
---@overload fun(name: "IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"UserExpanded"|"FaderEnabled"|"Owned"|"Hidden"|"ShowTitleBar"|"RequestDefaultTitlebuttons"|"Transposed"|"AdjustColumns"|"NoFixedColumns"|"ForceExpanded"|"RememberSorting"|"ShowFilterToolbar"|"AllowExtendedCondensed"|"ShowSplitView"|"Show3DPositions"|"FlatFilter"|"FilterOutDMXLess", role: nil): YesNo|boolean
---@overload fun(name: "SetAllVisible"|"SetAllInvisible"|"ResetColumnOrder"|"CheckColumnCondensedFilter", role: nil): fun()
---@overload fun(name: "Index"|"Count"|"No"|"MemoryFootprint"|"ColumnsCount"|"SelectedStage"|"FilterMaskValue"|"SplitFrameSize"|"SplitFrameSize3d"|"SelectedSplitView", role: nil): integer
...
---@overload fun(property_name: "IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"Hidden"|"ShowTitleBar"|"RequestDefaultTitlebuttons"|"Transposed"|"AdjustColumns"|"NoFixedColumns"|"ForceExpanded"|"RememberSorting"|"ShowFilterToolbar"|"AllowExtendedCondensed"|"ShowSplitView"|"Show3DPositions"|"FlatFilter"|"FilterOutDMXLess", property_value: YesNo|boolean, override_change_level: ChangeLevel?)
---@overload fun(property_name: "Index"|"Count"|"No"|"ColumnsCount"|"SelectedStage"|"FilterMaskValue"|"SplitFrameSize"|"SplitFrameSize3d"|"SelectedSplitView", property_value: integer, override_change_level: ChangeLevel?)
...
function PatchSettings:Set(property_name, property_value, override_change_level) end
...
function PatchSettings:SetChildren(property_name, property_value) end