...
---@overload fun(property_name: "ResetBlade", property_value: fun(str: string, int: integer) : boolean)
---@overload fun(property_name: "ResetSelectedDay"|"JumpToNext"|"ObtainCurrentCue"|"ResetPov"|"JumpToToday"|"JumpToPrevious"|"ResetShaper"|"ResetAllBlades"|"ResetSelectedAgenda"|"ResetRotation", property_value: fun(text: string) : boolean)
...
---@overload fun(property_name: "TimezoneStr"|"FileName"|"ClassFilter"|"TitlePrefix"|"StoredData"|"FixtureTypeFilter"|"Type"|"ToolAction"|"FileName"|"SelectedFilter"|"FilePath"|"GroupName"|"Interface"|"FileContent"|"Author"|"SelectionCount"|"Path"|"ManufacturerID"|"DeviceModelID"|"Name"|"Note"|"SoftwareVersionLabel"|"Comment"|"Note"|"DisplayPool"|"DependencyExport"|"Description"|"SelectedDataPool"|"GridColumnConfigurationType"|"Type"|"User"|"LastReceivedMidi"|"FeatureGroup"|"*"|"ContentFilterType"|"Trigger"|"NewShowStartDescription"|"Type"|"LayerFilter", property_value: string)
...
function WindowInfoSettings:SetChildren(property_name, property_value) end