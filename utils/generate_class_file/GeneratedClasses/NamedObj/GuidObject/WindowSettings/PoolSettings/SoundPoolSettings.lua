...
---@overload fun(property_name: "Action", property_value: PluginPoolAction|SequenceAction|PresetActionToken|TimecodeSlotPoolAction|TimecodePoolAction|PresetAction|FilterAction|VideoPoolAction|MacroPoolAction)
...
function SoundPoolSettings:ActiveDisplay(property_name, property_value) end