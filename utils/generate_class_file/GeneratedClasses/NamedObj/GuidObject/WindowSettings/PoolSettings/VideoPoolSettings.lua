...
---@overload fun(property_name: "Action", property_value: PluginPoolAction|SequenceAction|PresetActionToken|TimecodeSlotPoolAction|TimecodePoolAction|PresetAction|SoundPoolAction|FilterAction|MacroPoolAction)
...
function VideoPoolSettings:ActiveDisplay(property_name, property_value) end