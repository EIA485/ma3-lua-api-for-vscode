...
---@class PresetPoolSettings: PoolSettings
---@field DisplayMode PresetDisplayMode
---@field Action integer
local PresetPoolSettings = {
    DisplayMode="0"
}
---@return "PresetPoolSettings"
function PresetPoolSettings:GetClass() end
---@return "Object"
function PresetPoolSettings:GetChildClass() end
...
---@overload fun(name: "DisplayMode", role: nil): PresetDisplayMode
---@overload fun(name: "Action", role: nil): integer
...
ToEdit"|"ObjectActionEnabled"|"PoolColumnsCount"|"DataPool"|"PoolType"|"DrawActiveMode"|"DisplayMode"|"Action", role: Enums.Roles): string
---@overload fun(name: integer, role: nil): Object
function PresetPoolSettings:Get(name, role) end
