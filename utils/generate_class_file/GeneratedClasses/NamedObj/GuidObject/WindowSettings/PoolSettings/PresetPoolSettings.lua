...
---@overload fun(property_name: "Action", property_value: PluginPoolAction|SequenceAction|PresetActionToken|TimecodeSlotPoolAction|TimecodePoolAction|SoundPoolAction|FilterAction|VideoPoolAction|MacroPoolAction)
...
function PresetPoolSettings:ActiveDisplay(property_name, property_value) end