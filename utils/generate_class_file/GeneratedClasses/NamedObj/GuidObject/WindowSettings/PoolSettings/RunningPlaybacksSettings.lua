...
---@field MyPlaybacksOnly integer Show only my playbacks
---@field SheetStyle integer Show pool in sheet-style
---@field OffMode integer Turn Selected Items Off
---@field PlaybacksToShow integer Show playbacks of type
---@field HoldList integer Lock Listed Items in Place while turning them Off
---@field User User
