...
---@overload fun(property_name: "Action", property_value: PluginPoolAction|SequenceAction|PresetActionToken|TimecodeSlotPoolAction|TimecodePoolAction|PresetAction|SoundPoolAction|VideoPoolAction|MacroPoolAction)
...
function FilterPoolSettings:ActiveDisplay(property_name, property_value) end