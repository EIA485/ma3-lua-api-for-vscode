...
---@overload fun(property_name: "Action", property_value: PluginPoolAction|PresetActionToken|TimecodeSlotPoolAction|TimecodePoolAction|PresetAction|SoundPoolAction|FilterAction|VideoPoolAction|MacroPoolAction)
...
function SequencePoolSettings:ActiveDisplay(property_name, property_value) end