...
---@overload fun(property_name: "Action", property_value: PresetActionToken|SequenceAction|TimecodeSlotPoolAction|TimecodePoolAction|PresetAction|SoundPoolAction|FilterAction|VideoPoolAction|MacroPoolAction)
...
function PluginPoolSettings:ActiveDisplay(property_name, property_value) end