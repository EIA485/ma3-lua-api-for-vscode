...
---@field CreateReferenceObject YesNo|boolean
---@field SheetStyle YesNo|boolean
---@field FixtureGrid YesNo|boolean
---@field Advanced YesNo|boolean
---@field ExpandAtFilter YesNo|boolean
---@field SortColorBySaturation SortColorBy
---@field UseColorBook YesNo|boolean
---@field UseChannelSet AutoCreateSource
---@field DestinationObject Object
---@field ObjectTypeValid boolean
---@field IncludeDependencies YesNo|boolean
---@field GapsImport YesNo|boolean
---@field GapsExport YesNo|boolean
...
---@generic T : ShowCreatorSettings
---@param class `T`
---@return boolean
function ShowCreatorSettings:IsClass(class) end
---@return 60
function ShowCreatorSettings:PropertyCount() end
...
---@overload fun(idx: 39): "ObjectType"
---@overload fun(idx: 40): "SubPoolSelectorValue"
---@overload fun(idx: 41): "SubPoolSelectorIndex"
---@overload fun(idx: 42): "CreateReferenceObject"
---@overload fun(idx: 43): "SheetStyle"
---@overload fun(idx: 44): "FixtureGrid"
---@overload fun(idx: 45): "Advanced"
---@overload fun(idx: 46): "ExpandAtFilter"
---@overload fun(idx: 47): "SortColorBySaturation"
---@overload fun(idx: 48): "UseColorBook"
---@overload fun(idx: 49): "UseChannelSet"
---@overload fun(idx: 50): "DestinationObject"
---@overload fun(idx: 51): "ObjectTypeValid"
---@overload fun(idx: 52): "IncludeDependencies"
---@overload fun(idx: 53): "GapsImport"
---@overload fun(idx: 54): "GapsExport"
---@overload fun(idx: 55): "LastSelectedTab"
---@overload fun(idx: 56): "FixtureSourceType"
---@overload fun(idx: 57): "DimmerIncrement"
---@overload fun(idx: 58): "AmountHue"
---@overload fun(idx: 59): "AmountSaturation"
function ShowCreatorSettings:PropertyName(idx) end
---@overload fun(idx: 0|1|2): {ExportIgnore: True, EnumCollection: YesNo, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 3|11|22|24|26|32|33|34|38|42|43|44|45|46|48|52|53|54): {ExportIgnore: False, EnumCollection: YesNo, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 4|5|6|50): {ExportIgnore: True, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 7|12|14|15|16|18|19|20|23|27|28|29|30|31|36|40|41|57|58|59): {ExportIgnore: False, ReadOnly: False, ImportIgnore: False}
...
---@overload fun(idx: 13|17|25|51): {ExportIgnore: False, ReadOnly: True, ImportIgnore: True}
...
---@overload fun(idx: 39): {ExportIgnore: False, EnumCollection: ShowCreatorObjectType, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 47): {ExportIgnore: False, EnumCollection: SortColorBy, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 49): {ExportIgnore: False, EnumCollection: AutoCreateSource, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 55): {ExportIgnore: False, EnumCollection: LastSelectedTab, ReadOnly: True, ImportIgnore: True}
---@overload fun(idx: 56): {ExportIgnore: False, EnumCollection: FixtureSourceType, ReadOnly: False, ImportIgnore: False}
function ShowCreatorSettings:PropertyInfo(idx) end
---@overload fun(idx: 0|1|2|3|4|5|6|8|26|32|33|34|35|38|41): "UInt32"
---@overload fun(idx: 7|12|17|18|25): "String"
---@overload fun(idx: 9|10|51|52|53|54): "Bool"
---@overload fun(idx: 11): "UInt64"
---@overload fun(idx: 13): "Int64"
---@overload fun(idx: 14|19|23): "Custom"
---@overload fun(idx: 15|16|20|36|50): "Handle"
---@overload fun(idx: 21|22|24|37|55|56|57|58|59): "UInt8"
---@overload fun(idx: 27|28|29|30|31): "RGBA8"
---@overload fun(idx: 39|40): "Int32"
---@overload fun(idx: 42|43|44|45|46|47|48|49): "UInt16"
function ShowCreatorSettings:PropertyType(idx) end
---@overload fun(name: "Appearance", role: nil): Appearance
---@overload fun(name: "UseChannelSet", role: nil): AutoCreateSource
...
---@overload fun(name: "PreferenceHandle"|"DestinationObject", role: nil): Object
...
---@overload fun(name: "SortColorBySaturation", role: nil): SortColorBy
---@overload fun(name: "Tags", role: nil): TagMap
---@overload fun(name: "PoolColor"|"EmptyColor"|"ForNoneColor"|"ForSomeColor"|"ForAllColor", role: nil): UColor
---@overload fun(name: "IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"UserExpanded"|"FaderEnabled"|"Owned"|"Hidden"|"ShowTitleBar"|"RequestDefaultTitlebuttons"|"ShowEmpty"|"ShowBottomMenu"|"RightClickToEdit"|"ObjectActionEnabled"|"DrawActiveMode"|"CreateReferenceObject"|"SheetStyle"|"FixtureGrid"|"Advanced"|"ExpandAtFilter"|"UseColorBook"|"IncludeDependencies"|"GapsImport"|"GapsExport", role: nil): YesNo|boolean
---@overload fun(name: "ObjectTypeValid", role: nil): boolean
---@overload fun(name: "Index"|"Count"|"No"|"MemoryFootprint"|"SubPoolSelectorValue"|"SubPoolSelectorIndex"|"DimmerIncrement"|"AmountHue"|"AmountSaturation", role: nil): integer
...
---@overload fun(property_name: "UseChannelSet", property_value: AutoCreateSource, override_change_level: ChangeLevel?)
---@overload fun(property_name: "PoolColumnsCount", property_value: DefinedPoolColumns, override_change_level: ChangeLevel?)
---@overload fun(property_name: "FixtureSourceType", property_value: FixtureSourceType, override_change_level: ChangeLevel?)
...
---@overload fun(property_name: "PreferenceHandle"|"DestinationObject", property_value: Object, override_change_level: ChangeLevel?)
...
---@overload fun(property_name: "ObjectType", property_value: ShowCreatorObjectType, override_change_level: ChangeLevel?)
---@overload fun(property_name: "SortColorBySaturation", property_value: SortColorBy, override_change_level: ChangeLevel?)
...
---@overload fun(property_name: "IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"Hidden"|"ShowTitleBar"|"RequestDefaultTitlebuttons"|"ShowEmpty"|"ShowBottomMenu"|"RightClickToEdit"|"ObjectActionEnabled"|"DrawActiveMode"|"CreateReferenceObject"|"SheetStyle"|"FixtureGrid"|"Advanced"|"ExpandAtFilter"|"UseColorBook"|"IncludeDependencies"|"GapsImport"|"GapsExport", property_value: YesNo|boolean, override_change_level: ChangeLevel?)
---@overload fun(property_name: "Index"|"Count"|"No"|"SubPoolSelectorValue"|"SubPoolSelectorIndex"|"DimmerIncrement"|"AmountHue"|"AmountSaturation", property_value: integer, override_change_level: ChangeLevel?)
...
function ShowCreatorSettings:Set(property_name, property_value, override_change_level) end
...
---@overload fun(property_name: "MultiLedBeamMode", property_value: MultiLedBeamMode)
---@overload fun(property_name: "StageFilter", property_value: None_only)
---@overload fun(property_name: "Filter"|"SelectedAgenda"|"FixedTarget"|"Values"|"Filter"|"PreferenceHandle"|"Target", property_value: Object)
...
---@overload fun(property_name: "Page"|"VisibleGrid"|"SnapGrid"|"TimerIndex"|"PaddingBottom"|"LastConnectionTime"|"LightBeamOverdrawLimit"|"PaddingLeft"|"PaddingRight"|"Mode"|"MemoryLimit"|"PaddingTop"|"ParameterCount"|"InitialWhiteFilter"|"Page"|"FileSize"|"DesiredUiFps"|"Index"|"Page"|"Count"|"SplitSize"|"No"|"SoftwareID"|"DynamicGoboResolution"|"PoolObjectContentSizeLimitation"|"ColumnsCount"|"Texture"|"Width"|"HazeLayers"|"Cont.Size"|"Height"|"SplitSize"|"Cont.Ref"|"Page"|"TCSlot"|"ColumnsCount"|"RealtimeIteration"|"LabMaxCount"|"AutoColumnsWidth", property_value: integer)
---@overload fun(property_name: "StageFilterList", property_value: integer[])
...
function ShowCreatorSettings:SetChildren(property_name, property_value) end