...
---@field MAtricksTransformation integer
...
---@overload fun(name: "AutoScroll"|"FaderEnabled"|"Owned", role: nil): boolean
---@overload fun(name: "GridLines"|"ToolBar"|"MAtricksTransformation"|"CenterlineX"|"CenterlineY"|"AlignBar"|"ShowTitleBar"|"RequestDefaultTitlebuttons"|"IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"Index"|"Count"|"No"|"UserExpanded"|"Hidden"|"MemoryFootprint", role: nil): integer
