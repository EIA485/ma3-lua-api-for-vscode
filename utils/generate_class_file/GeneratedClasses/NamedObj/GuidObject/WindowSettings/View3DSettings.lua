...
---@overload fun(property_name: "SelectionMode", property_value: SelectionModeLayout|StrictNormalMode)
...
---@overload fun(property_name: "Page"|"VisibleGrid"|"SnapGrid"|"TimerIndex"|"PaddingBottom"|"LastConnectionTime"|"PaddingLeft"|"DimmerIncrement"|"AmountHue"|"PaddingRight"|"AmountSaturation"|"Mode"|"MemoryLimit"|"PaddingTop"|"ParameterCount"|"InitialWhiteFilter"|"Page"|"FileSize"|"Index"|"Page"|"Count"|"SplitSize"|"No"|"SoftwareID"|"PoolObjectContentSizeLimitation"|"SubPoolSelectorValue"|"SubPoolSelectorIndex"|"ColumnsCount"|"Texture"|"Width"|"HazeLayers"|"Cont.Size"|"Height"|"SplitSize"|"Cont.Ref"|"Page"|"TCSlot"|"ColumnsCount"|"RealtimeIteration"|"AutoColumnsWidth", property_value: integer)
---@overload fun(property_name: "StageFilterList", property_value: integer[])
---@overload fun(property_name: "Physical"|"Zoom"|"FOV"|"Pan"|"Tilt"|"Roll"|"ResolutionScale3D"|"ResolutionScaleLight"|"DilutionScale"|"NativeColors"|"Scale"|"Aspect"|"HazeParticleQuality"|"HazeScale"|"HazeParticleSize"|"HazeBlend"|"HazeAnimationSpeed"|"RowHeightFactor"|"Timezone", property_value: number)
...
function View3DSettings:SetChildren(property_name, property_value) end