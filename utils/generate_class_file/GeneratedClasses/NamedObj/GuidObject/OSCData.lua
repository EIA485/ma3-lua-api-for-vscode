...
---@field Receive YesNo|boolean
---@field Send YesNo|boolean
---@field ReceiveCommand YesNo|boolean
---@field SendCommand YesNo|boolean
---@field EchoInput YesNo|boolean
---@field EchoOutput YesNo|boolean
local OSCData = {
    DataPool="DataPool",
    Page="Page",
    Fader="Fader",
...
---@param class `T`
---@return boolean
function OSCData:IsClass(class) end
---@return OSCBase
function OSCData:Parent() end
---@return 36
function OSCData:PropertyCount() end
...
---@overload fun(idx: 20): "DestinationIP"
---@overload fun(idx: 21): "Mode"
---@overload fun(idx: 22): "Port"
---@overload fun(idx: 23): "Prefix"
---@overload fun(idx: 24): "DataPool"
---@overload fun(idx: 25): "Page"
---@overload fun(idx: 26): "Fader"
---@overload fun(idx: 27): "ExecutorKnob"
---@overload fun(idx: 28): "Key"
---@overload fun(idx: 29): "FaderRange"
---@overload fun(idx: 30): "Receive"
---@overload fun(idx: 31): "Send"
---@overload fun(idx: 32): "ReceiveCommand"
---@overload fun(idx: 33): "SendCommand"
---@overload fun(idx: 34): "EchoInput"
---@overload fun(idx: 35): "EchoOutput"
function OSCData:PropertyName(idx) end
---@overload fun(idx: 0|1|2): {ExportIgnore: True, EnumCollection: YesNo, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 3|11|30|31|32|33|34|35): {ExportIgnore: False, EnumCollection: YesNo, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 4|5|6): {ExportIgnore: True, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 7|12|14|15|16|18|19|20|22|23|24|25|26|27|28|29): {ExportIgnore: False, ReadOnly: False, ImportIgnore: False}
...
---@overload fun(idx: 21): {ExportIgnore: False, EnumCollection: OSCMode, ReadOnly: False, ImportIgnore: False}
function OSCData:PropertyInfo(idx) end
---@overload fun(idx: 0|1|2|3|4|5|6|8|21|30|31|32|33|34|35): "UInt32"
---@overload fun(idx: 7|12|17|18|23|24|25|26|27|28): "String"
...
---@overload fun(idx: 22|29): "UInt16"
function OSCData:PropertyType(idx) end
---@overload fun(name: "Appearance", role: nil): Appearance
---@overload fun(name: "Guid", role: nil): Key128
---@overload fun(name: "DestinationIP", role: nil): Manet.IP4
---@overload fun(name: "Mode", role: nil): OSCMode
---@overload fun(name: "Scribble", role: nil): Scribble
---@overload fun(name: "Tags", role: nil): TagMap
---@overload fun(name: "IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"UserExpanded"|"FaderEnabled"|"Owned"|"Hidden"|"Receive"|"Send"|"ReceiveCommand"|"SendCommand"|"EchoInput"|"EchoOutput", role: nil): YesNo|boolean
---@overload fun(name: "Index"|"Count"|"No"|"MemoryFootprint"|"Port"|"FaderRange", role: nil): integer
---@overload fun(name: "Name"|"DependencyExport"|"NameAndApp"|"Note"|"Prefix"|"DataPool"|"Page"|"Fader"|"ExecutorKnob"|"Key", role: nil): string
---@overload fun(name: "IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"Index"|"Count"|"No"|"Name"|"UserExpanded"|"FaderEnabled"|"Owned"|"Hidden"|"DependencyExport"|"MemoryFootprint"|"Guid"|"Scribble"|"Appearance"|"NameAndApp"|"Note"|"Tags"|"DestinationIP"|"Mode"|"Port"|"Prefix"|"DataPool"|"Page"|"Fader"|"ExecutorKnob"|"Key"|"FaderRange"|"Receive"|"Send"|"ReceiveCommand"|"SendCommand"|"EchoInput"|"EchoOutput", role: Enums.Roles): string
...
---@overload fun(property_name: "Mode", property_value: OSCMode, override_change_level: ChangeLevel?)
...
---@overload fun(property_name: "IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"Hidden"|"Receive"|"Send"|"ReceiveCommand"|"SendCommand"|"EchoInput"|"EchoOutput", property_value: YesNo|boolean, override_change_level: ChangeLevel?)
---@overload fun(property_name: "Index"|"Count"|"No"|"Port"|"FaderRange", property_value: integer, override_change_level: ChangeLevel?)
---@overload fun(property_name: "Name"|"DependencyExport"|"Note"|"Prefix"|"DataPool"|"Page"|"Fader"|"ExecutorKnob"|"Key", property_value: string, override_change_level: ChangeLevel?)
function OSCData:Set(property_name, property_value, override_change_level) end
...
function OSCData:SetChildren(property_name, property_value) end