...
---@param class `T`
---@return boolean
function ShowData:IsClass(class) end
---@return 22
function ShowData:PropertyCount() end
...
---@overload fun(idx: 20): "MemoryLimit"
---@overload fun(idx: 21): "ParameterCount"
function ShowData:PropertyName(idx) end
---@overload fun(idx: 0|1|2): {ExportIgnore: True, EnumCollection: YesNo, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 3|11): {ExportIgnore: False, EnumCollection: YesNo, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 4|5|6|21): {ExportIgnore: True, ReadOnly: False, ImportIgnore: False}
...
function ShowData:PropertyInfo(idx) end
...
---@overload fun(idx: 13|20): "Int64"
---@overload fun(idx: 14|19): "Custom"
---@overload fun(idx: 15|16): "Handle"
function ShowData:PropertyType(idx) end
...
---@overload fun(class: "NoteTextEdit", undo: Undo?): NoteTextEdit
---@overload fun(class: nil, undo: Undo?): Object
function ShowData:Find(class, undo) end
...
---@overload fun(property_name: "Index"|"Count"|"No"|"MemoryLimit"|"ParameterCount", property_value: integer, override_change_level: ChangeLevel?)
---@overload fun(property_name: "Name"|"DependencyExport"|"Note", property_value: string, override_change_level: ChangeLevel?)
function ShowData:Set(property_name, property_value, override_change_level) end
...
---@overload fun(property_name: "PreferredIP"|"PreferredIP", property_value: Manet.IP4)
---@overload fun(property_name: "Pivot", property_value: Math.TVector<float>)
---@overload fun(property_name: "InterpolationTo", property_value: MeasurementInterpolation)
---@overload fun(property_name: "Target", property_value: Mesh)
---@overload fun(property_name: "Category", property_value: MessageCategory)
...
---@overload fun(property_name: "Page"|"CountRTChannels"|"VisibleGrid"|"CountUIChannels"|"MemoryLimit"|"TimerIndex"|"SnapGrid"|"CountDMXModes"|"PaddingBottom"|"LastConnectionTime"|"LightBeamOverdrawLimit"|"CountLogicalChannels"|"PaddingLeft"|"DimmerIncrement"|"AmountHue"|"PaddingRight"|"PaddingTop"|"Mode"|"AmountSaturation"|"InitialWhiteFilter"|"Page"|"FileSize"|"DesiredUiFps"|"Index"|"Page"|"Count"|"SplitSize"|"No"|"SoftwareID"|"DynamicGoboResolution"|"PoolObjectContentSizeLimitation"|"SubPoolSelectorValue"|"SubPoolSelectorIndex"|"ColumnsCount"|"Texture"|"AutoColumnsWidth"|"Width"|"HazeLayers"|"Cont.Size"|"Height"|"SplitSize"|"Cont.Ref"|"Page"|"TCSlot"|"ColumnsCount"|"RealtimeIteration"|"LabMaxCount"|"CountFixtures"|"CountSubfixtures", property_value: integer)
---@overload fun(property_name: "StageFilterList", property_value: integer[])
...
---@overload fun(property_name: "TimezoneStr"|"FileName"|"ClassFilter"|"TitlePrefix"|"StoredData"|"FixtureTypeFilter"|"Type"|"Interface"|"ToolAction"|"FileName"|"SelectedFilter"|"FilePath"|"GroupName"|"Interface"|"Interface"|"FileContent"|"Author"|"SelectionCount"|"ManufacturerID"|"Path"|"DeviceModelID"|"Name"|"Note"|"SoftwareVersionLabel"|"Comment"|"Note"|"DisplayPool"|"TargetName"|"DependencyExport"|"ChildName"|"Description"|"SelectedDataPool"|"GridColumnConfigurationType"|"Type"|"User"|"LastReceivedMidi"|"FeatureGroup"|"*"|"ContentFilterType"|"Trigger"|"NewShowStartDescription"|"Type"|"LayerFilter", property_value: string)
...
function ShowData:SetChildren(property_name, property_value) end