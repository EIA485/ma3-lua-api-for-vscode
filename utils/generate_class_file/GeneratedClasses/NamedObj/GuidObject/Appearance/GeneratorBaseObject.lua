...
---@generic T : GeneratorBaseObject
---@param class `T`
---@return boolean
function GeneratorBaseObject:IsClass(class) end
---@return GenericPool
function GeneratorBaseObject:Parent() end
---@return 43
function GeneratorBaseObject:PropertyCount() end
...
function GeneratorBaseObject:PropertyName(idx) end
...
---@overload fun(idx: 7|12|14|15|17|18|20|28|29|30|31|33|37|38|39|40): {ExportIgnore: False, ReadOnly: False, ImportIgnore: False}
...
---@overload fun(idx: 13|16|19|21|23|24|25|26|27|32|41|42): {ExportIgnore: False, ReadOnly: True, ImportIgnore: True}
...
function GeneratorBaseObject:PropertyInfo(idx) end
...
---@overload fun(idx: 14|18|20): "Custom"
---@overload fun(idx: 15|19|21|42): "Handle"
---@overload fun(idx: 22|23|24|25|26|28|29|30|31|34|35|36): "UInt8"
---@overload fun(idx: 37|38|39|40): "Int16"
function GeneratorBaseObject:PropertyType(idx) end
...
---@overload fun(name: "Index"|"Count"|"No"|"MemoryFootprint"|"ImageR"|"ImageG"|"ImageB"|"ImageAlpha"|"BackR"|"BackG"|"BackB"|"BackAlpha"|"IPX"|"IPY"|"IPW"|"IPH"|"ID", role: nil): integer
...
---@overload fun(class: "NoteTextEdit", undo: Undo?): NoteTextEdit
---@overload fun(class: nil, undo: Undo?): Object
function GeneratorBaseObject:Find(class, undo) end
...
function GeneratorBaseObject:Set(property_name, property_value, override_change_level) end
...
function GeneratorBaseObject:SetChildren(property_name, property_value) end