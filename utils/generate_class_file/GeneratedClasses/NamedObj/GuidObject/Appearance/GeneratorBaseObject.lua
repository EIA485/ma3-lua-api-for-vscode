...
---@class GeneratorBaseObject: Appearance
---@field ID integer
---@field GridSelection GridSelection
local GeneratorBaseObject = {
    ID="0"
}
---@return "GeneratorBaseObject"
function GeneratorBaseObject:GetClass() end
---@return "Object"
function GeneratorBaseObject:GetChildClass() end
---@return GenericPool
function GeneratorBaseObject:Parent() end
...
function GeneratorBaseObject:Create(index, class, undo) end
...
function GeneratorBaseObject:Append(class, undo, count) end
...
function GeneratorBaseObject:Acquire(class, undo) end
---@overload fun(class: "Object", undo: Undo?): Object
---@overload fun(class: "MVRxchange", undo: Undo?): MVRxchange
---@overload fun(class: "GeneratorChannels", undo: Undo?): GeneratorChannels
---@overload fun(class: "PatternChannels", undo: Undo?): PatternChannels
...
function GeneratorBaseObject:Aquire(class, undo) end
...
function GeneratorBaseObject:Insert(index, class, undo, count) end
...
function GeneratorBaseObject:Find(name, class) end
---@overload fun(name: string, class: "Object"): Object
---@overload fun(name: string, class: "MVRxchange"): MVRxchange
---@overload fun(name: string, class: "GeneratorChannels"): GeneratorChannels
---@overload fun(name: string, class: "PatternChannels"): PatternChannels
...
---@overload fun(name: string, class: "IllegalObject"): IllegalObject
---@overload fun(name: string, class: nil): Object
function GeneratorBaseObject:FindRecursive(name, class) end
