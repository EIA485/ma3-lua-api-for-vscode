...
---@field Universal YesNo|boolean
---@field CanHaveChildren YesNo|boolean
---@field CircleInGeometries YesNo|boolean
---@field NotUniqueAttributes YesNo|boolean
---@field SpecialPurpose SpecialPurposeFT
---@field ShareGlobal YesNo|boolean
---@field Version Stream.Version
---@field ImageRotation ImageRotation
---@field ImageMirror ImageMirror
---@field XYZ FixtureTypeXYZStatus
local FixtureType = {
    Source="User",
    Universal="0",
    CanHaveChildren="No",
...
---@param class `T`
---@return boolean
function FixtureType:IsClass(class) end
---@return FixtureTypes
function FixtureType:Parent() end
---@return 56
function FixtureType:PropertyCount() end
...
---@overload fun(idx: 34): "CreatedBy"
---@overload fun(idx: 35): "IPX"
---@overload fun(idx: 36): "IPY"
---@overload fun(idx: 37): "IPW"
---@overload fun(idx: 38): "IPH"
---@overload fun(idx: 39): "Source"
---@overload fun(idx: 40): "ShortName"
---@overload fun(idx: 41): "LongName"
---@overload fun(idx: 42): "Description"
---@overload fun(idx: 43): "Manufacturer"
---@overload fun(idx: 44): "Used"
---@overload fun(idx: 45): "RealUsed"
---@overload fun(idx: 46): "Universal"
---@overload fun(idx: 47): "CanHaveChildren"
---@overload fun(idx: 48): "CircleInGeometries"
---@overload fun(idx: 49): "NotUniqueAttributes"
---@overload fun(idx: 50): "SpecialPurpose"
---@overload fun(idx: 51): "ShareGlobal"
---@overload fun(idx: 52): "Version"
---@overload fun(idx: 53): "ImageRotation"
---@overload fun(idx: 54): "ImageMirror"
---@overload fun(idx: 55): "XYZ"
function FixtureType:PropertyName(idx) end
---@overload fun(idx: 0|1|2): {ExportIgnore: True, EnumCollection: YesNo, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 3|11|46|47|48|49|51): {ExportIgnore: False, EnumCollection: YesNo, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 4|5|6|44|45): {ExportIgnore: True, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 7|12|14|15|17|18|20|28|29|30|31|33|35|36|37|38|40|41|42|43): {ExportIgnore: False, ReadOnly: False, ImportIgnore: False}
...
---@overload fun(idx: 34): {ExportIgnore: False, EnumCollection: CreateBy, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 39): {ExportIgnore: False, EnumCollection: FixtureTypeSource, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 50): {ExportIgnore: False, EnumCollection: SpecialPurposeFT, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 52): {ExportIgnore: True, ReadOnly: True, ImportIgnore: True}
---@overload fun(idx: 53|54): {ExportIgnore: False, ReadOnly: True, ImportIgnore: False}
---@overload fun(idx: 55): {ExportIgnore: True, EnumCollection: FixtureTypeXYZStatus, ReadOnly: True, ImportIgnore: True}
function FixtureType:PropertyInfo(idx) end
---@overload fun(idx: 0|1|2|3|4|5|6|8|39|44|45|46|47|48|49|50|51): "UInt32"
---@overload fun(idx: 7|12|16|17|27|32|33|40|41|42|43): "String"
---@overload fun(idx: 9|10): "Bool"
---@overload fun(idx: 11): "UInt64"
---@overload fun(idx: 13): "Int64"
---@overload fun(idx: 14|18|20|52): "Custom"
---@overload fun(idx: 15|19|21): "Handle"
---@overload fun(idx: 22|23|24|25|26|28|29|30|31|34|53|54|55): "UInt8"
---@overload fun(idx: 35|36|37|38): "Int16"
function FixtureType:PropertyType(idx) end
...
---@overload fun(name: "XYZ", role: nil): FixtureTypeXYZStatus
...
---@overload fun(name: "SpecialPurpose", role: nil): SpecialPurposeFT
---@overload fun(name: "Version", role: nil): Stream.Version
---@overload fun(name: "Tags", role: nil): TagMap
---@overload fun(name: "IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"UserExpanded"|"FaderEnabled"|"Owned"|"Hidden"|"Universal"|"CanHaveChildren"|"CircleInGeometries"|"NotUniqueAttributes"|"ShareGlobal", role: nil): YesNo|boolean
---@overload fun(name: "Index"|"Count"|"No"|"MemoryFootprint"|"ImageR"|"ImageG"|"ImageB"|"ImageAlpha"|"BackR"|"BackG"|"BackB"|"BackAlpha"|"IPX"|"IPY"|"IPW"|"IPH"|"Used"|"RealUsed", role: nil): integer
---@overload fun(name: "Name"|"DependencyExport"|"NameAndApp"|"Note"|"ImageRGBA"|"BackRGBA"|"MediaFileName"|"ShortName"|"LongName"|"Description"|"Manufacturer", role: nil): string
---@overload fun(name: "IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"Index"|"Count"|"No"|"Name"|"UserExpanded"|"FaderEnabled"|"Owned"|"Hidden"|"DependencyExport"|"MemoryFootprint"|"Guid"|"Scribble"|"NameAndApp"|"Note"|"Tags"|"Appearance"|"Color"|"Image"|"ImageMode"|"ImageR"|"ImageG"|"ImageB"|"ImageAlpha"|"ImageRGBA"|"BackR"|"BackG"|"BackB"|"BackAlpha"|"BackRGBA"|"MediaFileName"|"CreatedBy"|"IPX"|"IPY"|"IPW"|"IPH"|"Source"|"ShortName"|"LongName"|"Description"|"Manufacturer"|"Used"|"RealUsed"|"Universal"|"CanHaveChildren"|"CircleInGeometries"|"NotUniqueAttributes"|"SpecialPurpose"|"ShareGlobal"|"Version"|"ImageRotation"|"ImageMirror"|"XYZ", role: Enums.Roles): string
...
---@overload fun(property_name: "SpecialPurpose", property_value: SpecialPurposeFT, override_change_level: ChangeLevel?)
---@overload fun(property_name: "Tags", property_value: TagMap, override_change_level: ChangeLevel?)
---@overload fun(property_name: "IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"Hidden"|"Universal"|"CanHaveChildren"|"CircleInGeometries"|"NotUniqueAttributes"|"ShareGlobal", property_value: YesNo|boolean, override_change_level: ChangeLevel?)
---@overload fun(property_name: "Index"|"Count"|"No"|"BackR"|"BackG"|"BackB"|"BackAlpha"|"IPX"|"IPY"|"IPW"|"IPH"|"Used"|"RealUsed", property_value: integer, override_change_level: ChangeLevel?)
---@overload fun(property_name: "Name"|"DependencyExport"|"Note"|"MediaFileName"|"ShortName"|"LongName"|"Description"|"Manufacturer", property_value: string, override_change_level: ChangeLevel?)
function FixtureType:Set(property_name, property_value, override_change_level) end
...
function FixtureType:SetChildren(property_name, property_value) end