...
---@overload fun(name: "IPX"|"IPY"|"IPW"|"IPH"|"Source", role: nil): integer
---@overload fun(name: "ShortName"|"LongName"|"Description"|"Manufacturer", role: nil): string
---@overload fun(name: "Used"|"RealUsed"|"Universal"|"CanHaveChildren"|"CircleInGeometries"|"NotUniqueAttributes"|"Special
Purpose"|"Share
Global", role: nil): integer
---@overload fun(name: "Version", role: nil): Stream.Version
---@overload fun(name: "ImageRotation", role: nil): ImageRotation
---@overload fun(name: "ImageMirror", role: nil): ImageMirror
---@overload fun(name: "XYZ", role: nil): integer
---@overload fun(name: "IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"Index"|"Count"|"No"|"Name"|"Note"|"UserExpanded"|"FaderEnabled"|"Owned"|"Hidden"|"DependencyExport"|"MemoryFootprint"|"Guid"|"Scribble"|"Appearance"|"NameAndApp"|"Note"|"Tags"|"Appearance"|"Color"|"Image"|"ImageMode"|"ImageR"|"ImageG"|"ImageB"|"ImageAlpha"|"ImageRGBA"|"BackR"|"BackG"|"BackB"|"BackAlpha"|"BackRGBA"|"MediaFileName"|"ImageRotation"|"ImageMirror"|"CreatedBy"|"IPX"|"IPY"|"IPW"|"IPH"|"Source"|"ShortName"|"LongName"|"Description"|"Manufacturer"|"Used"|"RealUsed"|"Universal"|"CanHaveChildren"|"CircleInGeometries"|"NotUniqueAttributes"|"Special
Purpose"|"Share
Global"|"Version"|"ImageRotation"|"ImageMirror"|"XYZ", role: Enums.Roles): string
...
---@overload fun(index: integer, class: "PhysicalDescriptions", undo: Undo?): PhysicalDescriptions
---@overload fun(index: integer, class: "DMXModes", undo: Undo?): DMXModes
---@overload fun(index: integer, class: "Geometries", undo: Undo?): Geometries
---@overload fun(index: integer, class: "Models", undo: Undo?): Models
---@overload fun(index: integer, class: "Wheels", undo: Undo?): Wheels
---@overload fun(index: integer, class: "Protocols", undo: Undo?): Protocols
---@overload fun(index: integer, class: "Revisions", undo: Undo?): Revisions
...
---@overload fun(class: "PhysicalDescriptions", undo: Undo?, count: integer?): PhysicalDescriptions
---@overload fun(class: "DMXModes", undo: Undo?, count: integer?): DMXModes
---@overload fun(class: "Geometries", undo: Undo?, count: integer?): Geometries
---@overload fun(class: "Models", undo: Undo?, count: integer?): Models
---@overload fun(class: "Wheels", undo: Undo?, count: integer?): Wheels
---@overload fun(class: "Protocols", undo: Undo?, count: integer?): Protocols
---@overload fun(class: "Revisions", undo: Undo?, count: integer?): Revisions
...
---@overload fun(class: "PhysicalDescriptions", undo: Undo?): PhysicalDescriptions
---@overload fun(class: "DMXModes", undo: Undo?): DMXModes
---@overload fun(class: "Geometries", undo: Undo?): Geometries
---@overload fun(class: "Models", undo: Undo?): Models
---@overload fun(class: "Wheels", undo: Undo?): Wheels
---@overload fun(class: "Protocols", undo: Undo?): Protocols
---@overload fun(class: "Revisions", undo: Undo?): Revisions
...
---@overload fun(index: integer, class: "PhysicalDescriptions", undo: Undo?, count: integer?): PhysicalDescriptions
---@overload fun(index: integer, class: "DMXModes", undo: Undo?, count: integer?): DMXModes
---@overload fun(index: integer, class: "Geometries", undo: Undo?, count: integer?): Geometries
---@overload fun(index: integer, class: "Models", undo: Undo?, count: integer?): Models
---@overload fun(index: integer, class: "Wheels", undo: Undo?, count: integer?): Wheels
---@overload fun(index: integer, class: "Protocols", undo: Undo?, count: integer?): Protocols
---@overload fun(index: integer, class: "Revisions", undo: Undo?, count: integer?): Revisions
...
---@overload fun(name: string, class: "PhysicalDescriptions"): PhysicalDescriptions
---@overload fun(name: string, class: "DMXModes"): DMXModes
---@overload fun(name: string, class: "Geometries"): Geometries
---@overload fun(name: string, class: "Models"): Models
---@overload fun(name: string, class: "Wheels"): Wheels
---@overload fun(name: string, class: "Protocols"): Protocols
---@overload fun(name: string, class: "Revisions"): Revisions
...
function FixtureType:Find(name, class) end
---@overload fun(name: string, class: "Object"): Object
---@overload fun(name: string, class: "MVRxchange"): MVRxchange
---@overload fun(name: string, class: "SmartViewSettingsCollect"): SmartViewSettingsCollect
---@overload fun(name: string, class: "RunningPlaybacksSettingsCollect"): RunningPlaybacksSettingsCollect
...
---@overload fun(name: string, class: "IllegalObject"): IllegalObject
---@overload fun(name: string, class: nil): Object
function FixtureType:FindRecursive(name, class) end
