...
---@overload fun(class: "NoteTextEdit", undo: Undo?): NoteTextEdit
---@overload fun(class: nil, undo: Undo?): Object
function Pattern:Find(class, undo) end
...
function Pattern:SetChildren(property_name, property_value) end