...
---@field AutoFormat YesNo|boolean
---@field HasActiveBMC YesNo|boolean
...
---@param class `T`
---@return boolean
function Bitmap:IsClass(class) end
---@return Bitmaps
function Bitmap:Parent() end
---@return 59
function Bitmap:PropertyCount() end
...
---@overload fun(idx: 41): "ID"
---@overload fun(idx: 42): "GridSelection"
---@overload fun(idx: 43): "ControlContent"
---@overload fun(idx: 44): "ConfigHandle"
---@overload fun(idx: 45): "ControlX"
---@overload fun(idx: 46): "ControlY"
---@overload fun(idx: 47): "ControlZoom"
---@overload fun(idx: 48): "ControlAspect"
---@overload fun(idx: 49): "ControlRotate"
---@overload fun(idx: 50): "ColorR"
---@overload fun(idx: 51): "ColorG"
---@overload fun(idx: 52): "ColorB"
---@overload fun(idx: 53): "SpeedMaster"
---@overload fun(idx: 54): "BMC"
---@overload fun(idx: 55): "AutoFormat"
---@overload fun(idx: 56): "HasActiveBMC"
---@overload fun(idx: 57): "OnActivateBMC"
---@overload fun(idx: 58): "LuaCommand"
function Bitmap:PropertyName(idx) end
---@overload fun(idx: 0|1|2): {ExportIgnore: True, EnumCollection: YesNo, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 3|11|55|56): {ExportIgnore: False, EnumCollection: YesNo, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 4|5|6|44): {ExportIgnore: True, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 7|12|14|15|17|18|20|28|29|30|31|33|37|38|39|40|43|57|58): {ExportIgnore: False, ReadOnly: False, ImportIgnore: False}
...
---@overload fun(idx: 13|16|19|21|23|24|25|26|27|32|41|42|45|46|47|48|49|50|51|52|54): {ExportIgnore: False, ReadOnly: True, ImportIgnore: True}
...
---@overload fun(idx: 53): {ExportIgnore: False, EnumCollection: SpeedMaster, ReadOnly: False, ImportIgnore: False}
function Bitmap:PropertyInfo(idx) end
---@overload fun(idx: 0|1|2|3|4|5|6|8|41): "UInt32"
---@overload fun(idx: 7|12|16|17|27|32|33): "String"
---@overload fun(idx: 9|10|56): "Bool"
---@overload fun(idx: 11): "UInt64"
---@overload fun(idx: 13): "Int64"
---@overload fun(idx: 14|18|20|54): "Custom"
---@overload fun(idx: 15|19|21|42|44): "Handle"
---@overload fun(idx: 22|23|24|25|26|28|29|30|31|34|35|36|53|55): "UInt8"
---@overload fun(idx: 37|38|39|40): "Int16"
---@overload fun(idx: 43|45|46|47|48|49|50|51|52): "Int32"
---@overload fun(idx: 57|58): "Action"
function Bitmap:PropertyType(idx) end
...
---@overload fun(name: "IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"UserExpanded"|"FaderEnabled"|"Owned"|"Hidden"|"AutoFormat"|"HasActiveBMC", role: nil): YesNo|boolean
---@overload fun(name: "OnActivateBMC"|"LuaCommand", role: nil): fun(str: string) : boolean
---@overload fun(name: "Index"|"Count"|"No"|"MemoryFootprint"|"ImageR"|"ImageG"|"ImageB"|"ImageAlpha"|"BackR"|"BackG"|"BackB"|"BackAlpha"|"IPX"|"IPY"|"IPW"|"IPH"|"ID"|"ControlContent"|"ControlX"|"ControlY"|"ControlZoom"|"ControlAspect"|"ControlRotate"|"ColorR"|"ColorG"|"ColorB", role: nil): integer
...
---@overload fun(property_name: "ConfigHandle", property_value: Object, override_change_level: ChangeLevel?)
...
---@overload fun(property_name: "IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"Hidden"|"AutoFormat"|"HasActiveBMC", property_value: YesNo|boolean, override_change_level: ChangeLevel?)
---@overload fun(property_name: "OnActivateBMC"|"LuaCommand", property_value: fun(str: string) : boolean, override_change_level: ChangeLevel?)
---@overload fun(property_name: "Index"|"Count"|"No"|"BackR"|"BackG"|"BackB"|"BackAlpha"|"IPX"|"IPY"|"IPW"|"IPH"|"ControlContent", property_value: integer, override_change_level: ChangeLevel?)
...
function Bitmap:Set(property_name, property_value, override_change_level) end
...
function Bitmap:SetChildren(property_name, property_value) end