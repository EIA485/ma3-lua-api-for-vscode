...
---@class Random: GeneratorBaseObject
local Random = {}
---@return "Random"
function Random:GetClass() end
---@return "Object"
function Random:GetChildClass() end
---@return Generators
function Random:Parent() end
...
---@overload fun(index: integer, class: "RandomChannels", undo: Undo?): RandomChannels
...
function Random:Create(index, class, undo) end
...
---@overload fun(class: "RandomChannels", undo: Undo?, count: integer?): RandomChannels
...
function Random:Append(class, undo, count) end
...
---@overload fun(class: "RandomChannels", undo: Undo?): RandomChannels
...
function Random:Acquire(class, undo) end
---@overload fun(class: "Object", undo: Undo?): Object
---@overload fun(class: "MVRxchange", undo: Undo?): MVRxchange
---@overload fun(class: "GeneratorChannels", undo: Undo?): GeneratorChannels
---@overload fun(class: "PatternChannels", undo: Undo?): PatternChannels
...
function Random:Aquire(class, undo) end
...
---@overload fun(index: integer, class: "RandomChannels", undo: Undo?, count: integer?): RandomChannels
...
function Random:Insert(index, class, undo, count) end
...
---@overload fun(name: string, class: "RandomChannels"): RandomChannels
...
function Random:Find(name, class) end
---@overload fun(name: string, class: "Object"): Object
---@overload fun(name: string, class: "MVRxchange"): MVRxchange
---@overload fun(name: string, class: "GeneratorChannels"): GeneratorChannels
---@overload fun(name: string, class: "PatternChannels"): PatternChannels
...
---@overload fun(name: string, class: "IllegalObject"): IllegalObject
---@overload fun(name: string, class: nil): Object
function Random:FindRecursive(name, class) end
