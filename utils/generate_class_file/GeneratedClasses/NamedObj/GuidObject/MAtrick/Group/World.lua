...
---@class World: Group A fixture selection plus an additional attribute filter. Used to filter the working area for a user profile in the network.
...
---@return "World"
function World:GetClass() end
---@return "Object"
function World:GetChildClass() end
---@return Worlds
...
---@overload fun(name: "Mode"|"Selection", role: nil): integer
...
Cursor"|"PreserveGridPositions"|"SelectionData"|"Attributes"|"Mode"|"Selection", role: Enums.Roles): string
---@overload fun(name: integer, role: nil): Object
function World:Get(name, role) end
...
---@overload fun(index: integer, class: "FixtureFilterRules", undo: Undo?): FixtureFilterRules
...
function World:Create(index, class, undo) end
...
---@overload fun(class: "FixtureFilterRules", undo: Undo?, count: integer?): FixtureFilterRules
...
function World:Append(class, undo, count) end
...
---@overload fun(class: "FixtureFilterRules", undo: Undo?): FixtureFilterRules
...
function World:Acquire(class, undo) end
---@overload fun(class: "Object", undo: Undo?): Object
---@overload fun(class: "MVRxchange", undo: Undo?): MVRxchange
---@overload fun(class: "SmartViewSettingsCollect", undo: Undo?): SmartViewSettingsCollect
---@overload fun(class: "RunningPlaybacksSettingsCollect", undo: Undo?): RunningPlaybacksSettingsCollect
...
function World:Aquire(class, undo) end
...
---@overload fun(index: integer, class: "FixtureFilterRules", undo: Undo?, count: integer?): FixtureFilterRules
...
function World:Insert(index, class, undo, count) end
...
---@overload fun(name: string, class: "FixtureFilterRules"): FixtureFilterRules
...
function World:Find(name, class) end
---@overload fun(name: string, class: "Object"): Object
---@overload fun(name: string, class: "MVRxchange"): MVRxchange
---@overload fun(name: string, class: "SmartViewSettingsCollect"): SmartViewSettingsCollect
---@overload fun(name: string, class: "RunningPlaybacksSettingsCollect"): RunningPlaybacksSettingsCollect
...
---@overload fun(name: string, class: "IllegalObject"): IllegalObject
---@overload fun(name: string, class: nil): Object
function World:FindRecursive(name, class) end
