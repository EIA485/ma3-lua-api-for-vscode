...
---@return T
---@overload fun(class: nil, undo: Undo?): IllegalObject
function Recipe:Find(class, undo) end
---@generic T : IllegalObject
---@param name string
---@param class `T`
---@return T
...
---@overload fun(class: "Preset"): Preset
