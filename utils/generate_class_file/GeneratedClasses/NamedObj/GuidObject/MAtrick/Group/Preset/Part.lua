...
---@field TrackingDistance RelCueNumber
...
---@field IndivFade TimePropertyValue
---@field IndivDelay TimePropertyValue
---@field IndivDuration TimePropertyValue
local Part = {
    Part="0",
    Sync="0",
    Morph="0",
...
---@overload fun(name: "TrackingDistance"|"MIBTarget", role: nil): RelCueNumber
...
---@overload fun(name: "Duration"|"MIBFade"|"MIBDelay"|"IndivFade"|"IndivDelay"|"IndivDuration"|"OffFade", role: nil): TimePropertyValue
...
function Part:FindParent(class) end