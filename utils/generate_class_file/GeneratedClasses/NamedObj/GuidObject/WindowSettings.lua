...
---@overload fun(property_name: "LayerFilterList"|"FixtureTypeFilterList"|"ClassFilterList", property_value: string[])
function WindowSettings:ActiveDisplay(property_name, property_value) end