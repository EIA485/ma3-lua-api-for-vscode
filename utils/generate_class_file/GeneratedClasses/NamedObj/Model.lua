...
---@field DimensionsfollowRatio integer If you edit one dimensions, the other two will follow the original ratio
...
---@overload fun(name: "DimensionsfollowRatio"|"CastShadow"|"IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"Index"|"Count"|"No"|"UserExpanded"|"Hidden"|"MemoryFootprint", role: nil): integer
---@overload fun(name: "File"|"Name"|"Note"|"DependencyExport", role: nil): string
---@overload fun(name: "Length"|"Width"|"Height"|"DimensionsfollowRatio"|"CastShadow"|"Mesh"|"File"|"IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"Index"|"Count"|"No"|"Name"|"Note"|"UserExpanded"|"FaderEnabled"|"Owned"|"Hidden"|"DependencyExport"|"MemoryFootprint", role: Enums.Roles): string
