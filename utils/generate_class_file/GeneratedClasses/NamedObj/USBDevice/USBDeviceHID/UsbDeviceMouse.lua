...
---@param class `T`
---@return boolean
function UsbDeviceMouse:IsClass(class) end
---@return MouseDevices
function UsbDeviceMouse:Parent() end
---@return 20
function UsbDeviceMouse:PropertyCount() end
...
---@overload fun(idx: 18): "DevNode"
---@overload fun(idx: 19): "UsbAddr"
function UsbDeviceMouse:PropertyName(idx) end
...
function UsbDeviceMouse:PropertyInfo(idx) end
...
function UsbDeviceMouse:PropertyType(idx) end
...
---@overload fun(name: "Name"|"Note"|"DependencyExport"|"DevNode"|"UsbAddr", role: nil): string
---@overload fun(name: "IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"Index"|"Count"|"No"|"Name"|"Note"|"UserExpanded"|"FaderEnabled"|"Owned"|"Hidden"|"DependencyExport"|"MemoryFootprint"|"Connected"|"ConnectedCount"|"IP"|"DevNode"|"UsbAddr", role: Enums.Roles): string
...
---@overload fun(property_name: "Name"|"Note"|"DependencyExport"|"DevNode"|"UsbAddr", property_value: string, override_change_level: ChangeLevel?)
function UsbDeviceMouse:Set(property_name, property_value, override_change_level) end