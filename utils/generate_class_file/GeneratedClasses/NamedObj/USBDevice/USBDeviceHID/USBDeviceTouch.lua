...
---@param class `T`
---@return boolean
function USBDeviceTouch:IsClass(class) end
---@return TouchDevices
function USBDeviceTouch:Parent() end
---@return 21
function USBDeviceTouch:PropertyCount() end
...
---@overload fun(idx: 18): "MonitorId"
---@overload fun(idx: 19): "DevNode"
---@overload fun(idx: 20): "UsbAddr"
function USBDeviceTouch:PropertyName(idx) end
...
---@overload fun(idx: 4|5|6|16|17|19|20): {ExportIgnore: True, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 7|8|13|18): {ExportIgnore: False, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 9): {ExportIgnore: False, EnumCollection: YesNo, ReadOnly: True, ImportIgnore: True}
---@overload fun(idx: 10|11): {ExportIgnore: True, EnumCollection: YesNo, ReadOnly: True, ImportIgnore: True}
---@overload fun(idx: 14): {ExportIgnore: False, ReadOnly: True, ImportIgnore: True}
function USBDeviceTouch:PropertyInfo(idx) end
---@overload fun(idx: 0|1|2|3|4|5|6|9|16): "UInt32"
---@overload fun(idx: 7|8|13|18|19|20): "String"
---@overload fun(idx: 10|11|15): "Bool"
---@overload fun(idx: 12): "UInt64"
---@overload fun(idx: 14): "Int64"
---@overload fun(idx: 17): "Custom"
function USBDeviceTouch:PropertyType(idx) end
...
---@overload fun(name: "Name"|"Note"|"DependencyExport"|"MonitorId"|"DevNode"|"UsbAddr", role: nil): string
---@overload fun(name: "IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"Index"|"Count"|"No"|"Name"|"Note"|"UserExpanded"|"FaderEnabled"|"Owned"|"Hidden"|"DependencyExport"|"MemoryFootprint"|"Connected"|"ConnectedCount"|"IP"|"MonitorId"|"DevNode"|"UsbAddr", role: Enums.Roles): string
...
---@overload fun(property_name: "Name"|"Note"|"DependencyExport"|"MonitorId"|"DevNode"|"UsbAddr", property_value: string, override_change_level: ChangeLevel?)
function USBDeviceTouch:Set(property_name, property_value, override_change_level) end