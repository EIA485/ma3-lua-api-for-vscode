...
---@param class `T`
---@return boolean
function Tracker:IsClass(class) end
---@return System
function Tracker:Parent() end
---@return 27
function Tracker:PropertyCount() end
...
---@overload fun(idx: 15): "TrackerID"
---@overload fun(idx: 16): "MArkerID"
---@overload fun(idx: 17): "PositionX"
---@overload fun(idx: 18): "PositionY"
---@overload fun(idx: 19): "PositionZ"
---@overload fun(idx: 20): "SpeedX"
---@overload fun(idx: 21): "SpeedY"
---@overload fun(idx: 22): "SpeedZ"
---@overload fun(idx: 23): "RotX"
---@overload fun(idx: 24): "RotY"
---@overload fun(idx: 25): "RotZ"
---@overload fun(idx: 26): "IsOnline"
function Tracker:PropertyName(idx) end
---@overload fun(idx: 0|1|2): {ExportIgnore: True, EnumCollection: YesNo, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 3|12): {ExportIgnore: False, EnumCollection: YesNo, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 4|5|6|17|18|19|23|24|25): {ExportIgnore: True, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 7|8|13|15|20|21|22): {ExportIgnore: False, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 9): {ExportIgnore: False, EnumCollection: YesNo, ReadOnly: True, ImportIgnore: True}
---@overload fun(idx: 10|11): {ExportIgnore: True, EnumCollection: YesNo, ReadOnly: True, ImportIgnore: True}
---@overload fun(idx: 14): {ExportIgnore: False, ReadOnly: True, ImportIgnore: True}
---@overload fun(idx: 16): {ExportIgnore: False, EnumCollection: FixtureIdEnum, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 26): {ExportIgnore: True, EnumCollection: Yes, ReadOnly: False, ImportIgnore: False}
function Tracker:PropertyInfo(idx) end
---@overload fun(idx: 0|1|2|3|4|5|6|9|15|16|26): "UInt32"
---@overload fun(idx: 7|8|13): "String"
---@overload fun(idx: 10|11): "Bool"
---@overload fun(idx: 12): "UInt64"
---@overload fun(idx: 14): "Int64"
---@overload fun(idx: 17|18|19|20|21|22|23|24|25): "Float"
function Tracker:PropertyType(idx) end
---@overload fun(name: "MArkerID", role: nil): FixtureIdEnum
...
---@overload fun(name: "IsOnline", role: nil): Yes|true
---@overload fun(name: "Index"|"Count"|"No"|"MemoryFootprint"|"TrackerID", role: nil): integer
...
---@overload fun(property_name: "MArkerID", property_value: FixtureIdEnum, override_change_level: ChangeLevel?)
...
---@overload fun(property_name: "IsOnline", property_value: Yes|true, override_change_level: ChangeLevel?)
---@overload fun(property_name: "Index"|"Count"|"No"|"TrackerID", property_value: integer, override_change_level: ChangeLevel?)
---@overload fun(property_name: "PositionX"|"PositionY"|"PositionZ"|"SpeedX"|"SpeedY"|"SpeedZ"|"RotX"|"RotY"|"RotZ", property_value: number, override_change_level: ChangeLevel?)
---@overload fun(property_name: "Name"|"Note"|"DependencyExport", property_value: string, override_change_level: ChangeLevel?)
function Tracker:Set(property_name, property_value, override_change_level) end
...
function Tracker:SetChildren(property_name, property_value) end