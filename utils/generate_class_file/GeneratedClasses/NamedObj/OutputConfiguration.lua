...
---@field Type UsbProductID
---@field SMPTEMode SMPTEMode
---@field SMPTETC SignalSlot
---@field MIDITCMode MIDITCMode
---@field MIDITC SignalSlot
---@field MIDIDataMode MIDIMode
---@field MIDIOffset integer
---@field DCStart SignalOff
...
---@param class `T`
---@return boolean
function OutputConfiguration:IsClass(class) end
---@return OutputStation
function OutputConfiguration:Parent() end
---@return 32
function OutputConfiguration:PropertyCount() end
...
---@overload fun(idx: 16): "SMPTEMode"
---@overload fun(idx: 17): "SMPTETC"
---@overload fun(idx: 18): "MIDITCMode"
---@overload fun(idx: 19): "MIDITC"
---@overload fun(idx: 20): "MIDIDataMode"
---@overload fun(idx: 21): "MIDIOffset"
---@overload fun(idx: 22): "DCStart"
---@overload fun(idx: 23): "XLRPortCount"
---@overload fun(idx: 24): "DmxPortDefaultDirection"
---@overload fun(idx: 25): "TimecodePortsIn"
---@overload fun(idx: 26): "TimecodePortsOut"
---@overload fun(idx: 27): "DCIoPorts"
---@overload fun(idx: 28): "DigitalIoPorts"
---@overload fun(idx: 29): "MidiCount"
---@overload fun(idx: 30): "UsbDeviceIndex"
---@overload fun(idx: 31): "UsbDeviceType"
function OutputConfiguration:PropertyName(idx) end
...
---@overload fun(idx: 7|8|13|21|23|24|25|26|27|28|29|30|31): {ExportIgnore: False, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 9): {ExportIgnore: False, EnumCollection: YesNo, ReadOnly: True, ImportIgnore: True}
---@overload fun(idx: 10|11): {ExportIgnore: True, EnumCollection: YesNo, ReadOnly: True, ImportIgnore: True}
---@overload fun(idx: 14): {ExportIgnore: False, ReadOnly: True, ImportIgnore: True}
---@overload fun(idx: 15): {ExportIgnore: True, EnumCollection: UsbProductID, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 16): {ExportIgnore: False, EnumCollection: SMPTEMode, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 17|19): {ExportIgnore: False, EnumCollection: SignalSlot, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 18): {ExportIgnore: False, EnumCollection: MIDITCMode, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 20): {ExportIgnore: False, EnumCollection: MIDIMode, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 22): {ExportIgnore: False, EnumCollection: SignalOff, ReadOnly: False, ImportIgnore: False}
function OutputConfiguration:PropertyInfo(idx) end
---@overload fun(idx: 0|1|2|3|4|5|6|9|15|16|17|18|19|20|22|23|24|27|28|29|30|31): "UInt32"
---@overload fun(idx: 7|8|13): "String"
---@overload fun(idx: 10|11): "Bool"
---@overload fun(idx: 12): "UInt64"
---@overload fun(idx: 14): "Int64"
---@overload fun(idx: 21): "Int32"
---@overload fun(idx: 25|26): "UInt16"
function OutputConfiguration:PropertyType(idx) end
---@overload fun(name: "MIDIDataMode", role: nil): MIDIMode
---@overload fun(name: "MIDITCMode", role: nil): MIDITCMode
---@overload fun(name: "SMPTEMode", role: nil): SMPTEMode
---@overload fun(name: "DCStart", role: nil): SignalOff
---@overload fun(name: "SMPTETC"|"MIDITC", role: nil): SignalSlot
---@overload fun(name: "Type", role: nil): UsbProductID
...
---@overload fun(name: "Index"|"Count"|"No"|"MemoryFootprint"|"MIDIOffset"|"XLRPortCount"|"DmxPortDefaultDirection"|"TimecodePortsIn"|"TimecodePortsOut"|"DCIoPorts"|"DigitalIoPorts"|"MidiCount"|"UsbDeviceIndex"|"UsbDeviceType", role: nil): integer
---@overload fun(name: "Name"|"Note"|"DependencyExport", role: nil): string
---@overload fun(name: "IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"Index"|"Count"|"No"|"Name"|"Note"|"UserExpanded"|"FaderEnabled"|"Owned"|"Hidden"|"DependencyExport"|"MemoryFootprint"|"Type"|"SMPTEMode"|"SMPTETC"|"MIDITCMode"|"MIDITC"|"MIDIDataMode"|"MIDIOffset"|"DCStart"|"XLRPortCount"|"DmxPortDefaultDirection"|"TimecodePortsIn"|"TimecodePortsOut"|"DCIoPorts"|"DigitalIoPorts"|"MidiCount"|"UsbDeviceIndex"|"UsbDeviceType", role: Enums.Roles): string
...
---@overload fun(property_name: "MIDIDataMode", property_value: MIDIMode, override_change_level: ChangeLevel?)
---@overload fun(property_name: "MIDITCMode", property_value: MIDITCMode, override_change_level: ChangeLevel?)
---@overload fun(property_name: "SMPTEMode", property_value: SMPTEMode, override_change_level: ChangeLevel?)
---@overload fun(property_name: "DCStart", property_value: SignalOff, override_change_level: ChangeLevel?)
---@overload fun(property_name: "SMPTETC"|"MIDITC", property_value: SignalSlot, override_change_level: ChangeLevel?)
---@overload fun(property_name: "Type", property_value: UsbProductID, override_change_level: ChangeLevel?)
...
---@overload fun(property_name: "Index"|"Count"|"No"|"MIDIOffset"|"XLRPortCount"|"DmxPortDefaultDirection"|"TimecodePortsIn"|"TimecodePortsOut"|"DCIoPorts"|"DigitalIoPorts"|"MidiCount"|"UsbDeviceIndex"|"UsbDeviceType", property_value: integer, override_change_level: ChangeLevel?)
---@overload fun(property_name: "Name"|"Note"|"DependencyExport", property_value: string, override_change_level: ChangeLevel?)
function OutputConfiguration:Set(property_name, property_value, override_change_level) end
...
function OutputConfiguration:SetChildren(property_name, property_value) end