...
---@generic T : GridColumnBitFilter
---@param class `T`
---@return boolean
function GridColumnBitFilter:IsClass(class) end
---@return 17
function GridColumnBitFilter:PropertyCount() end
...
function GridColumnBitFilter:PropertyName(idx) end
...
function GridColumnBitFilter:PropertyInfo(idx) end
...
function GridColumnBitFilter:PropertyType(idx) end
...
function GridColumnBitFilter:Set(property_name, property_value, override_change_level) end