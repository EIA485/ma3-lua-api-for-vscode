...
---@field DMXFootprint [DMXBreak, DMXBreak, DMXBreak, DMXBreak, DMXBreak, DMXBreak, DMXBreak, DMXBreak]
---@field RDMPersonalityId string
---@field ConflictCount integer
---@field ConflictSummary string
---@field Used integer
---@field XYZ YesNo|boolean
---@field XYZPossible YesNo|boolean
---@field DiveInto YesNo|boolean
---@field BladeMirror YesNo|boolean
---@field BladePerPrismBeam YesNo|boolean
local DMXMode = {
    RDMPersonalityId="0",
    DiveInto="1",
    BladeMirror="No",
...
---@param class `T`
---@return boolean
function DMXMode:IsClass(class) end
---@return DMXModes
function DMXMode:Parent() end
---@return 28
function DMXMode:PropertyCount() end
...
---@overload fun(class: "NoteTextEdit", undo: Undo?): NoteTextEdit
---@overload fun(class: nil, undo: Undo?): Object
function DMXMode:Find(class, undo) end
---@overload fun(property_name: "Geometry", property_value: Geometry, override_change_level: ChangeLevel?)
---@overload fun(property_name: "IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"Hidden"|"XYZ"|"DiveInto"|"BladeMirror"|"BladePerPrismBeam", property_value: YesNo|boolean, override_change_level: ChangeLevel?)
...
---@overload fun(property_name: "Index"|"Count"|"No"|"TotalFootPrint", property_value: integer, override_change_level: ChangeLevel?)
---@overload fun(property_name: "Name"|"Note"|"DependencyExport"|"RDMPersonalityId", property_value: string, override_change_level: ChangeLevel?)
function DMXMode:Set(property_name, property_value, override_change_level) end
...
function DMXMode:SetChildren(property_name, property_value) end