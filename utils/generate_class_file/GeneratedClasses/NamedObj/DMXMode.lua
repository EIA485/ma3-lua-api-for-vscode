...
---@class DMXMode: NamedObj Describes a possible patch footprint and functional behavior of one type of fixture.
---@field TotalFootPrint integer
---@field Geometry Geometry
---@field GeometryDirect Geometry
---@field DMXFootprint DMXBreak
---@field RDM
PersonalityId string
---@field ConflictCount integer
---@field ConflictSummary string
---@field Used integer
---@field XYZ integer
---@field XYZPossible integer
---@field Dive
Into integer
---@field BladeMirror integer
---@field BladePerPrismBeam integer
local DMXMode = {
    ["RDM
PersonalityId"]="0",
    ["Dive
Into"]="1",
    BladeMirror="No",
    BladePerPrismBeam="No"
}
---@return "DMXMode"
function DMXMode:GetClass() end
---@return "Object"
function DMXMode:GetChildClass() end
---@return DMXModes
function DMXMode:Parent() end
...
---@overload fun(name: "MemoryFootprint"|"TotalFootPrint", role: nil): integer
---@overload fun(name: "Geometry"|"GeometryDirect", role: nil): Geometry
---@overload fun(name: "DMXFootprint", role: nil): DMXBreak
---@overload fun(name: "RDM
PersonalityId", role: nil): string
---@overload fun(name: "ConflictCount", role: nil): integer
---@overload fun(name: "ConflictSummary", role: nil): string
---@overload fun(name: "Used"|"XYZ"|"XYZPossible"|"Dive
Into"|"BladeMirror"|"BladePerPrismBeam", role: nil): integer
---@overload fun(name: "IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"Index"|"Count"|"No"|"Name"|"Note"|"UserExpanded"|"FaderEnabled"|"Owned"|"Hidden"|"DependencyExport"|"MemoryFootprint"|"TotalFootPrint"|"Geometry"|"GeometryDirect"|"DMXFootprint"|"RDM
PersonalityId"|"ConflictCount"|"ConflictSummary"|"Used"|"XYZ"|"XYZPossible"|"Dive
Into"|"BladeMirror"|"BladePerPrismBeam", role: Enums.Roles): string
---@overload fun(name: integer, role: nil): Object
function DMXMode:Get(name, role) end
...
---@overload fun(index: integer, class: "Relations", undo: Undo?): Relations
---@overload fun(index: integer, class: "SubfixtureOverview", undo: Undo?): SubfixtureOverview
---@overload fun(index: integer, class: "SoftwareVersions", undo: Undo?): SoftwareVersions
---@overload fun(index: integer, class: "DMXChannels", undo: Undo?): DMXChannels
---@overload fun(index: integer, class: "FTMacros", undo: Undo?): FTMacros
---@overload fun(index: integer, class: "FTPresets", undo: Undo?): FTPresets
...
function DMXMode:Create(index, class, undo) end
...
---@overload fun(class: "Relations", undo: Undo?, count: integer?): Relations
---@overload fun(class: "SubfixtureOverview", undo: Undo?, count: integer?): SubfixtureOverview
---@overload fun(class: "SoftwareVersions", undo: Undo?, count: integer?): SoftwareVersions
---@overload fun(class: "DMXChannels", undo: Undo?, count: integer?): DMXChannels
---@overload fun(class: "FTMacros", undo: Undo?, count: integer?): FTMacros
---@overload fun(class: "FTPresets", undo: Undo?, count: integer?): FTPresets
...
function DMXMode:Append(class, undo, count) end
...
---@overload fun(class: "Relations", undo: Undo?): Relations
---@overload fun(class: "SubfixtureOverview", undo: Undo?): SubfixtureOverview
---@overload fun(class: "SoftwareVersions", undo: Undo?): SoftwareVersions
---@overload fun(class: "DMXChannels", undo: Undo?): DMXChannels
---@overload fun(class: "FTMacros", undo: Undo?): FTMacros
---@overload fun(class: "FTPresets", undo: Undo?): FTPresets
...
function DMXMode:Acquire(class, undo) end
---@overload fun(class: "Object", undo: Undo?): Object
---@overload fun(class: "MVRxchange", undo: Undo?): MVRxchange
---@overload fun(class: "SmartViewSettingsCollect", undo: Undo?): SmartViewSettingsCollect
---@overload fun(class: "RunningPlaybacksSettingsCollect", undo: Undo?): RunningPlaybacksSettingsCollect
...
function DMXMode:Aquire(class, undo) end
...
---@overload fun(index: integer, class: "Relations", undo: Undo?, count: integer?): Relations
---@overload fun(index: integer, class: "SubfixtureOverview", undo: Undo?, count: integer?): SubfixtureOverview
---@overload fun(index: integer, class: "SoftwareVersions", undo: Undo?, count: integer?): SoftwareVersions
---@overload fun(index: integer, class: "DMXChannels", undo: Undo?, count: integer?): DMXChannels
---@overload fun(index: integer, class: "FTMacros", undo: Undo?, count: integer?): FTMacros
---@overload fun(index: integer, class: "FTPresets", undo: Undo?, count: integer?): FTPresets
...
function DMXMode:Insert(index, class, undo, count) end
...
---@overload fun(name: string, class: "Relations"): Relations
---@overload fun(name: string, class: "SubfixtureOverview"): SubfixtureOverview
---@overload fun(name: string, class: "SoftwareVersions"): SoftwareVersions
---@overload fun(name: string, class: "DMXChannels"): DMXChannels
---@overload fun(name: string, class: "FTMacros"): FTMacros
---@overload fun(name: string, class: "FTPresets"): FTPresets
...
function DMXMode:Find(name, class) end
---@overload fun(name: string, class: "Object"): Object
---@overload fun(name: string, class: "MVRxchange"): MVRxchange
---@overload fun(name: string, class: "SmartViewSettingsCollect"): SmartViewSettingsCollect
---@overload fun(name: string, class: "RunningPlaybacksSettingsCollect"): RunningPlaybacksSettingsCollect
...
---@overload fun(name: string, class: "IllegalObject"): IllegalObject
---@overload fun(name: string, class: nil): Object
function DMXMode:FindRecursive(name, class) end
