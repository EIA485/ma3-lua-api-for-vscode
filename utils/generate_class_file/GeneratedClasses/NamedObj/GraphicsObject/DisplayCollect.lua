...
function DisplayCollect:SetChildren(property_name, property_value) end
...
---@overload fun(property_name: "Iconified"|"DrawGradient"|"AutoSetWindowSettings"|"AllIndexesCollected"|"IsScribbleAvailable"|"IsAppearanceAvailable"|"FadeEncoder"|"UseSpecialTimezone"|"CheckForScreenEncoders"|"IsNoteAvailable"|"ChangeDestination"|"Expanded"|"RestoredRememberedDisplayPosition"|"IsPlaying"|"AllowSorting"|"ScribbleIsEmpty"|"IsCloneDestination"|"Blink", property_value: boolean)
---@overload fun(property_name: "ChangeActive", property_value: fun(childName: string) : boolean)
---@overload fun(property_name: "ExecuteCommandLine"|"ExecuteCommandLineIfEmpty", property_value: fun(command: string) : boolean)
