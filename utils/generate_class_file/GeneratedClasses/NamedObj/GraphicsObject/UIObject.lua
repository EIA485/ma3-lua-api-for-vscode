...
---@overload fun(property_name: "IconsGridAnchors", property_value: Gma3UI.IconsGridAnchors[])
---@overload fun(property_name: "ActiveController", property_value: Gma3UI.WindowFixturetypeVisualizer.ActiveController)
---@overload fun(property_name: "TextOffsetH"|"IconOffsetV"|"TextOffsetV"|"IconOffsetH"|"ScrollBarHeight", property_value: Graphics.SizeDescriptor)
...
---@overload fun(property_name: "MouseButtonType", property_value: MouseButtonTypes)
---@overload fun(property_name: "MoveValueToPart", property_value: MoveValueToPart)
---@overload fun(property_name: "Target"|"EditTarget"|"Target"|"Target"|"ExternScrollPos"|"Target"|"Target"|"AppearanceTarget"|"Target"|"CurrentUpdateObject"|"MainBuddy"|"Target"|"ScrollTarget"|"ScribbleTarget"|"Target"|"WorkingDestination"|"EditTarget"|"Target"|"Target"|"Target"|"Target"|"Target"|"Target"|"TargetObject"|"HistoryProvider"|"TextViewProvider"|"Context"|"Target"|"Target"|"EditTarget"|"Target"|"Target"|"Target"|"TargetObject"|"Target"|"Target"|"ScrollTarget"|"Target", property_value: Object)
---@overload fun(property_name: "SelectedElements", property_value: Object[])
...
---@overload fun(property_name: "Direction"|"Type"|"Direction"|"AutoNextCellDirection"|"ScrollType"|"Type"|"Direction", property_value: ScrollType)
---@overload fun(property_name: "Target", property_value: Sequence)
---@overload fun(property_name: "SetupType", property_value: SetupType)
...
---@overload fun(property_name: "CueStoreOp", property_value: StoreMode)
---@overload fun(property_name: "Icon"|"KnobTexture"|"TriggerTexture"|"SelectionFrame"|"Lasso"|"LockTexture"|"TitleButtonIcon"|"GearTexture"|"CursorTexture"|"SelectionBackgroundTexture"|"OverridesIndicator"|"TextureNormal"|"TextureHover"|"ProgIndicator"|"IndicatorBackTexture"|"SampleTexture"|"IndicatorTexture"|"SelectionTexture"|"ExpandedTexture"|"ContractedTexture"|"DelimiterTexture"|"Icon"|"KnobTexture"|"BrushTexture"|"SelectionTexture"|"SelectedIcon"|"SlotTexture"|"DeselectedIcon"|"UpperTexture"|"SensorTexture"|"SelectionFrame"|"LowerTexture"|"IconActive"|"UpperTexture"|"SelectionTexture"|"OnOffTexture"|"IconInactive"|"LowerTexture"|"LogoIcon"|"BlockerTexture"|"BorderTexture"|"SelectedIcon"|"ExpandedIcon"|"SignalTexture"|"HeadLineTexture"|"DeselectedIcon"|"CollapsedIcon"|"TitleButtonIcon"|"CursorTexture"|"SelectionBackgroundTexture"|"ArrowRight"|"ArrowLeft"|"CountDownIcon"|"OnOffTexture"|"SelectionFrame"|"StopwatchIcon"|"SortAsc"|"IndicatorIcon"|"SortDesc", property_value: Texture)
---@overload fun(property_name: "Icons", property_value: Texture[])
---@overload fun(property_name: "Source", property_value: TimeCodeSource)
...
---@overload fun(property_name: "AutoNextCell"|"ShowFileSegmentDmxProtocols"|"DependsOnLinkedObject"|"TargetIsAppearance"|"SelectionOnFocusOnly"|"DirectCommand"|"ShowNumber"|"FilterByMode"|"DirectQuotation"|"AvoidScroll"|"ShowKeyboardButton"|"Rounded"|"InteractWithCommandline"|"Secret"|"IndicatorBarEnabled"|"TargetIsScribble"|"SetPropertyOnlyOnTextChange"|"ShowLeftIcon"|"CanBeEmbedded"|"ShowRightIcon"|"CalledFromCmdline"|"ShowAdditionalInfo"|"EditTitlebar"|"IgnoreIconForTextAlign"|"ShowLeftScribble"|"ShowRightScribble"|"AllowBlocks"|"SkipTextIfIconExists"|"IsMidiOut"|"ForceSmallMode"|"ItemIndividualCorners"|"State"|"ShowVisibleDay"|"ReactToEdit"|"AutoCloseOnInput"|"WantsModal"|"ReadOnly"|"AutoClose"|"ShowLineNumbers"|"ShowWhiteSpace"|"AutoCloseOnOverlay"|"HighlightCurrentLine"|"IndirectEdit"|"CloseOnEscape"|"NewlineWithSpaces"|"ScrollChangesSelection"|"ForceCursor"|"IncludeTarget"|"InitialSaveEditTarget"|"EditTargetHasChanged"|"ReactToPreview"|"FilterByManufacturer"|"StayAlwaysVisible"|"FilterByName"|"PanScrollArea"|"VisualisableScrollV"|"SmallResizeArea"|"ScrollCellAutomatic"|"PanScroll"|"RelativeToDisplay"|"VisualisableScrollH"|"ScrollCellAutomaticWithOffset"|"ResetChildrenSize"|"EnterToExecute"|"FilterByDescription"|"FilterByUsedOnly"|"AdjustInitialPosition"|"IsMainBuddy"|"UpdateSettingsVisibility"|"UseSimplifiedResize"|"InitialSaveEditTarget"|"BigMode"|"AutoCreateFromProperties"|"DriveReset"|"EditTargetHasChanged"|"OverrideKeybSC"|"UseEditorTarget"|"SuppressModeSwitch"|"ReactToPreview"|"ForceHideCategories"|"ScreenEncoder"|"ReactToEdit"|"UseDynamicIndicatorColor"|"OnlyVisible"|"IsWorldCoordinateSystemActive"|"ResetIfUntargeted"|"TryFitIntoSecondary"|"IsCameraFocusOnSelectedItem"|"EditAllowedDelete"|"Inverted"|"StealFocusAfterSelect"|"Content"|"CmdlineInteraction"|"DrawShortcutInfo"|"TryAvoidZeroes"|"TitleButtonBool"|"TargetCmdlineInteraction"|"TryFitMainIfContentDriven"|"EditAllowedAdd"|"SeparatorSupport"|"CreateAndEdit"|"ModifyTextureLayout"|"AutoClose"|"AddTargets"|"ProvideEmpty"|"Features"|"ObserveSelectionChange"|"MixPercentAndHexDecModesAllowed"|"FeatureGroups"|"AllChannelSets"|"FeatureGroupsOnly"|"ShowFullSettings"|"Toggle"|"ForceFocusOnChange"|"ShowLabel"|"ShowCSHelp"|"DrawInbetweenValues"|"ValueAutoAdjust"|"ShowValue"|"DataAsIs"|"AutoHide"|"WorkWithGrid"|"IndirectEdit"|"IsScribbleNew"|"DirectProperty"|"IsAppearanceNew"|"DefaultAction"|"CharAction"|"Undo"|"ChangeDestination"|"ValueTextShadow"|"HiglightActiveCue"|"WorkWithGrid"|"IgnoreActiveForEnums"|"DimmerCueOnly"|"Auto"|"ShowOldVersions"|"UseCommandlineClick"|"SetIconAsActiveInactive"|"EditNewObject"|"ExclusivePropertyChange"|"UseTabRegistry"|"NoEmptyNames"|"UseGridColor"|"PositionBeneathFinger"|"MixInBackColorFromParentRecursive"|"DefaultAction"|"TrackEdit"|"ExpandContent"|"DefaultMarginOnBorders"|"TrackWorld"|"EncoderUseDisplay"|"SmallMode"|"ShowSelectionCount"|"UseDefaultValue"|"UseComposedText"|"ShowAdditionalInfo"|"ForceFastFade"|"TextChangeOnEnter"|"AutoScrollToEnd"|"AutoEnabled"|"NoEmptyNames"|"CloseProhibited"|"AllowAddContent"|"DisplayLevel"|"AllowAddNewline"|"ReactToRecipeEdit"|"ShowUnpatchedOnly"|"ScrollOpposite"|"AllowedInvisible"|"AllowMergeChildren"|"ShowManualCueSelection"|"ForceCursor"|"AllowEdit"|"ContentChanged"|"PrintCurrentValue"|"DirectQuotation"|"ReactToRecipeEdit"|"LongPressVK"|"CanProvideUiGridSelection"|"AllowFilterContent"|"AutoCloseAllowed"|"PrintMaxValue"|"FilterBlockUIEnabled"|"GapsForExpanded"|"UseUserProfileSettings"|"CloseOnClick"|"ScrollOutEnabled"|"VScrollOnHeader"|"PrimaryHasFocus"|"ConvertCursorToTabAtBoundaries"|"IsInExport"|"ReadOnly"|"DrawContent"|"BackgroundButtonStyle"|"ShowTcSlotAndTcMode"|"ContentStyle"|"KeyRepeatEnabled"|"ShowFileSegmentShowData"|"ShowFileSegmentLocalSettings"|"ShowFileSegmentOutputStations", property_value: YesNo|boolean)
---@overload fun(property_name: "DrawGradient"|"AutoSetWindowSettings"|"AllIndexesCollected"|"IsScribbleAvailable"|"IsAppearanceAvailable"|"FadeEncoder"|"CheckForScreenEncoders"|"UseSpecialTimezone"|"IsNoteAvailable"|"Expanded"|"ChangeDestination"|"IsPlaying"|"AllowSorting"|"ScribbleIsEmpty"|"IsCloneDestination"|"Blink", property_value: boolean)
---@overload fun(property_name: "ChangeActive", property_value: fun(childName: string) : boolean)
...
---@overload fun(property_name: "ResizeStart"|"SGResizeMove"|"Move"|"SGResizeMove"|"SelectCell"|"SelectRange"|"Resize"|"ResizeMove"|"Move", property_value: fun(str: string, int1: integer, int2: integer) : boolean)
---@overload fun(property_name: "TabChanged", property_value: fun(str: string, int1: integer, int2: integer, bool1: boolean, bool2: boolean))
---@overload fun(property_name: "GroupChangedTab", property_value: fun(str: string, int1: integer, int2: integer, bool1: boolean, bool2: boolean) : boolean)
...
---@overload fun(property_name: "Changed", property_value: fun(str: string, value: integer))
---@overload fun(property_name: "Set", property_value: fun(str: string, value: integer) : boolean)
---@overload fun(property_name: "OpenSequenceFilter"|"FlipLeftRight"|"OpenGroupFilter"|"SetText"|"OpenPresetFilter"|"ObtainCurrentCue"|"DoReset"|"AddText"|"InitTargetList"|"InitFirst"|"DoClone"|"InsertText"|"OpenWorldFilter"|"SelectFirst"|"OpenLayoutFilter"|"ChangeCloningViewMode"|"AllItemsToAll"|"AllItemsToNone", property_value: fun(text: string) : boolean)
---@overload fun(property_name: "FrameThickness"|"RasterWidth"|"SpecialExecOffset"|"ScrollCellFrameThickness"|"SelectedColumn"|"LevelDistance"|"Distance"|"UndoCount"|"IncrementFactor"|"ItemSize"|"RedoCount"|"Hour"|"ColumnResizeMaxDeviation"|"VisibleItemCount"|"PatchOffset"|"Mask"|"AutoFitColumn"|"Minute"|"Second"|"FilterMask"|"SlotIndex"|"GridDelta"|"GridVersion"|"Day"|"VisibleFixturesCount"|"HeadLineDimension"|"MaxTextLength"|"LevelLimit"|"SubDestination"|"ButtonDimension"|"Mask"|"SlotDimension"|"Priority"|"Direction"|"Year"|"ColorIndicatorHeight"|"MaxValue"|"LabelAreaHeight"|"MinValue"|"MinCellSize"|"LineHeightAdd"|"IgnoreChildren"|"Page"|"BigModeColumns"|"LineSpacing"|"TitleButtonUInt64"|"MaxValue"|"BigModeRows"|"ExecFrom"|"DelimiterSize"|"SelectedRow"|"Selector"|"FixtureCount"|"ActiveSource"|"ExecBarToDraw"|"TitleButtonInt64"|"FirstRow"|"DefaultMargin"|"TitleButtonPopup"|"LastRow"|"Columns"|"ExecutorIndex"|"Rows"|"BreakIdx"|"Border"|"CellWidth"|"CellHeight"|"PatchOffset"|"ExecutorIndex"|"BlockWidth"|"BlockHeight"|"ShowFileSegmentsMask"|"State"|"OptionHeight"|"ExecutorIndex"|"RasterHeight", property_value: integer)
---@overload fun(property_name: "Value"|"EncoderResolution"|"IconScale"|"CurrentFps"|"ItemPlacementOffsetFactorH"|"Progress"|"ScaleAll"|"ItemPlacementOffsetFactorV"|"RatioAll", property_value: number)
---@overload fun(property_name: "Property"|"DummyComposedText"|"EditEncoderBar"|"ReferencedTitleButton"|"VKPluginName"|"SwipeMenu"|"CurrentSelectedShowFile"|"ControlEncoderBar"|"ForcedInitialTab"|"Destination"|"Prompt"|"Property"|"BuddyGroupId"|"Filter"|"Property"|"Filter"|"ItemType"|"System"|"EmptyText"|"Property"|"Message"|"FuzzyFilter"|"DirectPrefix"|"Cursor"|"TargetPath"|"Property"|"FuzzyFilterExcludeEnd"|"EditEncoderBar"|"BaseFilter"|"ImportOptions"|"PrivacyPolicyUrl"|"InitialTab"|"FixtureToMeasure"|"DirectPrefix"|"System"|"Property"|"FilterComposed"|"Value"|"System"|"TrademarksUrl"|"InitialSubTab"|"WarningTooltip"|"Value"|"ReleaseNotesUrl"|"Value"|"ItemFilter"|"SelectedFile"|"Destination"|"SwipeMenu"|"StrContext"|"BarText"|"TargetPropertyName"|"TextLeftCorner"|"AuxProperty"|"DefaultTitle"|"DataType"|"Property"|"SelectionType"|"EmptyName"|"System"|"InsertType"|"LedToken"|"CellType"|"EditEncoderBar"|"SettingsType"|"Content"|"ControlEncoderBar"|"ActiveChild"|"FixtureName"|"VKTitleHint"|"AdditionalInfo"|"Property"|"Property"|"System", property_value: string)
---@overload fun(property_name: "DependentBuddies", property_value: string[])
---@overload fun(property_name: "AllTitlebuttons", property_value: table<string, TitlebuttonControl[]>)
---@overload fun(property_name: "AdditionalArgs", property_value: table<string, string>)
...
---@overload fun(property_name: "WindowRect", property_value: {left: number, right: number, top: number, bottom: number})
function UIObject:SetChildren(property_name, property_value) end