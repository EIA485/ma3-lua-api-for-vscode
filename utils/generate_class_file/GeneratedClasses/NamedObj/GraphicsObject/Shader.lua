...
---@param class `T`
---@return boolean
function Shader:IsClass(class) end
...
---@return 19
function Shader:PropertyCount() end
...
---@overload fun(idx: 15): "Source"
---@overload fun(idx: 16): "FileName"
---@overload fun(idx: 17): "Version"
---@overload fun(idx: 18): "Macros"
function Shader:PropertyName(idx) end
...
---@overload fun(class: "ShaderProgram"): ShaderProgram
function Shader:FindParent(class) end
...
---@overload fun(property_name: "Name"|"Note"|"DependencyExport"|"Source"|"FileName"|"Version"|"Macros", property_value: string, override_change_level: ChangeLevel?)
function Shader:Set(property_name, property_value, override_change_level) end