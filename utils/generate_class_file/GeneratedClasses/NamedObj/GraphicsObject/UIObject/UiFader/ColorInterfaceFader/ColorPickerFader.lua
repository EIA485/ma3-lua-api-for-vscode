...
---@field DrawInbetweenValues boolean
...
---@overload fun(name: "DrawInbetweenValues"|"DrawGradient"|"UseDynamicIndicatorColor"|"ResetIfUntargeted"|"HasFocus"|"HideFocusFrame"|"FaderEnabled"|"Owned", role: nil): boolean
