...
---@field Direction ScrollType Defines the primary direction to position children (vertical or horizontal)
local Toolbar = {
    Direction="Vertical"
}
---@return "Toolbar"
function Toolbar:GetClass() end
---@return "UIObject"
function Toolbar:GetChildClass() end
