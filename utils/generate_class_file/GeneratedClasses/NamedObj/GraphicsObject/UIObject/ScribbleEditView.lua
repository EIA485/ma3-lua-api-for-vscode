...
---@overload fun(name: "BrushTexture"|"Texture", role: nil): Texture
...
---@overload fun(name: "OnCreateNewScribble"|"DescriptionChanged", role: nil): fun(str: string)
