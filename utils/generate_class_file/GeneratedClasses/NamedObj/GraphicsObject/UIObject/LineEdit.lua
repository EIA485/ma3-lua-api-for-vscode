...
---@overload fun(name: "CursorTexture"|"ArrowRight"|"ArrowLeft", role: nil): Texture
---@overload fun(name: "SelectionColor"|"MessageColor", role: nil): Color
---@overload fun(name: "SelectionBackgroundTexture", role: nil): Texture
---@overload fun(name: "ScrollBarHeight", role: nil): Graphics.SizeDescriptor
---@overload fun(name: "Property"|"VKPluginName"|"VKTitleHint", role: nil): string
---@overload fun(name: "PolicyOnEnter", role: nil): PolicyOnEnter
---@overload fun(name: "TextChangeOnEnter", role: nil): boolean
---@overload fun(name: "Prompt"|"Filter"|"EmptyText"|"Message"|"Content"|"ContentBeforeCursor"|"SelectedContent", role: nil): string
---@overload fun(name: "ForceCursor"|"LongPressVK", role: nil): boolean
---@overload fun(name: "Target"|"HistoryProvider", role: nil): Object
---@overload fun(name: "Execute"|"TextChanged"|"OnWrongChar", role: nil): fun(str: string)
...
---@overload fun(name: "OpenVK"|"SelectAll", role: nil): fun(str: string) : boolean
---@overload fun(name: "SelectRange", role: nil): fun(str: string, int1: integer, int2: integer) : boolean
---@overload fun(name: "DeSelect"|"SetCursorToEnd", role: nil): fun(str: string) : boolean
---@overload fun(name: "ReadOnly"|"KeyRepeatEnabled", role: nil): boolean
---@overload fun(name: "Icon", role: nil): Texture
---@overload fun(name: "IconColor", role: nil): Color
---@overload fun(name: "IconAlignmentH", role: nil): AlignmentH
---@overload fun(name: "IconAlignmentV", role: nil): AlignmentV
---@overload fun(name: "KeyboardIconAlignmentH", role: nil): AlignmentH
---@overload fun(name: "KeyboardIconAlignmentV", role: nil): AlignmentV
---@overload fun(name: "MaxTextLength", role: nil): integer
---@overload fun(name: "ShowKeyboardButton"|"Secret"|"SetPropertyOnlyOnTextChange", role: nil): boolean
...
---@overload fun(index: integer, class: "ShowVKButton", undo: Undo?): ShowVKButton
...
---@overload fun(class: "ShowVKButton", undo: Undo?, count: integer?): ShowVKButton
...
---@overload fun(class: "ShowVKButton", undo: Undo?): ShowVKButton
...
---@overload fun(index: integer, class: "ShowVKButton", undo: Undo?, count: integer?): ShowVKButton
...
---@overload fun(name: string, class: "ShowVKButton"): ShowVKButton
...
function LineEdit:Find(name, class) end
---@overload fun(name: string, class: "UIObject"): UIObject
---@overload fun(name: string, class: "SampleTableView"): SampleTableView
---@overload fun(name: string, class: "FanRpmView"): FanRpmView
---@overload fun(name: string, class: "SysTempView"): SysTempView
...
function LineEdit:FindRecursive(name, class) end
