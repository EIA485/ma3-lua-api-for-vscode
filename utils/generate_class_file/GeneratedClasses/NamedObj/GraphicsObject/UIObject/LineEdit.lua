...
---@overload fun(property_name: "ValueAlignmentV"|"AlignmentV"|"TextAlignmentV"|"IconAlignmentV"|"LogoIconAlignmentV", property_value: AlignmentV)
---@overload fun(property_name: "Appearance", property_value: Appearance)
...
---@overload fun(property_name: "IconsGridAnchors", property_value: Gma3UI.IconsGridAnchors[])
---@overload fun(property_name: "ActiveController", property_value: Gma3UI.WindowFixturetypeVisualizer.ActiveController)
---@overload fun(property_name: "X"|"Y"|"TextOffsetH"|"W"|"H"|"TextOffsetV"|"IconOffsetH"|"IconOffsetV", property_value: Graphics.SizeDescriptor)
...
---@overload fun(property_name: "CueStoreOp", property_value: StoreMode)
---@overload fun(property_name: "BorderTexture"|"CountDownIcon"|"CollapsedIcon"|"OnOffTexture"|"SelectionFrame"|"StopwatchIcon"|"Texture"|"SelectedIcon"|"HeadLineTexture"|"IndicatorIcon"|"SortAsc"|"SortDesc"|"DeselectedIcon"|"KnobTexture"|"TriggerTexture"|"SelectionFrame"|"Lasso"|"LockTexture"|"TitleButtonIcon"|"CursorTexture"|"GearTexture"|"SelectionBackgroundTexture"|"OverridesIndicator"|"TextureNormal"|"TextureHover"|"ProgIndicator"|"IndicatorBackTexture"|"SampleTexture"|"IndicatorTexture"|"SelectionTexture"|"ExpandedTexture"|"ContractedTexture"|"DelimiterTexture"|"Icon"|"KnobTexture"|"BrushTexture"|"SelectionTexture"|"SelectedIcon"|"SlotTexture"|"ExpandedIcon"|"DeselectedIcon"|"UpperTexture"|"SensorTexture"|"SelectionFrame"|"LowerTexture"|"IconActive"|"UpperTexture"|"SelectionTexture"|"OnOffTexture"|"IconInactive"|"LowerTexture"|"LogoIcon"|"BlockerTexture"|"SignalTexture"|"TitleButtonIcon", property_value: Texture)
---@overload fun(property_name: "Icons", property_value: Texture[])
---@overload fun(property_name: "Source", property_value: TimeCodeSource)
...
---@overload fun(property_name: "SGResizeMove"|"ResizeStart"|"Move"|"SGResizeMove"|"SelectCell"|"Resize"|"ResizeMove"|"Move", property_value: fun(str: string, int1: integer, int2: integer) : boolean)
---@overload fun(property_name: "TabChanged", property_value: fun(str: string, int1: integer, int2: integer, bool1: boolean, bool2: boolean))
---@overload fun(property_name: "GroupChangedTab", property_value: fun(str: string, int1: integer, int2: integer, bool1: boolean, bool2: boolean) : boolean)
...
function LineEdit:CurrentTimeView(property_name, property_value) end