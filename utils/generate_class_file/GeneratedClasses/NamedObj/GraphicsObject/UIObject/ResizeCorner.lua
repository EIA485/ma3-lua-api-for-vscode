...
---@class ResizeCorner: UIObject
---@field ResizeStart fun(str: string, int1: integer, int2: integer) your description here
---@field ResizeMove fun(str: string, AbsX: integer, AbsY: integer) 0:AbsX(px);1:AbsY(px)
---@field ResizeEnd fun(str: string, bool: boolean) your description here
local ResizeCorner = {
    ResizeStart="out:ResizeStart(s;i2;i2;)",
    ResizeMove="out:ResizeMove(s;i2;i2;)",
    ResizeEnd="out:ResizeEnd(s;b;)"
}
---@return "ResizeCorner"
function ResizeCorner:GetClass() end
---@return "UIObject"
function ResizeCorner:GetChildClass() end
---@return UILayoutGrid
function ResizeCorner:Parent() end
