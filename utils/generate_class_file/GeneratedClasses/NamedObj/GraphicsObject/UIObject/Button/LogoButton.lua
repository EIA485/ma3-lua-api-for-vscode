...
---@overload fun(property_name: "ValueAlignmentV"|"AlignmentV"|"IconAlignmentV"|"TextAlignmentV"|"IconAlignmentV"|"KeyboardIconAlignmentV", property_value: AlignmentV)
---@overload fun(property_name: "Appearance", property_value: Appearance)
...
function LogoButton:SetPrompt(property_name, property_value) end