...
---@overload fun(name: "LogoIconAlignmentH"|"IconAlignmentH"|"AlignmentH"|"TextAlignmentH", role: nil): AlignmentH
---@overload fun(name: "LogoIconAlignmentV"|"IconAlignmentV"|"AlignmentV"|"TextAlignmentV", role: nil): AlignmentV
---@overload fun(name: "RecipeEditColor"|"IconColor"|"IconHoverColor"|"ActiveBackColor"|"ActiveTextColor"|"ActiveIconColor"|"BackColor"|"TextColor"|"TextShadowColor"|"MixInBackColor"|"HighlightedColor", role: nil): Color
...
---@overload fun(name: "LogoIcon"|"Icon"|"Texture", role: nil): Texture
---@overload fun(name: "LabelLinkHandle", role: nil): UIObject
---@overload fun(name: "UserRights", role: nil): UserRights
---@overload fun(name: "ReactToRecipeEdit"|"IgnoreIconForTextAlign"|"HasFocus"|"HideFocusFrame"|"FaderEnabled"|"Owned", role: nil): boolean
