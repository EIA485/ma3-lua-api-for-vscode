...
---@generic T : RadioItemButtonWithIndicator
---@param class `T`
---@return boolean
function RadioItemButtonWithIndicator:IsClass(class) end
---@return 176
function RadioItemButtonWithIndicator:PropertyCount() end
...
---@overload fun(idx: 171): "SelectedIcon"
---@overload fun(idx: 172): "DeselectedIcon"
---@overload fun(idx: 173): "SelectedIconColor"
---@overload fun(idx: 174): "ProgIndicator"
---@overload fun(idx: 175): "ProgIndicatorBackColor"
function RadioItemButtonWithIndicator:PropertyName(idx) end
...
function RadioItemButtonWithIndicator:PropertyInfo(idx) end
...
---@overload fun(idx: 21|114|155|156|170|171|172|174): "Texture"
---@overload fun(idx: 22|23): "Font"
---@overload fun(idx: 27|28|29|30|31|58|77|115|116|124|125|126|132|151|152|164|165|166|167|168|173|175): "Handle"
...
function RadioItemButtonWithIndicator:PropertyType(idx) end
...
---@overload fun(name: "Texture"|"Icon"|"IconActive"|"IconInactive"|"PinnedIcon"|"SelectedIcon"|"DeselectedIcon"|"ProgIndicator", role: nil): Texture
...
---@overload fun(property_name: "BackColor"|"TextColor"|"TextShadowColor"|"MixInBackColor"|"HighlightedColor"|"IconColor"|"IconHoverColor"|"ActiveBackColor"|"ActiveTextColor"|"ActiveIconColor"|"ValueTextColor"|"ValueActiveTextColor"|"NonEmptyIndicatorColor"|"SelectedBackColor"|"SelectedTextColor"|"EmptyBackColor"|"EmptyTextColor"|"SelectedIconColor"|"ProgIndicatorBackColor", property_value: Color, override_change_level: ChangeLevel?)
...
---@overload fun(property_name: "Texture"|"Icon"|"IconActive"|"IconInactive"|"PinnedIcon"|"SelectedIcon"|"DeselectedIcon"|"ProgIndicator", property_value: Texture, override_change_level: ChangeLevel?)
...
function RadioItemButtonWithIndicator:Set(property_name, property_value, override_change_level) end