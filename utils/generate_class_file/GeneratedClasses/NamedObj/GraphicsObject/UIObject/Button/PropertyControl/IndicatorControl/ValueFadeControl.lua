...
---@overload fun(property_name: "Type"|"Direction"|"ScrollType"|"AutoNextCellDirection"|"Type"|"Direction", property_value: ScrollType)
---@overload fun(property_name: "Target", property_value: Sequence)
---@overload fun(property_name: "SetupType", property_value: SetupType)
...
function ValueFadeControl:SetPrompt(property_name, property_value) end