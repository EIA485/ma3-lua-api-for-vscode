...
---@overload fun(property_name: "AllTitlebuttons", property_value: table<string, TitlebuttonControl[]>)
---@overload fun(property_name: "AdditionalArgs", property_value: table<string, string>)
---@overload fun(property_name: "Margin"|"LabelAreaMargins"|"Anchors"|"ValueAreaMargins"|"ContentAreaMargin"|"Padding", property_value: {left: integer, right: integer, top: integer, bottom: integer})
...
function ToggleButtonList:SetPrompt(property_name, property_value) end