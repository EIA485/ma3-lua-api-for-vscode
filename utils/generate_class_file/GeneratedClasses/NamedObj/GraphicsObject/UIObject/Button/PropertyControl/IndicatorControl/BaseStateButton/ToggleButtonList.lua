...
---@overload fun(name: "DirectCommand"|"DirectQuotation"|"InteractWithCommandline", role: nil): boolean
---@overload fun(name: "DirectPrefix", role: nil): string
---@overload fun(name: "InternalRole", role: nil): ValueRole
...
---@overload fun(name: "OptionHeight", role: nil): integer
---@overload fun(name: "SelectedOptionTextColor"|"SelectedOptionBackColor", role: nil): Color
---@overload fun(name: "OptionAreaMargin", role: nil): {left: integer, right: integer, top: integer, bottom: integer}
