...
---@generic T : StateItemButton
---@param class `T`
---@return boolean
function StateItemButton:IsClass(class) end
---@return 174
function StateItemButton:PropertyCount() end
...
function StateItemButton:PropertyName(idx) end
...
function StateItemButton:PropertyInfo(idx) end
...
---@overload fun(idx: 21|114|155|156|170|171|172): "Texture"
---@overload fun(idx: 22|23): "Font"
---@overload fun(idx: 27|28|29|30|31|58|77|115|116|124|125|126|132|151|152|164|165|166|167|168|173): "Handle"
...
function StateItemButton:PropertyType(idx) end
...
---@overload fun(name: "Texture"|"Icon"|"IconActive"|"IconInactive"|"PinnedIcon"|"SelectedIcon"|"DeselectedIcon", role: nil): Texture
...
---@overload fun(property_name: "BackColor"|"TextColor"|"TextShadowColor"|"MixInBackColor"|"HighlightedColor"|"IconColor"|"IconHoverColor"|"ActiveBackColor"|"ActiveTextColor"|"ActiveIconColor"|"ValueTextColor"|"ValueActiveTextColor"|"NonEmptyIndicatorColor"|"SelectedBackColor"|"SelectedTextColor"|"EmptyBackColor"|"EmptyTextColor"|"SelectedIconColor", property_value: Color, override_change_level: ChangeLevel?)
...
---@overload fun(property_name: "Texture"|"Icon"|"IconActive"|"IconInactive"|"PinnedIcon"|"SelectedIcon"|"DeselectedIcon", property_value: Texture, override_change_level: ChangeLevel?)
...
function StateItemButton:Set(property_name, property_value, override_change_level) end