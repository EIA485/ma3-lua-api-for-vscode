...
---@generic T : SelectionIndicatorButton
---@param class `T`
---@return boolean
function SelectionIndicatorButton:IsClass(class) end
---@return 167
function SelectionIndicatorButton:PropertyCount() end
...
---@overload fun(idx: 165): "OverridesIndicatorBackColor"
---@overload fun(idx: 166): "XYZTextColor"
function SelectionIndicatorButton:PropertyName(idx) end
...
function SelectionIndicatorButton:PropertyInfo(idx) end
...
---@overload fun(idx: 27|28|29|30|31|58|77|115|116|124|125|126|132|151|152|164|165|166): "Handle"
...
function SelectionIndicatorButton:PropertyType(idx) end
...
---@overload fun(name: "BackColor"|"TextColor"|"TextShadowColor"|"MixInBackColor"|"HighlightedColor"|"IconColor"|"IconHoverColor"|"ActiveBackColor"|"ActiveTextColor"|"ActiveIconColor"|"ValueTextColor"|"ValueActiveTextColor"|"NonEmptyIndicatorColor"|"OverridesIndicatorBackColor"|"XYZTextColor", role: nil): Color
...
function SelectionIndicatorButton:Set(property_name, property_value, override_change_level) end
...
function SelectionIndicatorButton:SetChildren(property_name, property_value) end