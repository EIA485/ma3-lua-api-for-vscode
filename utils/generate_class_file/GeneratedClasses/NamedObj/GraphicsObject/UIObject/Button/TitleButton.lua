...
---@overload fun(name: "TrackEdit"|"TrackWorld"|"ShowSelectionCount"|"ShowAdditionalInfo"|"IgnoreIconForTextAlign"|"HasFocus"|"HideFocusFrame"|"FaderEnabled"|"Owned", role: nil): boolean
---@overload fun(name: "MoveStart"|"DescriptionChanged", role: nil): fun(str: string)
...
---@overload fun(name: "MoveEnd"|"OnVisible", role: nil): fun(str: string, bool: boolean)
...
---@overload fun(name: "AdditionalInfo"|"ReferencedTitleButton"|"Text"|"ToolTip"|"HelpTopic"|"SignalValue"|"SignalValueHold"|"AppearanceSourceClassName"|"Name"|"Note"|"DependencyExport", role: nil): string
