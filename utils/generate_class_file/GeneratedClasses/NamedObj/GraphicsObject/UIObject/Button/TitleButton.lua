...
---@class TitleButton: Button A title bar UI control (derived from a button class) with an icon and a defined default font
---@field MoveStart fun(str: string) your description here
---@field Move fun(str: string, DeltaX: integer, DeltaY: integer) 0:DeltaX(px);1:DeltaY(px)
---@field MoveEnd fun(str: string, bool: boolean) your description here
---@field GestureClick fun(str: string, int1: integer, int2: integer, int3: integer, int4: integer) your description here
---@field TrackEdit boolean
---@field TrackWorld boolean
---@field ShowSelectionCount boolean
---@field Settings WindowSettings
---@field ShowAdditionalInfo boolean
---@field AdditionalInfo string
local TitleButton = {
    MoveStart="out:MoveStart(s;)",
    Move="out:Move(s;i2;i2;)",
    MoveEnd="out:MoveEnd(s;b;)",
    GestureClick="out:TitleGestureClick(s;i2;i2;i2;i2;)",
    TrackEdit="No",
    TrackWorld="No",
    ShowSelectionCount="No"
}
---@return "TitleButton"
function TitleButton:GetClass() end
---@return "UIObject"
function TitleButton:GetChildClass() end
