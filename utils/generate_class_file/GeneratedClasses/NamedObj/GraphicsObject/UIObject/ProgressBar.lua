...
---@overload fun(property_name: "Value"|"EncoderResolution"|"IconScale"|"CurrentFps"|"ItemPlacementOffsetFactorH"|"ScaleAll"|"RatioAll"|"ItemPlacementOffsetFactorV", property_value: number)
...
function ProgressBar:SetPrompt(property_name, property_value) end