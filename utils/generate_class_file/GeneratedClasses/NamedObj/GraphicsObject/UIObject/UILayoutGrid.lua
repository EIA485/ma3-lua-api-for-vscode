...
---@field ExpandContent boolean
---@field DefaultMarginOnBorders boolean
---@field MixInBackColorFromParentRecursive boolean
---@field EncoderUseDisplay boolean
...
function UILayoutGrid:Find(name, class) end
---@overload fun(name: string, class: "UIObject"): UIObject
---@overload fun(name: string, class: "SampleTableView"): SampleTableView
---@overload fun(name: string, class: "FanRpmView"): FanRpmView
---@overload fun(name: string, class: "SysTempView"): SysTempView
...
function UILayoutGrid:FindRecursive(name, class) end
---@param index integer
---@return integer
