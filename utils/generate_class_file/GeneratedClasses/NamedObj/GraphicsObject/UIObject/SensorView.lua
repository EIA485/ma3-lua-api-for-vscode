...
---@overload fun(name: "SensorColor"|"WarningColor"|"PeekColor"|"BackColor"|"TextColor"|"TextShadowColor"|"MixInBackColor"|"HighlightedColor", role: nil): Color
...
---@overload fun(name: "SensorTexture"|"Texture", role: nil): Texture
