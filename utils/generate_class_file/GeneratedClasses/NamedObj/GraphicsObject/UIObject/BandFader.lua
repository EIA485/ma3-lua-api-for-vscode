...
---@class BandFader: UIObject
---@field KnobTexture Texture
---@field KnobColor Color
---@field UpperColor Color
---@field LowerColor Color
---@field FaderLocked Color
---@field LowerPressedColor Color
---@field Speed EncoderResolutionType
---@field Resolution AttriebuteEncoderResolution
---@field Target Object
---@field Property string
---@field Direction ScrollType
---@field AutoCloseAllowed boolean
---@field SetPlus fun(str: string) : boolean
---@field SetMinus fun(str: string) : boolean
---@field Value number
local BandFader = {
    KnobTexture="grad_round_h",
    KnobColor="BandFader.Knob",
    UpperColor="BandFader.Background",
    LowerColor="BandFader.StripInactive",
    FaderLocked="BandFader.FaderLocked",
    LowerPressedColor="BandFader.StripActive",
    Speed="Fast",
    Resolution="Coarse",
    Property="Master",
    Direction="Vertical",
    AutoCloseAllowed="No",
    SetPlus="in:SetPlus(s;)",
    SetMinus="in:SetMinus(s;)"
}
---@return "BandFader"
function BandFader:GetClass() end
---@return "UIObject"
function BandFader:GetChildClass() end
