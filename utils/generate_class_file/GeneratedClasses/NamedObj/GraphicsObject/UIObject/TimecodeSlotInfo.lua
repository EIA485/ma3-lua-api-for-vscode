...
---@overload fun(name: "TcFont"|"Font"|"LowDpiFont", role: nil): Font
...
---@overload fun(name: "ShowTcSlotAndTcMode"|"HasFocus"|"HideFocusFrame"|"FaderEnabled"|"Owned", role: nil): boolean
