...
---@overload fun(name: "IndicatorBackColor"|"DefaultCellAltBackColor"|"FixedBackColor"|"FixedTextColor"|"HeaderBackColor"|"HeaderAltBackColor"|"HeaderTextColor"|"SelectedBackColor"|"SelectedTextColor"|"NoCellBackColor"|"ReadOnlyBackColor"|"ReadOnlyAltBackColor"|"ReadOnlyTextColor"|"DefaultValueColor"|"DisabledColor"|"FilterActiveColor"|"BackColor"|"TextColor"|"TextShadowColor"|"MixInBackColor"|"HighlightedColor", role: nil): Color
...
---@overload fun(name: "Indicator"|"IndicatorBack"|"IndicatorFrame"|"Texture", role: nil): Texture
---@overload fun(name: "LabelLinkHandle", role: nil): UIObject
---@overload fun(name: "UserRights", role: nil): UserRights
---@overload fun(name: "WeakAlternationInHeader"|"WeakAlternationInData"|"HasFocus"|"HideFocusFrame"|"FaderEnabled"|"Owned", role: nil): boolean
