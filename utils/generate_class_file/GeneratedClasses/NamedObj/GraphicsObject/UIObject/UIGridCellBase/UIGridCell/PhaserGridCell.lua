...
---@overload fun(name: "Indicator"|"IndicatorBack"|"IndicatorFrame", role: nil): Texture
---@overload fun(name: "IndicatorBackColor", role: nil): Color
---@overload fun(name: "MaxIndicatorSize", role: nil): integer
