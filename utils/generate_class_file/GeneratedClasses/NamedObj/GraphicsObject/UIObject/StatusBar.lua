...
---@class StatusBar: UIObject
---@field ChangeText fun(newTextStr: string) : boolean 0:new text str
local StatusBar = {
    ChangeText="in:(s;)"
}
---@return "StatusBar"
function StatusBar:GetClass() end
---@return "UIObject"
function StatusBar:GetChildClass() end
