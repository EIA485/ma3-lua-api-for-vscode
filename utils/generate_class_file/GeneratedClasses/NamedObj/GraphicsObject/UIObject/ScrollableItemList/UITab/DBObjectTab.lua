...
---@field IncludeTarget boolean Defines if a target object itself should be a tab
local DBObjectTab = {
    IncludeTarget="Yes"
}
---@return "DBObjectTab"
...
---@overload fun(name: "TargetObject"|"Target", role: nil): Object
