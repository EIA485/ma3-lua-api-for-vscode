...
---@class UITab: ScrollableItemList
---@field TabChanged fun(str: string, int1: integer, int2: integer, bool1: boolean, bool2: boolean)
---@field TabClickedOnCurrent fun(str: string, int1: integer, int2: integer, bool: boolean)
---@field SelectedTextColor Color Color of the text of the selected tab
---@field SelectedBackColor Color Color of the background of the selected tab
---@field AdditionalInfoTextColor Color Color of the additional Info sometimes shown in the Corner of a UITab Button
---@field DividerColor Color Color of the divider line
---@field UseTabRegistry boolean
---@field Target Object
---@field Property string
local UITab = {
    TabChanged="out:(s;u8;u4;b;b;)",
    TabClickedOnCurrent="out:(s;u8;u4;b;)",
    SelectedTextColor="UITab.SelectedText",
    SelectedBackColor="UITab.SelectedBackground",
    AdditionalInfoTextColor="UITab.AdditionalInfoText",
    DividerColor="UITab.Divider",
    UseTabRegistry="No"
}
---@return "UITab"
function UITab:GetClass() end
---@return "UIObject"
function UITab:GetChildClass() end
