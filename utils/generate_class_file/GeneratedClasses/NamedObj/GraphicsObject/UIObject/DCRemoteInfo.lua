...
---@overload fun(name: "UpperColor"|"LowerColor"|"BackColor"|"TextColor"|"TextShadowColor"|"MixInBackColor"|"HighlightedColor", role: nil): Color
...
---@overload fun(name: "UpperTexture"|"LowerTexture"|"Texture", role: nil): Texture
