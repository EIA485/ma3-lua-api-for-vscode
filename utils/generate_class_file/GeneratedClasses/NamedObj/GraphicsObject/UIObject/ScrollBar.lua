...
---@field ScrollOpposite boolean
local ScrollBar = {
    ScrollEntity="Area",
    ScrollOpposite="Yes"
}
---@return "ScrollBar"
function ScrollBar:GetClass() end
---@return "UIObject"
function ScrollBar:GetChildClass() end
