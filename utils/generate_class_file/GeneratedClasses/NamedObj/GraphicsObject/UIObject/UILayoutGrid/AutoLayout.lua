...
---@field Direction ScrollType Defines the primary direction to position children (vertical or horizontal or auto)
---@field GroupedCellsCount integer Defines amount of children per row/column (depending on the direction)
---@field SideSize integer Defines a size in pixels of the row (if a direction is horizontal) or column (if a direction is vertical)
...
---@field OnlyVisible boolean Defines if a place in the grid should be reserved for invisible children
---@field Inverted boolean In case of horizontal direction it will be from right to left, in case of vertical direction it will be from bottom to top
---@field Content boolean Columns/Rows will not be stretched but content-dependent
---@field TryAvoidZeroes boolean
---@field TryFitMainIfContentDriven boolean
---@field TryFitIntoSecondary boolean
---@field SeparatorSupport boolean
---@field ModifyTextureLayout boolean Texture Layout will modified
...
function AutoLayout:Find(name, class) end
---@overload fun(name: string, class: "UIObject"): UIObject
---@overload fun(name: string, class: "SampleTableView"): SampleTableView
---@overload fun(name: string, class: "FanRpmView"): FanRpmView
---@overload fun(name: string, class: "SysTempView"): SysTempView
...
function AutoLayout:FindRecursive(name, class) end
