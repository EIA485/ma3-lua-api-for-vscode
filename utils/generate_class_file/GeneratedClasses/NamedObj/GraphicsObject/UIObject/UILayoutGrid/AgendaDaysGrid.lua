...
---@overload fun(property_name: "Mode", property_value: CalculatorMode|DatumMode|ShowfileSelectorMode|BlinkingButtonMode)
...
function AgendaDaysGrid:SetPrompt(property_name, property_value) end