...
---@class PresetPoolLayoutGrid: PoolLayoutGrid
---@field PresetPoolType integer
local PresetPoolLayoutGrid = {}
---@return "PresetPoolLayoutGrid"
function PresetPoolLayoutGrid:GetClass() end
---@return "PresetPoolButton"
function PresetPoolLayoutGrid:GetChildClass() end
---@param index integer
---@return PresetPoolButton
function PresetPoolLayoutGrid:Ptr(index) end
---@return PresetPoolButton[]
function PresetPoolLayoutGrid:Children() end
---@return PresetPoolButton?
function PresetPoolLayoutGrid:CurrentChild() end
...
---@overload fun(name: "PresetPoolType"|"DefaultMargin"|"Columns"|"Rows"|"CellWidth"|"CellHeight"|"BlockWidth"|"BlockHeight"|"TextVertical"|"TextAutoAdjust"|"TextUniform"|"FrameWidth"|"Visible"|"CanCoExistWithModal"|"UserVisible"|"Enabled"|"Interactive"|"Transparent"|"BlockClickThru"|"UserInteracted"|"HasHover"|"Separator"|"HasPressedAnimation"|"ContentDriven"|"ContentWidth"|"ContentHeight"|"ForceContentMin"|"WantsNumericRedirect"|"AutoCloseValue"|"UiGroupId"|"IgnoreBackdropPadding"|"MixInBackColorFromParent"|"FocusSearchPolicy"|"IgnoreRequestedSize"|"ForceEncoderBar"|"SuppressOverlayAutoClose"|"IsClosing"|"TextShadow"|"VisibleOnlyInAlpha"|"VisibleOnlyInBeta"|"VisibleOnlyInRelease"|"ClickNearest"|"VisibleInAlpha"|"VisibleInBeta"|"VisibleInRelease"|"ForceIntensity"|"IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"Index"|"Count"|"No"|"UserExpanded"|"Hidden"|"MemoryFootprint", role: nil): integer
...
function PresetPoolLayoutGrid:Aquire(class, undo) end
---@generic T : PresetPoolButton
---@param index integer
---@param class `T`
---@param undo Undo?
---@param count integer?
---@return T
---@overload fun(index: integer, class: nil, undo: Undo?, count: integer?): PresetPoolButton
function PresetPoolLayoutGrid:Insert(index, class, undo, count) end
---@generic T : PresetPoolButton
---@param class `T`
---@param undo Undo?
---@return T
---@overload fun(class: nil, undo: Undo?): PresetPoolButton
function PresetPoolLayoutGrid:Find(class, undo) end