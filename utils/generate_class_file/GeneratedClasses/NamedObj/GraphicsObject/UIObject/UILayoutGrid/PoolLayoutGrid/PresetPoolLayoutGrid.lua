...
---@overload fun(name: string, class: nil): PresetPoolButton
function PresetPoolLayoutGrid:Find(name, class) end
---@overload fun(name: string, class: "PresetPoolButton"): PresetPoolButton
---@overload fun(name: string, class: nil): Object
function PresetPoolLayoutGrid:FindRecursive(name, class) end
