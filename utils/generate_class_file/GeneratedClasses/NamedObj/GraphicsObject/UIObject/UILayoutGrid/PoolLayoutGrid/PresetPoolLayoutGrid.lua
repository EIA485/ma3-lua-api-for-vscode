...
---@generic T : PresetPoolLayoutGrid
---@param class `T`
---@return boolean
function PresetPoolLayoutGrid:IsClass(class) end
---@param index integer
---@return PresetPoolButton
...
---@return 141
function PresetPoolLayoutGrid:PropertyCount() end
...
---@overload fun(idx: 140): "PresetPoolType"
function PresetPoolLayoutGrid:PropertyName(idx) end
...
---@overload fun(idx: 140): {ExportIgnore: False, EnumCollection: DynamicPresetPool, ReadOnly: False, ImportIgnore: False}
function PresetPoolLayoutGrid:PropertyInfo(idx) end
---@overload fun(idx: 0|1|2|3|4|5|6|9|119|120|140): "UInt32"
...
function PresetPoolLayoutGrid:PropertyType(idx) end
