...
---@field AutoClose integer The Dialog closes by itself when selection is done.
---@field ProvideEmpty integer The Dialog provides the option 'empty'.
...
---@overload fun(name: "ActiveSource", role: nil): integer
---@overload fun(name: "Target", role: nil): Object
---@overload fun(name: "TargetPropertyName", role: nil): string
---@overload fun(name: "AutoClose"|"ProvideEmpty", role: nil): integer
---@overload fun(name: "EmptyName", role: nil): string
...
---@overload fun(index: integer, class: "AssignmentUITab", undo: Undo?): AssignmentUITab
...
---@overload fun(class: "AssignmentUITab", undo: Undo?, count: integer?): AssignmentUITab
...
---@overload fun(class: "AssignmentUITab", undo: Undo?): AssignmentUITab
...
---@overload fun(index: integer, class: "AssignmentUITab", undo: Undo?, count: integer?): AssignmentUITab
...
---@overload fun(name: string, class: "AssignmentUITab"): AssignmentUITab
...
function GenericAssignmentSelector:Find(name, class) end
---@overload fun(name: string, class: "UIObject"): UIObject
---@overload fun(name: string, class: "SampleTableView"): SampleTableView
---@overload fun(name: string, class: "FanRpmView"): FanRpmView
---@overload fun(name: string, class: "SysTempView"): SysTempView
...
function GenericAssignmentSelector:FindRecursive(name, class) end
