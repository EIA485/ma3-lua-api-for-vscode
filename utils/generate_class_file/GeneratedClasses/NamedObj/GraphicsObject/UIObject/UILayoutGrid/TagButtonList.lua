...
---@generic T : TagButtonList
---@param class `T`
---@return boolean
function TagButtonList:IsClass(class) end
---@param index integer
---@return TagButton
...
---@return 129
function TagButtonList:PropertyCount() end
...
function TagButtonList:PropertyName(idx) end
...
function TagButtonList:PropertyInfo(idx) end
...
function TagButtonList:PropertyType(idx) end
