...
---@overload fun(name: string, class: nil): TagButton
function TagButtonList:Find(name, class) end
---@overload fun(name: string, class: "TagButton"): TagButton
---@overload fun(name: string, class: nil): Object
function TagButtonList:FindRecursive(name, class) end
