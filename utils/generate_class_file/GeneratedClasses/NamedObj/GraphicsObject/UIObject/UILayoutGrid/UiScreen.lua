...
---@field ViewW RequestedSize
---@field ViewH RequestedSize
local UiScreen = {
...
---@param class `T`
---@return boolean
function UiScreen:IsClass(class) end
---@param index integer
---@return Window
...
---@return 138
function UiScreen:PropertyCount() end
...
---@overload fun(idx: 128): "DelimiterTexture"
---@overload fun(idx: 129): "DelimiterColor"
---@overload fun(idx: 130): "ActiveDelimiterColor"
---@overload fun(idx: 131): "DelimiterSize"
---@overload fun(idx: 132): "SelectionFrame"
---@overload fun(idx: 133): "BlockerTexture"
---@overload fun(idx: 134): "BlockerColor"
---@overload fun(idx: 135): "WindowRect"
---@overload fun(idx: 136): "ViewW"
---@overload fun(idx: 137): "ViewH"
function UiScreen:PropertyName(idx) end
...
---@overload fun(idx: 136|137): {ExportIgnore: False, EnumCollection: RequestedSize, ReadOnly: False, ImportIgnore: False}
function UiScreen:PropertyInfo(idx) end
...
---@overload fun(idx: 19|20|67|68|135): "Custom"
---@overload fun(idx: 21|128|132|133): "Texture"
---@overload fun(idx: 22|23): "Font"
---@overload fun(idx: 27|28|29|30|31|58|77|129|130|134): "Handle"
---@overload fun(idx: 35|114|115|116|117|118|131|136|137): "Int16"
...
function UiScreen:PropertyType(idx) end
...
---@overload fun(name: "BackColor"|"TextColor"|"TextShadowColor"|"MixInBackColor"|"HighlightedColor"|"DelimiterColor"|"ActiveDelimiterColor"|"BlockerColor", role: nil): Color
...
---@overload fun(name: "ViewW"|"ViewH", role: nil): RequestedSize
---@overload fun(name: "Texture"|"DelimiterTexture"|"SelectionFrame"|"BlockerTexture", role: nil): Texture
...
---@overload fun(name: "Index"|"Count"|"No"|"MemoryFootprint"|"FrameWidth"|"AutoCloseValue"|"UiGroupId"|"ForceIntensity"|"DefaultMargin"|"Columns"|"Rows"|"CellWidth"|"CellHeight"|"BlockWidth"|"BlockHeight"|"DelimiterSize", role: nil): integer
...
---@overload fun(name: "AbsRect"|"AbsClientRect"|"WindowRect", role: nil): {left: number, right: number, top: number, bottom: number}
...
---@overload fun(property_name: "BackColor"|"TextColor"|"TextShadowColor"|"MixInBackColor"|"HighlightedColor"|"DelimiterColor"|"ActiveDelimiterColor"|"BlockerColor", property_value: Color, override_change_level: ChangeLevel?)
...
---@overload fun(property_name: "ViewW"|"ViewH", property_value: RequestedSize, override_change_level: ChangeLevel?)
---@overload fun(property_name: "Texture"|"DelimiterTexture"|"SelectionFrame"|"BlockerTexture", property_value: Texture, override_change_level: ChangeLevel?)
...
---@overload fun(property_name: "Index"|"Count"|"No"|"FrameWidth"|"AutoCloseValue"|"UiGroupId"|"ForceIntensity"|"DefaultMargin"|"Columns"|"Rows"|"CellWidth"|"CellHeight"|"BlockWidth"|"BlockHeight"|"DelimiterSize", property_value: integer, override_change_level: ChangeLevel?)
...
---@overload fun(property_name: "AbsRect"|"AbsClientRect"|"WindowRect", property_value: {left: number, right: number, top: number, bottom: number}, override_change_level: ChangeLevel?)
function UiScreen:Set(property_name, property_value, override_change_level) end
...
---@overload fun(property_name: "ScrollTarget", property_value: Object)
...
---@overload fun(property_name: "PreviewMixInColor"|"EditMixInNotOwnerColor"|"EditMixInColor", property_value: Color)
---@overload fun(property_name: "Layout", property_value: Layout)
---@overload fun(property_name: "ScrollTarget", property_value: Object)
---@overload fun(property_name: "Target", property_value: Sequence)
---@overload fun(property_name: "WindowAppearance", property_value: WindowAppearance)
