...
---@overload fun(property_name: "DrawGradient"|"AllIndexesCollected"|"IsScribbleAvailable"|"IsAppearanceAvailable"|"FadeEncoder"|"CheckForScreenEncoders"|"UseSpecialTimezone"|"IsNoteAvailable"|"Expanded"|"ChangeDestination"|"IsPlaying"|"AllowSorting"|"ScribbleIsEmpty"|"Blink"|"IsCloneDestination", property_value: boolean)
---@overload fun(property_name: "ChangeActive", property_value: fun(childName: string) : boolean)
...
function TitleAutoLayout:SetPrompt(property_name, property_value) end