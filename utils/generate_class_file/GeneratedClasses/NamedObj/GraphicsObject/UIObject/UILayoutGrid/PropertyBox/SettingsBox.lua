...
---@class SettingsBox: PropertyBox
---@field SaveToDefault fun(str: string) : boolean
---@field LoadFromDefault fun(str: string) : boolean
local SettingsBox = {
    SaveToDefault="in:(s;)",
    LoadFromDefault="in:(s;)"
}
---@return "SettingsBox"
function SettingsBox:GetClass() end
---@return "UIObject"
function SettingsBox:GetChildClass() end
