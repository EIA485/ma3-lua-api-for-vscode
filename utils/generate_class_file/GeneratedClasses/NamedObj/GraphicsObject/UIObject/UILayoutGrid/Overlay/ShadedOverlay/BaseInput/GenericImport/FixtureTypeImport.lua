...
---@overload fun(name: "FilterChanged"|"DescriptionChanged", role: nil): fun(str: string)
---@overload fun(name: "SelectedManufacturer"|"SelectedFixture"|"RememberSelection"|"InitGrids"|"MoveStart"|"ResizeEnd", role: nil): fun(str: string) : boolean
