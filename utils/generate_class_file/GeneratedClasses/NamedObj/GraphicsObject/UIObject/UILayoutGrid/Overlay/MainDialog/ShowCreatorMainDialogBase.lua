...
---@overload fun(property_name: "Settings", property_value: PSRPatchSheetSettings|CloningWindowSettings)
...
---@overload fun(property_name: "DrawGradient"|"AutoSetWindowSettings"|"IsScribbleAvailable"|"IsAppearanceAvailable"|"FadeEncoder"|"CheckForScreenEncoders"|"UseSpecialTimezone"|"IsNoteAvailable"|"Expanded"|"ChangeDestination"|"IsPlaying"|"AllowSorting"|"ScribbleIsEmpty"|"Blink"|"IsCloneDestination", property_value: boolean)
---@overload fun(property_name: "ChangeActive", property_value: fun(childName: string) : boolean)
...
function ShowCreatorMainDialogBase:SetPrompt(property_name, property_value) end