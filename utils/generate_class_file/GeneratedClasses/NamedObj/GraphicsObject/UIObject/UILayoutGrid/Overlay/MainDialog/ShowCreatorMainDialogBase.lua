...
---@overload fun(name: "OnCheckSubPoolSelector"|"OnSelectDataPool"|"OnCollectAllIndexes"|"MoveStart"|"ResizeEnd", role: nil): fun(str: string) : boolean
