...
---@class ThemeMergeDialog: MainDialog
---@field PrimaryHasFocus boolean
---@field IsInExport boolean
---@field JumpToNextLine fun(str: string, int: integer) : boolean Action to select the next line that differs
---@field JumpToPreviousLine fun(str: string, int: integer) : boolean Action to select the previews line that differs
---@field AddMissingLines fun(str: string, int: integer) : boolean Action to add missing lines
---@field AddSelectedLines fun(str: string, int: integer) : boolean Action to add selected lines
local ThemeMergeDialog = {
    PrimaryHasFocus="Yes",
    IsInExport="false",
    JumpToNextLine="in:(s;u8;)",
    JumpToPreviousLine="in:(s;u8;)",
    AddMissingLines="in:(s;u8;)",
    AddSelectedLines="in:(s;u8;)"
}
---@return "ThemeMergeDialog"
function ThemeMergeDialog:GetClass() end
---@return "UIObject"
function ThemeMergeDialog:GetChildClass() end
