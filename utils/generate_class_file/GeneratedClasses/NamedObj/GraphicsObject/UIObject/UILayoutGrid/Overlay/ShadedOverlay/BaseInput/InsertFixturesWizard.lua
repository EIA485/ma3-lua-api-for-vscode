...
---@overload fun(name: "FixtureName", role: nil): string
---@overload fun(name: "FixtureLayer", role: nil): FixtureLayer
---@overload fun(name: "FixtureClass", role: nil): Class
---@overload fun(name: "FixtureQuantity", role: nil): integer
---@overload fun(name: "FixtureIDType", role: nil): IDs
---@overload fun(name: "FixtureFID"|"FixtureCID"|"PatchOffset", role: nil): integer
