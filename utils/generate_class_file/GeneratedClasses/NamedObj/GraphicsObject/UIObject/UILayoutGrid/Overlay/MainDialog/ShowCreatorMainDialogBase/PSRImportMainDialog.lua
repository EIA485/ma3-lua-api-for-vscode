...
---@overload fun(name: "OnSelectedTreeItem"|"OnScrolledTreeItem"|"OnCheckSubPoolSelector"|"OnSelectDataPool"|"OnCollectAllIndexes"|"MoveStart"|"ResizeEnd", role: nil): fun(str: string) : boolean
