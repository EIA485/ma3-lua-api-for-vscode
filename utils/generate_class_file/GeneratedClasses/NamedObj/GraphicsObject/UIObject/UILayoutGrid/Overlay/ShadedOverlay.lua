...
---@overload fun(index: integer, class: "ImageImport", undo: Undo?): ImageImport
...
---@overload fun(class: "ImageImport", undo: Undo?, count: integer?): ImageImport
...
---@overload fun(class: "ImageImport", undo: Undo?): ImageImport
...
---@overload fun(index: integer, class: "ImageImport", undo: Undo?, count: integer?): ImageImport
...
---@overload fun(name: string, class: "ImageImport"): ImageImport
...
function ShadedOverlay:Find(name, class) end
---@overload fun(name: string, class: "UIObject"): UIObject
---@overload fun(name: string, class: "SampleTableView"): SampleTableView
---@overload fun(name: string, class: "FanRpmView"): FanRpmView
---@overload fun(name: string, class: "SysTempView"): SysTempView
...
function ShadedOverlay:FindRecursive(name, class) end
