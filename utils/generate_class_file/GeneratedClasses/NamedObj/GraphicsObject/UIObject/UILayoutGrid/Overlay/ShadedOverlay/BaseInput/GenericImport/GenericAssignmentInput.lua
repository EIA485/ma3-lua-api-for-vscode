...
---@overload fun(name: "OnSpecialButtonClicked"|"MoveStart"|"ResizeEnd", role: nil): fun(str: string) : boolean
...
---@overload fun(name: "FilterComposed"|"Value"|"StrContext"|"EditEncoderBar"|"ControlEncoderBar"|"BuddyGroupId"|"Text"|"ToolTip"|"HelpTopic"|"SignalValue"|"SignalValueHold"|"AppearanceSourceClassName"|"Name"|"Note"|"DependencyExport", role: nil): string
