...
---@overload fun(name: "SaveEditTarget"|"RevertEditTarget"|"MoveStart"|"ResizeEnd", role: nil): fun(str: string) : boolean
...
---@overload fun(name: "DefaultTitle"|"EditEncoderBar"|"ControlEncoderBar"|"BuddyGroupId"|"Text"|"ToolTip"|"HelpTopic"|"SignalValue"|"SignalValueHold"|"AppearanceSourceClassName"|"Name"|"Note"|"DependencyExport", role: nil): string
