...
---@overload fun(property_name: "Mode", property_value: CalculatorMode|DatumMode|GridModeAgenda|BlinkingButtonMode)
...
function BackupMenu:SetPrompt(property_name, property_value) end