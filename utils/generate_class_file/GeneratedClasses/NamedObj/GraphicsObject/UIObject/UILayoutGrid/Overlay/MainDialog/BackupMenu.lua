...
---@overload fun(name: "ShowFileSegmentsMask"|"ShowFileSegmentShowData"|"ShowFileSegmentLocalSettings"|"ShowFileSegmentOutputStations"|"ShowFileSegmentDmxProtocols", role: nil): integer
