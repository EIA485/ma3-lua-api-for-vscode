...
---@overload fun(name: "CurrentUpdateObject"|"MainBuddy"|"WorkingDestination"|"ReturnDestination", role: nil): Object
...
---@overload fun(name: "CheckAutoClose"|"MoveStart"|"ResizeEnd", role: nil): fun(str: string) : boolean
