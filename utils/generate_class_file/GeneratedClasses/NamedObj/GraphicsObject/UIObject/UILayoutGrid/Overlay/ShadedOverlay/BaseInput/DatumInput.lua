...
---@overload fun(property_name: "Mode", property_value: GridModeAgenda|CalculatorMode|ShowfileSelectorMode|BlinkingButtonMode)
...
function DatumInput:SetPrompt(property_name, property_value) end