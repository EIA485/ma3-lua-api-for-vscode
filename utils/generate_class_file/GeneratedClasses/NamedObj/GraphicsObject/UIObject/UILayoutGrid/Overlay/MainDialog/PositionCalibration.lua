...
---@overload fun(name: "StoreP1"|"CallP1"|"StoreP2"|"CallP2"|"StoreP3"|"CallP3"|"StoreP4"|"CallP4"|"Solve"|"Close"|"CloseConfirm"|"CloseCancel", role: nil): fun(dummyStr: string) : boolean
