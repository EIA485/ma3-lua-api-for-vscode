...
---@overload fun(property_name: "ChangeActive", property_value: fun(childName: string) : boolean)
---@overload fun(property_name: "OnTitleClick"|"Close"|"OnTitleClick"|"OnTitleClick"|"CloseConfirm"|"CloseCancel", property_value: fun(dummyStr: string) : boolean)
...
function PositionCalibration:SetPrompt(property_name, property_value) end