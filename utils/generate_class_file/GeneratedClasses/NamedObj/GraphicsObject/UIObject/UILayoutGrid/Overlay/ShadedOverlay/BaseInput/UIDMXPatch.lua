...
---@class UIDMXPatch: BaseInput
---@field OnBreakSelected fun(dummyStr: string, column: integer, row: integer) : boolean 0:dummy str, 1:column id uint64_t, 2:row id uint64_t
---@field OnBreakPatched fun(dummyStr: string, column: integer, row: integer) : boolean 0:dummy str, 1:column id uint64_t, 2:row id uint64_t
---@field OnAddressSelected fun(dummyStr: string, column: integer, row: integer) : boolean 0:dummy str, 1:column id uint64_t, 2:row id uint64_t
---@field OnUnpatchClicked fun(dummyStr: string, button: MouseButtonTypes, X: integer, Y: integer) : boolean 0:dummy str, 1:button type uint8_t, 2:X pixel_t, 3:Y pixel_t
---@field OnPatchToClicked fun(dummyStr: string, button: MouseButtonTypes, X: integer, Y: integer) : boolean 0:dummy str, 1:button type uint8_t, 2:X pixel_t, 3:Y pixel_t
---@field SelectAbsoluteAddress fun(str: string, int: AbsoluteAddress) : boolean 0:dummy str, 1:abs addr
---@field OnPatchToNextFree fun(str: string) : boolean
---@field OnMoveToUniverse fun(str: string) : boolean
---@field BreakIdx integer
---@field FixtureCount integer
---@field DMXMode DMXMode
---@field PatchOffset integer
local UIDMXPatch = {
    OnBreakSelected="in:OnBreakSelected(s;u8;u8;)",
    OnBreakPatched="in:OnBreakPatched(s;u8;u8;)",
    OnAddressSelected="in:OnAddressSelected(s;u8;u8;)",
    OnUnpatchClicked="in:OnUnpatchClicked(s;u1;i2;i2;)",
    OnPatchToClicked="in:OnPatchToClicked(s;u1;i2;i2;)",
    SelectAbsoluteAddress="in:(s;i4;)",
    OnPatchToNextFree="in:PatchToNextFree(s;)",
    OnMoveToUniverse="in:(s;)",
    BreakIdx="0",
    FixtureCount="0",
    PatchOffset="1"
}
---@return "UIDMXPatch"
function UIDMXPatch:GetClass() end
---@return "UIObject"
function UIDMXPatch:GetChildClass() end
