...
---@field AdditionalArgs table<string, string>
---@field ExclusivePropertyChange YesNo|boolean Property will not be changed by PropertyBase-job afterwards
---@field PositionBeneathFinger YesNo|boolean Input will be opened beneath finger instead beside
local BaseInput = {
...
---@param class `T`
---@return boolean
function BaseInput:IsClass(class) end
---@return 166
function BaseInput:PropertyCount() end
...
function BaseInput:PropertyName(idx) end
...
function BaseInput:PropertyInfo(idx) end
...
function BaseInput:PropertyType(idx) end
...
function BaseInput:Set(property_name, property_value, override_change_level) end
...
function BaseInput:SetChildren(property_name, property_value) end