...
---@class MessageBox: ShadedOverlay
---@field OnInput fun(str: string) : boolean
---@field OnState fun(str: string) : boolean
---@field OnCommand fun(str: string) : boolean
---@field OnTitle fun(str: string) : boolean
---@field OnFocusGet fun(str: string, obj: Object) : boolean
---@field OnFocusLost fun(str: string) : boolean
---@field State boolean
---@field Selector integer
---@field AutoCloseOnInput boolean
local MessageBox = {
    OnInput="in:OnInput(s;)",
    OnState="in:OnState(s;)",
    OnCommand="in:OnCommand(s;)",
    OnTitle="in:OnTitle(s;)",
    OnFocusGet="in:MBFocusGet(s;o;)",
    OnFocusLost="in:MBFocusLost(s;)",
    AutoCloseOnInput="Yes"
}
---@return "MessageBox"
function MessageBox:GetClass() end
---@return "UIObject"
function MessageBox:GetChildClass() end
