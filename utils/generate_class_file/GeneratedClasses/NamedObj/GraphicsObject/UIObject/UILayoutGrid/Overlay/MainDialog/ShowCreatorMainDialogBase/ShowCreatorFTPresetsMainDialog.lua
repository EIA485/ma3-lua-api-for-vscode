...
---@overload fun(name: "OnFixtureSourceChanged"|"OnCheckSubPoolSelector"|"OnSelectDataPool"|"OnCollectAllIndexes"|"MoveStart"|"ResizeEnd", role: nil): fun(str: string) : boolean
...
---@overload fun(name: "InitialTab"|"InitialSubTab"|"EditEncoderBar"|"ControlEncoderBar"|"BuddyGroupId"|"Text"|"ToolTip"|"HelpTopic"|"SignalValue"|"SignalValueHold"|"AppearanceSourceClassName"|"Name"|"Note"|"DependencyExport", role: nil): string
