...
---@overload fun(name: "OnCheckSubPoolSelector", role: nil): fun(str: string) : boolean
---@overload fun(name: "AllIndexesCollected", role: nil): boolean
---@overload fun(name: "ShowCreatorType", role: nil): ShowCreatorType
---@overload fun(name: "OnSelectDataPool"|"OnCollectAllIndexes", role: nil): fun(str: string) : boolean
---@overload fun(name: "FTPresetCollect", role: nil): boolean
---@overload fun(name: "OnFixtureSourceChanged", role: nil): fun(str: string) : boolean
