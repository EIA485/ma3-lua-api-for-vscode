...
---@field IsScribbleAvailable boolean
---@field IsAppearanceAvailable boolean
---@field IsNoteAvailable boolean
---@field IsScribbleNew boolean
---@field IsAppearanceNew boolean
---@field Appearance Appearance
---@field ApplyNameBlacklist fun()
---@field ApplyFilenameBlacklist fun()
---@field Target Object
---@field ScribbleIsEmpty boolean
---@field OnUserProfileChanged fun(str: string)
local TextInput = {
    IsScribbleAvailable="0",
    IsAppearanceAvailable="0",
    IsNoteAvailable="0",
    IsScribbleNew="0",
    IsAppearanceNew="0",
    OnUserProfileChanged="out:(s;)"
}
---@return "TextInput"
function TextInput:GetClass() end
---@return "UIObject"
function TextInput:GetChildClass() end
