...
---@overload fun(name: "Target"|"Context"|"MainBuddy"|"WorkingDestination"|"ReturnDestination", role: nil): Object
...
---@overload fun(name: "OnUserProfileChanged"|"DescriptionChanged", role: nil): fun(str: string)
