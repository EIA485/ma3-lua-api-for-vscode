...
---@overload fun(name: "MeasureColor"|"DarkCalibrate"|"FindDevice"|"MoveStart"|"ResizeEnd", role: nil): fun(str: string) : boolean
...
---@overload fun(name: "FixtureToMeasure"|"EditEncoderBar"|"ControlEncoderBar"|"BuddyGroupId"|"Text"|"ToolTip"|"HelpTopic"|"SignalValue"|"SignalValueHold"|"AppearanceSourceClassName"|"Name"|"Note"|"DependencyExport", role: nil): string
