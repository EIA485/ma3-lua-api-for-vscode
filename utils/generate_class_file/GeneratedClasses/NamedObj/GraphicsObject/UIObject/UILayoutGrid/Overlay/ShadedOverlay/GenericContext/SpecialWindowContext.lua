...
---@overload fun(name: "ChangedActiveTab"|"DeleteClicked"|"TBDeleteAll"|"TBLoadDefaults"|"MoveStart"|"ResizeEnd", role: nil): fun(str: string) : boolean
