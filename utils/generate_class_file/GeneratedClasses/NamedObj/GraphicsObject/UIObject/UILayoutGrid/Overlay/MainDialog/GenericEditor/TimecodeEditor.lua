...
---@overload fun(name: "SGResizeStart"|"SGResizeEnd"|"Context"|"SaveEditTarget"|"RevertEditTarget"|"MoveStart"|"ResizeEnd", role: nil): fun(str: string) : boolean
...
---@overload fun(name: "SGResizeMove"|"Move"|"ResizeStart"|"Resize", role: nil): fun(str: string, int1: integer, int2: integer) : boolean
