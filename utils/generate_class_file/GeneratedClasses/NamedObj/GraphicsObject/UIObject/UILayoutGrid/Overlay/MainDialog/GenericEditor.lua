...
---@class GenericEditor: MainDialog
---@field OnSetEditTarget fun(str: string, obj: Object) your description here
---@field OnUpdateTitle fun(str: string, str: string) your description here
---@field EditTarget Object
---@field EditTargetList Object[]
---@field ForcedInitialTab string
---@field ChangeDestination boolean
---@field UpdateSettingsVisibility boolean
---@field SubDestination integer
---@field Context fun(str: string) : boolean
---@field SaveEditTarget fun(str: string) : boolean
---@field RevertEditTarget fun(str: string) : boolean
---@field InitialSaveEditTarget boolean
---@field EditTargetHasChanged boolean
local GenericEditor = {
    OnSetEditTarget="out:(s;o;)",
    OnUpdateTitle="out:(s;s;)",
    ChangeDestination="0",
    UpdateSettingsVisibility="No",
    Context="in:Context(s;)",
    SaveEditTarget="in:SaveEditTarget(s;)",
    RevertEditTarget="in:RevertEditTarget(s;)",
    InitialSaveEditTarget="0",
    EditTargetHasChanged="0"
}
---@return "GenericEditor"
function GenericEditor:GetClass() end
---@return "UIObject"
function GenericEditor:GetChildClass() end
