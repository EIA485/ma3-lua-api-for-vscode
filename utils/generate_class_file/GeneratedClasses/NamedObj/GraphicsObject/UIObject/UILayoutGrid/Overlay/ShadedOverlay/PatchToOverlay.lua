...
---@field ShowUnpatchedOnly boolean
...
---@overload fun(name: "OnPatchToClicked"|"OnShowUnpatchedClicked"|"MoveStart"|"ResizeEnd", role: nil): fun(str: string) : boolean
