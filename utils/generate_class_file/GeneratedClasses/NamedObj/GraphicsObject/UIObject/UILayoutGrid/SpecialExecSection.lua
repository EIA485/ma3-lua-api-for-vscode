...
---@generic T : SpecialExecSection
---@param class `T`
---@return boolean
function SpecialExecSection:IsClass(class) end
---@param index integer
---@return AllExecDisplay
...
---@return 131
function SpecialExecSection:PropertyCount() end
...
---@overload fun(idx: 128): "ExecBarToDraw"
---@overload fun(idx: 129): "FirstRow"
---@overload fun(idx: 130): "LastRow"
function SpecialExecSection:PropertyName(idx) end
...
---@overload fun(idx: 128): {ExportIgnore: False, EnumCollection: None, ReadOnly: False, ImportIgnore: False}
function SpecialExecSection:PropertyInfo(idx) end
---@overload fun(idx: 0|1|2|3|4|5|6|9|119|120|128|129|130): "UInt32"
...
function SpecialExecSection:PropertyType(idx) end
...
---@overload fun(name: "Index"|"Count"|"No"|"MemoryFootprint"|"FrameWidth"|"AutoCloseValue"|"UiGroupId"|"ForceIntensity"|"DefaultMargin"|"Columns"|"Rows"|"CellWidth"|"CellHeight"|"BlockWidth"|"BlockHeight"|"ExecBarToDraw"|"FirstRow"|"LastRow", role: nil): integer
...
---@overload fun(property_name: "Index"|"Count"|"No"|"FrameWidth"|"AutoCloseValue"|"UiGroupId"|"ForceIntensity"|"DefaultMargin"|"Columns"|"Rows"|"CellWidth"|"CellHeight"|"BlockWidth"|"BlockHeight"|"ExecBarToDraw"|"FirstRow"|"LastRow", property_value: integer, override_change_level: ChangeLevel?)
...
function SpecialExecSection:Set(property_name, property_value, override_change_level) end
function SpecialExecSection:SetChildren(property_name, property_value) end