...
---@overload fun(index: integer, class: "LastSelectedExecDisplay", undo: Undo?): LastSelectedExecDisplay
---@overload fun(index: integer, class: "SpecialExecutorDisplay", undo: Undo?): SpecialExecutorDisplay
...
---@overload fun(class: "LastSelectedExecDisplay", undo: Undo?, count: integer?): LastSelectedExecDisplay
---@overload fun(class: "SpecialExecutorDisplay", undo: Undo?, count: integer?): SpecialExecutorDisplay
...
---@overload fun(class: "LastSelectedExecDisplay", undo: Undo?): LastSelectedExecDisplay
---@overload fun(class: "SpecialExecutorDisplay", undo: Undo?): SpecialExecutorDisplay
...
---@overload fun(index: integer, class: "LastSelectedExecDisplay", undo: Undo?, count: integer?): LastSelectedExecDisplay
---@overload fun(index: integer, class: "SpecialExecutorDisplay", undo: Undo?, count: integer?): SpecialExecutorDisplay
...
---@overload fun(name: string, class: "LastSelectedExecDisplay"): LastSelectedExecDisplay
---@overload fun(name: string, class: "SpecialExecutorDisplay"): SpecialExecutorDisplay
---@overload fun(name: string, class: nil): AllExecDisplay
function SpecialExecSection:Find(name, class) end
---@overload fun(name: string, class: "AllExecDisplay"): AllExecDisplay
---@overload fun(name: string, class: "LastSelectedExecDisplay"): LastSelectedExecDisplay
---@overload fun(name: string, class: "SpecialExecutorDisplay"): SpecialExecutorDisplay
---@overload fun(name: string, class: nil): Object
function SpecialExecSection:FindRecursive(name, class) end
