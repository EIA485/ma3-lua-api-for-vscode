...
---@overload fun(property_name: "MouseButtonType", property_value: MouseButtonTypes)
---@overload fun(property_name: "MoveValueToPart", property_value: MoveValueToPart)
---@overload fun(property_name: "Target"|"Target"|"TargetObject"|"Target"|"Target"|"ScrollTarget"|"Target"|"Target"|"EditTarget"|"Target"|"Target"|"ExternScrollPos"|"Target"|"Target"|"AppearanceTarget"|"Target"|"CurrentUpdateObject"|"Target"|"ScrollTarget"|"ScribbleTarget"|"Target"|"EditTarget"|"Target"|"Target"|"Target"|"Target"|"Target"|"Target"|"TargetObject"|"HistoryProvider"|"TextViewProvider"|"Context"|"Target"|"Target"|"EditTarget"|"Target", property_value: Object)
---@overload fun(property_name: "SelectedElements", property_value: Object[])
...
---@overload fun(property_name: "ChangeActive", property_value: fun(childName: string) : boolean)
---@overload fun(property_name: "Solve"|"CallP1"|"OnTitleClick"|"StoreP2"|"CallP2"|"StoreP1"|"OnTitleClick"|"OnTitleClick"|"StoreP3"|"CallP3"|"StoreP4"|"CallP4", property_value: fun(dummyStr: string) : boolean)
...
---@overload fun(property_name: "SGResizeMove"|"ResizeMove"|"SGResizeMove"|"SelectCell"|"SelectRange"|"ResizeMove"|"Move", property_value: fun(str: string, int1: integer, int2: integer) : boolean)
---@overload fun(property_name: "TabChanged", property_value: fun(str: string, int1: integer, int2: integer, bool1: boolean, bool2: boolean))
---@overload fun(property_name: "GroupChangedTab", property_value: fun(str: string, int1: integer, int2: integer, bool1: boolean, bool2: boolean) : boolean)
...
function Overlay:SetPrompt(property_name, property_value) end