...
---@class CloningDialog: UILayoutGrid
---@field ChangeCloningViewMode fun(text: string) : boolean 0:text
---@field DoClone fun(text: string) : boolean 0:text
---@field OpenSequenceFilter fun(text: string) : boolean 0:text
---@field OpenGroupFilter fun(text: string) : boolean 0:text
---@field OpenPresetFilter fun(text: string) : boolean 0:text
---@field OpenWorldFilter fun(text: string) : boolean 0:text
---@field OpenLayoutFilter fun(text: string) : boolean 0:text
---@field AllItemsToAll fun(text: string) : boolean 0:text
---@field AllItemsToNone fun(text: string) : boolean 0:text
---@field InitTargetList fun(text: string) : boolean 0:text
---@field FlipLeftRight fun(text: string) : boolean 0:text
---@field CloneSourceGrid CloneGrid
---@field CloneDestinationGrid CloneGrid
---@field OpenAtFilter fun(str: string) : boolean Action to open AtFilter overlay
local CloningDialog = {
    ChangeCloningViewMode="in:(s;)",
    DoClone="in:(s;)",
    OpenSequenceFilter="in:(s;)",
    OpenGroupFilter="in:(s;)",
    OpenPresetFilter="in:(s;)",
    OpenWorldFilter="in:(s;)",
    OpenLayoutFilter="in:(s;)",
    AllItemsToAll="in:(s;)",
    AllItemsToNone="in:(s;)",
    InitTargetList="in:(s;)",
    FlipLeftRight="in:(s;)",
...
function CloningDialog:GetClass() end
---@return "UIObject"
function CloningDialog:GetChildClass() end
