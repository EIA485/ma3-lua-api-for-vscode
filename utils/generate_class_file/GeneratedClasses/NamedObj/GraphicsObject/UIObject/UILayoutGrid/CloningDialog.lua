...
---@overload fun(property_name: "Changed", property_value: fun(str: string, value: integer))
---@overload fun(property_name: "Set", property_value: fun(str: string, value: integer) : boolean)
---@overload fun(property_name: "SetText"|"DoReset"|"ObtainCurrentCue"|"InitFirst"|"AddText"|"InsertText"|"SelectFirst", property_value: fun(text: string) : boolean)
...
function CloningDialog:SetPrompt(property_name, property_value) end