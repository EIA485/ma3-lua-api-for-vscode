...
---@class Bar: UILayoutGrid A UI component that represents a bar
---@field DependsOnLinkedObject boolean
---@field LinkedObject UIObject A UI object associated with this bar
---@field LinkedObjectChanged fun(str: string, obj: Object) your description here
local Bar = {
    DependsOnLinkedObject="Yes",
    LinkedObjectChanged="out:(s;o;)"
}
---@return "Bar"
function Bar:GetClass() end
---@return "UIObject"
function Bar:GetChildClass() end
