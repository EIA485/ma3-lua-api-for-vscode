...
---@class ScribbleEditContent: UILayoutGrid
---@field ScribbleTarget Object
---@field TargetIsScribble boolean
---@field ApplyScribble fun(str: string) : boolean your description here
---@field RevertScribble fun(str: string) : boolean your description here
---@field OnCreateNewScribble fun(str: string) : boolean your description here
local ScribbleEditContent = {
    TargetIsScribble="No",
    ApplyScribble="in:ApplyScribble(s;)",
    RevertScribble="in:RevertScribble(s;)",
    OnCreateNewScribble="in:OnCreateNewScribble(s;)"
}
---@return "ScribbleEditContent"
function ScribbleEditContent:GetClass() end
---@return "UIObject"
function ScribbleEditContent:GetChildClass() end
