...
---@class TouchMonitor: UILayoutGrid
---@field MapClicked fun(str: string) : boolean Handle of a map button click event
local TouchMonitor = {
    MapClicked="in:(s;)"
}
---@return "TouchMonitor"
function TouchMonitor:GetClass() end
---@return "UIObject"
function TouchMonitor:GetChildClass() end
