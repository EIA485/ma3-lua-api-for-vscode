...
---@class PresetBar: Gma3EncoderBar
---@field FunctionSelectorChanged fun(str: string) : boolean Reaction on the change of the function selector
---@field EncoderReadoutSelectorChanged fun(str: string) : boolean Reaction on the change of the encoder resolution selector
local PresetBar = {
    FunctionSelectorChanged="in:PresetBarFunctionSelectorChanged(s;)",
    EncoderReadoutSelectorChanged="in:PresetBarEncoderResolutionChanged(s;)"
}
---@return "PresetBar"
function PresetBar:GetClass() end
---@return "UIObject"
function PresetBar:GetChildClass() end
