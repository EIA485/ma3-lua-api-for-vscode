...
---@overload fun(property_name: "EncoderFunction", property_value: PhaserEncoderFunction|TimecodeEncoderFunction)
...
function SequenceEditBar:SetPrompt(property_name, property_value) end