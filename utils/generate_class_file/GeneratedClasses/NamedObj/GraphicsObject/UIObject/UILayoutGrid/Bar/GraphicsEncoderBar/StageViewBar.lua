...
---@overload fun(property_name: "GroupClickedTab", property_value: fun(str: string, int1: integer, int2: integer, bool: boolean) : boolean)
---@overload fun(property_name: "ReloadCamera"|"OnClick"|"OnShow3dSettings"|"ResetCamera"|"ActionSetPriority"|"OnClick"|"AnalyzeMeshPool"|"HardkeyMouseUp"|"SelectionToGrid"|"HardkeyMouseDown"|"ReloadCamera"|"ReloadRenderQuality"|"OnClick", property_value: fun(str: string, int1: integer, int2: integer, int3: integer) : boolean)
...
function StageViewBar:SetPrompt(property_name, property_value) end