...
---@overload fun(property_name: "EncoderFunction", property_value: PhaserEncoderFunction|EncoderFunction)
...
function TimecodeBar:SetPrompt(property_name, property_value) end