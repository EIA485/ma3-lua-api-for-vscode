...
---@overload fun(property_name: "DrawGradient"|"AllIndexesCollected"|"AutoSetWindowSettings"|"IsScribbleAvailable"|"IsAppearanceAvailable"|"CheckForScreenEncoders"|"UseSpecialTimezone"|"IsNoteAvailable"|"Expanded"|"ChangeDestination"|"IsPlaying"|"AllowSorting"|"ScribbleIsEmpty"|"Blink"|"IsCloneDestination", property_value: boolean)
---@overload fun(property_name: "ChangeActive", property_value: fun(childName: string) : boolean)
...
function GraphicsEncoderBar:SetPrompt(property_name, property_value) end