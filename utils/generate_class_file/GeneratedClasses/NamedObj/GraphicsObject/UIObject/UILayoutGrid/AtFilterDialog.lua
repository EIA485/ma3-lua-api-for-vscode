...
---@class AtFilterDialog: UILayoutGrid
---@field Features FeatureMask
---@field FeatureGroups FeatureGroupMask
---@field FeatureGroupsOnly boolean
---@field SelectAll fun(str: string) : boolean
---@field SelectNothing fun(str: string) : boolean
---@field SwitchExpansion fun(str: string) : boolean Should be called when UserExpanded has changed within this dialog
---@field OnCollapseAll fun(str: string) : boolean Should be called all buttons shall collapse/expand
local AtFilterDialog = {
    SelectAll="in:SelectAll(s;)",
    SelectNothing="in:SelectNothing(s;)",
    SwitchExpansion="in:SwitchExpansion(s;)",
    OnCollapseAll="in:OnCollapseAll(s;)"
}
---@return "AtFilterDialog"
function AtFilterDialog:GetClass() end
---@return "UIObject"
function AtFilterDialog:GetChildClass() end
