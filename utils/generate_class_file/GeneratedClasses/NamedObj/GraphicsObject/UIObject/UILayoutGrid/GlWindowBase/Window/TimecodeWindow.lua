...
---@overload fun(name: "SGResizeStart"|"SGResizeEnd"|"ResizeStart"|"MoveStart"|"Context"|"UpdateEncoderBar", role: nil): fun(str: string) : boolean
...
---@overload fun(name: "SGResizeMove"|"ResizeMove"|"Move", role: nil): fun(str: string, int1: integer, int2: integer) : boolean
