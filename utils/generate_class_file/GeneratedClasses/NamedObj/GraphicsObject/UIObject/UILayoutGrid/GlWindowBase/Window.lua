...
---@class Window: GlWindowBase An abstract window UI component that can be created and placed on the screen
---@field WindowSettings WindowSettings A reference to a settings object
---@field WindowAppearance WindowAppearance A reference to an appearance object
---@field WindowScrollPositions WindowScrollPositions A reference to a scroll position object
---@field EditEncoderBar string
---@field ControlEncoderBar string
---@field ScrollTarget Object
---@field ReactToPreview boolean
---@field ReactToEdit boolean
---@field SmallResizeArea boolean
---@field PreviewMixInColor Color
---@field EditMixInColor Color
---@field EditMixInNotOwnerColor Color
---@field ResizeStart fun(str: string) : boolean your description here
---@field ResizeMove fun(str: string, int1: integer, int2: integer) : boolean your description here
---@field ResizeEnd fun(str: string, bool: boolean) : boolean your description here
---@field MoveStart fun(str: string) : boolean your description here
---@field Move fun(str: string, int1: integer, int2: integer) : boolean your description here
---@field MoveEnd fun(str: string, bool: boolean) : boolean your description here
---@field Context fun(str: string) : boolean your description here
---@field GestureClick fun(str: string, int1: integer, int2: integer, int3: integer, int4: integer) : boolean your description here
---@field UpdateEncoderBar fun(str: string) : boolean
local Window = {
    ReactToPreview="No",
    ReactToEdit="No",
    SmallResizeArea="No",
    PreviewMixInColor="Window.PreviewMixIn",
    EditMixInColor="Window.EditMixIn",
    EditMixInNotOwnerColor="Window.EditMixInNotOwner",
    ResizeStart="in:ResizeStart(s;)",
    ResizeMove="in:ResizeMove(s;i2;i2;)",
    ResizeEnd="in:ResizeEnd(s;b;)",
    MoveStart="in:MoveStart(s;)",
    Move="in:Move(s;i2;i2;)",
    MoveEnd="in:MoveEnd(s;b;)",
    Context="in:Context(s;)",
    GestureClick="in:TitleGestureClick(s;i2;i2;i2;i2;)",
    UpdateEncoderBar="in:UpdateEncoderBar(s;)"
}
---@return "Window"
function Window:GetClass() end
---@return "UIObject"
function Window:GetChildClass() end
...
---@overload fun(name: "ScrollTarget", role: nil): Object
---@overload fun(name: "ReactToPreview"|"ReactToEdit"|"SmallResizeArea", role: nil): boolean
---@overload fun(name: "PreviewMixInColor"|"EditMixInColor"|"EditMixInNotOwnerColor", role: nil): Color
---@overload fun(name: "ResizeStart", role: nil): fun(str: string) : boolean
---@overload fun(name: "ResizeMove", role: nil): fun(str: string, int1: integer, int2: integer) : boolean
---@overload fun(name: "ResizeEnd", role: nil): fun(str: string, bool: boolean) : boolean
