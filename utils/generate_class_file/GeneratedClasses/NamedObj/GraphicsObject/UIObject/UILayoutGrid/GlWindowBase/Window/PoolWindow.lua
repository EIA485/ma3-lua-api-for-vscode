...
---@generic T : PoolWindow
---@param class `T`
---@return boolean
function PoolWindow:IsClass(class) end
---@return UILayoutGrid
function PoolWindow:Parent() end
---@return 150
function PoolWindow:PropertyCount() end
...
function PoolWindow:PropertyName(idx) end
...
function PoolWindow:PropertyInfo(idx) end
...
function PoolWindow:PropertyType(idx) end
...
function PoolWindow:Set(property_name, property_value, override_change_level) end
...
function PoolWindow:SetChildren(property_name, property_value) end