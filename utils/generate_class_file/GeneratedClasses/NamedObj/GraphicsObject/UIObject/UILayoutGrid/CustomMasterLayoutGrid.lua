...
---@overload fun(property_name: "ChangeActive", property_value: fun(childName: string) : boolean)
---@overload fun(property_name: "Solve"|"CallP1"|"OnTitleClick"|"StoreP2"|"Close"|"CallP2"|"StoreP1"|"OnTitleClick"|"CloseConfirm"|"StoreP3"|"CloseCancel"|"CallP3"|"StoreP4"|"CallP4", property_value: fun(dummyStr: string) : boolean)
...
function CustomMasterLayoutGrid:SetPrompt(property_name, property_value) end