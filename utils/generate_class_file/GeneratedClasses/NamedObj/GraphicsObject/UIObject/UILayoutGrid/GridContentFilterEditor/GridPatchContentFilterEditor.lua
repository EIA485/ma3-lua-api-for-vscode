...
---@generic T : GridPatchContentFilterEditor
---@param class `T`
---@return boolean
function GridPatchContentFilterEditor:IsClass(class) end
...
function GridPatchContentFilterEditor:SetChildren(property_name, property_value) end