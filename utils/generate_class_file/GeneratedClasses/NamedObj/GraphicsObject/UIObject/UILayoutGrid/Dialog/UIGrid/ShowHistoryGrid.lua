...
---@overload fun(name: "ReTriggerInit"|"SelectRow"|"AddRow"|"SelectColumn"|"SortByColumn"|"ScrollVertical"|"ScrollHorizontal", role: nil): fun(str: string, int: integer) : boolean
...
---@overload fun(name: "CurrentSelectedShowFile"|"DataType"|"SelectionType"|"CellType"|"SettingsType"|"Text"|"ToolTip"|"HelpTopic"|"SignalValue"|"SignalValueHold"|"AppearanceSourceClassName"|"Name"|"Note"|"DependencyExport", role: nil): string
