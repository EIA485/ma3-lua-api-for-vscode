...
---@overload fun(name: "SelectionChanged"|"ChangeTarget"|"SelectRow"|"AddRow"|"SelectColumn"|"SortByColumn"|"ScrollVertical"|"ScrollHorizontal", role: nil): fun(str: string, int: integer) : boolean
