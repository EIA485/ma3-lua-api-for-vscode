...
---@class FilebrowserView: UIGrid
---@field FuzzyFilter string
---@field FuzzyFilterExcludeEnd string
---@field BaseFilter string
---@field PathChanged fun(str: string) your description here
---@field SetPath fun(str: string) : boolean your description here
---@field SetFilter fun(str: string) : boolean your description here
---@field GoUp fun(str: string) : boolean your description here
---@field SelectFirstFile fun(str: string) : boolean
---@field ScrollToFirstFile fun(str: string) : boolean
---@field DeleteSelectedFiles fun(str: string) : boolean
---@field SelectedFile string
local FilebrowserView = {
    BaseFilter="*",
    PathChanged="out:FB_PathChanged(s;)",
    SetPath="in:FB_SetPath(s;)",
    SetFilter="in:FB_SetFilter(s;)",
    GoUp="in:FB_GoUp(s;)",
    SelectFirstFile="in:(s;)",
    ScrollToFirstFile="in:(s;)",
    DeleteSelectedFiles="in:(s;)"
}
---@return "FilebrowserView"
function FilebrowserView:GetClass() end
---@return "UIObject"
function FilebrowserView:GetChildClass() end
