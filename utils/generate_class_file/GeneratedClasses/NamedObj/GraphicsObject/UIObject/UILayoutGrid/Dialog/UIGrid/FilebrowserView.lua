...
---@overload fun(name: "PathChanged"|"OnScreenPushed"|"DescriptionChanged", role: nil): fun(str: string)
---@overload fun(name: "SetPath"|"SetFilter"|"GoUp"|"SelectFirstFile"|"ScrollToFirstFile"|"DeleteSelectedFiles"|"ClearSelection"|"SelectAllRows"|"ClearFilter"|"ExpandAll"|"ScrollToEnd", role: nil): fun(str: string) : boolean
...
---@overload fun(name: "FuzzyFilter"|"FuzzyFilterExcludeEnd"|"BaseFilter"|"SelectedFile"|"DataType"|"SelectionType"|"CellType"|"SettingsType"|"Text"|"ToolTip"|"HelpTopic"|"SignalValue"|"SignalValueHold"|"AppearanceSourceClassName"|"Name"|"Note"|"DependencyExport", role: nil): string
