...
---@class DBObjectGridBase: UIGrid
---@field TargetObjects Object[]
---@field SelectedObjects Object[]
---@field TargetObject Object
---@field IgnoreChildren integer
---@field ChangeTarget fun(str: string, int: integer) : boolean 0:dummy str;1:obj handle
---@field StealFocusAfterSelect boolean
---@field CmdlineInteraction boolean
---@field TargetCmdlineInteraction boolean
---@field EditAllowedAdd boolean
---@field EditAllowedDelete boolean
---@field CreateAndEdit boolean
---@field AddTargets boolean
---@field ObserveSelectionChange boolean
---@field FixedColumns integer
---@field InsertType string
---@field OnTargetChanged fun(str: string, int: integer)
---@field OnSelectionAfterCmd fun(str: string, int1: integer, int2: integer)
local DBObjectGridBase = {
    IgnoreChildren="0",
    ChangeTarget="in:(s;u8;)",
    StealFocusAfterSelect="No",
    CmdlineInteraction="No",
    TargetCmdlineInteraction="No",
    EditAllowedAdd="Yes",
    EditAllowedDelete="Yes",
    CreateAndEdit="No",
    AddTargets="No",
    ObserveSelectionChange="Yes",
    FixedColumns="Auto",
    OnTargetChanged="out:(s;u8;)",
    OnSelectionAfterCmd="out:(s;u8;u8;)"
}
---@return "DBObjectGridBase"
function DBObjectGridBase:GetClass() end
---@return "UIObject"
function DBObjectGridBase:GetChildClass() end
