...
---@overload fun(property_name: "Settings", property_value: PSRPatchSheetSettings|ShowCreatorSettings)
...
---@overload fun(property_name: "DrawGradient"|"AllIndexesCollected"|"AutoSetWindowSettings"|"IsScribbleAvailable"|"IsAppearanceAvailable"|"FadeEncoder"|"CheckForScreenEncoders"|"UseSpecialTimezone"|"IsNoteAvailable"|"Expanded"|"ChangeDestination"|"IsPlaying"|"AllowSorting"|"ScribbleIsEmpty"|"Blink", property_value: boolean)
---@overload fun(property_name: "ChangeActive", property_value: fun(childName: string) : boolean)
...
---@overload fun(property_name: "ChangeTarget"|"SortByColumn"|"AddSelectedLines"|"ReTriggerInit"|"OnChar"|"ChangeTarget"|"SetFPSLimit"|"ScrollVertical"|"SelectRow"|"ScrollHorizontal"|"JumpToNextLine"|"AddRow"|"SelectionChanged"|"JumpToPreviousLine"|"SelectColumn"|"AddMissingLines"|"ScrollToRow"|"OnChar", property_value: fun(str: string, int: integer) : boolean)
...
function CloneGrid:SetPrompt(property_name, property_value) end