...
---@overload fun(name: "ReTriggerInit"|"AddSelectedFixtures"|"ClearGrid"|"GridMoveUp"|"GridMoveDown"|"GridCopy"|"GridPaste"|"GridAdd"|"GridDelete"|"GridCut"|"GridFillUp"|"GridUnify"|"SelectRow"|"AddRow"|"SelectColumn"|"SortByColumn"|"ScrollVertical"|"ScrollHorizontal", role: nil): fun(str: string, int: integer) : boolean
