...
---@class CloneGrid: UIGrid
---@field ReTriggerInit fun(str: string, int: integer) : boolean Action to reinit clone grid
---@field AddSelectedFixtures fun(str: string, int: integer) : boolean Action to add selected fixtures to clone grid
---@field ClearGrid fun(str: string, int: integer) : boolean Action to empty clone grid
---@field GridMoveUp fun(str: string, int: integer) : boolean Action to modify clone grid content
---@field GridMoveDown fun(str: string, int: integer) : boolean Action to modify clone grid content
---@field GridCopy fun(str: string, int: integer) : boolean Action to modify clone grid content
---@field GridPaste fun(str: string, int: integer) : boolean Action to modify clone grid content
---@field GridAdd fun(str: string, int: integer) : boolean Action to modify clone grid content
---@field GridDelete fun(str: string, int: integer) : boolean Action to modify clone grid content
---@field GridCut fun(str: string, int: integer) : boolean Action to modify clone grid content
---@field GridFillUp fun(str: string, int: integer) : boolean Action to modify clone grid content
---@field GridUnify fun(str: string, int: integer) : boolean Action to unify clone grid content
---@field IsCloneDestination boolean
---@field Settings CloningWindowSettings
---@field ScrollBuddy CloneGrid
local CloneGrid = {
    ReTriggerInit="in:(s;u8;)",
    AddSelectedFixtures="in:(s;u8;)",
    ClearGrid="in:(s;u8;)",
    GridMoveUp="in:(s;u8;)",
    GridMoveDown="in:(s;u8;)",
    GridCopy="in:(s;u8;)",
    GridPaste="in:(s;u8;)",
    GridAdd="in:(s;u8;)",
    GridDelete="in:(s;u8;)",
    ...
    GridFillUp="in:(s;u8;)",
    GridUnify="in:(s;u8;)",
    IsCloneDestination="No"
}
---@return "CloneGrid"
function CloneGrid:GetClass() end
---@return "UIObject"
function CloneGrid:GetChildClass() end
