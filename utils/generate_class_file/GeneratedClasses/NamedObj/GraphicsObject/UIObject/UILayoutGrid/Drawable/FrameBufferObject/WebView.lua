...
---@class WebView: FrameBufferObject
---@field UrlChanged fun(str: string) your description here
---@field ProgressChanged fun(str: string) your description here
---@field StatusChanged fun(str: string) your description here
---@field TooltipChanged fun(str: string) your description here
---@field MemUsageUpdated fun(str: string, int: integer) your description here
---@field SetUrlA fun(str: string) : boolean your description here
---@field GoBack fun(str: string) : boolean your description here
---@field GoFwd fun(str: string) : boolean your description here
---@field Reload fun(str: string) : boolean your description here
---@field SetFPSLimit fun(str: string, int: integer) : boolean your description here
---@field RequestMemUsage fun(str: string) : boolean your description here
---@field Priority integer
local WebView = {
    UrlChanged="out:WV_UrlChanged(s;)",
    ProgressChanged="out:WV_ProgressChanged(s;)",
    StatusChanged="out:WV_StatusChanged(s;)",
    TooltipChanged="out:ShowToolTip(s;)",
    MemUsageUpdated="out:WV_MemUsageUpdated(s;u8;)",
    SetUrlA="in:WV_SetUrl(s;)",
    GoBack="in:WV_GoBackward(s;)",
    GoFwd="in:WV_GoForward(s;)",
    Reload="in:WV_Reload(s;)",
    SetFPSLimit="in:WV_SetFPSLimit(s;u1;)",
    RequestMemUsage="in:WV_RequestMemUsage(s;)",
    Priority="0"
}
---@return "WebView"
function WebView:GetClass() end
---@return "UIObject"
function WebView:GetChildClass() end
