...
---@class LayoutCanvas: FrameBufferObject
---@field SelectionFrame Texture
---@field WindowCount integer
---@field IndicatorIconBackColor Color
---@field IndicatorIcon Texture
---@field OnZoomToFit fun(str: string) : boolean
---@field OnSetRecalcCenterOfGravity fun(str: string) : boolean
---@field ForceScale fun(str: string, num: number) : boolean
---@field GetSelectedObject fun(int: integer) : Element
---@field GetSelectedObjectCount fun() : integer
---@field SelectionToGrid fun()
---@field AlignSelected fun()
---@field ScaleAll number
---@field RatioAll number
local LayoutCanvas = {
    SelectionFrame="SelectionFrame",
    IndicatorIconBackColor="Button.IndicatorIcon",
    OnZoomToFit="in:OnZoomToFit(s;)",
    OnSetRecalcCenterOfGravity="in:OnSetRecalcCenterOfGravity(s;)",
    ForceScale="in:ForceScale(s;d;)"
}
---@return "LayoutCanvas"
function LayoutCanvas:GetClass() end
---@return "UIObject"
function LayoutCanvas:GetChildClass() end
