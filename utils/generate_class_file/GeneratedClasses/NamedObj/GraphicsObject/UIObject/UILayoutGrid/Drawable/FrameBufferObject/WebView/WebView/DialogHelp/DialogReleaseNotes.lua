...
---@overload fun(name: "Search"|"SetUrlA"|"GoBack"|"GoFwd"|"Reload"|"RequestMemUsage", role: nil): fun(str: string) : boolean
...
---@overload fun(name: "ReleaseNotesUrl"|"Text"|"ToolTip"|"HelpTopic"|"SignalValue"|"SignalValueHold"|"AppearanceSourceClassName"|"Name"|"Note"|"DependencyExport", role: nil): string
