...
---@class View3D: UI2DView
---@field SelectionFrame Texture
---@field LockTexture Texture
---@field GearTexture Texture
---@field CurrentFps number
---@field ReloadCamera fun(str: string, int1: integer, int2: integer, int3: integer) : boolean Description
---@field ResetCamera fun(str: string, int1: integer, int2: integer, int3: integer) : boolean Description
---@field AnalyzeMeshPool fun(str: string, int1: integer, int2: integer, int3: integer) : boolean Description
---@field SelectionToGrid fun(str: string, int1: integer, int2: integer, int3: integer) : boolean Description
local View3D = {
    SelectionFrame="SelectionFrame",
    LockTexture="locked_big_red",
    GearTexture="settings",
    ReloadCamera="in:ReloadCamera(s;u1;i2;i2;)",
    ResetCamera="in:ResetCamera(s;u1;i2;i2;)",
    AnalyzeMeshPool="in:AnalyzeMeshPool(s;u1;i2;i2;)",
    SelectionToGrid="in:SelectionToGrid(s;u1;i2;i2;)"
}
---@return "View3D"
function View3D:GetClass() end
---@return "UIObject"
function View3D:GetChildClass() end
