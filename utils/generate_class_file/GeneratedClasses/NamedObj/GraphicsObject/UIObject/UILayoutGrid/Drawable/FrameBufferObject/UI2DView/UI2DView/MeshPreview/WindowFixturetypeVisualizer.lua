...
---@overload fun(name: "IsWorldCoordinateSystemActive"|"IsCameraFocusOnSelectedItem"|"ExpandContent"|"DefaultMarginOnBorders"|"MixInBackColorFromParentRecursive"|"EncoderUseDisplay"|"HasFocus"|"HideFocusFrame"|"FaderEnabled"|"Owned", role: nil): boolean
