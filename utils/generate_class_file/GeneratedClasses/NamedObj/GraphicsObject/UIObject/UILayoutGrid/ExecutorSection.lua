...
---@overload fun(index: integer, class: "ExecutorDisplay", undo: Undo?, count: integer?): ExecutorDisplay
...
---@overload fun(name: string, class: "ExecutorDisplay"): ExecutorDisplay
---@overload fun(name: string, class: nil): ExecutorDisplay
function ExecutorSection:Find(name, class) end
---@overload fun(name: string, class: "ExecutorDisplay"): ExecutorDisplay
---@overload fun(name: string, class: nil): Object
function ExecutorSection:FindRecursive(name, class) end
