...
---@generic T : ExecutorSection
---@param class `T`
---@return boolean
function ExecutorSection:IsClass(class) end
---@return ExecutorBar
...
---@return 130
function ExecutorSection:PropertyCount() end
...
---@overload fun(idx: 128): "ExecRowCount"
---@overload fun(idx: 129): "ExecColCount"
function ExecutorSection:PropertyName(idx) end
...
---@overload fun(idx: 4|5|6|20|128|129): {ExportIgnore: True, ReadOnly: False, ImportIgnore: False}
...
function ExecutorSection:PropertyInfo(idx) end
---@overload fun(idx: 0|1|2|3|4|5|6|9|119|120|128|129): "UInt32"
...
function ExecutorSection:PropertyType(idx) end
...
---@overload fun(name: "Index"|"Count"|"No"|"MemoryFootprint"|"FrameWidth"|"AutoCloseValue"|"UiGroupId"|"ForceIntensity"|"DefaultMargin"|"Columns"|"Rows"|"CellWidth"|"CellHeight"|"BlockWidth"|"BlockHeight"|"ExecRowCount"|"ExecColCount", role: nil): integer
...
---@overload fun(property_name: "Index"|"Count"|"No"|"FrameWidth"|"AutoCloseValue"|"UiGroupId"|"ForceIntensity"|"DefaultMargin"|"Columns"|"Rows"|"CellWidth"|"CellHeight"|"BlockWidth"|"BlockHeight"|"ExecRowCount"|"ExecColCount", property_value: integer, override_change_level: ChangeLevel?)
