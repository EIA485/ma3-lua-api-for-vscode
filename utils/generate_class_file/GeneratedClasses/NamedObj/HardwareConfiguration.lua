...
---@param class `T`
---@return boolean
function HardwareConfiguration:IsClass(class) end
---@return HardwareConfigurations
function HardwareConfiguration:Parent() end
---@return 17
function HardwareConfiguration:PropertyCount() end
...
---@overload fun(idx: 15): "ModuleVersion"
---@overload fun(idx: 16): "IsWing"
function HardwareConfiguration:PropertyName(idx) end
---@overload fun(idx: 0|1|2): {ExportIgnore: True, EnumCollection: YesNo, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 3|12|16): {ExportIgnore: False, EnumCollection: YesNo, ReadOnly: False, ImportIgnore: False}
...
function HardwareConfiguration:PropertyInfo(idx) end
---@overload fun(idx: 0|1|2|3|4|5|6|9): "UInt32"
---@overload fun(idx: 7|8|13|15): "String"
---@overload fun(idx: 10|11|16): "Bool"
---@overload fun(idx: 12): "UInt64"
---@overload fun(idx: 14): "Int64"
function HardwareConfiguration:PropertyType(idx) end
---@overload fun(name: "IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"UserExpanded"|"FaderEnabled"|"Owned"|"Hidden"|"IsWing", role: nil): YesNo|boolean
---@overload fun(name: "Index"|"Count"|"No"|"MemoryFootprint", role: nil): integer
---@overload fun(name: "Name"|"Note"|"DependencyExport"|"ModuleVersion", role: nil): string
...
---@overload fun(class: "NoteTextEdit", undo: Undo?): NoteTextEdit
---@overload fun(class: nil, undo: Undo?): Object
function HardwareConfiguration:Find(class, undo) end
---@overload fun(property_name: "IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"Hidden"|"IsWing", property_value: YesNo|boolean, override_change_level: ChangeLevel?)
---@overload fun(property_name: "Index"|"Count"|"No", property_value: integer, override_change_level: ChangeLevel?)
---@overload fun(property_name: "Name"|"Note"|"DependencyExport"|"ModuleVersion", property_value: string, override_change_level: ChangeLevel?)
function HardwareConfiguration:Set(property_name, property_value, override_change_level) end
...
---@overload fun(property_name: "Page"|"DmxPortDefaultDirection"|"VisibleGrid"|"TimecodePortsIn"|"TimerIndex"|"SnapGrid"|"TimecodePortsOut"|"PaddingBottom"|"LastConnectionTime"|"LightBeamOverdrawLimit"|"DCIoPorts"|"PaddingLeft"|"DigitalIoPorts"|"DimmerIncrement"|"MidiCount"|"AmountHue"|"PaddingRight"|"PaddingTop"|"Mode"|"MemoryLimit"|"AmountSaturation"|"ParameterCount"|"InitialWhiteFilter"|"Page"|"FileSize"|"DesiredUiFps"|"Index"|"Page"|"Count"|"SplitSize"|"No"|"SoftwareID"|"DynamicGoboResolution"|"PoolObjectContentSizeLimitation"|"SubPoolSelectorValue"|"SubPoolSelectorIndex"|"ColumnsCount"|"Texture"|"AutoColumnsWidth"|"Width"|"HazeLayers"|"Cont.Size"|"Height"|"SplitSize"|"Cont.Ref"|"Page"|"TCSlot"|"ColumnsCount"|"RealtimeIteration"|"LabMaxCount"|"BootAnimationLength"|"DmxPortCount", property_value: integer)
---@overload fun(property_name: "StageFilterList", property_value: integer[])
...
function HardwareConfiguration:SetChildren(property_name, property_value) end