...
---@class HardwareConfiguration: NamedObj
---@field ModuleVersion string
---@field IsWing boolean
local HardwareConfiguration = {
    IsWing="0"
}
---@return "HardwareConfiguration"
function HardwareConfiguration:GetClass() end
---@return "Object"
function HardwareConfiguration:GetChildClass() end
---@return HardwareConfigurations
function HardwareConfiguration:Parent() end
...
---@overload fun(name: "ModuleVersion", role: nil): string
---@overload fun(name: "IsWing", role: nil): boolean
---@overload fun(name: "IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"Index"|"Count"|"No"|"Name"|"Note"|"UserExpanded"|"FaderEnabled"|"Owned"|"Hidden"|"DependencyExport"|"MemoryFootprint"|"ModuleVersion"|"IsWing", role: Enums.Roles): string
---@overload fun(name: integer, role: nil): Object
function HardwareConfiguration:Get(name, role) end
...
---@overload fun(index: integer, class: "HardwareIoConnectors", undo: Undo?): HardwareIoConnectors
---@overload fun(index: integer, class: "FaderDefinitions", undo: Undo?): FaderDefinitions
---@overload fun(index: integer, class: "LedDefinitions", undo: Undo?): LedDefinitions
---@overload fun(index: integer, class: "Hardkeys", undo: Undo?): Hardkeys
---@overload fun(index: integer, class: "EncoderDefinitions", undo: Undo?): EncoderDefinitions
...
function HardwareConfiguration:Create(index, class, undo) end
...
---@overload fun(class: "HardwareIoConnectors", undo: Undo?, count: integer?): HardwareIoConnectors
---@overload fun(class: "FaderDefinitions", undo: Undo?, count: integer?): FaderDefinitions
---@overload fun(class: "LedDefinitions", undo: Undo?, count: integer?): LedDefinitions
---@overload fun(class: "Hardkeys", undo: Undo?, count: integer?): Hardkeys
---@overload fun(class: "EncoderDefinitions", undo: Undo?, count: integer?): EncoderDefinitions
...
function HardwareConfiguration:Append(class, undo, count) end
...
---@overload fun(class: "HardwareIoConnectors", undo: Undo?): HardwareIoConnectors
---@overload fun(class: "FaderDefinitions", undo: Undo?): FaderDefinitions
---@overload fun(class: "LedDefinitions", undo: Undo?): LedDefinitions
---@overload fun(class: "Hardkeys", undo: Undo?): Hardkeys
---@overload fun(class: "EncoderDefinitions", undo: Undo?): EncoderDefinitions
...
function HardwareConfiguration:Acquire(class, undo) end
---@overload fun(class: "Object", undo: Undo?): Object
---@overload fun(class: "MVRxchange", undo: Undo?): MVRxchange
---@overload fun(class: "SmartViewSettingsCollect", undo: Undo?): SmartViewSettingsCollect
---@overload fun(class: "RunningPlaybacksSettingsCollect", undo: Undo?): RunningPlaybacksSettingsCollect
...
function HardwareConfiguration:Aquire(class, undo) end
...
---@overload fun(index: integer, class: "HardwareIoConnectors", undo: Undo?, count: integer?): HardwareIoConnectors
---@overload fun(index: integer, class: "FaderDefinitions", undo: Undo?, count: integer?): FaderDefinitions
---@overload fun(index: integer, class: "LedDefinitions", undo: Undo?, count: integer?): LedDefinitions
---@overload fun(index: integer, class: "Hardkeys", undo: Undo?, count: integer?): Hardkeys
---@overload fun(index: integer, class: "EncoderDefinitions", undo: Undo?, count: integer?): EncoderDefinitions
...
function HardwareConfiguration:Insert(index, class, undo, count) end
...
---@overload fun(name: string, class: "HardwareIoConnectors"): HardwareIoConnectors
---@overload fun(name: string, class: "FaderDefinitions"): FaderDefinitions
---@overload fun(name: string, class: "LedDefinitions"): LedDefinitions
---@overload fun(name: string, class: "Hardkeys"): Hardkeys
---@overload fun(name: string, class: "EncoderDefinitions"): EncoderDefinitions
...
function HardwareConfiguration:Find(name, class) end
---@overload fun(name: string, class: "Object"): Object
---@overload fun(name: string, class: "MVRxchange"): MVRxchange
---@overload fun(name: string, class: "SmartViewSettingsCollect"): SmartViewSettingsCollect
---@overload fun(name: string, class: "RunningPlaybacksSettingsCollect"): RunningPlaybacksSettingsCollect
...
---@overload fun(name: string, class: "IllegalObject"): IllegalObject
---@overload fun(name: string, class: nil): Object
function HardwareConfiguration:FindRecursive(name, class) end
