...
function Sequences:Action(property_name, property_value) end
...
---@overload fun(property_name: "Release"|"Sync"|"Morph"|"AllowDuplicates", property_value: Yes|true)
...
function Sequences:TrigSound(property_name, property_value) end
---@overload fun(property_name: "Assert", property_value: CueAssert)
---@overload fun(property_name: "No", property_value: CueNumber)
---@overload fun(property_name: "FailedCookedPart", property_value: FailedCookedPart)
---@overload fun(property_name: "Generator", property_value: GeneratorBaseObject)
...
---@overload fun(property_name: "Break"|"Values", property_value: Object)
---@overload fun(property_name: "Preset", property_value: Preset)
---@overload fun(property_name: "TrackingDistance"|"MIBTarget", property_value: RelCueNumber)
---@overload fun(property_name: "Action", property_value: SequenceActionToken)
---@overload fun(property_name: "TrigSound", property_value: SoundValues)
---@overload fun(property_name: "SelectionMode", property_value: StrictNormalMode)
---@overload fun(property_name: "TimingGoto"|"TimingGoBack"|"TimingGoFast"|"TimingGoBackFast", property_value: TimeDefault)
---@overload fun(property_name: "TrigTime"|"Duration"|"IndivFade"|"IndivDelay"|"IndivDuration", property_value: TimePropertyValue)
---@overload fun(property_name: "Filter", property_value: World)
---@overload fun(property_name: "EmptyLastCooking"|"Enabled"|"CommandEnabled", property_value: YesNo|boolean)
---@overload fun(property_name: "Release"|"AllowDuplicates"|"Sync"|"Morph", property_value: Yes|true)
---@overload fun(property_name: "TrigType"|"Part", property_value: integer)
---@overload fun(property_name: "Type"|"CueNo"|"CueName"|"User"|"Command", property_value: string)
