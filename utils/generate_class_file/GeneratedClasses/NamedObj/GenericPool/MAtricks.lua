...
---@overload fun(property_name: "InvertX"|"InvertY"|"InvertZ"|"OwnDataPresent"|"AlignRangeX"|"AlignRangeY"|"OwnNonCookedDataPresent"|"Active"|"AlignRangeZ"|"HasAnyMatricksData"|"RelativeFade"|"RelativeDelay"|"RecipeTemplate"|"RelativePhase"|"RelativeSpeed"|"Relative"|"Enabled"|"EmptyLastCooking"|"MAgic", property_value: YesNo|boolean)
---@overload fun(property_name: "Mode", property_value: integer)
---@overload fun(property_name: "Type"|"StoredData"|"User"|"InitialName"|"FeatureGroup"|"Trigger", property_value: string)
function MAtricks:SetChildren(property_name, property_value) end