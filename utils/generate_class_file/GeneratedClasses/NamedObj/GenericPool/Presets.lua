...
---@param class `T`
---@return boolean
function Presets:IsClass(class) end
---@return PresetPools
...
---@return 19
function Presets:PropertyCount() end
...
---@overload fun(idx: 16): "InputFilter"
---@overload fun(idx: 17): "PresetMode"
---@overload fun(idx: 18): "CuePart"
function Presets:PropertyName(idx) end
...
---@overload fun(idx: 17): {ExportIgnore: False, EnumCollection: PresetMode, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 18): {ExportIgnore: False, EnumCollection: CuePartMode, ReadOnly: False, ImportIgnore: False}
function Presets:PropertyInfo(idx) end
...
function Presets:PropertyType(idx) end
---@overload fun(name: "CuePart", role: nil): CuePartMode
---@overload fun(name: "PresetMode", role: nil): PresetMode
...
---@overload fun(name: "IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"Index"|"Count"|"No"|"Name"|"Note"|"UserExpanded"|"FaderEnabled"|"Owned"|"Hidden"|"DependencyExport"|"MemoryFootprint"|"DefaultsLoaded"|"InputFilter"|"PresetMode"|"CuePart", role: Enums.Roles): string
...
---@overload fun(class: "Preset", undo: Undo?): Preset
---@overload fun(class: nil, undo: Undo?): Preset
function Presets:Find(class, undo) end
...
function Presets:FindParent(class) end
---@overload fun(property_name: "CuePart", property_value: CuePartMode, override_change_level: ChangeLevel?)
---@overload fun(property_name: "PresetMode", property_value: PresetMode, override_change_level: ChangeLevel?)
...
function Presets:Set(property_name, property_value, override_change_level) end
...
function Presets:SetChildren(property_name, property_value) end
---@overload fun(property_name: "CuePart", property_value: CuePartMode)
---@overload fun(property_name: "OffFade", property_value: TimePropertyValue)
---@overload fun(property_name: "Generator", property_value: GeneratorBaseObject)
---@overload fun(property_name: "Values", property_value: Object)
...
---@overload fun(property_name: "Mode", property_value: integer)
---@overload fun(property_name: "Type"|"StoredData"|"User"|"FeatureGroup"|"Trigger", property_value: string)
function Presets:SetChildrenRecursive(property_name, property_value) end