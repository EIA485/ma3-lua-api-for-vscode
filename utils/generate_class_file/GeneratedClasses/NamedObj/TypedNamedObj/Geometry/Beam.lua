...
---@overload fun(property_name: "PinCount"|"SignalLayer"|"Count", property_value: integer)
---@overload fun(property_name: "OutputStrength"|"BeamDiameter"|"BeamDivergenceMin"|"CapacityX"|"BeamDivergenceMax"|"CapacityY"|"ScanAnglePan"|"ResistanceX"|"ScanAngleTilt"|"CapacityZ"|"ScanSpeed"|"CapacityXX"|"CapacityYY"|"CapacityZZ"|"ResistanceY"|"ResistanceZ"|"ResistanceXX"|"ResistanceYY"|"ResistanceZZ"|"RotX"|"ElectricalPayLoad"|"MaxPayLoad"|"RotY"|"VoltageRangeMax"|"RotZ"|"CrossSectionHeight"|"VoltageRangeMin"|"CrossSectionWallThickness"|"FrequencyRangeMax"|"FrequencyRangeMin"|"Voltage"|"CosPhi"|"FuseCurrent"|"Color", property_value: number)
...
function Beam:SetChildren(property_name, property_value) end