...
---@overload fun(property_name: "ColorRenderingIndex"|"SignalLayer"|"PinCount", property_value: integer)
...
function Inventory:ComponentType(property_name, property_value) end