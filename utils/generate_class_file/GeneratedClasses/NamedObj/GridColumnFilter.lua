...
---@param class `T`
---@return boolean
function GridColumnFilter:IsClass(class) end
---@return GridColumnFilterCollect
function GridColumnFilter:Parent() end
---@return 16
function GridColumnFilter:PropertyCount() end
...
function GridColumnFilter:PropertyName(idx) end
...
---@overload fun(class: "NoteTextEdit", undo: Undo?): NoteTextEdit
---@overload fun(class: nil, undo: Undo?): Object
function GridColumnFilter:Find(class, undo) end
...
function GridColumnFilter:Set(property_name, property_value, override_change_level) end
...
function GridColumnFilter:SetChildren(property_name, property_value) end