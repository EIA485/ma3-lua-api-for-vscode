...
---@class GridColumnFilter: NamedObj
---@field Inclusive boolean
local GridColumnFilter = {
    Inclusive="No"
}
---@return "GridColumnFilter"
function GridColumnFilter:GetClass() end
---@return "Object"
function GridColumnFilter:GetChildClass() end
---@return GridColumnFilterCollect
function GridColumnFilter:Parent() end
...
---@overload fun(name: "IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"Index"|"Count"|"No"|"Name"|"Note"|"UserExpanded"|"FaderEnabled"|"Owned"|"Hidden"|"DependencyExport"|"MemoryFootprint"|"Inclusive", role: Enums.Roles): string
---@overload fun(name: integer, role: nil): Object
function GridColumnFilter:Get(name, role) end
...
function GridColumnFilter:Create(index, class, undo) end
...
function GridColumnFilter:Append(class, undo, count) end
...
function GridColumnFilter:Acquire(class, undo) end
---@overload fun(class: "Object", undo: Undo?): Object
---@overload fun(class: "MVRxchange", undo: Undo?): MVRxchange
---@overload fun(class: "SmartViewSettingsCollect", undo: Undo?): SmartViewSettingsCollect
---@overload fun(class: "RunningPlaybacksSettingsCollect", undo: Undo?): RunningPlaybacksSettingsCollect
...
function GridColumnFilter:Aquire(class, undo) end
...
function GridColumnFilter:Insert(index, class, undo, count) end
...
function GridColumnFilter:Find(name, class) end
---@overload fun(name: string, class: "Object"): Object
---@overload fun(name: string, class: "MVRxchange"): MVRxchange
---@overload fun(name: string, class: "SmartViewSettingsCollect"): SmartViewSettingsCollect
---@overload fun(name: string, class: "RunningPlaybacksSettingsCollect"): RunningPlaybacksSettingsCollect
...
---@overload fun(name: string, class: "IllegalObject"): IllegalObject
---@overload fun(name: string, class: nil): Object
function GridColumnFilter:FindRecursive(name, class) end
