...
---@overload fun(name: "ColorTemperature"|"IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"Index"|"Count"|"No"|"Name"|"Note"|"UserExpanded"|"FaderEnabled"|"Owned"|"Hidden"|"DependencyExport"|"MemoryFootprint", role: Enums.Roles): string
...
---@return T
---@overload fun(class: nil, undo: Undo?): CRI
function CRIGroup:Find(class, undo) end
...
---@param class `T`
---@return T
function CRIGroup:FindParent(class) end