...
---@generic T : MediaPools
---@param class `T`
---@return boolean
function MediaPools:IsClass(class) end
---@return ShowData
function MediaPools:Parent() end
---@return 16
function MediaPools:PropertyCount() end
...
---@overload fun(idx: 15): "MemoryLimit"
function MediaPools:PropertyName(idx) end
...
function MediaPools:PropertyInfo(idx) end
---@overload fun(idx: 0|1|2|3|4|5|6|9): "UInt32"
---@overload fun(idx: 7|8|13): "String"
---@overload fun(idx: 10|11): "Bool"
---@overload fun(idx: 12): "UInt64"
---@overload fun(idx: 14|15): "Int64"
function MediaPools:PropertyType(idx) end
...
---@overload fun(name: "Index"|"Count"|"No"|"MemoryFootprint"|"MemoryLimit", role: nil): integer
...
---@overload fun(class: "NoteTextEdit", undo: Undo?): NoteTextEdit
---@overload fun(class: nil, undo: Undo?): Object
function MediaPools:Find(class, undo) end
...
---@overload fun(property_name: "Index"|"Count"|"No"|"MemoryLimit", property_value: integer, override_change_level: ChangeLevel?)
---@overload fun(property_name: "Name"|"Note"|"DependencyExport", property_value: string, override_change_level: ChangeLevel?)
function MediaPools:Set(property_name, property_value, override_change_level) end
...
function MediaPools:SetChildren(property_name, property_value) end