...
---@class MediaPools: Object
---@field MemoryLimit integer
local MediaPools = {
    MemoryLimit="10737418240"
}
---@return "MediaPools"
function MediaPools:GetClass() end
---@return "Object"
function MediaPools:GetChildClass() end
---@return ShowData
function MediaPools:Parent() end
...
---@overload fun(name: "MemoryFootprint"|"MemoryLimit", role: nil): integer
---@overload fun(name: "IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"Index"|"Count"|"No"|"Name"|"Note"|"UserExpanded"|"FaderEnabled"|"Owned"|"Hidden"|"DependencyExport"|"MemoryFootprint"|"MemoryLimit", role: Enums.Roles): string
---@overload fun(name: integer, role: nil): Object
function MediaPools:Get(name, role) end
...
---@overload fun(index: integer, class: "Sounds", undo: Undo?): Sounds
---@overload fun(index: integer, class: "ImagePool", undo: Undo?): ImagePool
---@overload fun(index: integer, class: "Videos", undo: Undo?): Videos
...
function MediaPools:Create(index, class, undo) end
...
---@overload fun(class: "Sounds", undo: Undo?, count: integer?): Sounds
---@overload fun(class: "ImagePool", undo: Undo?, count: integer?): ImagePool
---@overload fun(class: "Videos", undo: Undo?, count: integer?): Videos
...
function MediaPools:Append(class, undo, count) end
...
---@overload fun(class: "Sounds", undo: Undo?): Sounds
---@overload fun(class: "ImagePool", undo: Undo?): ImagePool
---@overload fun(class: "Videos", undo: Undo?): Videos
...
function MediaPools:Acquire(class, undo) end
---@overload fun(class: "Object", undo: Undo?): Object
---@overload fun(class: "MVRxchange", undo: Undo?): MVRxchange
---@overload fun(class: "SmartViewSettingsCollect", undo: Undo?): SmartViewSettingsCollect
---@overload fun(class: "RunningPlaybacksSettingsCollect", undo: Undo?): RunningPlaybacksSettingsCollect
...
function MediaPools:Aquire(class, undo) end
...
---@overload fun(index: integer, class: "Sounds", undo: Undo?, count: integer?): Sounds
---@overload fun(index: integer, class: "ImagePool", undo: Undo?, count: integer?): ImagePool
---@overload fun(index: integer, class: "Videos", undo: Undo?, count: integer?): Videos
...
function MediaPools:Insert(index, class, undo, count) end
...
---@overload fun(name: string, class: "Sounds"): Sounds
---@overload fun(name: string, class: "ImagePool"): ImagePool
---@overload fun(name: string, class: "Videos"): Videos
...
function MediaPools:Find(name, class) end
---@overload fun(name: string, class: "Object"): Object
---@overload fun(name: string, class: "MVRxchange"): MVRxchange
---@overload fun(name: string, class: "SmartViewSettingsCollect"): SmartViewSettingsCollect
---@overload fun(name: string, class: "RunningPlaybacksSettingsCollect"): RunningPlaybacksSettingsCollect
...
---@overload fun(name: string, class: "IllegalObject"): IllegalObject
---@overload fun(name: string, class: nil): Object
function MediaPools:FindRecursive(name, class) end
