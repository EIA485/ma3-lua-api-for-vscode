...
---@class Pult: Object An object that represents a single user seat (own displays, own command line, own de-coupled input)
---@field PultType PultType
---@field LinkMainCmdline boolean
---@field Cmd Cmdline
---@field MainLoopCount integer
---@field RunTest fun(str: string) : boolean dummy
local Pult = {
    LinkMainCmdline="No",
    RunTest="in:(s;)"
}
---@return "Pult"
function Pult:GetClass() end
---@return "Object"
function Pult:GetChildClass() end
---@return PultCollect
function Pult:Parent() end
...
---@overload fun(name: "LinkMainCmdline", role: nil): boolean
---@overload fun(name: "Cmd", role: nil): Cmdline
---@overload fun(name: "MainLoopCount", role: nil): integer
---@overload fun(name: "RunTest", role: nil): fun(str: string) : boolean
---@overload fun(name: "IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"Index"|"Count"|"No"|"Name"|"Note"|"UserExpanded"|"FaderEnabled"|"Owned"|"Hidden"|"DependencyExport"|"MemoryFootprint"|"PultType"|"LinkMainCmdline"|"Cmd"|"MainLoopCount"|"RunTest", role: Enums.Roles): string
---@overload fun(name: integer, role: nil): Object
function Pult:Get(name, role) end
...
---@overload fun(index: integer, class: "Devices", undo: Undo?): Devices
...
function Pult:Create(index, class, undo) end
...
---@overload fun(class: "Devices", undo: Undo?, count: integer?): Devices
...
function Pult:Append(class, undo, count) end
...
---@overload fun(class: "Devices", undo: Undo?): Devices
...
function Pult:Acquire(class, undo) end
---@overload fun(class: "Object", undo: Undo?): Object
---@overload fun(class: "MVRxchange", undo: Undo?): MVRxchange
---@overload fun(class: "SmartViewSettingsCollect", undo: Undo?): SmartViewSettingsCollect
---@overload fun(class: "RunningPlaybacksSettingsCollect", undo: Undo?): RunningPlaybacksSettingsCollect
...
function Pult:Aquire(class, undo) end
...
---@overload fun(index: integer, class: "Devices", undo: Undo?, count: integer?): Devices
...
function Pult:Insert(index, class, undo, count) end
...
---@overload fun(name: string, class: "Devices"): Devices
...
function Pult:Find(name, class) end
---@overload fun(name: string, class: "Object"): Object
---@overload fun(name: string, class: "MVRxchange"): MVRxchange
---@overload fun(name: string, class: "SmartViewSettingsCollect"): SmartViewSettingsCollect
---@overload fun(name: string, class: "RunningPlaybacksSettingsCollect"): RunningPlaybacksSettingsCollect
...
---@overload fun(name: string, class: "IllegalObject"): IllegalObject
---@overload fun(name: string, class: nil): Object
function Pult:FindRecursive(name, class) end
