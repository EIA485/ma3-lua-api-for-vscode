...
---@field LinkMainCmdline YesNo|boolean
---@field Cmd Cmdline
...
---@param class `T`
---@return boolean
function Pult:IsClass(class) end
---@return PultCollect
function Pult:Parent() end
---@return 19
function Pult:PropertyCount() end
...
---@overload fun(idx: 15): "PultType"
---@overload fun(idx: 16): "LinkMainCmdline"
---@overload fun(idx: 17): "Cmd"
---@overload fun(idx: 18): "MainLoopCount"
function Pult:PropertyName(idx) end
---@overload fun(idx: 0|1|2): {ExportIgnore: True, EnumCollection: YesNo, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 3|12|16): {ExportIgnore: False, EnumCollection: YesNo, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 4|5|6|17|18): {ExportIgnore: True, ReadOnly: False, ImportIgnore: False}
...
---@overload fun(idx: 15): {ExportIgnore: True, EnumCollection: PultType, ReadOnly: True, ImportIgnore: True}
function Pult:PropertyInfo(idx) end
...
---@overload fun(class: "NoteTextEdit", undo: Undo?): NoteTextEdit
---@overload fun(class: nil, undo: Undo?): Object
function Pult:Find(class, undo) end
---@overload fun(property_name: "Cmd", property_value: Cmdline, override_change_level: ChangeLevel?)
---@overload fun(property_name: "IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"Hidden"|"LinkMainCmdline", property_value: YesNo|boolean, override_change_level: ChangeLevel?)
---@overload fun(property_name: "Index"|"Count"|"No"|"MainLoopCount", property_value: integer, override_change_level: ChangeLevel?)
---@overload fun(property_name: "Name"|"Note"|"DependencyExport", property_value: string, override_change_level: ChangeLevel?)
function Pult:Set(property_name, property_value, override_change_level) end
...
function Pult:SetChildren(property_name, property_value) end