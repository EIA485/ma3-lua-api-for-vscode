...
---@generic T : PresetGridData
---@param class `T`
---@return boolean
function PresetGridData:IsClass(class) end
---@return 16
function PresetGridData:PropertyCount() end
...
function PresetGridData:PropertyName(idx) end
...
function PresetGridData:PropertyInfo(idx) end
...
function PresetGridData:PropertyType(idx) end
...
---@overload fun(property_name: "Target", property_value: Preset, override_change_level: ChangeLevel?)
...
function PresetGridData:Set(property_name, property_value, override_change_level) end