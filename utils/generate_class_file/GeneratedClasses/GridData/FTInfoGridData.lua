...
---@generic T : FTInfoGridData
---@param class `T`
---@return boolean
function FTInfoGridData:IsClass(class) end
---@return 16
function FTInfoGridData:PropertyCount() end
...
---@overload fun(idx: 15): "Channels"
function FTInfoGridData:PropertyName(idx) end
...
function FTInfoGridData:PropertyInfo(idx) end
...
function FTInfoGridData:PropertyType(idx) end
...
---@overload fun(property_name: "Channels", property_value: DeskLightChannel[], override_change_level: ChangeLevel?)
...
function FTInfoGridData:Set(property_name, property_value, override_change_level) end