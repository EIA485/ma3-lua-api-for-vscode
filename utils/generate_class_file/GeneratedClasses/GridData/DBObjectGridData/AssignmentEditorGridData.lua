...
---@generic T : AssignmentEditorGridData
---@param class `T`
---@return boolean
function AssignmentEditorGridData:IsClass(class) end
---@return 28
function AssignmentEditorGridData:PropertyCount() end
...
---@overload fun(idx: 26): "SearchString"
---@overload fun(idx: 27): "RowFilter"
function AssignmentEditorGridData:PropertyName(idx) end
...
---@overload fun(idx: 7|8|13|15|16|22|23|26): {ExportIgnore: False, ReadOnly: False, ImportIgnore: False}
...
---@overload fun(idx: 27): {ExportIgnore: False, EnumCollection: RowFilter, ReadOnly: False, ImportIgnore: False}
function AssignmentEditorGridData:PropertyInfo(idx) end
---@overload fun(idx: 0|1|2|3|4|5|6|9|15): "UInt32"
---@overload fun(idx: 7|8|13|26): "String"
...
---@overload fun(idx: 27): "UInt8"
function AssignmentEditorGridData:PropertyType(idx) end
---@overload fun(name: "DefaultToken", role: nil): PresetActionToken
---@overload fun(name: "DefaultRole", role: nil): Roles
---@overload fun(name: "RowFilter", role: nil): RowFilter
...
---@overload fun(name: "Name"|"Note"|"DependencyExport"|"SearchString", role: nil): string
...
---@overload fun(property_name: "RowFilter", property_value: RowFilter, override_change_level: ChangeLevel?)
...
---@overload fun(property_name: "Name"|"Note"|"DependencyExport"|"SearchString", property_value: string, override_change_level: ChangeLevel?)
function AssignmentEditorGridData:Set(property_name, property_value, override_change_level) end