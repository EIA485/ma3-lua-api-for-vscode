...
---@field ShowFileName string
---@field Status integer
---@field PSRStatus CleanupOperation
---@field PSRAllowed boolean
---@field OnRunPreparation fun(str: string) : boolean
---@field OnOpenPatch fun(str: string) : boolean
---@field OnRunConversion fun(str: string) : boolean
---@field OnOpenImport fun(str: string) : boolean
---@field OnRunImport fun(str: string) : boolean
---@field OnCleanup fun(str: string) : boolean
---@field OnClosePSR fun(str: string) : boolean
local ConvertTask = {
    OnRunPreparation="in:OnRunPreparation(s;)",
    OnOpenPatch="in:OnOpenPatch(s;)",
    OnRunConversion="in:OnRunConversion(s;)",
    OnOpenImport="in:OnOpenImport(s;)",
    OnRunImport="in:OnRunImport(s;)",
    OnCleanup="in:OnCleanup(s;)",
    OnClosePSR="in:OnClosePSR(s;)"
}
---@return "ConvertTask"
function ConvertTask:GetClass() end
---@return "Object"
function ConvertTask:GetChildClass() end
---@return Temp
function ConvertTask:Parent() end
...
---@overload fun(name: "ShowFileName", role: nil): string
---@overload fun(name: "Status", role: nil): integer
---@overload fun(name: "PSRStatus", role: nil): CleanupOperation
---@overload fun(name: "PSRAllowed", role: nil): boolean
---@overload fun(name: "OnRunPreparation"|"OnOpenPatch"|"OnRunConversion"|"OnOpenImport"|"OnRunImport"|"OnCleanup"|"OnClosePSR", role: nil): fun(str: string) : boolean
---@overload fun(name: "IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"Index"|"Count"|"No"|"Name"|"Note"|"UserExpanded"|"FaderEnabled"|"Owned"|"Hidden"|"DependencyExport"|"MemoryFootprint"|"ShowFileName"|"Status"|"PSRStatus"|"PSRAllowed"|"OnRunPreparation"|"OnOpenPatch"|"OnRunConversion"|"OnOpenImport"|"OnRunImport"|"OnCleanup"|"OnClosePSR", role: Enums.Roles): string
---@overload fun(name: integer, role: nil): Object
function ConvertTask:Get(name, role) end
---@overload fun(index: integer, class: "Object", undo: Undo?): Object
---@overload fun(index: integer, class: "ImportObjectCollect", undo: Undo?): ImportObjectCollect
---@overload fun(index: integer, class: "PatchFakeCollect", undo: Undo?): PatchFakeCollect
...
function ConvertTask:Create(index, class, undo) end
---@overload fun(class: "Object", undo: Undo?, count: integer?): Object
---@overload fun(class: "ImportObjectCollect", undo: Undo?, count: integer?): ImportObjectCollect
---@overload fun(class: "PatchFakeCollect", undo: Undo?, count: integer?): PatchFakeCollect
...
function ConvertTask:Append(class, undo, count) end
---@overload fun(class: "Object", undo: Undo?): Object
---@overload fun(class: "ImportObjectCollect", undo: Undo?): ImportObjectCollect
---@overload fun(class: "PatchFakeCollect", undo: Undo?): PatchFakeCollect
...
function ConvertTask:Acquire(class, undo) end
---@overload fun(class: "Object", undo: Undo?): Object
---@overload fun(class: "ImportObjectCollect", undo: Undo?): ImportObjectCollect
---@overload fun(class: "PatchFakeCollect", undo: Undo?): PatchFakeCollect
---@overload fun(class: "MVRxchange", undo: Undo?): MVRxchange
...
function ConvertTask:Aquire(class, undo) end
---@overload fun(index: integer, class: "Object", undo: Undo?, count: integer?): Object
---@overload fun(index: integer, class: "ImportObjectCollect", undo: Undo?, count: integer?): ImportObjectCollect
---@overload fun(index: integer, class: "PatchFakeCollect", undo: Undo?, count: integer?): PatchFakeCollect
...
function ConvertTask:Insert(index, class, undo, count) end
---@overload fun(name: string, class: "Object"): Object
---@overload fun(name: string, class: "ImportObjectCollect"): ImportObjectCollect
---@overload fun(name: string, class: "PatchFakeCollect"): PatchFakeCollect
...
function ConvertTask:Find(name, class) end
---@overload fun(name: string, class: "Object"): Object
---@overload fun(name: string, class: "ImportObjectCollect"): ImportObjectCollect
---@overload fun(name: string, class: "PatchFakeCollect"): PatchFakeCollect
---@overload fun(name: string, class: "MVRxchange"): MVRxchange
...
---@overload fun(name: string, class: "IllegalObject"): IllegalObject
---@overload fun(name: string, class: nil): Object
function ConvertTask:FindRecursive(name, class) end
