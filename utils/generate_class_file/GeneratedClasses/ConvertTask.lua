...
---@field PSRStatus PsrOperation
---@field PSRAllowed YesNo|boolean
...
---@generic T : ConvertTask
---@param class `T`
---@return boolean
function ConvertTask:IsClass(class) end
---@return Temp
function ConvertTask:Parent() end
---@return 26
function ConvertTask:PropertyCount() end
...
---@overload fun(idx: 15): "ShowFileName"
---@overload fun(idx: 16): "Status"
---@overload fun(idx: 17): "PSRStatus"
---@overload fun(idx: 18): "PSRAllowed"
---@overload fun(idx: 19): "OnRunPreparation"
---@overload fun(idx: 20): "OnOpenPatch"
---@overload fun(idx: 21): "OnRunConversion"
---@overload fun(idx: 22): "OnOpenImport"
---@overload fun(idx: 23): "OnRunImport"
---@overload fun(idx: 24): "OnCleanup"
---@overload fun(idx: 25): "OnClosePSR"
function ConvertTask:PropertyName(idx) end
...
---@overload fun(idx: 7|8|13|15|16|19|20|21|22|23|24|25): {ExportIgnore: False, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 9): {ExportIgnore: False, EnumCollection: YesNo, ReadOnly: True, ImportIgnore: True}
---@overload fun(idx: 10|11): {ExportIgnore: True, EnumCollection: YesNo, ReadOnly: True, ImportIgnore: True}
---@overload fun(idx: 14): {ExportIgnore: False, ReadOnly: True, ImportIgnore: True}
---@overload fun(idx: 17): {ExportIgnore: False, EnumCollection: PsrOperation, ReadOnly: False, ImportIgnore: False}
function ConvertTask:PropertyInfo(idx) end
---@overload fun(idx: 0|1|2|3|4|5|6|9|16|17): "UInt32"
---@overload fun(idx: 7|8|13|15): "String"
---@overload fun(idx: 10|11|18): "Bool"
---@overload fun(idx: 12): "UInt64"
---@overload fun(idx: 14): "Int64"
---@overload fun(idx: 19|20|21|22|23|24|25): "Action"
function ConvertTask:PropertyType(idx) end
---@overload fun(name: "PSRStatus", role: nil): PsrOperation
---@overload fun(name: "IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"UserExpanded"|"FaderEnabled"|"Owned"|"Hidden"|"PSRAllowed", role: nil): YesNo|boolean
...
---@overload fun(name: "Index"|"Count"|"No"|"MemoryFootprint"|"Status", role: nil): integer
---@overload fun(name: "Name"|"Note"|"DependencyExport"|"ShowFileName", role: nil): string
...
---@overload fun(class: "NoteTextEdit", undo: Undo?): NoteTextEdit
---@overload fun(class: nil, undo: Undo?): Object
function ConvertTask:Find(class, undo) end
---@overload fun(property_name: "PSRStatus", property_value: PsrOperation, override_change_level: ChangeLevel?)
---@overload fun(property_name: "IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"Hidden"|"PSRAllowed", property_value: YesNo|boolean, override_change_level: ChangeLevel?)
---@overload fun(property_name: "OnRunPreparation"|"OnOpenPatch"|"OnRunConversion"|"OnOpenImport"|"OnRunImport"|"OnCleanup"|"OnClosePSR", property_value: fun(str: string) : boolean, override_change_level: ChangeLevel?)
---@overload fun(property_name: "Index"|"Count"|"No"|"Status", property_value: integer, override_change_level: ChangeLevel?)
---@overload fun(property_name: "Name"|"Note"|"DependencyExport"|"ShowFileName", property_value: string, override_change_level: ChangeLevel?)
function ConvertTask:Set(property_name, property_value, override_change_level) end
...
function ConvertTask:SetChildren(property_name, property_value) end