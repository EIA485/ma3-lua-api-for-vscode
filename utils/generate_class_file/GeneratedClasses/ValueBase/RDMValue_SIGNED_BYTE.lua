...
---@generic T : RDMValue_SIGNED_BYTE
---@param class `T`
---@return boolean
function RDMValue_SIGNED_BYTE:IsClass(class) end
---@return 17
function RDMValue_SIGNED_BYTE:PropertyCount() end
...
function RDMValue_SIGNED_BYTE:PropertyName(idx) end
...
function RDMValue_SIGNED_BYTE:PropertyInfo(idx) end
...
---@overload fun(idx: 16): "Int8"
function RDMValue_SIGNED_BYTE:PropertyType(idx) end
...
function RDMValue_SIGNED_BYTE:Set(property_name, property_value, override_change_level) end