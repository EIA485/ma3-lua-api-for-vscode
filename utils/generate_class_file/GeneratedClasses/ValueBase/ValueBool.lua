...
---@param class `T`
---@return boolean
function ValueBool:IsClass(class) end
---@return 17
function ValueBool:PropertyCount() end
...
function ValueBool:PropertyName(idx) end
...
---@overload fun(idx: 16): {ExportIgnore: True, EnumCollection: TrueFalse, ReadOnly: False, ImportIgnore: False}
function ValueBool:PropertyInfo(idx) end
...
function ValueBool:PropertyType(idx) end
---@overload fun(name: "ThresholdOperator", role: nil): RDMNotificationThresholdOperator
---@overload fun(name: "Value", role: nil): TrueFalse|boolean
...
---@overload fun(property_name: "Value", property_value: TrueFalse|boolean, override_change_level: ChangeLevel?)
...
function ValueBool:Set(property_name, property_value, override_change_level) end