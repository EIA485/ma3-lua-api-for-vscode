...
---@generic T : Value_Default_Slot_Value
---@param class `T`
---@return boolean
function Value_Default_Slot_Value:IsClass(class) end
---@return 18
function Value_Default_Slot_Value:PropertyCount() end
...
---@overload fun(idx: 17): "DefaultSlotValue"
function Value_Default_Slot_Value:PropertyName(idx) end
...
function Value_Default_Slot_Value:PropertyInfo(idx) end
...
function Value_Default_Slot_Value:PropertyType(idx) end
...
---@overload fun(name: "Index"|"Count"|"No"|"MemoryFootprint"|"Offset"|"DefaultSlotValue", role: nil): integer
---@overload fun(name: "Name"|"Note"|"DependencyExport", role: nil): string
---@overload fun(name: "IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"Index"|"Count"|"No"|"Name"|"Note"|"UserExpanded"|"FaderEnabled"|"Owned"|"Hidden"|"DependencyExport"|"MemoryFootprint"|"ThresholdOperator"|"Offset"|"DefaultSlotValue", role: Enums.Roles): string
...
---@overload fun(property_name: "Index"|"Count"|"No"|"Offset"|"DefaultSlotValue", property_value: integer, override_change_level: ChangeLevel?)
---@overload fun(property_name: "Name"|"Note"|"DependencyExport", property_value: string, override_change_level: ChangeLevel?)
function Value_Default_Slot_Value:Set(property_name, property_value, override_change_level) end