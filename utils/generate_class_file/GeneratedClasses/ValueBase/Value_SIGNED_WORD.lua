...
---@generic T : Value_SIGNED_WORD
---@param class `T`
---@return boolean
function Value_SIGNED_WORD:IsClass(class) end
---@return 17
function Value_SIGNED_WORD:PropertyCount() end
...
function Value_SIGNED_WORD:PropertyName(idx) end
...
function Value_SIGNED_WORD:PropertyInfo(idx) end
...
---@overload fun(idx: 16): "Int16"
function Value_SIGNED_WORD:PropertyType(idx) end
...
function Value_SIGNED_WORD:Set(property_name, property_value, override_change_level) end