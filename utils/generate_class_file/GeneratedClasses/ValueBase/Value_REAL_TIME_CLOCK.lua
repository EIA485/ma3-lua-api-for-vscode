...
---@generic T : Value_REAL_TIME_CLOCK
---@param class `T`
---@return boolean
function Value_REAL_TIME_CLOCK:IsClass(class) end
---@return 22
function Value_REAL_TIME_CLOCK:PropertyCount() end
...
---@overload fun(idx: 16): "Year"
---@overload fun(idx: 17): "Month"
---@overload fun(idx: 18): "Day"
---@overload fun(idx: 19): "Hours"
---@overload fun(idx: 20): "Minute"
---@overload fun(idx: 21): "Second"
function Value_REAL_TIME_CLOCK:PropertyName(idx) end
...
---@overload fun(idx: 7|8|13|16|17|18|19|20|21): {ExportIgnore: False, ReadOnly: False, ImportIgnore: False}
...
function Value_REAL_TIME_CLOCK:PropertyInfo(idx) end
---@overload fun(idx: 0|1|2|3|4|5|6|9): "UInt32"
---@overload fun(idx: 7|8|13): "String"
---@overload fun(idx: 10|11): "Bool"
---@overload fun(idx: 12): "UInt64"
---@overload fun(idx: 14): "Int64"
---@overload fun(idx: 15|17|18|19|20|21): "UInt8"
---@overload fun(idx: 16): "UInt16"
function Value_REAL_TIME_CLOCK:PropertyType(idx) end
...
---@overload fun(name: "Index"|"Count"|"No"|"MemoryFootprint"|"Year"|"Month"|"Day"|"Hours"|"Minute"|"Second", role: nil): integer
---@overload fun(name: "Name"|"Note"|"DependencyExport", role: nil): string
---@overload fun(name: "IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"Index"|"Count"|"No"|"Name"|"Note"|"UserExpanded"|"FaderEnabled"|"Owned"|"Hidden"|"DependencyExport"|"MemoryFootprint"|"ThresholdOperator"|"Year"|"Month"|"Day"|"Hours"|"Minute"|"Second", role: Enums.Roles): string
...
---@overload fun(property_name: "Index"|"Count"|"No"|"Year"|"Month"|"Day"|"Hours"|"Minute"|"Second", property_value: integer, override_change_level: ChangeLevel?)
---@overload fun(property_name: "Name"|"Note"|"DependencyExport", property_value: string, override_change_level: ChangeLevel?)
function Value_REAL_TIME_CLOCK:Set(property_name, property_value, override_change_level) end