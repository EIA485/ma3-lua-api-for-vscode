...
---@generic T : Value_ASCII
---@param class `T`
---@return boolean
function Value_ASCII:IsClass(class) end
---@return 17
function Value_ASCII:PropertyCount() end
...
function Value_ASCII:PropertyName(idx) end
...
function Value_ASCII:PropertyInfo(idx) end
...
function Value_ASCII:PropertyType(idx) end
...
---@overload fun(name: "Name"|"Note"|"DependencyExport"|"Value", role: nil): string
...
---@overload fun(property_name: "Name"|"Note"|"DependencyExport"|"Value", property_value: string, override_change_level: ChangeLevel?)
function Value_ASCII:Set(property_name, property_value, override_change_level) end