...
---@generic T : Value_SIGNED_DWORD
---@param class `T`
---@return boolean
function Value_SIGNED_DWORD:IsClass(class) end
---@return 17
function Value_SIGNED_DWORD:PropertyCount() end
...
function Value_SIGNED_DWORD:PropertyName(idx) end
...
function Value_SIGNED_DWORD:PropertyInfo(idx) end
...
function Value_SIGNED_DWORD:PropertyType(idx) end
...
function Value_SIGNED_DWORD:Set(property_name, property_value, override_change_level) end