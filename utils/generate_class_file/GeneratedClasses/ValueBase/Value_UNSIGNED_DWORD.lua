...
---@generic T : Value_UNSIGNED_DWORD
---@param class `T`
---@return boolean
function Value_UNSIGNED_DWORD:IsClass(class) end
---@return 17
function Value_UNSIGNED_DWORD:PropertyCount() end
...
function Value_UNSIGNED_DWORD:PropertyName(idx) end
...
function Value_UNSIGNED_DWORD:PropertyInfo(idx) end
...
function Value_UNSIGNED_DWORD:PropertyType(idx) end
...
function Value_UNSIGNED_DWORD:Set(property_name, property_value, override_change_level) end