...
---@generic T : RDMValue_UNSIGNED_BYTE
---@param class `T`
---@return boolean
function RDMValue_UNSIGNED_BYTE:IsClass(class) end
---@return 17
function RDMValue_UNSIGNED_BYTE:PropertyCount() end
...
function RDMValue_UNSIGNED_BYTE:PropertyName(idx) end
...
function RDMValue_UNSIGNED_BYTE:PropertyInfo(idx) end
...
function RDMValue_UNSIGNED_BYTE:PropertyType(idx) end
...
function RDMValue_UNSIGNED_BYTE:Set(property_name, property_value, override_change_level) end