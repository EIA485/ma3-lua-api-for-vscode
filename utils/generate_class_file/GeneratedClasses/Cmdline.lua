...
---@param class `T`
---@return boolean
function Cmdline:IsClass(class) end
---@return Cmdlines
function Cmdline:Parent() end
---@return 28
function Cmdline:PropertyCount() end
...
---@overload fun(idx: 15): "Destination"
---@overload fun(idx: 16): "User"
---@overload fun(idx: 17): "Profile"
---@overload fun(idx: 18): "Action"
---@overload fun(idx: 19): "ClearCmd"
---@overload fun(idx: 20): "RefreshMetaData"
---@overload fun(idx: 21): "DMXReadout"
---@overload fun(idx: 22): "EditObject"
---@overload fun(idx: 23): "CmdText"
---@overload fun(idx: 24): "LastCommand"
---@overload fun(idx: 25): "MaxStep"
---@overload fun(idx: 26): "IsFixed"
---@overload fun(idx: 27): "GetSelectedObject"
function Cmdline:PropertyName(idx) end
---@overload fun(idx: 0|1|2): {ExportIgnore: True, EnumCollection: YesNo, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 3|12): {ExportIgnore: False, EnumCollection: YesNo, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 4|5|6|15|16|17|23|24|25): {ExportIgnore: True, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 7|8|13|18|19|20): {ExportIgnore: False, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 9): {ExportIgnore: False, EnumCollection: YesNo, ReadOnly: True, ImportIgnore: True}
---@overload fun(idx: 10|11): {ExportIgnore: True, EnumCollection: YesNo, ReadOnly: True, ImportIgnore: True}
---@overload fun(idx: 14|26|27): {ExportIgnore: False, ReadOnly: True, ImportIgnore: True}
---@overload fun(idx: 21): {ExportIgnore: False, EnumCollection: DMXReadoutMode, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 22): {ExportIgnore: True, ReadOnly: True, ImportIgnore: True}
function Cmdline:PropertyInfo(idx) end
---@overload fun(idx: 0|1|2|3|4|5|6|9): "UInt32"
---@overload fun(idx: 7|8|13|23|24): "String"
---@overload fun(idx: 10|11): "Bool"
---@overload fun(idx: 12): "UInt64"
---@overload fun(idx: 14): "Int64"
---@overload fun(idx: 15|22): "Handle"
---@overload fun(idx: 16|17): "Custom"
---@overload fun(idx: 18|19|20): "Action"
---@overload fun(idx: 21|25): "UInt8"
---@overload fun(idx: 26|27): "Method"
function Cmdline:PropertyType(idx) end
---@overload fun(name: "DMXReadout", role: nil): DMXReadoutMode
---@overload fun(name: "Destination"|"EditObject", role: nil): Object
...
---@overload fun(name: "Index"|"Count"|"No"|"MemoryFootprint"|"MaxStep", role: nil): integer
---@overload fun(name: "Name"|"Note"|"DependencyExport"|"CmdText"|"LastCommand", role: nil): string
...
---@overload fun(class: "NoteTextEdit", undo: Undo?): NoteTextEdit
---@overload fun(class: nil, undo: Undo?): Object
function Cmdline:Find(class, undo) end
---@overload fun(property_name: "DMXReadout", property_value: DMXReadoutMode, override_change_level: ChangeLevel?)
---@overload fun(property_name: "Destination", property_value: Object, override_change_level: ChangeLevel?)
---@overload fun(property_name: "User", property_value: User, override_change_level: ChangeLevel?)
---@overload fun(property_name: "Profile", property_value: UserProfile, override_change_level: ChangeLevel?)
...
---@overload fun(property_name: "ClearCmd"|"RefreshMetaData", property_value: fun(str: string) : boolean, override_change_level: ChangeLevel?)
---@overload fun(property_name: "Index"|"Count"|"No"|"MaxStep", property_value: integer, override_change_level: ChangeLevel?)
---@overload fun(property_name: "Name"|"Note"|"DependencyExport"|"CmdText"|"LastCommand", property_value: string, override_change_level: ChangeLevel?)
function Cmdline:Set(property_name, property_value, override_change_level) end
...
---@overload fun(property_name: "ImageNDISource", property_value: NDISource)
...
---@overload fun(property_name: "FilterMode", property_value: ProgUpdateCueMode)
...
---@overload fun(property_name: "UpdateCueOnly", property_value: CueOnly)
...
---@overload fun(property_name: "ContentSheetCueMode", property_value: ContentSheetCueMode)
---@overload fun(property_name: "CueOnly"|"CopyCueOnly", property_value: CopyCueOnly)
---@overload fun(property_name: "ShownCue", property_value: Cue)
---@overload fun(property_name: "CopyCueDst", property_value: CueCopyDst)
---@overload fun(property_name: "CopyCueDstMode", property_value: CueCopyDstMode)
---@overload fun(property_name: "CopyCueSrc", property_value: CueCopySrc)
...
---@overload fun(property_name: "ImageNDISource", property_value: NDISource)
---@overload fun(property_name: "StageFilter", property_value: None_only)
---@overload fun(property_name: "Filter"|"FixedTarget"|"SelectedAgenda"|"Values"|"Filter"|"Target"|"PreferenceHandle"|"ShowDestination"|"DestinationObject", property_value: Object)
...
---@overload fun(property_name: "UpdateModeCues"|"UpdateModePresets", property_value: Update)
---@overload fun(property_name: "User", property_value: User)
---@overload fun(property_name: "UserRights", property_value: UserRights)
...
---@overload fun(property_name: "Page"|"VisibleGrid"|"SnapGrid"|"TimerIndex"|"PaddingBottom"|"LastConnectionTime"|"LightBeamOverdrawLimit"|"ImageNDIIndex"|"PaddingLeft"|"DimmerIncrement"|"AmountHue"|"PaddingRight"|"AmountSaturation"|"Mode"|"MemoryLimit"|"PaddingTop"|"ParameterCount"|"InitialWhiteFilter"|"Page"|"FileSize"|"DesiredUiFps"|"Index"|"Page"|"Count"|"SplitSize"|"No"|"ChangeCount"|"SoftwareID"|"DynamicGoboResolution"|"PoolObjectContentSizeLimitation"|"SubPoolSelectorValue"|"SubPoolSelectorIndex"|"ColumnsCount"|"Texture"|"UndoIndex"|"Width"|"HazeLayers"|"Cont.Size"|"Height"|"SplitSize"|"Cont.Ref"|"Page"|"TCSlot"|"ColumnsCount"|"ScreenContentMask"|"RealtimeIteration"|"LabMaxCount"|"AutoColumnsWidth", property_value: integer)
---@overload fun(property_name: "ObjectList"|"StageFilterList"|"ObjectList", property_value: integer[])
...
---@overload fun(property_name: "TimezoneStr"|"StoredData"|"TitlePrefix"|"LibraryPath"|"ClassFilter"|"OptionalLibraryPath"|"FileName"|"FixtureTypeFilter"|"Type"|"ToolAction"|"FileName"|"SelectedFilter"|"FilePath"|"GroupName"|"Interface"|"FileContent"|"Author"|"SelectionCount"|"ManufacturerID"|"Path"|"DeviceModelID"|"Name"|"Note"|"SoftwareVersionLabel"|"Comment"|"Note"|"DisplayPool"|"TargetName"|"DependencyExport"|"ChildName"|"Description"|"SelectedDataPool"|"GridColumnConfigurationType"|"Type"|"NewName"|"User"|"LastReceivedMidi"|"FeatureGroup"|"*"|"ContentFilterType"|"Trigger"|"NewShowStartDescription"|"Type"|"LayerFilter", property_value: string)
---@overload fun(property_name: "ClassFilterList"|"Filters"|"VisibleTitlebuttons"|"FixtureTypeFilterList"|"LayerFilterList", property_value: string[])
function Cmdline:SetChildren(property_name, property_value) end