...
---@field ClearCmd fun(str: string) : boolean
---@field RefreshMetaData fun(str: string) : boolean
---@field DMXReadout DMXReadoutMode
---@field EditObject Object
---@field CmdText string
---@field LastCommand string
---@field MaxStep integer
---@field IsFixed fun(exec: Exec) : CmdEventStatus
---@field GetSelectedObject fun() : Object
local Cmdline = {
    Action="in:(s;)",
    ClearCmd="in:(s;)",
    RefreshMetaData="in:(s;)",
    DMXReadout="Percent",
    MaxStep="0"
}
---@return "Cmdline"
function Cmdline:GetClass() end
---@return "Object"
function Cmdline:GetChildClass() end
---@return Cmdlines
function Cmdline:Parent() end
...
---@overload fun(name: "Destination", role: nil): Object
...
---@overload fun(name: "ClearCmd"|"RefreshMetaData", role: nil): fun(str: string) : boolean
---@overload fun(name: "DMXReadout", role: nil): DMXReadoutMode
---@overload fun(name: "EditObject", role: nil): Object
---@overload fun(name: "CmdText"|"LastCommand", role: nil): string
---@overload fun(name: "MaxStep", role: nil): integer
---@overload fun(name: "IsFixed", role: nil): fun(exec: Exec) : CmdEventStatus
---@overload fun(name: "GetSelectedObject", role: nil): fun() : Object
---@overload fun(name: "IgnoreNetwork"|"StructureLocked"|"SystemLocked"|"Lock"|"Index"|"Count"|"No"|"Name"|"Note"|"UserExpanded"|"FaderEnabled"|"Owned"|"Hidden"|"DependencyExport"|"MemoryFootprint"|"Destination"|"User"|"Profile"|"Action"|"ClearCmd"|"RefreshMetaData"|"DMXReadout"|"EditObject"|"CmdText"|"LastCommand"|"MaxStep"|"IsFixed"|"GetSelectedObject", role: Enums.Roles): string
---@overload fun(name: integer, role: nil): Object
function Cmdline:Get(name, role) end
...
---@overload fun(index: integer, class: "Library", undo: Undo?): Library
...
---@overload fun(index: integer, class: "TempStoreSettings", undo: Undo?): TempStoreSettings
...
---@overload fun(index: integer, class: "ShowMetaDataCollect", undo: Undo?): ShowMetaDataCollect
...
---@overload fun(index: integer, class: "ProgUpdateCollect", undo: Undo?): ProgUpdateCollect
---@overload fun(index: integer, class: "CueUpdates", undo: Undo?): CueUpdates
---@overload fun(index: integer, class: "PresetUpdates", undo: Undo?): PresetUpdates
---@overload fun(index: integer, class: "Undos", undo: Undo?): Undos
...
function Cmdline:Create(index, class, undo) end
...
---@overload fun(class: "Library", undo: Undo?, count: integer?): Library
...
---@overload fun(class: "TempStoreSettings", undo: Undo?, count: integer?): TempStoreSettings
...
---@overload fun(class: "ShowMetaDataCollect", undo: Undo?, count: integer?): ShowMetaDataCollect
...
---@overload fun(class: "ProgUpdateCollect", undo: Undo?, count: integer?): ProgUpdateCollect
---@overload fun(class: "CueUpdates", undo: Undo?, count: integer?): CueUpdates
---@overload fun(class: "PresetUpdates", undo: Undo?, count: integer?): PresetUpdates
---@overload fun(class: "Undos", undo: Undo?, count: integer?): Undos
...
function Cmdline:Append(class, undo, count) end
...
---@overload fun(class: "Library", undo: Undo?): Library
...
---@overload fun(class: "TempStoreSettings", undo: Undo?): TempStoreSettings
...
---@overload fun(class: "ShowMetaDataCollect", undo: Undo?): ShowMetaDataCollect
---@overload fun(class: "ShowMetaData", undo: Undo?): ShowMetaData
---@overload fun(class: "SoundChannels", undo: Undo?): SoundChannels
---@overload fun(class: "ProgUpdateCollect", undo: Undo?): ProgUpdateCollect
---@overload fun(class: "CueUpdates", undo: Undo?): CueUpdates
---@overload fun(class: "PresetUpdates", undo: Undo?): PresetUpdates
---@overload fun(class: "Undos", undo: Undo?): Undos
...
function Cmdline:Acquire(class, undo) end
---@overload fun(class: "Object", undo: Undo?): Object
---@overload fun(class: "MVRxchange", undo: Undo?): MVRxchange
---@overload fun(class: "SmartViewSettingsCollect", undo: Undo?): SmartViewSettingsCollect
---@overload fun(class: "RunningPlaybacksSettingsCollect", undo: Undo?): RunningPlaybacksSettingsCollect
...
function Cmdline:Aquire(class, undo) end
...
---@overload fun(index: integer, class: "Library", undo: Undo?, count: integer?): Library
...
---@overload fun(index: integer, class: "TempStoreSettings", undo: Undo?, count: integer?): TempStoreSettings
...
---@overload fun(index: integer, class: "ShowMetaDataCollect", undo: Undo?, count: integer?): ShowMetaDataCollect
...
---@overload fun(index: integer, class: "ProgUpdateCollect", undo: Undo?, count: integer?): ProgUpdateCollect
---@overload fun(index: integer, class: "CueUpdates", undo: Undo?, count: integer?): CueUpdates
---@overload fun(index: integer, class: "PresetUpdates", undo: Undo?, count: integer?): PresetUpdates
---@overload fun(index: integer, class: "Undos", undo: Undo?, count: integer?): Undos
...
function Cmdline:Insert(index, class, undo, count) end
...
---@overload fun(name: string, class: "Library"): Library
...
---@overload fun(name: string, class: "TempStoreSettings"): TempStoreSettings
...
---@overload fun(name: string, class: "ShowMetaDataCollect"): ShowMetaDataCollect
---@overload fun(name: string, class: "ShowMetaData"): ShowMetaData
---@overload fun(name: string, class: "SoundChannels"): SoundChannels
---@overload fun(name: string, class: "ProgUpdateCollect"): ProgUpdateCollect
---@overload fun(name: string, class: "CueUpdates"): CueUpdates
---@overload fun(name: string, class: "PresetUpdates"): PresetUpdates
---@overload fun(name: string, class: "Undos"): Undos
...
function Cmdline:Find(name, class) end
---@overload fun(name: string, class: "Object"): Object
---@overload fun(name: string, class: "MVRxchange"): MVRxchange
---@overload fun(name: string, class: "SmartViewSettingsCollect"): SmartViewSettingsCollect
---@overload fun(name: string, class: "RunningPlaybacksSettingsCollect"): RunningPlaybacksSettingsCollect
...
---@overload fun(name: string, class: "IllegalObject"): IllegalObject
---@overload fun(name: string, class: nil): Object
function Cmdline:FindRecursive(name, class) end
