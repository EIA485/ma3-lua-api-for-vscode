...
---@generic T : RDMSensorNotification
---@param class `T`
---@return boolean
function RDMSensorNotification:IsClass(class) end
---@param index integer
---@return ValueSensor
...
---@return 16
function RDMSensorNotification:PropertyCount() end
...
---@overload fun(idx: 15): "SensorOffset"
function RDMSensorNotification:PropertyName(idx) end
...
function RDMSensorNotification:PropertyInfo(idx) end
...
function RDMSensorNotification:PropertyType(idx) end
...
---@overload fun(name: "Index"|"Count"|"No"|"MemoryFootprint"|"SensorOffset", role: nil): integer
...
---@overload fun(property_name: "Index"|"Count"|"No"|"SensorOffset", property_value: integer, override_change_level: ChangeLevel?)
---@overload fun(property_name: "Name"|"Note"|"DependencyExport", property_value: string, override_change_level: ChangeLevel?)
function RDMSensorNotification:Set(property_name, property_value, override_change_level) end