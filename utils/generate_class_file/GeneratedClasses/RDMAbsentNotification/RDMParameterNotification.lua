...
---@generic T : RDMParameterNotification
---@param class `T`
---@return boolean
function RDMParameterNotification:IsClass(class) end
---@return 16
function RDMParameterNotification:PropertyCount() end
...
function RDMParameterNotification:PropertyName(idx) end
...
function RDMParameterNotification:PropertyInfo(idx) end
...
function RDMParameterNotification:PropertyType(idx) end
...
function RDMParameterNotification:Set(property_name, property_value, override_change_level) end