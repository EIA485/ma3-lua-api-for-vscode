...
---@param class `T`
---@return boolean
function Patch:IsClass(class) end
---@return ShowData
function Patch:Parent() end
---@return 24
function Patch:PropertyCount() end
...
---@overload fun(idx: 15): "CountFixtures"
---@overload fun(idx: 16): "CountSubfixtures"
---@overload fun(idx: 17): "CountRTChannels"
---@overload fun(idx: 18): "CountUIChannels"
---@overload fun(idx: 19): "CountDMXModes"
---@overload fun(idx: 20): "CountLogicalChannels"
---@overload fun(idx: 21): "ResetAttribDefinitionsToDefault"
---@overload fun(idx: 22): "OpenPatch"
---@overload fun(idx: 23): "ClosePatch"
function Patch:PropertyName(idx) end
---@overload fun(idx: 0|1|2): {ExportIgnore: True, EnumCollection: YesNo, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 3|12): {ExportIgnore: False, EnumCollection: YesNo, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 4|5|6|15|16|17|18|19|20): {ExportIgnore: True, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 7|8|13): {ExportIgnore: False, ReadOnly: False, ImportIgnore: False}
---@overload fun(idx: 9): {ExportIgnore: False, EnumCollection: YesNo, ReadOnly: True, ImportIgnore: True}
---@overload fun(idx: 10|11): {ExportIgnore: True, EnumCollection: YesNo, ReadOnly: True, ImportIgnore: True}
---@overload fun(idx: 14|21|22|23): {ExportIgnore: False, ReadOnly: True, ImportIgnore: True}
function Patch:PropertyInfo(idx) end
---@overload fun(idx: 0|1|2|3|4|5|6|9): "UInt32"
---@overload fun(idx: 7|8|13): "String"
---@overload fun(idx: 10|11): "Bool"
---@overload fun(idx: 12|15|16|17|18|19|20): "UInt64"
---@overload fun(idx: 14): "Int64"
---@overload fun(idx: 21|22|23): "Method"
function Patch:PropertyType(idx) end
...
---@overload fun(name: "Index"|"Count"|"No"|"MemoryFootprint"|"CountFixtures"|"CountSubfixtures"|"CountRTChannels"|"CountUIChannels"|"CountDMXModes"|"CountLogicalChannels", role: nil): integer
...
---@overload fun(class: "NoteTextEdit", undo: Undo?): NoteTextEdit
---@overload fun(class: nil, undo: Undo?): Object
function Patch:Find(class, undo) end
...
---@overload fun(property_name: "Index"|"Count"|"No"|"CountFixtures"|"CountSubfixtures"|"CountRTChannels"|"CountUIChannels"|"CountDMXModes"|"CountLogicalChannels", property_value: integer, override_change_level: ChangeLevel?)
---@overload fun(property_name: "Name"|"Note"|"DependencyExport", property_value: string, override_change_level: ChangeLevel?)
function Patch:Set(property_name, property_value, override_change_level) end
...
---@overload fun(property_name: "MultiLedBeamMode", property_value: MultiLedBeamMode)
---@overload fun(property_name: "StageFilter", property_value: None_only)
---@overload fun(property_name: "Filter"|"SelectedAgenda"|"FixedTarget"|"Values"|"Filter"|"Target"|"Target"|"PreferenceHandle"|"DestinationObject", property_value: Object)
...
function Patch:SetChildren(property_name, property_value) end